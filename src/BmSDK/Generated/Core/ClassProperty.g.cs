...
public partial class ClassProperty : BmSDK.ObjectProperty, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ClassProperty.
    /// </summary>
    public static ClassProperty DefaultObject => (ClassProperty)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ClassProperty>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ClassProperty>, new()
