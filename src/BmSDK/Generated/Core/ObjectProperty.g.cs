...
public partial class ObjectProperty : BmSDK.Property, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ObjectProperty.
    /// </summary>
    public static ObjectProperty DefaultObject => (ObjectProperty)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ObjectProperty>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ObjectProperty>, new()
