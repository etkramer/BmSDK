...
public partial class StrProperty : BmSDK.Property, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as StrProperty.
    /// </summary>
    public static StrProperty DefaultObject => (StrProperty)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<StrProperty>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<StrProperty>, new()
