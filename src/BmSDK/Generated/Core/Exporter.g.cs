...
public partial class Exporter : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as Exporter.
    /// </summary>
    public static Exporter DefaultObject => (Exporter)StaticClass().DefaultObject;
    ...
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<Exporter>, new()
