...
public partial class StructProperty : BmSDK.Property, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as StructProperty.
    /// </summary>
    public static StructProperty DefaultObject => (StructProperty)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<StructProperty>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<StructProperty>, new()
