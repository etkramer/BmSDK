...
public partial class NameProperty : BmSDK.Property, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as NameProperty.
    /// </summary>
    public static NameProperty DefaultObject => (NameProperty)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<NameProperty>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<NameProperty>, new()
