...
public partial class InterfaceProperty : BmSDK.Property, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterfaceProperty.
    /// </summary>
    public static InterfaceProperty DefaultObject => (InterfaceProperty)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterfaceProperty>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterfaceProperty>, new()
