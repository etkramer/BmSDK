...
public partial class TextBufferFactory : BmSDK.Factory, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as TextBufferFactory.
    /// </summary>
    public static TextBufferFactory DefaultObject => (TextBufferFactory)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<TextBufferFactory>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<TextBufferFactory>, new()
