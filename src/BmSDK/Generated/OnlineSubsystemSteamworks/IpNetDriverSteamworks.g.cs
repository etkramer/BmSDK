...
public partial class IpNetDriverSteamworks : BmSDK.IpDrv.TcpNetDriver, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as IpNetDriverSteamworks.
    /// </summary>
    public static IpNetDriverSteamworks DefaultObject => (IpNetDriverSteamworks)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<IpNetDriverSteamworks>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<IpNetDriverSteamworks>, new()
