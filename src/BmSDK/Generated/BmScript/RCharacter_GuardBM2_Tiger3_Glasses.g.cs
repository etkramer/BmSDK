...
public partial class RCharacter_GuardBM2_Tiger3_Glasses : BmSDK.BmScript.RCharacter_GuardBM2_Tiger3, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_GuardBM2_Tiger3_Glasses.
    /// </summary>
    public static RCharacter_GuardBM2_Tiger3_Glasses DefaultObject => (RCharacter_GuardBM2_Tiger3_Glasses)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_GuardBM2_Tiger3_Glasses>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_GuardBM2_Tiger3_Glasses>, new()
