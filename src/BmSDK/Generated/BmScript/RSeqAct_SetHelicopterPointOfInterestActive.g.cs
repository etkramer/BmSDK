...
public partial class RSeqAct_SetHelicopterPointOfInterestActive : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SetHelicopterPointOfInterestActive.
    /// </summary>
    public static RSeqAct_SetHelicopterPointOfInterestActive DefaultObject => (RSeqAct_SetHelicopterPointOfInterestActive)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetHelicopterPointOfInterestActive>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetHelicopterPointOfInterestActive>, new()
