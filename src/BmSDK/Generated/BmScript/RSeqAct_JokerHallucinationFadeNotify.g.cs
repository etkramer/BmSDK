...
public partial class RSeqAct_JokerHallucinationFadeNotify : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_JokerHallucinationFadeNotify.
    /// </summary>
    public static RSeqAct_JokerHallucinationFadeNotify DefaultObject => (RSeqAct_JokerHallucinationFadeNotify)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_JokerHallucinationFadeNotify>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_JokerHallucinationFadeNotify>, new()
