...
/// <summary>
/// Class: RCombatMove_BatmanCounterKickingGuard<br/>
/// (size = 876)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_BatmanCounterKickingGuard : BmSDK.BmGame.RCombatMove_BatmanCounter, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RCombatMove_BatmanCounterKickingGuard", false);
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_BatmanCounterKickingGuard.
    /// </summary>
    public static RCombatMove_BatmanCounterKickingGuard DefaultObject => (RCombatMove_BatmanCounterKickingGuard)StaticClass().DefaultObject;

    internal RCombatMove_BatmanCounterKickingGuard() { }

    /// <summary>
    /// Constructs a new RCombatMove_BatmanCounterKickingGuard
    /// </summary>
    public RCombatMove_BatmanCounterKickingGuard(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_BatmanCounterKickingGuard Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_BatmanCounterKickingGuard(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanCounterKickingGuard>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanCounterKickingGuard>, new()
    ...
    /// <summary>
    /// BoolProperty: bResetOnce
    /// </summary>
    public unsafe bool bResetOnce
    {
