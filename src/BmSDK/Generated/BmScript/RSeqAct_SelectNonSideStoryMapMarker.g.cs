...
public partial class RSeqAct_SelectNonSideStoryMapMarker : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SelectNonSideStoryMapMarker.
    /// </summary>
    public static RSeqAct_SelectNonSideStoryMapMarker DefaultObject => (RSeqAct_SelectNonSideStoryMapMarker)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SelectNonSideStoryMapMarker>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SelectNonSideStoryMapMarker>, new()
