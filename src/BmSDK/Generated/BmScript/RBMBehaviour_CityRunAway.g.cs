...
public partial class RBMBehaviour_CityRunAway : BmSDK.BmGame.RBMBehaviour_CityRunAwayBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_CityRunAway.
    /// </summary>
    public static RBMBehaviour_CityRunAway DefaultObject => (RBMBehaviour_CityRunAway)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_CityRunAway>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_CityRunAway>, new()
