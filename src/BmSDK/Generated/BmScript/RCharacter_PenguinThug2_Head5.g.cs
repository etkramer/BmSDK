...
public partial class RCharacter_PenguinThug2_Head5 : BmSDK.BmScript.RCharacter_PenguinThug, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_PenguinThug2_Head5.
    /// </summary>
    public static RCharacter_PenguinThug2_Head5 DefaultObject => (RCharacter_PenguinThug2_Head5)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug2_Head5>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug2_Head5>, new()
