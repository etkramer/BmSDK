...
public partial class RCharacter_GuardBM2_G3 : BmSDK.BmScript.RCharacter_GuardBM2, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_GuardBM2_G3.
    /// </summary>
    public static RCharacter_GuardBM2_G3 DefaultObject => (RCharacter_GuardBM2_G3)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_GuardBM2_G3>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_GuardBM2_G3>, new()
