...
public partial class RSeqEvent_SecondaryHelicopterScanned : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_SecondaryHelicopterScanned.
    /// </summary>
    public static RSeqEvent_SecondaryHelicopterScanned DefaultObject => (RSeqEvent_SecondaryHelicopterScanned)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_SecondaryHelicopterScanned>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_SecondaryHelicopterScanned>, new()
