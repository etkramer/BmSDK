...
public partial class RSeqAct_GetTransInFromGangPoint : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_GetTransInFromGangPoint.
    /// </summary>
    public static RSeqAct_GetTransInFromGangPoint DefaultObject => (RSeqAct_GetTransInFromGangPoint)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_GetTransInFromGangPoint>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_GetTransInFromGangPoint>, new()
