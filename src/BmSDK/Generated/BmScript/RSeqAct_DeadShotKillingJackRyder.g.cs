...
/// <summary>
/// Class: RSeqAct_DeadShotKillingJackRyder<br/>
/// (size = 260)
/// (flags = 8210)
/// </summary>
public partial class RSeqAct_DeadShotKillingJackRyder : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RSeqAct_DeadShotKillingJackRyder", false);
    ...
    /// <summary>
    /// Constructs a new RSeqAct_DeadShotKillingJackRyder
    /// </summary>
    public RSeqAct_DeadShotKillingJackRyder(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSeqAct_DeadShotKillingJackRyder Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RSeqAct_DeadShotKillingJackRyder(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_DeadShotKillingJackRyder>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_DeadShotKillingJackRyder>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RSeqAct_DeadShotKillingJackRyder.GetObjClassVersion", true);
    ...
    /// </summary>
    public unsafe BmSDK.Engine.Actor Deadshot
    {
    ...
    /// <summary>
    /// ObjectProperty: DSCamera
    /// </summary>
    public unsafe BmSDK.Engine.Actor DSCamera
    {
    ...
    /// ObjectProperty: DS
    /// </summary>
    public unsafe BmSDK.BmScript.RPawnBossDeadshot DS
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmScript.RPawnBossDeadshot>(Ptr + 240); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.R3rdPersonCamera>(Ptr + 244); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 244); }
    }

    /// <summary>
    /// ObjectProperty: DSCam
    /// </summary>
    public unsafe BmSDK.BmGame.RCameraActor DSCam
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RCameraActor>(Ptr + 248); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmScript.RSpecialMoveConfig_SaveJackRyderFromDeadShot>(Ptr + 252); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmScript.RSpecialMoveInstance_SaveJackRyderFromDeadShot>(Ptr + 256); }
