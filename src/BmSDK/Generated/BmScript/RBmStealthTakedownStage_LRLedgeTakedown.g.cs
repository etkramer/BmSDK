...
public partial class RBmStealthTakedownStage_LRLedgeTakedown : BmSDK.BmGame.RStealthTakeDownStage_LedgeAttack, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBmStealthTakedownStage_LRLedgeTakedown(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBmStealthTakedownStage_LRLedgeTakedown Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
