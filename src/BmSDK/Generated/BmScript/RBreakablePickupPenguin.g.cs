...
public partial class RBreakablePickupPenguin : BmSDK.BmScript.RPenguinTarget, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBreakablePickupPenguin(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBreakablePickupPenguin Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
