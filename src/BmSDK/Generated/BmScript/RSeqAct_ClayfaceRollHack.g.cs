...
/// <summary>
/// Class: RSeqAct_ClayfaceRollHack<br/>
/// (size = 248)
/// (flags = 8210)
/// </summary>
public partial class RSeqAct_ClayfaceRollHack : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RSeqAct_ClayfaceRollHack", false);
    ...
    /// <summary>
    /// Constructs a new RSeqAct_ClayfaceRollHack
    /// </summary>
    public RSeqAct_ClayfaceRollHack(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSeqAct_ClayfaceRollHack Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RSeqAct_ClayfaceRollHack(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ClayfaceRollHack>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ClayfaceRollHack>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RSeqAct_ClayfaceRollHack:GetObjClassVersion", true);
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RPawnCharacter Clayface
    {
    ...
    /// <summary>
    /// FloatProperty: TimeInTransition
    /// </summary>
    public unsafe float TimeInTransition
    {
    ...
    /// <summary>
    /// ObjectProperty: AllowedToRollVolume
    /// </summary>
    public unsafe BmSDK.Engine.Volume AllowedToRollVolume
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.Volume>(Ptr + 244); }
