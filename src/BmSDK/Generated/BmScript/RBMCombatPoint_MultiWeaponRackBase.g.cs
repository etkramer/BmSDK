...
/// <summary>
/// ABSTRACT Class: RBMCombatPoint_MultiWeaponRackBase<br/>
/// (size = 544)
/// (flags = 8389139)
/// </summary>
public partial class RBMCombatPoint_MultiWeaponRackBase : BmSDK.BmGame.RBMCombatPoint_EnvironmentWeapon, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RBMCombatPoint_MultiWeaponRackBase", false);
    ...
    /// </summary>
    protected RBMCombatPoint_MultiWeaponRackBase(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMCombatPoint_MultiWeaponRackBase>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMCombatPoint_MultiWeaponRackBase>, new()
    ...
    /// <summary>
    /// ArrayProperty: WeaponInfoList
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.BmScript.RBMCombatPoint_MultiWeaponRackBase.FWeaponInfo> WeaponInfoList
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.BmScript.RBMCombatPoint_MultiWeaponRackBase.FWeaponInfo>>(Ptr + 516); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 516); }
    }

    /// <summary>
    /// IntProperty: CurrWeaponID
    /// </summary>
    public unsafe int CurrWeaponID
    {
    ...
    public partial record struct FWeaponInfo
    {
        /// <summary>
        /// ComponentProperty: WeaponMesh
        /// </summary>
        public unsafe BmSDK.Engine.StaticMeshComponent WeaponMesh
        {
        ...
        /// <summary>
        /// NameProperty: WeaponAnimName
        /// </summary>
        public unsafe BmSDK.FName WeaponAnimName
        {
        ...
        /// <summary>
        /// IntProperty: WeaponPriority
        /// </summary>
        public unsafe int WeaponPriority
        {
