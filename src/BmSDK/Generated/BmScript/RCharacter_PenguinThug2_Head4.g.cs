...
public partial class RCharacter_PenguinThug2_Head4 : BmSDK.BmScript.RCharacter_PenguinThug, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_PenguinThug2_Head4.
    /// </summary>
    public static RCharacter_PenguinThug2_Head4 DefaultObject => (RCharacter_PenguinThug2_Head4)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug2_Head4>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug2_Head4>, new()
