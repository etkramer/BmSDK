...
public partial class RBMSeqEvent_HarleyChokePointTakedownStart : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMSeqEvent_HarleyChokePointTakedownStart.
    /// </summary>
    public static RBMSeqEvent_HarleyChokePointTakedownStart DefaultObject => (RBMSeqEvent_HarleyChokePointTakedownStart)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMSeqEvent_HarleyChokePointTakedownStart>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMSeqEvent_HarleyChokePointTakedownStart>, new()
