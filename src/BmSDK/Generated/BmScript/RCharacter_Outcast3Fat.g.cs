...
public partial class RCharacter_Outcast3Fat : BmSDK.BmScript.RCharacter_OutcastBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_Outcast3Fat.
    /// </summary>
    public static RCharacter_Outcast3Fat DefaultObject => (RCharacter_Outcast3Fat)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_Outcast3Fat>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_Outcast3Fat>, new()
