...
public partial class RSentryGun : BmSDK.BmGame.RSentryGunBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSentryGun.
    /// </summary>
    public static RSentryGun DefaultObject => (RSentryGun)StaticClass().DefaultObject;
