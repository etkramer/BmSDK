...
public partial class RSeqAct_MadHatterCombat : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    /// </summary>
    public InlineArray<BmSDK.Engine.AkEvent> clockSoundStartEvents => new(4, Ptr + 432, 4);
    ...
    /// </summary>
    public InlineArray<BmSDK.Engine.AkEvent> clockSoundStopEvents => new(4, Ptr + 448, 4);
