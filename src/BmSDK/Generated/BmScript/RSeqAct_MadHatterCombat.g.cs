...
public partial class RSeqAct_MadHatterCombat : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_MadHatterCombat>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_MadHatterCombat>, new()
    ...
    /// </summary>
    public InlineArray<BmSDK.Engine.AkEvent> clockSoundStartEvents => new(4, Ptr + 432, 4, this);
    ...
    /// </summary>
    public InlineArray<BmSDK.Engine.AkEvent> clockSoundStopEvents => new(4, Ptr + 448, 4, this);
