...
/// <summary>
/// Class: RPawnVillainThug_MadHatter_Combat<br/>
/// (size = 3568)
/// (flags = 10485814)
/// </summary>
public partial class RPawnVillainThug_MadHatter_Combat : BmSDK.BmGame.RPawnVillainThug, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RPawnVillainThug_MadHatter_Combat", false);
    ...
    /// <summary>
    /// Constructs a new RPawnVillainThug_MadHatter_Combat
    /// </summary>
    public RPawnVillainThug_MadHatter_Combat(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RPawnVillainThug_MadHatter_Combat Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RPawnVillainThug_MadHatter_Combat(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RPawnVillainThug_MadHatter_Combat>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RPawnVillainThug_MadHatter_Combat>, new()
    ...
    /// <summary>
    /// BoolProperty: bDoneDespawnFX
    /// </summary>
    public unsafe bool bDoneDespawnFX
    {
