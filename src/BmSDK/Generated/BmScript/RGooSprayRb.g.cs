...
public partial class RGooSprayRb : BmSDK.BmGame.RGooSpray, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RGooSprayRb(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RGooSprayRb Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
