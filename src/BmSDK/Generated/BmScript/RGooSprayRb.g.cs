...
/// <summary>
/// Class: RGooSprayRb<br/>
/// (size = 1104)
/// (flags = 8388658)
/// </summary>
public partial class RGooSprayRb : BmSDK.BmGame.RGooSpray, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RGooSprayRb", false);
    ...
    /// <summary>
    /// Gets the class default object as RGooSprayRb.
    /// </summary>
    public static RGooSprayRb DefaultObject => (RGooSprayRb)StaticClass().DefaultObject;

    internal RGooSprayRb() { }

    /// <summary>
    /// Constructs a new RGooSprayRb
    /// </summary>
    public RGooSprayRb(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RGooSprayRb(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RGooSprayRb>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RGooSprayRb>, new()
