...
public partial class RBMCombatPoint_Explosive : BmSDK.BmGame.RBMCombatPoint_EnvironmentWeapon, BmSDK.BmGame.RBatarangableInterface, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBMCombatPoint_Explosive(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMCombatPoint_Explosive Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
