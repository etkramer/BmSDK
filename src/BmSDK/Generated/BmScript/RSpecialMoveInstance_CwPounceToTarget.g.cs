...
public partial class RSpecialMoveInstance_CwPounceToTarget : BmSDK.BmGame.RSpecialMoveInstance_RelativeAnimMove, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe void TriggerLaunchCam()
    {
    ...
    /// </summary>
    public unsafe void WallClimbStartCam()
    {
    ...
    /// </summary>
    public unsafe void LookAtLandPoint()
    {
    ...
    /// </summary>
    public unsafe void GetTargetFeature(BmSDK.BmGame.RPawnPlayer.FEnvironmentSpecialMoveLocator Locator)
    {
    ...
    /// </summary>
    public unsafe void SetEndCameraState()
    {
    ...
    /// </summary>
    public unsafe void StartNextPounceAnimation()
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPawnPlayer.FEnvironmentSpecialMoveLocator>(Ptr + 764); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmScript.RSpecialMoveConfig_CwPounceToTarget>(Ptr + 876); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPawnPlayer.EnvironmentSpecialMoveTypes>(Ptr + 880); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmScript.RCwGrappleGun>(Ptr + 892); }
