...
public partial class RCharacter_OutcastTwoFace3 : BmSDK.BmGame.RCharacter_TwoFaceThugBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_OutcastTwoFace3.
    /// </summary>
    public static RCharacter_OutcastTwoFace3 DefaultObject => (RCharacter_OutcastTwoFace3)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_OutcastTwoFace3>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_OutcastTwoFace3>, new()
