...
/// <summary>
/// Class: RCombatMove_BatmanProgramBatarang<br/>
/// (size = 488)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_BatmanProgramBatarang : BmSDK.BmGame.RCombatMove, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RCombatMove_BatmanProgramBatarang", false);
    ...
    /// <summary>
    /// Constructs a new RCombatMove_BatmanProgramBatarang
    /// </summary>
    public RCombatMove_BatmanProgramBatarang(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_BatmanProgramBatarang Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_BatmanProgramBatarang(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanProgramBatarang>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanProgramBatarang>, new()
    ...
    /// </summary>
    public unsafe BmSDK.BmScript.RSeqAct_RasBossLogic RasBossController
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmScript.RSeqAct_RasBossLogic>(Ptr + 468); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmScript.RBMCombatThrownObject_RasSword>(Ptr + 480); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 480); }
    }

    /// <summary>
    /// ObjectProperty: Backarang
    /// </summary>
    public unsafe BmSDK.BmScript.RBMWeaponBatmanBackarang Backarang
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmScript.RBMWeaponBatmanBackarang>(Ptr + 484); }
