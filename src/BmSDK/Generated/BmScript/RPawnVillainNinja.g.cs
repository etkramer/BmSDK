...
public partial class RPawnVillainNinja : BmSDK.BmScript.RPawnVillainNinjaScriptBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RPawnVillainNinja(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RPawnVillainNinja Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
