...
public partial class RCharacter_PenguinThug : BmSDK.BmGame.RCharacter_PenguinThugBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_PenguinThug.
    /// </summary>
    public static RCharacter_PenguinThug DefaultObject => (RCharacter_PenguinThug)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug>, new()
