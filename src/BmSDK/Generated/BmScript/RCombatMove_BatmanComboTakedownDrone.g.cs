...
/// <summary>
/// Class: RCombatMove_BatmanComboTakedownDrone<br/>
/// (size = 580)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_BatmanComboTakedownDrone : BmSDK.BmGame.RCombatMove_PlayerSpecial, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RCombatMove_BatmanComboTakedownDrone", false);
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_BatmanComboTakedownDrone.
    /// </summary>
    public static RCombatMove_BatmanComboTakedownDrone DefaultObject => (RCombatMove_BatmanComboTakedownDrone)StaticClass().DefaultObject;

    internal RCombatMove_BatmanComboTakedownDrone() { }

    /// <summary>
    /// Constructs a new RCombatMove_BatmanComboTakedownDrone
    /// </summary>
    public RCombatMove_BatmanComboTakedownDrone(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_BatmanComboTakedownDrone Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_BatmanComboTakedownDrone(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanComboTakedownDrone>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanComboTakedownDrone>, new()
