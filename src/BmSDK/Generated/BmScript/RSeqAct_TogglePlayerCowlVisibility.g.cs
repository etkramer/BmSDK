...
public partial class RSeqAct_TogglePlayerCowlVisibility : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_TogglePlayerCowlVisibility.
    /// </summary>
    public static RSeqAct_TogglePlayerCowlVisibility DefaultObject => (RSeqAct_TogglePlayerCowlVisibility)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_TogglePlayerCowlVisibility>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_TogglePlayerCowlVisibility>, new()
