...
public partial class RSpecialMoveConfig_CalibrateVoiceSynthesiser : BmSDK.BmGame.RSpecialMoveConfig, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_CalibrateVoiceSynthesiser.
    /// </summary>
    public static RSpecialMoveConfig_CalibrateVoiceSynthesiser DefaultObject => (RSpecialMoveConfig_CalibrateVoiceSynthesiser)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_CalibrateVoiceSynthesiser>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_CalibrateVoiceSynthesiser>, new()
    ...
    /// </summary>
    public enum VoiceSyntheserTarget : byte
    {
        VST_HarleyQuinn = 0,
        VST_SimonStagg = 1,
        VST_Riddler = 2,
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RGameInfo.FDofStruct DOFSettings
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RGameInfo.FDofStruct>(Ptr + 492);
