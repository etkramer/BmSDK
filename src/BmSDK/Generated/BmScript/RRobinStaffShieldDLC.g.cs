...
public partial class RRobinStaffShieldDLC : BmSDK.BmScript.RRobinStaffShield, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RRobinStaffShieldDLC(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RRobinStaffShieldDLC Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
    ...
    /// </summary>
    public unsafe bool IsSameShieldAttackVolume(BmSDK.Engine.Actor A, BmSDK.Engine.Actor B)
    {
    ...
    /// </summary>
    public unsafe void BulletShieldFadeTimer()
    {
    ...
    /// </summary>
    public unsafe void TurretHitTimer()
    {
