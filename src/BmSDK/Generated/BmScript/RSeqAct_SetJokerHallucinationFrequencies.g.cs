...
public partial class RSeqAct_SetJokerHallucinationFrequencies : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SetJokerHallucinationFrequencies.
    /// </summary>
    public static RSeqAct_SetJokerHallucinationFrequencies DefaultObject => (RSeqAct_SetJokerHallucinationFrequencies)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetJokerHallucinationFrequencies>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetJokerHallucinationFrequencies>, new()
