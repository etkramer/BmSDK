...
public partial class RCinematicBatman : BmSDK.BmGame.RCinematicBatmanBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCinematicBatman.
    /// </summary>
    public static RCinematicBatman DefaultObject => (RCinematicBatman)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RCinematicBatman(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
