...
public partial class RCharacter_VenomHenchman : BmSDK.BmScript.RCharacter_Venom, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_VenomHenchman.
    /// </summary>
    public static RCharacter_VenomHenchman DefaultObject => (RCharacter_VenomHenchman)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_VenomHenchman>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_VenomHenchman>, new()
