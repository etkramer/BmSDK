...
public partial class RVehicleBehaviour_DriveToRiotPoint : BmSDK.BmGame.RVehicleBehaviour_DriveToGoalPoint, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RVehicleBehaviour_DriveToRiotPoint.
    /// </summary>
    public static RVehicleBehaviour_DriveToRiotPoint DefaultObject => (RVehicleBehaviour_DriveToRiotPoint)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_DriveToRiotPoint>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_DriveToRiotPoint>, new()
