...
public partial class RPresurePad : BmSDK.BmGame.RPresurePadBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT BaseMesh
    {
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT PadMesh
    {
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT AudioSwitchActivated
    {
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT AudioSwitchActivatedOff
    {
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT AudioSwitchActivated2nd
    {
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT AudioSwitchActivated3rd
    {
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT ActivePads
    {
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT TurnedOffMIC
    {
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT VoiceSynthesiserInteractionComponent
    {
    ...
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.FString> ValidAttached
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.FString>>(Ptr + 824); }
    ...
    /// </summary>
    public unsafe NEED_UPDATE_STRUCTPROPERTY_LAYOUT MICList_0
    {
    ...
    /// StructProperty: MICList
    /// </summary>
    public unsafe NEED_UPDATE_STRUCTPROPERTY_LAYOUT MICList_1
    {
    ...
    /// StructProperty: MICList
    /// </summary>
    public unsafe NEED_UPDATE_STRUCTPROPERTY_LAYOUT MICList_2
    {
    ...
    /// StructProperty: MICList
    /// </summary>
    public unsafe NEED_UPDATE_STRUCTPROPERTY_LAYOUT MICList_3
    {
    ...
    /// StructProperty: MICList
    /// </summary>
    public unsafe NEED_UPDATE_STRUCTPROPERTY_LAYOUT MICList_4
    {
    ...
    /// StructProperty: MICList
    /// </summary>
    public unsafe NEED_UPDATE_STRUCTPROPERTY_LAYOUT MICList_5
    {
    ...
    /// StructProperty: MICList
    /// </summary>
    public unsafe NEED_UPDATE_STRUCTPROPERTY_LAYOUT MICList_6
    {
    ...
    /// StructProperty: MICList
    /// </summary>
    public unsafe NEED_UPDATE_STRUCTPROPERTY_LAYOUT MICList_7
    {
    ...
    /// StructProperty: MICList
    /// </summary>
    public unsafe NEED_UPDATE_STRUCTPROPERTY_LAYOUT MICList_8
    {
