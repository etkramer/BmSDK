...
public partial class RPresurePad : BmSDK.BmGame.RPresurePadBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RPresurePad(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
    ...
    /// <summary>
    /// BoolProperty: BadPressurePad
    /// </summary>
    public unsafe bool BadPressurePad
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.RInteractionClass>(Ptr + 444); }
