...
public partial class RCharacter_Penguin : BmSDK.BmGame.RCharacter, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_Penguin.
    /// </summary>
    public static RCharacter_Penguin DefaultObject => (RCharacter_Penguin)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_Penguin>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_Penguin>, new()
