...
public partial class RRiddlerSwitch : BmSDK.BmGame.RInteractableItem, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Function: AllowController
    /// </summary>
    public unsafe virtual bool AllowController(BmSDK.Engine.Controller C)
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RRiddlerSwitch.AllowController", true);
        byte* paramsPtr = stackalloc byte[12];
    ...
    /// </summary>
    public unsafe override bool CanBeMissileTargetted()
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RRiddlerSwitch.CanBeMissileTargetted", true);
        byte* paramsPtr = stackalloc byte[4];
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return BmSDK.Framework.MarshalUtil.ToManaged<bool>(paramsPtr + 0);
    }
    ...
    /// <summary>
    /// BoolProperty: bCanSwitchBackOn
    /// </summary>
    public unsafe bool bCanSwitchBackOn
    {
    ...
    /// <summary>
    /// BoolProperty: bDontPlayHitAudio
    /// </summary>
    public unsafe bool bDontPlayHitAudio
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.MaterialInstanceConstant>(Ptr + 908); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.AkEvent>(Ptr + 932); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.StaticMeshComponent>(Ptr + 940); }
