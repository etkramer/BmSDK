...
public partial class RBMBehaviour_JokerBossRiddler : BmSDK.BmGame.RBMBehaviour, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_JokerBossRiddler.
    /// </summary>
    public static RBMBehaviour_JokerBossRiddler DefaultObject => (RBMBehaviour_JokerBossRiddler)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_JokerBossRiddler>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_JokerBossRiddler>, new()
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 SavedFireLocation
