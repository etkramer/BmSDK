...
/// <summary>
/// Class: RCombatMove_FreezeBeatUp<br/>
/// (size = 1040)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_FreezeBeatUp : BmSDK.BmGame.RCombatMove_FreezeBeatUpBase, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RCombatMove_FreezeBeatUp", false);
    ...
    /// <summary>
    /// Constructs a new RCombatMove_FreezeBeatUp
    /// </summary>
    public RCombatMove_FreezeBeatUp(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_FreezeBeatUp Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_FreezeBeatUp(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_FreezeBeatUp>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_FreezeBeatUp>, new()
    ...
    /// <summary>
    /// Function: PlayFreezeReaction
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId PlayFreezeReaction()
    {
    ...
    /// </summary>
    public unsafe void ReturnToNormalCamera()
    {
    ...
    /// <summary>
    /// Function: SafeToInitiateNextAttack
    /// </summary>
    public unsafe void SafeToInitiateNextAttack()
    {
    ...
    /// <summary>
    /// Function: TryToPlayCamera
    /// </summary>
    public unsafe bool TryToPlayCamera(BmSDK.BmGame.RInGameCinematicCam CinematicCamera, BmSDK.FName AnimName, BmSDK.Engine.AnimSet TheAnimSet, bool bCamMirrored, float FOV = default, bool bHardCut = default)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(TheAnimSet, paramsPtr + 12);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(bCamMirrored, paramsPtr + 16);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(FOV, paramsPtr + 20);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(bHardCut, paramsPtr + 24);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return BmSDK.Framework.MarshalUtil.ToManaged<bool>(paramsPtr + 28);
    }

    /// <summary>
    /// Function: PlayFinisherCameraAnim
    /// </summary>
    public unsafe void PlayFinisherCameraAnim(System.Numerics.Vector3 ref_position, System.Numerics.Vector3 ref_direction, BmSDK.FName primary_camera, BmSDK.FName backup_camera)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(primary_camera, paramsPtr + 24);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(backup_camera, paramsPtr + 32);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }

    /// <summary>
    /// Function: StartFinalBlowCamera
    /// </summary>
    public unsafe void StartFinalBlowCamera()
    {
    ...
    /// <summary>
    /// Function: GetFlipOverHeadAnim
    /// </summary>
    public unsafe BmSDK.FName GetFlipOverHeadAnim()
    {
    ...
    /// <summary>
    /// Function: GetBeatdownStrikeAnim
    /// </summary>
    public unsafe BmSDK.FName GetBeatdownStrikeAnim()
    {
    ...
    /// <summary>
    /// Function: GetCustomStrikeAnim
    /// </summary>
    public unsafe BmSDK.FName GetCustomStrikeAnim()
    {
    ...
    /// </summary>
    public unsafe bool IsFinalBlow()
    {
    ...
    /// <summary>
    /// BoolProperty: bIsSomersaultAttack
    /// </summary>
    public unsafe bool bIsSomersaultAttack
    {
    ...
    /// <summary>
    /// BoolProperty: bMirroredStrike
    /// </summary>
    public unsafe bool bMirroredStrike
    {
    ...
    /// <summary>
    /// BoolProperty: StrikeIsKillingBlow
    /// </summary>
    public unsafe bool StrikeIsKillingBlow
    {
    ...
    /// <summary>
    /// BoolProperty: StrikeIsFinalBlowInSequence
    /// </summary>
    public unsafe bool StrikeIsFinalBlowInSequence
    {
