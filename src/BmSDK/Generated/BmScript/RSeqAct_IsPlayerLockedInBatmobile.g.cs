...
public partial class RSeqAct_IsPlayerLockedInBatmobile : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_IsPlayerLockedInBatmobile.
    /// </summary>
    public static RSeqAct_IsPlayerLockedInBatmobile DefaultObject => (RSeqAct_IsPlayerLockedInBatmobile)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_IsPlayerLockedInBatmobile>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_IsPlayerLockedInBatmobile>, new()
