...
public partial class RSeqEvent_FreezeIceMeshActivated : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_FreezeIceMeshActivated.
    /// </summary>
    public static RSeqEvent_FreezeIceMeshActivated DefaultObject => (RSeqEvent_FreezeIceMeshActivated)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_FreezeIceMeshActivated>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_FreezeIceMeshActivated>, new()
