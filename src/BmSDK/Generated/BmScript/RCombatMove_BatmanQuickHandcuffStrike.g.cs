...
/// <summary>
/// Class: RCombatMove_BatmanQuickHandcuffStrike<br/>
/// (size = 1036)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_BatmanQuickHandcuffStrike : BmSDK.BmGame.RCombatMove_BatmanQuickStrike, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RCombatMove_BatmanQuickHandcuffStrike", false);
    ...
    /// <summary>
    /// Constructs a new RCombatMove_BatmanQuickHandcuffStrike
    /// </summary>
    public RCombatMove_BatmanQuickHandcuffStrike(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_BatmanQuickHandcuffStrike Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_BatmanQuickHandcuffStrike(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanQuickHandcuffStrike>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanQuickHandcuffStrike>, new()
