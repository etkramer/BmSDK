...
public partial class RSeqAct_SideStory_SetIntelVisuallySuppressed : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SideStory_SetIntelVisuallySuppressed.
    /// </summary>
    public static RSeqAct_SideStory_SetIntelVisuallySuppressed DefaultObject => (RSeqAct_SideStory_SetIntelVisuallySuppressed)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SideStory_SetIntelVisuallySuppressed>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SideStory_SetIntelVisuallySuppressed>, new()
