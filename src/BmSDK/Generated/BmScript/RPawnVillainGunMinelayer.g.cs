...
/// (flags = 10485814)
/// </summary>
public partial class RPawnVillainGunMinelayer : BmSDK.BmScript.RPawnVillainGun, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RPawnVillainGunMinelayer(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
    ...
    /// Function: SpawnMine
    /// </summary>
    public unsafe override void SpawnMine(BmSDK.BmGame.RThugMineablePointBase TargetMinePoint)
    {
    ...
    /// </summary>
    public unsafe BmSDK.Engine.StaticMeshComponent GrabMineMeshStandard
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.StaticMeshComponent>(Ptr + 3652); }
