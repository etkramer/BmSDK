...
public partial class RCharacter_JokerThug1Fat_Mask : BmSDK.BmScript.RCharacter_JokerThug1Fat, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_JokerThug1Fat_Mask.
    /// </summary>
    public static RCharacter_JokerThug1Fat_Mask DefaultObject => (RCharacter_JokerThug1Fat_Mask)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug1Fat_Mask>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug1Fat_Mask>, new()
