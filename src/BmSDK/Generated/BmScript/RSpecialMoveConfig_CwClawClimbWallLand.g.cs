...
public partial class RSpecialMoveConfig_CwClawClimbWallLand : BmSDK.BmGame.RSpecialMoveConfig_RelativeAnimMove, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_CwClawClimbWallLand.
    /// </summary>
    public static RSpecialMoveConfig_CwClawClimbWallLand DefaultObject => (RSpecialMoveConfig_CwClawClimbWallLand)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_CwClawClimbWallLand>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_CwClawClimbWallLand>, new()
