...
/// <summary>
/// Class: RBMBehaviour_HarleyWalkAroundBats<br/>
/// (size = 444)
/// (flags = 8210)
/// </summary>
public partial class RBMBehaviour_HarleyWalkAroundBats : BmSDK.BmGame.RBMBehaviour, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RBMBehaviour_HarleyWalkAroundBats", false);
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_HarleyWalkAroundBats.
    /// </summary>
    public static RBMBehaviour_HarleyWalkAroundBats DefaultObject => (RBMBehaviour_HarleyWalkAroundBats)StaticClass().DefaultObject;

    internal RBMBehaviour_HarleyWalkAroundBats() { }

    /// <summary>
    /// Constructs a new RBMBehaviour_HarleyWalkAroundBats
    /// </summary>
    public RBMBehaviour_HarleyWalkAroundBats(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMBehaviour_HarleyWalkAroundBats Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RBMBehaviour_HarleyWalkAroundBats(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_HarleyWalkAroundBats>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_HarleyWalkAroundBats>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RBMBehaviour_HarleyWalkAroundBats.GetObjClassVersion", true);
    ...
    /// <summary>
    /// BoolProperty: bFirstPathSet
    /// </summary>
    public unsafe bool bFirstPathSet
    {
    ...
    /// <summary>
    /// FloatProperty: TimeTillFirstWalk
    /// </summary>
    public unsafe float TimeTillFirstWalk
    {
    ...
    /// <summary>
    /// FloatProperty: CurrentTimeTillFirstWalk
    /// </summary>
    public unsafe float CurrentTimeTillFirstWalk
    {
    ...
    /// <summary>
    /// FloatProperty: TimeForFaceAt
    /// </summary>
    public unsafe float TimeForFaceAt
    {
    ...
    /// <summary>
    /// FloatProperty: CurrentTimeForFaceAt
    /// </summary>
    public unsafe float CurrentTimeForFaceAt
    {
    ...
    /// <summary>
    /// NameProperty: TurnSlowTransition
    /// </summary>
    public unsafe BmSDK.FName TurnSlowTransition
    {
