...
public partial class RChatterTeeth : BmSDK.BmGame.RChatteringTeeth, BmSDK.BmGame.RBatarangableInterface, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RChatterTeeth(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RChatterTeeth Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
