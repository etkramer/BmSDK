...
/// <summary>
/// Class: RChatterTeeth<br/>
/// (size = 556)
/// (flags = 8389138)
/// </summary>
public partial class RChatterTeeth : BmSDK.BmGame.RChatteringTeeth, BmSDK.BmGame.RBatarangableInterface, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RChatterTeeth", false);
    ...
    /// <summary>
    /// Constructs a new RChatterTeeth
    /// </summary>
    public RChatterTeeth(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RChatterTeeth(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RChatterTeeth>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RChatterTeeth>, new()
    ...
    /// <summary>
    /// ObjectProperty: ChatterAnimSet
    /// </summary>
    public unsafe BmSDK.Engine.AnimSet ChatterAnimSet
    {
    ...
    /// <summary>
    /// NameProperty: Name_TeethParam
    /// </summary>
    public unsafe BmSDK.FName Name_TeethParam
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.DynamicLightEnvironmentComponent>(Ptr + 548); }
