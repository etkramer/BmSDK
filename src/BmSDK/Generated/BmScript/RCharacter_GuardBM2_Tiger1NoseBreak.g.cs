...
public partial class RCharacter_GuardBM2_Tiger1NoseBreak : BmSDK.BmScript.RCharacter_GuardBM2_Tiger1, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_GuardBM2_Tiger1NoseBreak.
    /// </summary>
    public static RCharacter_GuardBM2_Tiger1NoseBreak DefaultObject => (RCharacter_GuardBM2_Tiger1NoseBreak)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_GuardBM2_Tiger1NoseBreak>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_GuardBM2_Tiger1NoseBreak>, new()
