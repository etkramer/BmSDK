...
public partial class RCharacter_Outcast3Thin : BmSDK.BmScript.RCharacter_OutcastBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_Outcast3Thin.
    /// </summary>
    public static RCharacter_Outcast3Thin DefaultObject => (RCharacter_Outcast3Thin)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_Outcast3Thin>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_Outcast3Thin>, new()
