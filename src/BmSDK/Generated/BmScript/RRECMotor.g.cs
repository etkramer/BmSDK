...
public partial class RRECMotor : BmSDK.BmScript.RMagneticSurfaceSM, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RRECMotor(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RRECMotor Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
