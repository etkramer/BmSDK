...
public partial class RPawnVillainMilitiaCaptain : BmSDK.BmGame.RPawnVillainThug, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RPawnVillainMilitiaCaptain.
    /// </summary>
    public static RPawnVillainMilitiaCaptain DefaultObject => (RPawnVillainMilitiaCaptain)StaticClass().DefaultObject;
