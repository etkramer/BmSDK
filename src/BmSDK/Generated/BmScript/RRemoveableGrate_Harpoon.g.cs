...
public partial class RRemoveableGrate_Harpoon : BmSDK.BmGame.RRemoveableGrate, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RRemoveableGrate_Harpoon.
    /// </summary>
    public static RRemoveableGrate_Harpoon DefaultObject => (RRemoveableGrate_Harpoon)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RRemoveableGrate_Harpoon(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
