...
public partial class RSeqAct_UpdateJokerNuke : BmSDK.BmGame.RSeqAct_UpdateJokerNukeBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_UpdateJokerNuke.
    /// </summary>
    public static RSeqAct_UpdateJokerNuke DefaultObject => (RSeqAct_UpdateJokerNuke)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_UpdateJokerNuke>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_UpdateJokerNuke>, new()
