...
/// <summary>
/// Class: RBMBehaviour_PDLCHarley<br/>
/// (size = 500)
/// (flags = 8210)
/// </summary>
public partial class RBMBehaviour_PDLCHarley : BmSDK.BmGame.RBMBehaviour_Combat, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RBMBehaviour_PDLCHarley", false);
    ...
    /// <summary>
    /// Constructs a new RBMBehaviour_PDLCHarley
    /// </summary>
    public RBMBehaviour_PDLCHarley(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMBehaviour_PDLCHarley Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RBMBehaviour_PDLCHarley(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_PDLCHarley>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_PDLCHarley>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RBMBehaviour_PDLCHarley.GetObjClassVersion", true);
    ...
    /// <summary>
    /// BoolProperty: bDoneAttack
    /// </summary>
    public unsafe bool bDoneAttack
    {
