...
/// <summary>
/// Class: RCombatMove_BatmanCounterHarleyChurch<br/>
/// (size = 872)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_BatmanCounterHarleyChurch : BmSDK.BmGame.RCombatMove_BatmanCounter, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RCombatMove_BatmanCounterHarleyChurch", false);
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_BatmanCounterHarleyChurch.
    /// </summary>
    public static RCombatMove_BatmanCounterHarleyChurch DefaultObject => (RCombatMove_BatmanCounterHarleyChurch)StaticClass().DefaultObject;

    internal RCombatMove_BatmanCounterHarleyChurch() { }

    /// <summary>
    /// Constructs a new RCombatMove_BatmanCounterHarleyChurch
    /// </summary>
    public RCombatMove_BatmanCounterHarleyChurch(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_BatmanCounterHarleyChurch Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_BatmanCounterHarleyChurch(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanCounterHarleyChurch>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanCounterHarleyChurch>, new()
