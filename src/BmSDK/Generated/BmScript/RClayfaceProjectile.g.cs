...
public partial class RClayfaceProjectile : BmSDK.BmGame.RClayfaceProjectileBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RClayfaceProjectile.
    /// </summary>
    public static RClayfaceProjectile DefaultObject => (RClayfaceProjectile)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RClayfaceProjectile(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
