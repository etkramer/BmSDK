...
public partial class RCharacter_GuardBM2_G1 : BmSDK.BmScript.RCharacter_GuardBM2, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_GuardBM2_G1.
    /// </summary>
    public static RCharacter_GuardBM2_G1 DefaultObject => (RCharacter_GuardBM2_G1)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_GuardBM2_G1>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_GuardBM2_G1>, new()
