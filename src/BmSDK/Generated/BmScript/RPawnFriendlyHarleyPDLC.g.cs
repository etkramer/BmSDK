...
public partial class RPawnFriendlyHarleyPDLC : BmSDK.BmGame.RPawnVillainThug, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RPawnFriendlyHarleyPDLC(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RPawnFriendlyHarleyPDLC Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
    ...
    /// </summary>
    public unsafe void CounterAttempted()
    {
    ...
    /// </summary>
    public unsafe bool NeedsToDodgeSpecificActor(BmSDK.Engine.Actor inActor)
    {
    ...
    /// </summary>
    public unsafe bool NeedsToDodge()
    {
    ...
    /// </summary>
    public unsafe bool AreRobotThugsPresent()
    {
    ...
    /// </summary>
    public unsafe void DestroyProjectiles()
    {
    ...
    /// </summary>
    public unsafe void TurnLaserOn()
    {
    ...
    /// </summary>
    public unsafe void CleanUpLastRocket()
    {
