...
public partial class RPawnBossClayfaceCoup : BmSDK.BmGame.RPawnBossClayfaceBase, BmSDK.BmGame.RInteractInterface, BmSDK.IGameObject
{
    ...
    public partial record struct FSwipeParameters
    {
        ...
        /// </summary>
        public unsafe float SwipeDamage
        {
    ...
    public partial record struct FDroneParameters
    {
        ...
        /// </summary>
        public unsafe int MaxSmallDronesAttacking
        {
        ...
        /// </summary>
        public unsafe float KillDroneDamageToClayface
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<float>(Ptr + 12); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 12); }; }
        }
        ...
        /// </summary>
        public unsafe float KillLargeDroneDamageToClayface
        {
    ...
    public partial record struct FVomitParameters
    {
        ...
        /// </summary>
        public unsafe float VomitSpeed
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<float>(Ptr + 0); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 0); }; }
        }
        ...
        /// </summary>
        public unsafe float VomitDamage
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<float>(Ptr + 12); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 12); }; }
        }
        ...
        /// </summary>
        public unsafe float MouthOpenTime
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<float>(Ptr + 24); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 24); }; }
        }
