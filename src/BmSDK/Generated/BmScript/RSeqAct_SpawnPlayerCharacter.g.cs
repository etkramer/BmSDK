...
public partial class RSeqAct_SpawnPlayerCharacter : BmSDK.BmGame.RSeqAct_SpawnerBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SpawnPlayerCharacter.
    /// </summary>
    public static RSeqAct_SpawnPlayerCharacter DefaultObject => (RSeqAct_SpawnPlayerCharacter)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SpawnPlayerCharacter>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SpawnPlayerCharacter>, new()
