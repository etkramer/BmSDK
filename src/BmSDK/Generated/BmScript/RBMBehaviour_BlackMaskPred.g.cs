...
/// <summary>
/// Class: RBMBehaviour_BlackMaskPred<br/>
/// (size = 500)
/// (flags = 8210)
/// </summary>
public partial class RBMBehaviour_BlackMaskPred : BmSDK.BmGame.RBMBehaviour, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RBMBehaviour_BlackMaskPred", false);
    ...
    /// <summary>
    /// Constructs a new RBMBehaviour_BlackMaskPred
    /// </summary>
    public RBMBehaviour_BlackMaskPred(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMBehaviour_BlackMaskPred Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RBMBehaviour_BlackMaskPred(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_BlackMaskPred>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_BlackMaskPred>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RBMBehaviour_BlackMaskPred.GetObjClassVersion", true);
    ...
    public unsafe virtual float PickFromRange(float rangeMin, float rangeMax)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(rangeMin, paramsPtr + 0);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(rangeMax, paramsPtr + 4);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
    ...
    public unsafe virtual void BlackMaskPlayAnim(BmSDK.FName transitionAnimName, BmSDK.FName IdleAnimName, float startProportion = default)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(IdleAnimName, paramsPtr + 8);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(startProportion, paramsPtr + 16);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    /// <summary>
    /// ObjectProperty: RefPointActor
    /// </summary>
    public unsafe BmSDK.Engine.Actor RefPointActor
    {
    ...
    /// <summary>
    /// FloatProperty: TimeTillIdleStateChange
    /// </summary>
    public unsafe float TimeTillIdleStateChange
    {
    ...
    /// <summary>
    /// FloatProperty: timeBetweenOverlays_DeskMin
    /// </summary>
    public unsafe float timeBetweenOverlays_DeskMin
    {
    ...
    /// <summary>
    /// FloatProperty: timeBetweenOverlays_DeskMax
    /// </summary>
    public unsafe float timeBetweenOverlays_DeskMax
    {
    ...
    /// <summary>
    /// FloatProperty: idleTime_DeskMin
    /// </summary>
    public unsafe float idleTime_DeskMin
    {
    ...
    /// <summary>
    /// FloatProperty: idleTime_DeskMax
    /// </summary>
    public unsafe float idleTime_DeskMax
    {
    ...
    /// <summary>
    /// FloatProperty: timeBetweenOverlays_WindowMin
    /// </summary>
    public unsafe float timeBetweenOverlays_WindowMin
    {
    ...
    /// <summary>
    /// FloatProperty: timeBetweenOverlays_WindowMax
    /// </summary>
    public unsafe float timeBetweenOverlays_WindowMax
    {
    ...
    /// <summary>
    /// FloatProperty: idleTime_WindowMin
    /// </summary>
    public unsafe float idleTime_WindowMin
    {
    ...
    /// <summary>
    /// FloatProperty: idleTime_WindowMax
    /// </summary>
    public unsafe float idleTime_WindowMax
    {
    ...
    /// <summary>
    /// FloatProperty: sightDistance
    /// </summary>
    public unsafe float sightDistance
    {
    ...
    /// <summary>
    /// BoolProperty: bBatmanLocated
    /// </summary>
    public unsafe bool bBatmanLocated
    {
    ...
    /// <summary>
    /// FloatProperty: sightMemoryTime
    /// </summary>
    public unsafe float sightMemoryTime
    {
    ...
    /// <summary>
    /// FloatProperty: lastBlackMaskSeenBatmanTime
    /// </summary>
    public unsafe float lastBlackMaskSeenBatmanTime
    {
    ...
    /// <summary>
    /// NameProperty: lastTransitionName
    /// </summary>
    public unsafe BmSDK.FName lastTransitionName
    {
    ...
    /// <summary>
    /// FloatProperty: lastTransitionStartTime
    /// </summary>
    public unsafe float lastTransitionStartTime
    {
    ...
    /// <summary>
    /// StrProperty: BatmanSeenFlagName
    /// </summary>
    public unsafe BmSDK.FString BatmanSeenFlagName
    {
    ...
    /// <summary>
    /// ArrayProperty: noSeeVolumes
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.Engine.Volume> noSeeVolumes
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Volume>>(Ptr + 488); }
