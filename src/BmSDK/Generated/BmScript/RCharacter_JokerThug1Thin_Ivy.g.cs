...
public partial class RCharacter_JokerThug1Thin_Ivy : BmSDK.BmScript.RCharacter_JokerThug1Thin, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_JokerThug1Thin_Ivy.
    /// </summary>
    public static RCharacter_JokerThug1Thin_Ivy DefaultObject => (RCharacter_JokerThug1Thin_Ivy)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug1Thin_Ivy>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug1Thin_Ivy>, new()
