...
public partial class RBMWeaponSniperDLC : BmSDK.BmScript.RBMWeaponSniper, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBMWeaponSniperDLC(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMWeaponSniperDLC Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
