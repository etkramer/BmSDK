...
/// <summary>
/// Class: RSeqAct_ChallengeModifiers<br/>
/// (size = 260)
/// (flags = 8210)
/// </summary>
public partial class RSeqAct_ChallengeModifiers : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RSeqAct_ChallengeModifiers", false);
    ...
    /// <summary>
    /// Constructs a new RSeqAct_ChallengeModifiers
    /// </summary>
    public RSeqAct_ChallengeModifiers(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSeqAct_ChallengeModifiers Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RSeqAct_ChallengeModifiers(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ChallengeModifiers>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ChallengeModifiers>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RSeqAct_ChallengeModifiers.GetObjClassVersion", true);
    ...
    public unsafe virtual bool IsModifierAllowedForCustom(int ModifierEnum)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(ModifierEnum, paramsPtr + 0);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return BmSDK.Framework.MarshalUtil.ToManaged<bool>(paramsPtr + 4);
    }
    ...
    /// <summary>
    /// BoolProperty: bSequenceFinished
    /// </summary>
    public unsafe bool bSequenceFinished
    {
    ...
    /// <summary>
    /// BoolProperty: WaitForOtherPlayer
    /// </summary>
    public unsafe bool WaitForOtherPlayer
    {
    ...
    /// <summary>
    /// IntProperty: NumberOfModifiersAvailable
    /// </summary>
    public unsafe int NumberOfModifiersAvailable
    {
    ...
    /// <summary>
    /// ArrayProperty: RankedInstructionsText
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.FString> RankedInstructionsText
    {
    ...
    /// <summary>
    /// ArrayProperty: ProhibitedModifiersForCustom
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.BmGame.RGameInfo.EChallengeModifiers> ProhibitedModifiersForCustom
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.BmGame.RGameInfo.EChallengeModifiers>>(Ptr + 248); }
