...
public partial class RCharacter_OutcastTwoFace2Fat : BmSDK.BmGame.RCharacter_TwoFaceThugBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_OutcastTwoFace2Fat.
    /// </summary>
    public static RCharacter_OutcastTwoFace2Fat DefaultObject => (RCharacter_OutcastTwoFace2Fat)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_OutcastTwoFace2Fat>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_OutcastTwoFace2Fat>, new()
