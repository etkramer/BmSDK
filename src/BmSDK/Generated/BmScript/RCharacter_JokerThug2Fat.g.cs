...
public partial class RCharacter_JokerThug2Fat : BmSDK.BmGame.RCharacter_JokerThug2Base, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_JokerThug2Fat.
    /// </summary>
    public static RCharacter_JokerThug2Fat DefaultObject => (RCharacter_JokerThug2Fat)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug2Fat>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug2Fat>, new()
