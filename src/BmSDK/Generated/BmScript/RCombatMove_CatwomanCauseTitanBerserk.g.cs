...
/// <summary>
/// Class: RCombatMove_CatwomanCauseTitanBerserk<br/>
/// (size = 536)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_CatwomanCauseTitanBerserk : BmSDK.BmGame.RCombatMove_BatmanAttack, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RCombatMove_CatwomanCauseTitanBerserk", false);
    ...
    /// <summary>
    /// Constructs a new RCombatMove_CatwomanCauseTitanBerserk
    /// </summary>
    public RCombatMove_CatwomanCauseTitanBerserk(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_CatwomanCauseTitanBerserk Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_CatwomanCauseTitanBerserk(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_CatwomanCauseTitanBerserk>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_CatwomanCauseTitanBerserk>, new()
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPawnBossVenomBase>(Ptr + 500); }
    ...
    /// <summary>
    /// IntProperty: SpawnCamCount
    /// </summary>
    public unsafe int SpawnCamCount
    {
    ...
    /// <summary>
    /// NameProperty: CameraAnim
    /// </summary>
    public unsafe BmSDK.FName CameraAnim
    {
