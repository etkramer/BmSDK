...
/// <summary>
/// Class: RCombatMove_PipeDoctorAttack<br/>
/// (size = 636)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_PipeDoctorAttack : BmSDK.BmGame.RCombatMove_VillainCloseAttack, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RCombatMove_PipeDoctorAttack", false);
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_PipeDoctorAttack.
    /// </summary>
    public static RCombatMove_PipeDoctorAttack DefaultObject => (RCombatMove_PipeDoctorAttack)StaticClass().DefaultObject;

    internal RCombatMove_PipeDoctorAttack() { }

    /// <summary>
    /// Constructs a new RCombatMove_PipeDoctorAttack
    /// </summary>
    public RCombatMove_PipeDoctorAttack(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_PipeDoctorAttack Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_PipeDoctorAttack(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_PipeDoctorAttack>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_PipeDoctorAttack>, new()
