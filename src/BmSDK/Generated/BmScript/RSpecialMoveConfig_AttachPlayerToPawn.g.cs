...
public partial class RSpecialMoveConfig_AttachPlayerToPawn : BmSDK.BmGame.RSpecialMoveConfig, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_AttachPlayerToPawn.
    /// </summary>
    public static RSpecialMoveConfig_AttachPlayerToPawn DefaultObject => (RSpecialMoveConfig_AttachPlayerToPawn)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_AttachPlayerToPawn>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_AttachPlayerToPawn>, new()
