...
public partial class RSeqAct_IsHeavyTankEncounterActive : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_IsHeavyTankEncounterActive.
    /// </summary>
    public static RSeqAct_IsHeavyTankEncounterActive DefaultObject => (RSeqAct_IsHeavyTankEncounterActive)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_IsHeavyTankEncounterActive>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_IsHeavyTankEncounterActive>, new()
