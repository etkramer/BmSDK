...
public partial class RBMWeaponRifle : BmSDK.BmGame.RBMWeaponRiflePredBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMWeaponRifle.
    /// </summary>
    public static RBMWeaponRifle DefaultObject => (RBMWeaponRifle)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RBMWeaponRifle(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
