...
public partial class RCharacter_Cop2 : BmSDK.BmScript.RCharacter_Cop, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_Cop2.
    /// </summary>
    public static RCharacter_Cop2 DefaultObject => (RCharacter_Cop2)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_Cop2>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_Cop2>, new()
