...
public partial class RSeqAct_DriveBatmobileToLocation : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_DriveBatmobileToLocation.
    /// </summary>
    public static RSeqAct_DriveBatmobileToLocation DefaultObject => (RSeqAct_DriveBatmobileToLocation)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_DriveBatmobileToLocation>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_DriveBatmobileToLocation>, new()
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 WantDir
