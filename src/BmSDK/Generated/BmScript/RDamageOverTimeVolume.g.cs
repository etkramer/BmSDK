...
public partial class RDamageOverTimeVolume : BmSDK.Engine.Volume, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RDamageOverTimeVolume(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
    ...
    /// </summary>
    public unsafe BmSDK.Engine.RDialogueLine CwReactionDialogue
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.RDialogueLine>(Ptr + 496); }
