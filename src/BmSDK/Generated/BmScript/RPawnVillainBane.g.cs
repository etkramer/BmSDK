...
public partial class RPawnVillainBane : BmSDK.BmGame.RPawnVillain, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RPawnVillainBane(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RPawnVillainBane Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
    ...
    /// </summary>
    public unsafe bool CanReachTarget(BmSDK.BmGame.RPawnVillain NewTarget)
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RWeaponConfig CreateBaneConfigUnarmed(BmSDK.GameObject NewOwner)
    {
    ...
    /// </summary>
    public unsafe void BlockAttack(BmSDK.BmGame.RPawnCombat NewAttacker, BmSDK.Class dmgType)
    {
    ...
    /// </summary>
    public unsafe void PlayHitPawnBark(BmSDK.BmGame.RPawnCombat HitPawn)
    {
