...
public partial class RLevelTransitionMagBlastSecurityDoor : BmSDK.BmScript.RLevelTransitionDoubleDoors, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RLevelTransitionMagBlastSecurityDoor(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RLevelTransitionMagBlastSecurityDoor Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
    ...
    /// </summary>
    public unsafe void StopMotorFX()
    {
    ...
    /// </summary>
    public unsafe void UnlockedDoorReact(BmSDK.Engine.PrimitiveComponent OtherComp)
    {
    ...
    /// </summary>
    public unsafe void LockedDoorReact(BmSDK.Engine.PrimitiveComponent OtherComp)
    {
