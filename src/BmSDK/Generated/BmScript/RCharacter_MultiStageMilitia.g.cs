...
public partial class RCharacter_MultiStageMilitia : BmSDK.BmScript.RCharacter_MultiStage, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_MultiStageMilitia.
    /// </summary>
    public static RCharacter_MultiStageMilitia DefaultObject => (RCharacter_MultiStageMilitia)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_MultiStageMilitia>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_MultiStageMilitia>, new()
