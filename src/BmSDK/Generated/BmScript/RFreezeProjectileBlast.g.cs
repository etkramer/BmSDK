...
public partial class RFreezeProjectileBlast : BmSDK.BmGame.RProjectile, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RFreezeProjectileBlast.
    /// </summary>
    public static RFreezeProjectileBlast DefaultObject => (RFreezeProjectileBlast)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RFreezeProjectileBlast(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
