...
public partial class RSeqAct_GiveTopHealthForDemo : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_GiveTopHealthForDemo.
    /// </summary>
    public static RSeqAct_GiveTopHealthForDemo DefaultObject => (RSeqAct_GiveTopHealthForDemo)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_GiveTopHealthForDemo>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_GiveTopHealthForDemo>, new()
