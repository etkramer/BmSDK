...
public partial class RCharacter_Hobo_Gen1 : BmSDK.BmGame.RCharacter_JokerThug, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_Hobo_Gen1.
    /// </summary>
    public static RCharacter_Hobo_Gen1 DefaultObject => (RCharacter_Hobo_Gen1)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_Hobo_Gen1>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_Hobo_Gen1>, new()
