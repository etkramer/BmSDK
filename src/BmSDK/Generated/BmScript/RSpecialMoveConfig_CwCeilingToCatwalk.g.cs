...
public partial class RSpecialMoveConfig_CwCeilingToCatwalk : BmSDK.BmGame.RSpecialMoveConfig, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_CwCeilingToCatwalk.
    /// </summary>
    public static RSpecialMoveConfig_CwCeilingToCatwalk DefaultObject => (RSpecialMoveConfig_CwCeilingToCatwalk)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_CwCeilingToCatwalk>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_CwCeilingToCatwalk>, new()
