...
/// <summary>
/// Class: RCombatMove_SmallDroneAttack<br/>
/// (size = 640)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_SmallDroneAttack : BmSDK.BmGame.RCombatMove_VillainCloseAttack, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RCombatMove_SmallDroneAttack", false);
    ...
    /// <summary>
    /// Constructs a new RCombatMove_SmallDroneAttack
    /// </summary>
    public RCombatMove_SmallDroneAttack(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_SmallDroneAttack Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_SmallDroneAttack(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_SmallDroneAttack>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_SmallDroneAttack>, new()
    ...
    /// <summary>
    /// FloatProperty: CloseAttackRange
    /// </summary>
    public unsafe float CloseAttackRange
    {
