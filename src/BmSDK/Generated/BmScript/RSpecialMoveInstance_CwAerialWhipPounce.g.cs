...
public partial class RSpecialMoveInstance_CwAerialWhipPounce : BmSDK.BmGame.RSpecialMoveInstance_AerialWhipPounceBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.REnvironmentCheckTicker.FEnvironmentSpecialMoveLocator MoveLocation
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Rotator>(Ptr + 1152); }
