...
public partial class RBMWeaponTwoFaceLauncher : BmSDK.BmGame.RBMWeaponRanged, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMWeaponTwoFaceLauncher.
    /// </summary>
    public static RBMWeaponTwoFaceLauncher DefaultObject => (RBMWeaponTwoFaceLauncher)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RBMWeaponTwoFaceLauncher(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
