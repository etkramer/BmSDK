...
/// (flags = 8388626)
/// </summary>
public partial class RMaggot : BmSDK.BmGame.RJokerBombTeeth, BmSDK.BmGame.RBatarangableInterface, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RMaggot", false);
    ...
    /// <summary>
    /// Constructs a new RMaggot
    /// </summary>
    public RMaggot(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RMaggot(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RMaggot>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RMaggot>, new()
    ...
    public unsafe virtual void InitialiseMaggot(BmSDK.BmGame.RBMPawnAI Thug, int Damage, bool onFire, bool electrified, float inLifetime, float inMaxSpeed)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(onFire, paramsPtr + 8);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(electrified, paramsPtr + 12);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(inLifetime, paramsPtr + 16);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(inMaxSpeed, paramsPtr + 20);
    ...
    public unsafe virtual float DoGetFloorZ(System.Numerics.Vector3 Motion)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(Motion, paramsPtr + 0);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
    ...
    /// <summary>
    /// FloatProperty: TimeTillDirectionChange
    /// </summary>
    public unsafe float TimeTillDirectionChange
    {
    ...
    /// <summary>
    /// FloatProperty: NextTimeTillDirectionChange
    /// </summary>
    public unsafe float NextTimeTillDirectionChange
    {
    ...
    /// </summary>
    public unsafe float NextDirectionChangeRandom
    {
    ...
    /// <summary>
    /// BoolProperty: bInExplodeWait
    /// </summary>
    public unsafe bool bInExplodeWait
    {
    ...
    /// <summary>
    /// BoolProperty: bHasDroppedDown
    /// </summary>
    public unsafe bool bHasDroppedDown
    {
    ...
    /// <summary>
    /// BoolProperty: bInThugsHand
    /// </summary>
    public unsafe bool bInThugsHand
    {
    ...
    /// <summary>
    /// BoolProperty: bWaitingToCompleteSpawnAnim
    /// </summary>
    public unsafe bool bWaitingToCompleteSpawnAnim
    {
    ...
    /// <summary>
    /// BoolProperty: bHurtBatsWhenBataranged
    /// </summary>
    public unsafe bool bHurtBatsWhenBataranged
    {
    ...
    /// <summary>
    /// BoolProperty: bInEarlyDeathDelay
    /// </summary>
    public unsafe bool bInEarlyDeathDelay
    {
    ...
    /// <summary>
    /// BoolProperty: explodeNeighbours
    /// </summary>
    public unsafe bool explodeNeighbours
    {
    ...
    /// <summary>
    /// ComponentProperty: MaggotFirePFX
    /// </summary>
    public unsafe BmSDK.Engine.ParticleSystemComponent MaggotFirePFX
    {
    ...
    /// <summary>
    /// ComponentProperty: MaggotElectricPFX
    /// </summary>
    public unsafe BmSDK.Engine.ParticleSystemComponent MaggotElectricPFX
    {
    ...
    /// <summary>
    /// FloatProperty: rootToBaseOffset
    /// </summary>
    public unsafe float rootToBaseOffset
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.SkeletalMeshComponent>(Ptr + 476); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.LightEnvironmentComponent>(Ptr + 480); }
    ...
    /// <summary>
    /// ComponentProperty: FloorHitFX
    /// </summary>
    public unsafe BmSDK.Engine.ParticleSystemComponent FloorHitFX
    {
    ...
    /// <summary>
    /// ComponentProperty: TrailFX
    /// </summary>
    public unsafe BmSDK.Engine.ParticleSystemComponent TrailFX
    {
    ...
    /// <summary>
    /// FloatProperty: BombKillBaseDamage
    /// </summary>
    public unsafe float BombKillBaseDamage
    {
    ...
    /// <summary>
    /// FloatProperty: BombKillBasePlayerDamage
    /// </summary>
    public unsafe float BombKillBasePlayerDamage
    {
    ...
    /// <summary>
    /// FloatProperty: ExplodeTimeDef
    /// </summary>
    public unsafe float ExplodeTimeDef
    {
    ...
    /// <summary>
    /// FloatProperty: BowlOverImpulse
    /// </summary>
    public unsafe float BowlOverImpulse
    {
    ...
    /// <summary>
    /// FloatProperty: BombBowlOverDamage
    /// </summary>
    public unsafe float BombBowlOverDamage
    {
    ...
    /// <summary>
    /// FloatProperty: PlayerBombBowlOverDamage
    /// </summary>
    public unsafe float PlayerBombBowlOverDamage
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPawnPlayer>(Ptr + 540); }
    ...
    /// <summary>
    /// ObjectProperty: WarningEvent
    /// </summary>
    public unsafe BmSDK.Engine.AkEvent WarningEvent
    {
    ...
    /// <summary>
    /// ObjectProperty: StartMovementEvent
    /// </summary>
    public unsafe BmSDK.Engine.AkEvent StartMovementEvent
    {
    ...
    /// <summary>
    /// ObjectProperty: StopMovementEvent
    /// </summary>
    public unsafe BmSDK.Engine.AkEvent StopMovementEvent
    {
