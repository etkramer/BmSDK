...
public partial class RShield_Ras : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RShield_Ras(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 LevelCentre
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 476);

    /// <summary>
    /// StructProperty: HeightOffset
    /// </summary>
    public unsafe ref System.Numerics.Vector3 HeightOffset
