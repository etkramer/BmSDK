...
public partial class RStealthTakedownStage_SilentFromAboveEnd : BmSDK.BmGame.RStealthTakedownStageQuickBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RStealthTakedownStage_SilentFromAboveEnd.
    /// </summary>
    public static RStealthTakedownStage_SilentFromAboveEnd DefaultObject => (RStealthTakedownStage_SilentFromAboveEnd)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 vPreviousReferencePosition
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 1712);

    /// <summary>
    /// StructProperty: rPreviousReferenceRotation
    /// </summary>
    public unsafe ref BmSDK.Rotator rPreviousReferenceRotation
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 1724);
}
