...
public partial class RGooSprayBm : BmSDK.BmGame.RGooSpray, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RGooSprayBm(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RGooSprayBm Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
