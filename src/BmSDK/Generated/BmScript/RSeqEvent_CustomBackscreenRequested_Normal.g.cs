...
public partial class RSeqEvent_CustomBackscreenRequested_Normal : BmSDK.BmGame.RSeqEvent_CustomBackscreenRequested, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_CustomBackscreenRequested_Normal.
    /// </summary>
    public static RSeqEvent_CustomBackscreenRequested_Normal DefaultObject => (RSeqEvent_CustomBackscreenRequested_Normal)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_CustomBackscreenRequested_Normal>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_CustomBackscreenRequested_Normal>, new()
