...
public partial class RCharacter_OutcastTwoFaceCWIntro1 : BmSDK.BmScript.RCharacter_OutcastTwoFace4Fat, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_OutcastTwoFaceCWIntro1.
    /// </summary>
    public static RCharacter_OutcastTwoFaceCWIntro1 DefaultObject => (RCharacter_OutcastTwoFaceCWIntro1)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_OutcastTwoFaceCWIntro1>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_OutcastTwoFaceCWIntro1>, new()
