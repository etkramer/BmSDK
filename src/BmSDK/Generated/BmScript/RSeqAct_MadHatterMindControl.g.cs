...
/// <summary>
/// Class: RSeqAct_MadHatterMindControl<br/>
/// (size = 544)
/// (flags = 2105362)
/// </summary>
public partial class RSeqAct_MadHatterMindControl : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RSeqAct_MadHatterMindControl", false);
    ...
    /// <summary>
    /// Constructs a new RSeqAct_MadHatterMindControl
    /// </summary>
    public RSeqAct_MadHatterMindControl(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSeqAct_MadHatterMindControl Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RSeqAct_MadHatterMindControl(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_MadHatterMindControl>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_MadHatterMindControl>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RSeqAct_MadHatterMindControl.GetObjClassVersion", true);
    ...
    public unsafe virtual void UpdateMindControlPP(float DeltaTime, float topPanVal, float bottomPanVal)
    {
        ...
        byte* paramsPtr = stackalloc byte[12];
        BmSDK.Framework.MarshalUtil.ToUnmanaged(DeltaTime, paramsPtr + 0);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(topPanVal, paramsPtr + 4);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(bottomPanVal, paramsPtr + 8);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    /// <summary>
    /// BoolProperty: bPuttingMaskOn
    /// </summary>
    public unsafe bool bPuttingMaskOn
    {
    ...
    /// <summary>
    /// BoolProperty: bMindControlInProgress
    /// </summary>
    public unsafe bool bMindControlInProgress
    {
    ...
    /// <summary>
    /// BoolProperty: bInCompletionDelay
    /// </summary>
    public unsafe bool bInCompletionDelay
    {
    ...
    /// <summary>
    /// BoolProperty: enabledCamControl
    /// </summary>
    public unsafe bool enabledCamControl
    {
    ...
    /// <summary>
    /// BoolProperty: bInConversation
    /// </summary>
    public unsafe bool bInConversation
    {
    ...
    /// <summary>
    /// BoolProperty: reachedScoreMin
    /// </summary>
    public unsafe bool reachedScoreMin
    {
    ...
    /// <summary>
    /// BoolProperty: bCompleted
    /// </summary>
    public unsafe bool bCompleted
    {
    ...
    /// <summary>
    /// BoolProperty: bNeedPrompt
    /// </summary>
    public unsafe bool bNeedPrompt
    {
    ...
    /// <summary>
    /// BoolProperty: bPassedAThreshold
    /// </summary>
    public unsafe bool bPassedAThreshold
    {
    ...
    /// <summary>
    /// FloatProperty: timeBetweenDebugSpam
    /// </summary>
    public unsafe float timeBetweenDebugSpam
    {
    ...
    /// <summary>
    /// FloatProperty: lastDebugSpamTime
    /// </summary>
    public unsafe float lastDebugSpamTime
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.R3rdPersonCamera>(Ptr + 236); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 236); }
    }

    /// <summary>
    /// ObjectProperty: Hatter
    /// </summary>
    public unsafe BmSDK.BmScript.RPawnVillainMadHatter Hatter
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmScript.RPawnVillainMadHatter>(Ptr + 240); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 240); }
    }

    /// <summary>
    /// FloatProperty: maskFadeDuration
    /// </summary>
    public unsafe float maskFadeDuration
    {
    ...
    /// <summary>
    /// FloatProperty: maskFadeStartTime
    /// </summary>
    public unsafe float maskFadeStartTime
    {
    ...
    /// <summary>
    /// FloatProperty: ppMaskTopPanStart
    /// </summary>
    public unsafe float ppMaskTopPanStart
    {
    ...
    /// <summary>
    /// FloatProperty: ppMaskTopPanEnd
    /// </summary>
    public unsafe float ppMaskTopPanEnd
    {
    ...
    /// <summary>
    /// FloatProperty: ppMaskBottomPan
    /// </summary>
    public unsafe float ppMaskBottomPan
    {
    ...
    /// <summary>
    /// FloatProperty: ppMaskRoundness
    /// </summary>
    public unsafe float ppMaskRoundness
    {
    ...
    /// <summary>
    /// FloatProperty: scoreDecayRateDuringConversation
    /// </summary>
    public unsafe float scoreDecayRateDuringConversation
    {
    ...
    /// <summary>
    /// FloatProperty: scoreIncreasePerButtonPress
    /// </summary>
    public unsafe float scoreIncreasePerButtonPress
    {
    ...
    /// <summary>
    /// FloatProperty: scoreMin
    /// </summary>
    public unsafe float scoreMin
    {
    ...
    /// <summary>
    /// FloatProperty: postChatScoreBonus
    /// </summary>
    public unsafe float postChatScoreBonus
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmScript.RSpecialMoveConfig_MadHatterMindControl MoveConfig
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmScript.RSpecialMoveConfig_MadHatterMindControl>(Ptr + 292); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RViewPostProcess>(Ptr + 296); }
    ...
    /// <summary>
    /// FloatProperty: ppMindControlBottomPanComplete
    /// </summary>
    public unsafe float ppMindControlBottomPanComplete
    {
    ...
    /// <summary>
    /// FloatProperty: ppMindControlTopPanComplete
    /// </summary>
    public unsafe float ppMindControlTopPanComplete
    {
    ...
    /// <summary>
    /// FloatProperty: blurKernelInitial
    /// </summary>
    public unsafe float blurKernelInitial
    {
    ...
    /// <summary>
    /// FloatProperty: blurKernelWin
    /// </summary>
    public unsafe float blurKernelWin
    {
    ...
    /// <summary>
    /// FloatProperty: maxNearBlurAmountInitial
    /// </summary>
    public unsafe float maxNearBlurAmountInitial
    {
    ...
    /// <summary>
    /// FloatProperty: maxNearBlurAmountWin
    /// </summary>
    public unsafe float maxNearBlurAmountWin
    {
    ...
    /// <summary>
    /// FloatProperty: maxFarBlurAmountInitial
    /// </summary>
    public unsafe float maxFarBlurAmountInitial
    {
    ...
    /// <summary>
    /// FloatProperty: maxFarBlurAmountWin
    /// </summary>
    public unsafe float maxFarBlurAmountWin
    {
    ...
    /// <summary>
    /// FloatProperty: blurKernelToAmountTransitionPoint
    /// </summary>
    public unsafe float blurKernelToAmountTransitionPoint
    {
    ...
    /// <summary>
    /// FloatProperty: dofInterpDuration
    /// </summary>
    public unsafe float dofInterpDuration
    {
    ...
    /// <summary>
    /// FloatProperty: dofFalloffExponentInitial
    /// </summary>
    public unsafe float dofFalloffExponentInitial
    {
    ...
    /// <summary>
    /// FloatProperty: dofFalloffExponentWin
    /// </summary>
    public unsafe float dofFalloffExponentWin
    {
    ...
    /// <summary>
    /// FloatProperty: dofFocusDistanceInitial
    /// </summary>
    public unsafe float dofFocusDistanceInitial
    {
    ...
    /// <summary>
    /// FloatProperty: dofFocusDistanceWin
    /// </summary>
    public unsafe float dofFocusDistanceWin
    {
    ...
    /// <summary>
    /// FloatProperty: dofFocusInnerRadiusInitial
    /// </summary>
    public unsafe float dofFocusInnerRadiusInitial
    {
    ...
    /// <summary>
    /// FloatProperty: dofFocusInnerRadiusWin
    /// </summary>
    public unsafe float dofFocusInnerRadiusWin
    {
    ...
    /// <summary>
    /// FloatProperty: bloomScaleInitial
    /// </summary>
    public unsafe float bloomScaleInitial
    {
    ...
    /// <summary>
    /// FloatProperty: bloomScaleWin
    /// </summary>
    public unsafe float bloomScaleWin
    {
    ...
    /// <summary>
    /// FloatProperty: bloomThresholdInitial
    /// </summary>
    public unsafe float bloomThresholdInitial
    {
    ...
    /// <summary>
    /// FloatProperty: bloomThresholdWin
    /// </summary>
    public unsafe float bloomThresholdWin
    {
    ...
    /// <summary>
    /// ObjectProperty: BMCombatLocator
    /// </summary>
    public unsafe BmSDK.Engine.Actor BMCombatLocator
    {
    ...
    /// <summary>
    /// ObjectProperty: CamTeaPartyLocator
    /// </summary>
    public unsafe BmSDK.Engine.Actor CamTeaPartyLocator
    {
    ...
    /// <summary>
    /// ObjectProperty: BMTeaPartyLocator
    /// </summary>
    public unsafe BmSDK.Engine.Actor BMTeaPartyLocator
    {
    ...
    /// <summary>
    /// ObjectProperty: MindControlCamera
    /// </summary>
    public unsafe BmSDK.BmGame.RCameraActor MindControlCamera
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RCameraActor>(Ptr + 412); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 412); }
    }

    /// <summary>
    /// ObjectProperty: BMRabbitHead
    /// </summary>
    public unsafe BmSDK.Engine.SkeletalMesh BMRabbitHead
    {
    ...
    /// <summary>
    /// ObjectProperty: BMRabbitHeadPhysics
    /// </summary>
    public unsafe BmSDK.Engine.PhysicsAsset BMRabbitHeadPhysics
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.PhysicsAsset>(Ptr + 420); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 420); }
    }

    /// <summary>
    /// FloatProperty: timeBetweenHatAndMindControl
    /// </summary>
    public unsafe float timeBetweenHatAndMindControl
    {
    ...
    /// <summary>
    /// FloatProperty: mindControlStartDelay
    /// </summary>
    public unsafe float mindControlStartDelay
    {
    ...
    /// <summary>
    /// FloatProperty: postCompletionDelay
    /// </summary>
    public unsafe float postCompletionDelay
    {
    ...
    /// <summary>
    /// FloatProperty: completionTimer
    /// </summary>
    public unsafe float completionTimer
    {
    ...
    /// <summary>
    /// FloatProperty: regainFocusDuration
    /// </summary>
    public unsafe float regainFocusDuration
    {
    ...
    /// <summary>
    /// FloatProperty: regainFocusTimer
    /// </summary>
    public unsafe float regainFocusTimer
    {
    ...
    /// <summary>
    /// FloatProperty: camControlCountDown
    /// </summary>
    public unsafe float camControlCountDown
    {
    ...
    /// </summary>
    public InlineArray<float> scoreThresholds => new(4, Ptr + 468, 4, this);
    ...
    /// <summary>
    /// IntProperty: nextThreshold
    /// </summary>
    public unsafe int nextThreshold
    {
    ...
    /// <summary>
    /// FloatProperty: idleChatMinInterval
    /// </summary>
    public unsafe float idleChatMinInterval
    {
    ...
    /// <summary>
    /// FloatProperty: idleChatMaxInterval
    /// </summary>
    public unsafe float idleChatMaxInterval
    {
    ...
    /// <summary>
    /// FloatProperty: idleChatInterval
    /// </summary>
    public unsafe float idleChatInterval
    {
    ...
    /// <summary>
    /// FloatProperty: idleChatTimer
    /// </summary>
    public unsafe float idleChatTimer
    {
    ...
    /// <summary>
    /// IntProperty: nextConversation
    /// </summary>
    public unsafe int nextConversation
    {
    ...
    /// <summary>
    /// FloatProperty: timeTillMindControlHelpPrompt
    /// </summary>
    public unsafe float timeTillMindControlHelpPrompt
    {
    ...
    /// <summary>
    /// FloatProperty: helpPromptTimer
    /// </summary>
    public unsafe float helpPromptTimer
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.ForceFeedbackWaveform>(Ptr + 516); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 516); }
    }

    /// <summary>
    /// FloatProperty: rumbleInterval
    /// </summary>
    public unsafe float rumbleInterval
    {
    ...
    /// <summary>
    /// FloatProperty: nextRumbleTime
    /// </summary>
    public unsafe float nextRumbleTime
    {
    ...
    /// <summary>
    /// FloatProperty: minRumbleDuration
    /// </summary>
    public unsafe float minRumbleDuration
    {
    ...
    /// <summary>
    /// FloatProperty: maxRumbleDuration
    /// </summary>
    public unsafe float maxRumbleDuration
    {
    ...
    /// <summary>
    /// FloatProperty: minRumbleStrength
    /// </summary>
    public unsafe float minRumbleStrength
    {
    ...
    /// <summary>
    /// FloatProperty: maxRumbleStrength
    /// </summary>
    public unsafe float maxRumbleStrength
    {
