...
public partial class RStealthTakedownStage_ChainTakedown_GrappleBoostTakedown : BmSDK.BmGame.RStealthTakedownStage_ChainTakedown_Base, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RStealthTakedownStage_ChainTakedown_GrappleBoostTakedown(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RStealthTakedownStage_ChainTakedown_GrappleBoostTakedown Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
