...
public partial class RBMBehaviour_JokerRooftop : BmSDK.BmGame.RBMBehaviour_JokerRooftopBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_JokerRooftop.
    /// </summary>
    public static RBMBehaviour_JokerRooftop DefaultObject => (RBMBehaviour_JokerRooftop)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_JokerRooftop>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_JokerRooftop>, new()
