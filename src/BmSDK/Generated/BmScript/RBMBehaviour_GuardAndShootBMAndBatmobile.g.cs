...
public partial class RBMBehaviour_GuardAndShootBMAndBatmobile : BmSDK.BmGame.RBMBehaviour, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_GuardAndShootBMAndBatmobile.
    /// </summary>
    public static RBMBehaviour_GuardAndShootBMAndBatmobile DefaultObject => (RBMBehaviour_GuardAndShootBMAndBatmobile)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_GuardAndShootBMAndBatmobile>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_GuardAndShootBMAndBatmobile>, new()
