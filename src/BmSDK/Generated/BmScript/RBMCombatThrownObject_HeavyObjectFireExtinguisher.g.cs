...
/// (flags = 8389138)
/// </summary>
public partial class RBMCombatThrownObject_HeavyObjectFireExtinguisher : BmSDK.BmScript.RBMCombatThrownObject_HeavyObject, BmSDK.BmGame.RBatarangableInterface, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBMCombatThrownObject_HeavyObjectFireExtinguisher(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMCombatThrownObject_HeavyObjectFireExtinguisher Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
