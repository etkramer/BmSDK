...
public partial class RBatarangProjectileRb_Controllable : BmSDK.BmGame.RBatarangProjectile_Controllable, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBatarangProjectileRb_Controllable.
    /// </summary>
    public static RBatarangProjectileRb_Controllable DefaultObject => (RBatarangProjectileRb_Controllable)StaticClass().DefaultObject;
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RBatarangProjectileRb_Controllable.StopSpinSound", true);
