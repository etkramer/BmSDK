...
public partial class RLineLauncherNw : BmSDK.BmScript.RLineLauncherBm, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RLineLauncherNw(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RLineLauncherNw Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
