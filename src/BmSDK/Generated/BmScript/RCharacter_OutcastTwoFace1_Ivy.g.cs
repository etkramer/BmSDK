...
public partial class RCharacter_OutcastTwoFace1_Ivy : BmSDK.BmScript.RCharacter_OutcastTwoFace1, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_OutcastTwoFace1_Ivy.
    /// </summary>
    public static RCharacter_OutcastTwoFace1_Ivy DefaultObject => (RCharacter_OutcastTwoFace1_Ivy)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_OutcastTwoFace1_Ivy>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_OutcastTwoFace1_Ivy>, new()
