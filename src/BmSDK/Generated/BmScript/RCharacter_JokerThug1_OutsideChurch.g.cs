...
public partial class RCharacter_JokerThug1_OutsideChurch : BmSDK.BmScript.RCharacter_JokerThug1, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_JokerThug1_OutsideChurch.
    /// </summary>
    public static RCharacter_JokerThug1_OutsideChurch DefaultObject => (RCharacter_JokerThug1_OutsideChurch)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug1_OutsideChurch>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug1_OutsideChurch>, new()
