...
public partial class RSpecialMoveConfig_CarryPerson : BmSDK.BmGame.RSpecialMoveConfig, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_CarryPerson.
    /// </summary>
    public static RSpecialMoveConfig_CarryPerson DefaultObject => (RSpecialMoveConfig_CarryPerson)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_CarryPerson>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_CarryPerson>, new()
