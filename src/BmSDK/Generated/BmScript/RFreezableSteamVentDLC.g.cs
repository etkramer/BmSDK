...
/// <summary>
/// Class: RFreezableSteamVentDLC<br/>
/// (size = 476)
/// (flags = 8389138)
/// </summary>
public partial class RFreezableSteamVentDLC : BmSDK.BmScript.RFreezableSteamVent, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RFreezableSteamVentDLC", false);
    ...
    /// <summary>
    /// Constructs a new RFreezableSteamVentDLC
    /// </summary>
    public RFreezableSteamVentDLC(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RFreezableSteamVentDLC(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RFreezableSteamVentDLC>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RFreezableSteamVentDLC>, new()
    ...
    /// <summary>
    /// ObjectProperty: LastPlayer
    /// </summary>
    public unsafe BmSDK.Engine.Actor LastPlayer
    {
