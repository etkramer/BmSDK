...
public partial class RBMBehaviour_Chapter0KickingGuard : BmSDK.BmGame.RBMBehaviour_Combat, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_Chapter0KickingGuard.
    /// </summary>
    public static RBMBehaviour_Chapter0KickingGuard DefaultObject => (RBMBehaviour_Chapter0KickingGuard)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_Chapter0KickingGuard>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_Chapter0KickingGuard>, new()
