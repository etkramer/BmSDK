...
public partial class RRobinStaff : BmSDK.BmGame.RStaffBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RRobinStaff(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RRobinStaff Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
