...
public partial class RRiddleAzraelGlyph : BmSDK.BmGame.RRiddleSolutionBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RRiddleAzraelGlyph(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RRiddleAzraelGlyph Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
