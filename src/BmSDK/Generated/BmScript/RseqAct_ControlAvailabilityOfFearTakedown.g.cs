...
public partial class RseqAct_ControlAvailabilityOfFearTakedown : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RseqAct_ControlAvailabilityOfFearTakedown.
    /// </summary>
    public static RseqAct_ControlAvailabilityOfFearTakedown DefaultObject => (RseqAct_ControlAvailabilityOfFearTakedown)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RseqAct_ControlAvailabilityOfFearTakedown>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RseqAct_ControlAvailabilityOfFearTakedown>, new()
