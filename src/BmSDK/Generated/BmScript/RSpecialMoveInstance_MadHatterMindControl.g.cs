...
/// <summary>
/// Class: RSpecialMoveInstance_MadHatterMindControl<br/>
/// (size = 584)
/// (flags = 8388626)
/// </summary>
public partial class RSpecialMoveInstance_MadHatterMindControl : BmSDK.BmGame.RSpecialMoveInstance, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RSpecialMoveInstance_MadHatterMindControl", false);
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveInstance_MadHatterMindControl.
    /// </summary>
    public static RSpecialMoveInstance_MadHatterMindControl DefaultObject => (RSpecialMoveInstance_MadHatterMindControl)StaticClass().DefaultObject;

    internal RSpecialMoveInstance_MadHatterMindControl() { }

    /// <summary>
    /// Constructs a new RSpecialMoveInstance_MadHatterMindControl
    /// </summary>
    public RSpecialMoveInstance_MadHatterMindControl(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSpecialMoveInstance_MadHatterMindControl Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RSpecialMoveInstance_MadHatterMindControl(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveInstance_MadHatterMindControl>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveInstance_MadHatterMindControl>, new()
    ...
    /// </summary>
    public unsafe BmSDK.BmScript.RSeqAct_MadHatterMindControl SeqAct
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmScript.RSeqAct_MadHatterMindControl>(Ptr + 576); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 576); }
    }

    /// <summary>
    /// BoolProperty: bFinishedScreaming
    /// </summary>
    public unsafe bool bFinishedScreaming
    {
