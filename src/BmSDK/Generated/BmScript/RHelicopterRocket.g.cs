...
public partial class RHelicopterRocket : BmSDK.BmGame.RPenguinRocketBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RHelicopterRocket.
    /// </summary>
    public static RHelicopterRocket DefaultObject => (RHelicopterRocket)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RHelicopterRocket(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
