...
public partial class RPawnVillainDoctorWithPipe : BmSDK.BmGame.RPawnVillainThug, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RPawnVillainDoctorWithPipe(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RPawnVillainDoctorWithPipe Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
