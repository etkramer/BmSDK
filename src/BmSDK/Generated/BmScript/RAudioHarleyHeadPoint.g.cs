...
public partial class RAudioHarleyHeadPoint : BmSDK.BmGame.RAudioHarleyHeadPointBase, BmSDK.BmGame.RInteractInterface, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RAudioHarleyHeadPoint(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RAudioHarleyHeadPoint Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
