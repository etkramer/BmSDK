...
/// <summary>
/// Class: RAudioHarleyHeadPoint<br/>
/// (size = 604)
/// (flags = 8389138)
/// </summary>
public partial class RAudioHarleyHeadPoint : BmSDK.BmGame.RAudioHarleyHeadPointBase, BmSDK.BmGame.RInteractInterface, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RAudioHarleyHeadPoint", false);
    ...
    /// <summary>
    /// Gets the class default object as RAudioHarleyHeadPoint.
    /// </summary>
    public static RAudioHarleyHeadPoint DefaultObject => (RAudioHarleyHeadPoint)StaticClass().DefaultObject;

    internal RAudioHarleyHeadPoint() { }

    /// <summary>
    /// Constructs a new RAudioHarleyHeadPoint
    /// </summary>
    public RAudioHarleyHeadPoint(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RAudioHarleyHeadPoint(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAudioHarleyHeadPoint>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAudioHarleyHeadPoint>, new()
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.RInteractionComponent>(Ptr + 576); }
