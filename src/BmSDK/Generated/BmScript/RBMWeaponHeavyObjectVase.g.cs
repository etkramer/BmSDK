...
public partial class RBMWeaponHeavyObjectVase : BmSDK.BmScript.RBMWeaponHeavyObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMWeaponHeavyObjectVase.
    /// </summary>
    public static RBMWeaponHeavyObjectVase DefaultObject => (RBMWeaponHeavyObjectVase)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RBMWeaponHeavyObjectVase(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
