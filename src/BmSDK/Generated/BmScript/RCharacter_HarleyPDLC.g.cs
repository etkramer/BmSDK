...
public partial class RCharacter_HarleyPDLC : BmSDK.BmGame.RCharacter, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_HarleyPDLC.
    /// </summary>
    public static RCharacter_HarleyPDLC DefaultObject => (RCharacter_HarleyPDLC)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_HarleyPDLC>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_HarleyPDLC>, new()
