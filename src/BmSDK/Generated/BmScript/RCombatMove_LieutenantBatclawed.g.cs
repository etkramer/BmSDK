...
public partial class RCombatMove_LieutenantBatclawed : BmSDK.BmGame.RCombatMove, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_LieutenantBatclawed.
    /// </summary>
    public static RCombatMove_LieutenantBatclawed DefaultObject => (RCombatMove_LieutenantBatclawed)StaticClass().DefaultObject;
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.BmGame.RPawnCombat>>(Ptr + 800); }
