...
public partial class RUberSimpleCrowdActor : BmSDK.BmGame.RUberSimpleCrowdActorBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RUberSimpleCrowdActor.
    /// </summary>
    public static RUberSimpleCrowdActor DefaultObject => (RUberSimpleCrowdActor)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RUberSimpleCrowdActor(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
