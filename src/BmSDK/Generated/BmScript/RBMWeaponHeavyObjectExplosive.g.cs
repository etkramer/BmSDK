...
/// (flags = 10485810)
/// </summary>
public partial class RBMWeaponHeavyObjectExplosive : BmSDK.BmScript.RBMWeaponHeavyObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMWeaponHeavyObjectExplosive.
    /// </summary>
    public static RBMWeaponHeavyObjectExplosive DefaultObject => (RBMWeaponHeavyObjectExplosive)StaticClass().DefaultObject;
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.RInteractionComponent>(Ptr + 1748); }
    ...
    public unsafe ref System.Numerics.Vector3 BatarangImpactLocation
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 1760);

    /// <summary>
    /// StructProperty: TargetOffset
    /// </summary>
    public unsafe ref System.Numerics.Vector3 TargetOffset
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 1772);
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.AkEvent>(Ptr + 1784); }
    ...
    {
        get { return (BmSDK.Framework.MarshalUtil.ToManaged<int>(Ptr + 1792) & 1) != 0; }
        set { var currentMask = BmSDK.Framework.MarshalUtil.ToManaged<int>(Ptr + 1792); var newMask = value ? (currentMask | 1) : (currentMask & ~1); BmSDK.Framework.MarshalUtil.ToUnmanaged<int>(newMask, Ptr + 1792); }
    }
}
