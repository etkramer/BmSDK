...
public partial class RDisruptableControlBox : BmSDK.BmGame.RDisruptableObjectBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public InlineArray<BmSDK.Engine.MaterialInterface> ScreenMats => new(4, Ptr + 680, 4);
    ...
    /// </summary>
    public InlineArray<BmSDK.Engine.MaterialInterface> BoxMats => new(4, Ptr + 696, 4);
    ...
    /// </summary>
    public InlineArray<BmSDK.Engine.StaticMesh> BoxMesh => new(4, Ptr + 712, 4);
