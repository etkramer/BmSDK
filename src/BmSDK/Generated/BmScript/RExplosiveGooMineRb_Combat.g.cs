...
public partial class RExplosiveGooMineRb_Combat : BmSDK.BmScript.RExplosiveGooMineRb, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RExplosiveGooMineRb_Combat.
    /// </summary>
    public static RExplosiveGooMineRb_Combat DefaultObject => (RExplosiveGooMineRb_Combat)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RExplosiveGooMineRb_Combat(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
