...
public partial class RCharacter_PenguinThug2_Head5_Thin : BmSDK.BmScript.RCharacter_PenguinThug, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_PenguinThug2_Head5_Thin.
    /// </summary>
    public static RCharacter_PenguinThug2_Head5_Thin DefaultObject => (RCharacter_PenguinThug2_Head5_Thin)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug2_Head5_Thin>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug2_Head5_Thin>, new()
