...
public partial class RSeqAct_Rain : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RSeqAct_Rain.GetObjClassVersion", true);
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RSeqAct_Rain.Activated", true);
        byte* paramsPtr = stackalloc byte[64];
    ...
    public partial record struct FRockRainMapSettings
    {
        /// <summary>
