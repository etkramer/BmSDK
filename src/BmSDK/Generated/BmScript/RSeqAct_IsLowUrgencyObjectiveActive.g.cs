...
public partial class RSeqAct_IsLowUrgencyObjectiveActive : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_IsLowUrgencyObjectiveActive.
    /// </summary>
    public static RSeqAct_IsLowUrgencyObjectiveActive DefaultObject => (RSeqAct_IsLowUrgencyObjectiveActive)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_IsLowUrgencyObjectiveActive>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_IsLowUrgencyObjectiveActive>, new()
