...
public partial class RRbStealthTakeDownStage_GrabFromCrouchPDLC : BmSDK.BmScript.RRbStealthTakeDownStage_GrabFromCrouch, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RRbStealthTakeDownStage_GrabFromCrouchPDLC(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RRbStealthTakeDownStage_GrabFromCrouchPDLC Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
