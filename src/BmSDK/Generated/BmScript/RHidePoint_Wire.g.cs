...
public partial class RHidePoint_Wire : BmSDK.BmScript.RHidePoint_Rope, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RHidePoint_Wire(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RHidePoint_Wire Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
