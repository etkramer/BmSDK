...
public partial class RSeqAct_SetVehicleProperties : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SetVehicleProperties.
    /// </summary>
    public static RSeqAct_SetVehicleProperties DefaultObject => (RSeqAct_SetVehicleProperties)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetVehicleProperties>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetVehicleProperties>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RSeqAct_SetVehicleProperties.Activated", true);
