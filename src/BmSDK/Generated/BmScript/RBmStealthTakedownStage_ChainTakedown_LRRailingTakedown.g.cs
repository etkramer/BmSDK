...
public partial class RBmStealthTakedownStage_ChainTakedown_LRRailingTakedown : BmSDK.BmGame.RStealthTakedownStage_ChainTakedown_Base, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBmStealthTakedownStage_ChainTakedown_LRRailingTakedown(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBmStealthTakedownStage_ChainTakedown_LRRailingTakedown Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
