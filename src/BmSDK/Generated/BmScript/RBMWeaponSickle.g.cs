...
public partial class RBMWeaponSickle : BmSDK.BmGame.RBMWeaponMelee, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBMWeaponSickle(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMWeaponSickle Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
