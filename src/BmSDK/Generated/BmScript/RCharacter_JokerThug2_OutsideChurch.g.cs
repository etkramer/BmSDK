...
public partial class RCharacter_JokerThug2_OutsideChurch : BmSDK.BmScript.RCharacter_JokerThug2Thin, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_JokerThug2_OutsideChurch.
    /// </summary>
    public static RCharacter_JokerThug2_OutsideChurch DefaultObject => (RCharacter_JokerThug2_OutsideChurch)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug2_OutsideChurch>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug2_OutsideChurch>, new()
