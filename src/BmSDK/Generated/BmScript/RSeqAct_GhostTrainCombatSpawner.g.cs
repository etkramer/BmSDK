...
public partial class RSeqAct_GhostTrainCombatSpawner : BmSDK.BmGame.RSeqAct_CombatSpawnerBase, BmSDK.IGameObject
{
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_GhostTrainCombatSpawner>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_GhostTrainCombatSpawner>, new()
    ...
    /// </summary>
    public InlineArray<BmSDK.BmGame.RPawnVillain> TrainList => new(4, Ptr + 284, 4, this);
    ...
    /// </summary>
    public InlineArray<BmSDK.Engine.SkeletalMeshActor> Train1Cars => new(2, Ptr + 308, 4, this);
    ...
    /// </summary>
    public InlineArray<BmSDK.Engine.SkeletalMeshActor> Train2Cars => new(2, Ptr + 316, 4, this);
