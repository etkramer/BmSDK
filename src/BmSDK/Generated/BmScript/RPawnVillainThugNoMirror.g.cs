...
public partial class RPawnVillainThugNoMirror : BmSDK.BmGame.RPawnVillainThug, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RPawnVillainThugNoMirror(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RPawnVillainThugNoMirror Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
