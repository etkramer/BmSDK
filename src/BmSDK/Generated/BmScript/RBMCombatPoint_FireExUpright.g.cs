...
/// <summary>
/// Class: RBMCombatPoint_FireExUpright<br/>
/// (size = 536)
/// (flags = 8389138)
/// </summary>
public partial class RBMCombatPoint_FireExUpright : BmSDK.BmGame.RBMCombatPoint_EnvironmentWeapon, BmSDK.BmGame.RBatarangableInterface, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RBMCombatPoint_FireExUpright", false);
    ...
    /// <summary>
    /// Constructs a new RBMCombatPoint_FireExUpright
    /// </summary>
    public RBMCombatPoint_FireExUpright(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMCombatPoint_FireExUpright Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RBMCombatPoint_FireExUpright(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMCombatPoint_FireExUpright>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMCombatPoint_FireExUpright>, new()
