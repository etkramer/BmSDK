...
public partial class RPickup_RiddlerCatwoman : BmSDK.BmGame.RPickupBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RPickup_RiddlerCatwoman.
    /// </summary>
    public static RPickup_RiddlerCatwoman DefaultObject => (RPickup_RiddlerCatwoman)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RPickup_RiddlerCatwoman(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
