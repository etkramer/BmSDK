...
public partial class RCharacter_MadHatterThug_Combat3 : BmSDK.BmScript.RCharacter_PenguinThug1, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_MadHatterThug_Combat3.
    /// </summary>
    public static RCharacter_MadHatterThug_Combat3 DefaultObject => (RCharacter_MadHatterThug_Combat3)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_MadHatterThug_Combat3>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_MadHatterThug_Combat3>, new()
