...
public partial class RSeqAct_GetActorPointingAtTarget : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RDummyTarget_Spawnable>(Ptr + 368); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 368); }
    }

    /// <summary>
    /// BoolProperty: bOnlyInXY
    /// </summary>
    public unsafe bool bOnlyInXY
    {
    ...
    /// <summary>
    /// BoolProperty: bSpawnAtEnd
    /// </summary>
    public unsafe bool bSpawnAtEnd
    {
