...
/// <summary>
/// Class: RCombatMove_NinjaSecretDoor<br/>
/// (size = 648)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_NinjaSecretDoor : BmSDK.BmGame.RCombatMove_VillainCloseAttack, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RCombatMove_NinjaSecretDoor", false);
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_NinjaSecretDoor.
    /// </summary>
    public static RCombatMove_NinjaSecretDoor DefaultObject => (RCombatMove_NinjaSecretDoor)StaticClass().DefaultObject;

    internal RCombatMove_NinjaSecretDoor() { }

    /// <summary>
    /// Constructs a new RCombatMove_NinjaSecretDoor
    /// </summary>
    public RCombatMove_NinjaSecretDoor(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_NinjaSecretDoor Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_NinjaSecretDoor(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_NinjaSecretDoor>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_NinjaSecretDoor>, new()
