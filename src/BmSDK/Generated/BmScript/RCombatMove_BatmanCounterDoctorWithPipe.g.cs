...
/// <summary>
/// Class: RCombatMove_BatmanCounterDoctorWithPipe<br/>
/// (size = 872)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_BatmanCounterDoctorWithPipe : BmSDK.BmGame.RCombatMove_BatmanCounter, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RCombatMove_BatmanCounterDoctorWithPipe", false);
    ...
    /// <summary>
    /// Constructs a new RCombatMove_BatmanCounterDoctorWithPipe
    /// </summary>
    public RCombatMove_BatmanCounterDoctorWithPipe(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_BatmanCounterDoctorWithPipe Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_BatmanCounterDoctorWithPipe(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanCounterDoctorWithPipe>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_BatmanCounterDoctorWithPipe>, new()
