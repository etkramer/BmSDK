...
public partial class RDivePressurePad : BmSDK.BmScript.RPresurePad, BmSDK.BmGame.RBatarangableInterface, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDivePressurePad.
    /// </summary>
    public static RDivePressurePad DefaultObject => (RDivePressurePad)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RDivePressurePad(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
