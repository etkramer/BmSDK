...
public partial class RSpecialMoveConfig_KickJokerIntoGurney : BmSDK.BmGame.RSpecialMoveConfig, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_KickJokerIntoGurney.
    /// </summary>
    public static RSpecialMoveConfig_KickJokerIntoGurney DefaultObject => (RSpecialMoveConfig_KickJokerIntoGurney)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_KickJokerIntoGurney>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_KickJokerIntoGurney>, new()
