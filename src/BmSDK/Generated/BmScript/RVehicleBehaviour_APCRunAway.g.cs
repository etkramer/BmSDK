...
public partial class RVehicleBehaviour_APCRunAway : BmSDK.BmGame.RVehicleBehaviour_RunAway, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RVehicleBehaviour_APCRunAway.
    /// </summary>
    public static RVehicleBehaviour_APCRunAway DefaultObject => (RVehicleBehaviour_APCRunAway)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_APCRunAway>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_APCRunAway>, new()
