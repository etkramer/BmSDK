...
/// <summary>
/// Class: RSpecialMoveInstance_IceEscape<br/>
/// (size = 628)
/// (flags = 8388626)
/// </summary>
public partial class RSpecialMoveInstance_IceEscape : BmSDK.BmGame.RSpecialMoveInstance, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RSpecialMoveInstance_IceEscape", false);
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveInstance_IceEscape.
    /// </summary>
    public static RSpecialMoveInstance_IceEscape DefaultObject => (RSpecialMoveInstance_IceEscape)StaticClass().DefaultObject;

    internal RSpecialMoveInstance_IceEscape() { }

    /// <summary>
    /// Constructs a new RSpecialMoveInstance_IceEscape
    /// </summary>
    public RSpecialMoveInstance_IceEscape(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSpecialMoveInstance_IceEscape Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RSpecialMoveInstance_IceEscape(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveInstance_IceEscape>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveInstance_IceEscape>, new()
