...
public partial class RSpecialMoveConfig_RobinBatClawAttackPDLC : BmSDK.BmScript.RSpecialMoveConfig_RobinBatClawAttack, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_RobinBatClawAttackPDLC.
    /// </summary>
    public static RSpecialMoveConfig_RobinBatClawAttackPDLC DefaultObject => (RSpecialMoveConfig_RobinBatClawAttackPDLC)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_RobinBatClawAttackPDLC>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_RobinBatClawAttackPDLC>, new()
