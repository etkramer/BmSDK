...
public partial class RCharacter_PenguinThug2_Head3_Fat : BmSDK.BmScript.RCharacter_PenguinThug, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_PenguinThug2_Head3_Fat.
    /// </summary>
    public static RCharacter_PenguinThug2_Head3_Fat DefaultObject => (RCharacter_PenguinThug2_Head3_Fat)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug2_Head3_Fat>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug2_Head3_Fat>, new()
