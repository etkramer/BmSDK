...
public partial class RCharacter_PenguinThug1_Head7_Thin : BmSDK.BmScript.RCharacter_PenguinThug, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_PenguinThug1_Head7_Thin.
    /// </summary>
    public static RCharacter_PenguinThug1_Head7_Thin DefaultObject => (RCharacter_PenguinThug1_Head7_Thin)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug1_Head7_Thin>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_PenguinThug1_Head7_Thin>, new()
