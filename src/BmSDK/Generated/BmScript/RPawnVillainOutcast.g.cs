...
/// <summary>
/// Class: RPawnVillainOutcast<br/>
/// (size = 3564)
/// (flags = 10485814)
/// </summary>
public partial class RPawnVillainOutcast : BmSDK.BmGame.RPawnVillainThug, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RPawnVillainOutcast", false);
    ...
    /// <summary>
    /// Gets the class default object as RPawnVillainOutcast.
    /// </summary>
    public static RPawnVillainOutcast DefaultObject => (RPawnVillainOutcast)StaticClass().DefaultObject;

    internal RPawnVillainOutcast() { }

    /// <summary>
    /// Constructs a new RPawnVillainOutcast
    /// </summary>
    public RPawnVillainOutcast(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RPawnVillainOutcast(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RPawnVillainOutcast>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RPawnVillainOutcast>, new()
