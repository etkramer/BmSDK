...
public partial class RPrototank_Missile : BmSDK.BmGame.RProjectile, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RPrototank_Missile.
    /// </summary>
    public static RPrototank_Missile DefaultObject => (RPrototank_Missile)StaticClass().DefaultObject;
