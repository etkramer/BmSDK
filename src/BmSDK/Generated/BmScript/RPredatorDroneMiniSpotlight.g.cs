...
public partial class RPredatorDroneMiniSpotlight : BmSDK.Engine.SpotLightComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RPredatorDroneMiniSpotlight.
    /// </summary>
    public static RPredatorDroneMiniSpotlight DefaultObject => (RPredatorDroneMiniSpotlight)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RPredatorDroneMiniSpotlight>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RPredatorDroneMiniSpotlight>, new()
