...
public partial class RPawnBossPenguinIceberg : BmSDK.BmGame.RPawnBossPenguinIcebergBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RPawnBossPenguinIceberg(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RPawnBossPenguinIceberg Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
