...
/// <summary>
/// Class: RPawnBossPenguinIceberg<br/>
/// (size = 2908)
/// (flags = 10486326)
/// </summary>
public partial class RPawnBossPenguinIceberg : BmSDK.BmGame.RPawnBossPenguinIcebergBase, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RPawnBossPenguinIceberg", false);
    ...
    /// <summary>
    /// Gets the class default object as RPawnBossPenguinIceberg.
    /// </summary>
    public static RPawnBossPenguinIceberg DefaultObject => (RPawnBossPenguinIceberg)StaticClass().DefaultObject;

    internal RPawnBossPenguinIceberg() { }

    /// <summary>
    /// Constructs a new RPawnBossPenguinIceberg
    /// </summary>
    public RPawnBossPenguinIceberg(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RPawnBossPenguinIceberg(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RPawnBossPenguinIceberg>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RPawnBossPenguinIceberg>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RPawnBossPenguinIceberg.GetWeaponUpAimingConfig", true);
        byte* paramsPtr = stackalloc byte[4];
    ...
    /// <summary>
    /// ObjectProperty: GunAiming
    /// </summary>
    public unsafe BmSDK.BmGame.RAimingConfig GunAiming
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAimingConfig>(Ptr + 2900); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 2900); }
    }

    /// <summary>
    /// FloatProperty: DegreesExtraForSightCheck
    /// </summary>
    public unsafe float DegreesExtraForSightCheck
    {
