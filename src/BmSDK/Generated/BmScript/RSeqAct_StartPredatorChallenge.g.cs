...
public partial class RSeqAct_StartPredatorChallenge : BmSDK.BmGame.RSeqAct_StartPredatorChallengeBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public InlineArray<BmSDK.BmGame.RGameInfo.EGameAction> ActualChallengeActions => new(3, Ptr + 268, 1);
    ...
    /// </summary>
    public InlineArray<BmSDK.BmGame.RGameInfo.EGameAction> ChallengeActions => new(3, Ptr + 271, 1);
    ...
    /// </summary>
    public InlineArray<BmSDK.BmGame.RGameInfo.EGameAction> CWChallengeActions => new(3, Ptr + 274, 1);
    ...
    /// </summary>
    public InlineArray<BmSDK.BmGame.RGameInfo.EGameAction> CoopChallengeActions => new(3, Ptr + 277, 1);
