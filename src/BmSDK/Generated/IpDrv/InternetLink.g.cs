...
public partial class InternetLink : BmSDK.Engine.Info, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InternetLink.
    /// </summary>
    public static InternetLink DefaultObject => (InternetLink)StaticClass().DefaultObject;
