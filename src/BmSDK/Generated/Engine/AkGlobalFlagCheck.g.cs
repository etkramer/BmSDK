...
public partial class AkGlobalFlagCheck : BmSDK.Engine.AkPredicate, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkGlobalFlagCheck.
    /// </summary>
    public static AkGlobalFlagCheck DefaultObject => (AkGlobalFlagCheck)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkGlobalFlagCheck>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkGlobalFlagCheck>, new()
