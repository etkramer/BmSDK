...
public partial class ParticleSystemReplay : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleSystemReplay>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleSystemReplay>, new()
    ...
    public partial record struct FParticleEmitterReplayFrame
    {
        ...
        /// </summary>
        public unsafe ref System.IntPtr FrameState
        {
