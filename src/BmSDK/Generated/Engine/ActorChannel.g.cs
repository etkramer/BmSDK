...
public partial class ActorChannel : BmSDK.Engine.Channel, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ActorChannel.
    /// </summary>
    public static ActorChannel DefaultObject => (ActorChannel)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ActorChannel>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ActorChannel>, new()
