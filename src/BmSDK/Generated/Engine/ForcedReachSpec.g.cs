...
public partial class ForcedReachSpec : BmSDK.Engine.ReachSpec, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ForcedReachSpec.
    /// </summary>
    public static ForcedReachSpec DefaultObject => (ForcedReachSpec)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ForcedReachSpec>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ForcedReachSpec>, new()
