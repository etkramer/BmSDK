...
public partial class AkDialogueType : BmSDK.Engine.AkHash, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkDialogueType.
    /// </summary>
    public static AkDialogueType DefaultObject => (AkDialogueType)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkDialogueType>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkDialogueType>, new()
    ...
    /// </summary>
    public enum SpeechBusyResponse : byte
    {
        eSBR_AUTORETRY = 0,
        eSBR_FIREFINISHED = 1,
        eSBR_FIREBUSY = 2,
    ...
    /// </summary>
    public enum SpeechInteruptResponse : byte
    {
        eSIR_FIREFINISHED = 0,
