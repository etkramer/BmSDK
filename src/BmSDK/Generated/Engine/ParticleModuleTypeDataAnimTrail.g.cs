...
public partial class ParticleModuleTypeDataAnimTrail : BmSDK.Engine.ParticleModuleTypeDataBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleTypeDataAnimTrail.
    /// </summary>
    public static ParticleModuleTypeDataAnimTrail DefaultObject => (ParticleModuleTypeDataAnimTrail)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleTypeDataAnimTrail>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleTypeDataAnimTrail>, new()
