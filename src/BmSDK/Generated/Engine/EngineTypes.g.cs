...
public partial class EngineTypes : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    public partial record struct FMaterialReferenceList
    {
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.EngineTypes.FPrimitiveMaterialRef>>(Ptr + 4); }; }
    ...
    public partial record struct FRootMotionCurve
    {
        ...
        /// </summary>
        public unsafe ref BmSDK.GameObject.FInterpCurveVector Curve
        {
            get { fixed (void* thisPtr = &this) { return ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FInterpCurveVector>((IntPtr)thisPtr + 8); } }
        }
    ...
    public partial record struct FDominantShadowInfo
    {
        ...
        /// </summary>
        public unsafe ref BmSDK.GameObject.FBox LightSpaceImportanceBounds
        {
            get { fixed (void* thisPtr = &this) { return ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FBox>((IntPtr)thisPtr + 128); } }
        }
    ...
    public partial record struct FLightMapRef
    {
        ...
        /// </summary>
        public unsafe ref System.IntPtr Reference
        {
    ...
    public enum EPathFindingError
    {
        ...
        PATHERROR_NoMesh = 8,
        PATHERROR_NotInMesh = 9,
        PATHERROR_NoNavPoint = 10,
        PATHERROR_NotAbleToSearch = 11,
        PATHERROR_CantInitialiseSearch = 12,
        PATHERROR_CantSeedWorkingSet = 13,
        PATHERROR_AnchorDestinationPylonMismatch = 14,
        PATHERROR_MAX = 15,
    }
}
