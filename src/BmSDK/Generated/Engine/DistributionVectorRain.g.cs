...
public partial class DistributionVectorRain : BmSDK.Engine.DistributionVectorParameterBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as DistributionVectorRain.
    /// </summary>
    public static DistributionVectorRain DefaultObject => (DistributionVectorRain)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<DistributionVectorRain>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<DistributionVectorRain>, new()
