...
public partial class ParticleModuleSourceMovement : BmSDK.Engine.ParticleModuleLocationBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleSourceMovement.
    /// </summary>
    public static ParticleModuleSourceMovement DefaultObject => (ParticleModuleSourceMovement)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleSourceMovement>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleSourceMovement>, new()
    ...
    /// </summary>
    public unsafe ref BmSDK.DistributionVector.FRawDistributionVector SourceMovementScale
