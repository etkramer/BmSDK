...
public partial class MaterialExpressionTexelSize : BmSDK.Engine.MaterialExpression, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionTexelSize.
    /// </summary>
    public static MaterialExpressionTexelSize DefaultObject => (MaterialExpressionTexelSize)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionTexelSize>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionTexelSize>, new()
