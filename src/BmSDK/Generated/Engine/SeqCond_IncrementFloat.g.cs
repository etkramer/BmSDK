...
public partial class SeqCond_IncrementFloat : BmSDK.Engine.SequenceCondition, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqCond_IncrementFloat.
    /// </summary>
    public static SeqCond_IncrementFloat DefaultObject => (SeqCond_IncrementFloat)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqCond_IncrementFloat>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqCond_IncrementFloat>, new()
