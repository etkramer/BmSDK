...
public partial class RParticleModuleVelocityDrag : BmSDK.Engine.ParticleModuleVelocityBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RParticleModuleVelocityDrag.
    /// </summary>
    public static RParticleModuleVelocityDrag DefaultObject => (RParticleModuleVelocityDrag)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RParticleModuleVelocityDrag>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RParticleModuleVelocityDrag>, new()
