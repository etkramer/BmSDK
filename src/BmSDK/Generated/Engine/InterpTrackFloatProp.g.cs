...
public partial class InterpTrackFloatProp : BmSDK.Engine.InterpTrackFloatBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpTrackFloatProp.
    /// </summary>
    public static InterpTrackFloatProp DefaultObject => (InterpTrackFloatProp)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpTrackFloatProp>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpTrackFloatProp>, new()
