...
public partial class RSkeletalMeshPhysSceneInterface : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSkeletalMeshPhysSceneInterface.
    /// </summary>
    public static RSkeletalMeshPhysSceneInterface DefaultObject => (RSkeletalMeshPhysSceneInterface)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSkeletalMeshPhysSceneInterface>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSkeletalMeshPhysSceneInterface>, new()
