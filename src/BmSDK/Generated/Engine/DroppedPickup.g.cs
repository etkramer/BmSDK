...
public partial class DroppedPickup : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as DroppedPickup.
    /// </summary>
    public static DroppedPickup DefaultObject => (DroppedPickup)StaticClass().DefaultObject;
    ...
    /// </summary>
    public DroppedPickup(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
