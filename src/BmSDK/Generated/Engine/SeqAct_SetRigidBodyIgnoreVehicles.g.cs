...
public partial class SeqAct_SetRigidBodyIgnoreVehicles : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqAct_SetRigidBodyIgnoreVehicles.
    /// </summary>
    public static SeqAct_SetRigidBodyIgnoreVehicles DefaultObject => (SeqAct_SetRigidBodyIgnoreVehicles)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqAct_SetRigidBodyIgnoreVehicles>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqAct_SetRigidBodyIgnoreVehicles>, new()
