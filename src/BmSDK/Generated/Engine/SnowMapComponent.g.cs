...
public partial class SnowMapComponent : BmSDK.Engine.ActorComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SnowMapComponent.
    /// </summary>
    public static SnowMapComponent DefaultObject => (SnowMapComponent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SnowMapComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SnowMapComponent>, new()
    ...
    /// </summary>
    public unsafe ref BmSDK.GameObject.FLinearColor SnowGroundColor
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FLinearColor>(Ptr + 140);
