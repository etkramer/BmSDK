...
public partial class RInterpTrackVehicleProp : BmSDK.Engine.InterpTrackFloatBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RInterpTrackVehicleProp.
    /// </summary>
    public static RInterpTrackVehicleProp DefaultObject => (RInterpTrackVehicleProp)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RInterpTrackVehicleProp>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RInterpTrackVehicleProp>, new()
    ...
    /// </summary>
    public enum EVehiclePropertyForControl : byte
    {
        VP_RPM = 0,
        VP_Gear = 1,
        VP_Brake = 2,
