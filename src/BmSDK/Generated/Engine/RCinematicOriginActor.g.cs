...
public partial class RCinematicOriginActor : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCinematicOriginActor.
    /// </summary>
    public static RCinematicOriginActor DefaultObject => (RCinematicOriginActor)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe ref BmSDK.Rotator AdditionalRotation
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 668);
}
