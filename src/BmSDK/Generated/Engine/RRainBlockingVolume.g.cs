...
public partial class RRainBlockingVolume : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RRainBlockingVolume.
    /// </summary>
    public static RRainBlockingVolume DefaultObject => (RRainBlockingVolume)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe ref BmSDK.Engine.RRainBlockingVolume.FFRainBlockInfo RainBlockInfo
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.RRainBlockingVolume.FFRainBlockInfo>(Ptr + 672);
