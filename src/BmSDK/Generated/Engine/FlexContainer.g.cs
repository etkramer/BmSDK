...
public partial class FlexContainer : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.FlexContainer", false);
    ...
    /// <summary>
    /// Gets the class default object as FlexContainer.
    /// </summary>
    public static FlexContainer DefaultObject => (FlexContainer)StaticClass().DefaultObject;

    internal FlexContainer() { }

    /// <summary>
    /// Constructs a new FlexContainer
    /// </summary>
    public FlexContainer(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, FlexContainer Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected FlexContainer(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<FlexContainer>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<FlexContainer>, new()
    ...
    /// <summary>
    /// BoolProperty: bDebugDrawPoints
    /// </summary>
    public unsafe bool bDebugDrawPoints
    {
    ...
    /// <summary>
    /// BoolProperty: bEnableCCD
    /// </summary>
    public unsafe bool bEnableCCD
    {
    ...
    /// <summary>
    /// BoolProperty: bComplexCollision
    /// </summary>
    public unsafe bool bComplexCollision
    {
    ...
    /// <summary>
    /// FloatProperty: DebugDrawSpheres
    /// </summary>
    public unsafe float DebugDrawSpheres
    {
    ...
    /// <summary>
    /// IntProperty: NumIterations
    /// </summary>
    public unsafe int NumIterations
    {
    ...
    /// <summary>
    /// IntProperty: NumSubsteps
    /// </summary>
    public unsafe int NumSubsteps
    {
    ...
    /// <summary>
    /// FloatProperty: MaxContainerBound
    /// </summary>
    public unsafe float MaxContainerBound
    {
    ...
    /// <summary>
    /// FloatProperty: SuccessiveOverRelaxation
    /// </summary>
    public unsafe float SuccessiveOverRelaxation
    {
    ...
    public unsafe ref BmSDK.Engine.PrimitiveComponent.FRBCollisionChannelContainer RBCollideWithChannels
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.PrimitiveComponent.FRBCollisionChannelContainer>(Ptr + 144);

    /// <summary>
    /// FloatProperty: CellSizeFactor
    /// </summary>
    public unsafe float CellSizeFactor
    {
    ...
    /// <summary>
    /// FloatProperty: CollisionMargin
    /// </summary>
    public unsafe float CollisionMargin
    {
    ...
    /// <summary>
    /// FloatProperty: CollisionMarginShapes
    /// </summary>
    public unsafe float CollisionMarginShapes
    {
    ...
    /// <summary>
    /// FloatProperty: ParticleFriction
    /// </summary>
    public unsafe float ParticleFriction
    {
    ...
    /// <summary>
    /// FloatProperty: StaticFriction
    /// </summary>
    public unsafe float StaticFriction
    {
    ...
    /// <summary>
    /// FloatProperty: ShockPropagation
    /// </summary>
    public unsafe float ShockPropagation
    {
    ...
    /// <summary>
    /// FloatProperty: Dissipation
    /// </summary>
    public unsafe float Dissipation
    {
    ...
    /// StructProperty: Wind
    /// </summary>
    public unsafe ref System.Numerics.Vector3 Wind
    ...
    /// <summary>
    /// FloatProperty: RestDistance
    /// </summary>
    public unsafe float RestDistance
    {
    ...
    /// <summary>
    /// FloatProperty: Adhesion
    /// </summary>
    public unsafe float Adhesion
    {
    ...
    /// <summary>
    /// FloatProperty: Cohesion
    /// </summary>
    public unsafe float Cohesion
    {
    ...
    /// <summary>
    /// FloatProperty: SolidPressure
    /// </summary>
    public unsafe float SolidPressure
    {
    ...
    /// <summary>
    /// FloatProperty: FreeSurfaceDrag
    /// </summary>
    public unsafe float FreeSurfaceDrag
    {
    ...
    /// <summary>
    /// FloatProperty: PlasticThreshold
    /// </summary>
    public unsafe float PlasticThreshold
    {
    ...
    /// <summary>
    /// FloatProperty: PlasticCreep
    /// </summary>
    public unsafe float PlasticCreep
    {
