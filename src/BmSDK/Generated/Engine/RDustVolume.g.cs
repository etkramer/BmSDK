...
public partial class RDustVolume : BmSDK.Engine.RHeightMapCaptureVolume, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDustVolume.
    /// </summary>
    public static RDustVolume DefaultObject => (RDustVolume)StaticClass().DefaultObject;
