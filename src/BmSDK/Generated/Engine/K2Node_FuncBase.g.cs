...
public partial class K2Node_FuncBase : BmSDK.Engine.K2Node_Code, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as K2Node_FuncBase.
    /// </summary>
    public static K2Node_FuncBase DefaultObject => (K2Node_FuncBase)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<K2Node_FuncBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<K2Node_FuncBase>, new()
