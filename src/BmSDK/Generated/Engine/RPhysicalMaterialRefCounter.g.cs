...
public partial class RPhysicalMaterialRefCounter : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RPhysicalMaterialRefCounter.
    /// </summary>
    public static RPhysicalMaterialRefCounter DefaultObject => (RPhysicalMaterialRefCounter)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RPhysicalMaterialRefCounter>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RPhysicalMaterialRefCounter>, new()
