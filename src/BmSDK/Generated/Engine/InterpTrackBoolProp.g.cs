...
public partial class InterpTrackBoolProp : BmSDK.Engine.InterpTrack, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpTrackBoolProp.
    /// </summary>
    public static InterpTrackBoolProp DefaultObject => (InterpTrackBoolProp)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpTrackBoolProp>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpTrackBoolProp>, new()
