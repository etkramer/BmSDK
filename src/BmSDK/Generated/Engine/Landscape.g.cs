...
public partial class Landscape : BmSDK.Engine.LandscapeProxy, BmSDK.IGameObject
{
    ...
    public partial record struct FLandscapeLayerInfo
    {
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.PhysicalMaterial>(Ptr + 16); }; }
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.MaterialInstanceConstant>(Ptr + 24); }; }
        ...
        /// <summary>
        /// StrProperty: LayerSourceFile
        /// </summary>
        public unsafe BmSDK.FString LayerSourceFile
        {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.FName>>(Ptr + 960); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Landscape.FLandscapeLayerInfo>>(Ptr + 976); }
