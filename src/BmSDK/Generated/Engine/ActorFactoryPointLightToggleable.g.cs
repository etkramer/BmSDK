...
public partial class ActorFactoryPointLightToggleable : BmSDK.Engine.ActorFactoryLight, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ActorFactoryPointLightToggleable.
    /// </summary>
    public static ActorFactoryPointLightToggleable DefaultObject => (ActorFactoryPointLightToggleable)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ActorFactoryPointLightToggleable>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ActorFactoryPointLightToggleable>, new()
