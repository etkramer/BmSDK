...
public partial class MaterialExpressionTextureSampleParameterCube : BmSDK.Engine.MaterialExpressionTextureSampleParameter, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionTextureSampleParameterCube.
    /// </summary>
    public static MaterialExpressionTextureSampleParameterCube DefaultObject => (MaterialExpressionTextureSampleParameterCube)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionTextureSampleParameterCube>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionTextureSampleParameterCube>, new()
