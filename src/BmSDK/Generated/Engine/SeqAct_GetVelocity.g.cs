...
public partial class SeqAct_GetVelocity : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqAct_GetVelocity.
    /// </summary>
    public static SeqAct_GetVelocity DefaultObject => (SeqAct_GetVelocity)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqAct_GetVelocity>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqAct_GetVelocity>, new()
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 VelocityVect
