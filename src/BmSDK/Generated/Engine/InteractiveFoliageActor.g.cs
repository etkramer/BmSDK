...
/// <summary>
/// Class: InteractiveFoliageActor<br/>
/// (size = 828)
/// (flags = 144704146)
/// </summary>
public partial class InteractiveFoliageActor : BmSDK.Engine.StaticMeshActor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.InteractiveFoliageActor", false);
    ...
    /// <summary>
    /// Constructs a new InteractiveFoliageActor
    /// </summary>
    public InteractiveFoliageActor(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, InteractiveFoliageActor Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected InteractiveFoliageActor(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InteractiveFoliageActor>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InteractiveFoliageActor>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "Engine.InteractiveFoliageActor.Touch", true);
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "Engine.InteractiveFoliageActor.TakeDamage", true);
    ...
    /// <summary>
    /// BoolProperty: bAutomateBoundingCylinder
    /// </summary>
    public unsafe bool bAutomateBoundingCylinder
    {
    ...
    /// <summary>
    /// BoolProperty: bPlayedTouchVFX
    /// </summary>
    public unsafe bool bPlayedTouchVFX
    {
    ...
    /// <summary>
    /// StructProperty: TouchingActorEntryPosition
    /// </summary>
    public unsafe System.Numerics.Vector3 TouchingActorEntryPosition
    {
    ...
    /// <summary>
    /// StructProperty: FoliageVelocity
    /// </summary>
    public unsafe System.Numerics.Vector3 FoliageVelocity
    {
    ...
    /// <summary>
    /// StructProperty: FoliageForce
    /// </summary>
    public unsafe System.Numerics.Vector3 FoliageForce
    {
    ...
    /// <summary>
    /// StructProperty: FoliagePosition
    /// </summary>
    public unsafe System.Numerics.Vector3 FoliagePosition
    {
    ...
    /// <summary>
    /// FloatProperty: FoliageDamageImpulseScale
    /// </summary>
    ...
    /// <summary>
    /// FloatProperty: FoliageTouchImpulseScale
    /// </summary>
    ...
    /// <summary>
    /// FloatProperty: FoliageStiffness
    /// </summary>
    ...
    /// <summary>
    /// FloatProperty: FoliageStiffnessQuadratic
    /// </summary>
    ...
    /// <summary>
    /// FloatProperty: MaxDamageImpulse
    /// </summary>
    ...
    /// <summary>
    /// ObjectProperty: RotationRTPC
    /// </summary>
    public unsafe BmSDK.Engine.AkParameterName RotationRTPC
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.AkParameterName>(Ptr + 808); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 808); }
    }

    /// <summary>
    /// ObjectProperty: TouchParticleSystem
    /// </summary>
    public unsafe BmSDK.Engine.ParticleSystem TouchParticleSystem
    {
