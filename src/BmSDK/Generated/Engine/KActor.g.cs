...
public partial class KActor : BmSDK.Engine.DynamicSMActor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public enum EKActorTickReason : byte
    {
    ...
    /// </summary>
    public unsafe ref BmSDK.Engine.AkWwise.FAkFakePhysics FakePhysics
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.AkWwise.FAkFakePhysics>(Ptr + 772);
    ...
    public unsafe ref BmSDK.Engine.Actor.FRigidBodyState RBState
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.Actor.FRigidBodyState>(Ptr + 896);
    ...
    public unsafe ref BmSDK.Rotator InitialRotation
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 976);
