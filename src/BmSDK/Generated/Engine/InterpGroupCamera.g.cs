...
public partial class InterpGroupCamera : BmSDK.Engine.InterpGroup, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpGroupCamera.
    /// </summary>
    public static InterpGroupCamera DefaultObject => (InterpGroupCamera)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpGroupCamera>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpGroupCamera>, new()
    ...
    /// </summary>
    public unsafe ref BmSDK.Engine.InterpGroupCamera.FCameraPreviewInfo Target
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.InterpGroupCamera.FCameraPreviewInfo>(Ptr + 172);
