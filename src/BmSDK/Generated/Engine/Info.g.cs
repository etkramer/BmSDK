...
public partial class Info : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.Info", false);
    ...
    /// </summary>
    public Info(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, Info Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected Info(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<Info>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<Info>, new()
    ...
    {
        /// <summary>
        /// IntProperty: ServerID
        /// </summary>
        public unsafe int ServerID
        {
        ...
        /// StrProperty: IP
        /// </summary>
        public unsafe BmSDK.FString IP
        {
        ...
        /// <summary>
        /// ArrayProperty: ServerInfo
        /// </summary>
        public unsafe BmSDK.TArray<BmSDK.Engine.Info.FKeyValuePair> ServerInfo
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Info.FKeyValuePair>>(Ptr + 88); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 88); }; }
        }

        /// <summary>
        /// ArrayProperty: PlayerInfo
        /// </summary>
        public unsafe BmSDK.TArray<BmSDK.Engine.Info.FPlayerResponseLine> PlayerInfo
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Info.FPlayerResponseLine>>(Ptr + 104); }; }
    ...
    public partial record struct FPlayerResponseLine
    {
        ...
        /// ArrayProperty: PlayerInfo
        /// </summary>
        public unsafe BmSDK.TArray<BmSDK.Engine.Info.FKeyValuePair> PlayerInfo
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Info.FKeyValuePair>>(Ptr + 36); }; }
