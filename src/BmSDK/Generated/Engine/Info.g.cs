...
public partial class Info : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as Info.
    /// </summary>
    public static Info DefaultObject => (Info)StaticClass().DefaultObject;
    ...
    public partial record struct FServerResponseLine
    {
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Info.FKeyValuePair>>(Ptr + 72); }; }
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Info.FPlayerResponseLine>>(Ptr + 84); }; }
    ...
    public partial record struct FPlayerResponseLine
    {
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Info.FKeyValuePair>>(Ptr + 32); }; }
