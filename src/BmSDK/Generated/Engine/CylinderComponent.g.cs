...
public partial class CylinderComponent : BmSDK.Engine.PrimitiveComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as CylinderComponent.
    /// </summary>
    public static CylinderComponent DefaultObject => (CylinderComponent)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.GameObject.FColor CylinderColor
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FColor>(Ptr + 552);
