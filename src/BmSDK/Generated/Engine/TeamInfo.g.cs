...
public partial class TeamInfo : BmSDK.Engine.ReplicationInfo, BmSDK.IGameObject
{
    ...
    /// Function: AddToTeam
    /// </summary>
    public unsafe virtual bool AddToTeam(BmSDK.Engine.Controller Other)
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "Engine.TeamInfo.AddToTeam", true);
    ...
    public unsafe ref BmSDK.GameObject.FColor TeamColor
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FColor>(Ptr + 696);
}
