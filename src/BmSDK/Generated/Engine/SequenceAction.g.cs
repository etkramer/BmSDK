...
public partial class SequenceAction : BmSDK.Engine.SequenceOp, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SequenceAction.
    /// </summary>
    public static SequenceAction DefaultObject => (SequenceAction)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SequenceAction>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SequenceAction>, new()
