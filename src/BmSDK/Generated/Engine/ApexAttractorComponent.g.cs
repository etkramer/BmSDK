...
public partial class ApexAttractorComponent : BmSDK.Engine.ApexFieldSamplerComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ApexAttractorComponent.
    /// </summary>
    public static ApexAttractorComponent DefaultObject => (ApexAttractorComponent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ApexAttractorComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ApexAttractorComponent>, new()
