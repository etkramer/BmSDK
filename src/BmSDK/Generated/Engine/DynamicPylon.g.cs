...
public partial class DynamicPylon : BmSDK.Engine.Pylon, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as DynamicPylon.
    /// </summary>
    public static DynamicPylon DefaultObject => (DynamicPylon)StaticClass().DefaultObject;
    ...
    /// </summary>
    public DynamicPylon(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
