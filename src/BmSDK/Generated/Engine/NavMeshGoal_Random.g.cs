...
public partial class NavMeshGoal_Random : BmSDK.Engine.NavMeshPathGoalEvaluator, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as NavMeshGoal_Random.
    /// </summary>
    public static NavMeshGoal_Random DefaultObject => (NavMeshGoal_Random)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<NavMeshGoal_Random>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<NavMeshGoal_Random>, new()
