...
public partial class CodecMovieBink : BmSDK.Engine.CodecMovie, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as CodecMovieBink.
    /// </summary>
    public static CodecMovieBink DefaultObject => (CodecMovieBink)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<CodecMovieBink>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<CodecMovieBink>, new()
