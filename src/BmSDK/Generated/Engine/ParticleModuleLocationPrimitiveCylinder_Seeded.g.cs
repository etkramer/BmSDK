...
public partial class ParticleModuleLocationPrimitiveCylinder_Seeded : BmSDK.Engine.ParticleModuleLocationPrimitiveCylinder, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleLocationPrimitiveCylinder_Seeded.
    /// </summary>
    public static ParticleModuleLocationPrimitiveCylinder_Seeded DefaultObject => (ParticleModuleLocationPrimitiveCylinder_Seeded)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.Engine.ParticleModule.FParticleRandomSeedInfo RandomSeedInfo
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.ParticleModule.FParticleRandomSeedInfo>(Ptr + 180);
}
