...
public partial class RockReflectionVolumeMovable : BmSDK.Engine.RockReflectionVolume, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RockReflectionVolumeMovable(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RockReflectionVolumeMovable Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
