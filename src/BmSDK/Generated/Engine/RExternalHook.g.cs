...
public partial class RExternalHook : BmSDK.Engine.AkHash, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RExternalHook.
    /// </summary>
    public static RExternalHook DefaultObject => (RExternalHook)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RExternalHook>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RExternalHook>, new()
