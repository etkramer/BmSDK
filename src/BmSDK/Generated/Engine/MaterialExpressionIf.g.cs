...
public partial class MaterialExpressionIf : BmSDK.Engine.MaterialExpression, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionIf.
    /// </summary>
    public static MaterialExpressionIf DefaultObject => (MaterialExpressionIf)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.Engine.MaterialExpression.FExpressionInput ALessThanB
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.MaterialExpression.FExpressionInput>(Ptr + 380);
}
