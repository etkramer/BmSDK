...
/// <summary>
/// Class: ParticleModuleRotationBase<br/>
/// (size = 0)
/// (flags = 0)
/// </summary>
public partial class ParticleModuleRotationBase : BmSDK.Engine.ParticleModule, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Constructs a new ParticleModuleRotationBase
    /// </summary>
    public ParticleModuleRotationBase(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, ParticleModuleRotationBase Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
