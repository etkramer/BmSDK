...
public partial class RFakeVehicle : BmSDK.Engine.AkVehicle, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RFakeVehicle.
    /// </summary>
    public static RFakeVehicle DefaultObject => (RFakeVehicle)StaticClass().DefaultObject;
