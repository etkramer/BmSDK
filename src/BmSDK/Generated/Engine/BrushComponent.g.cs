...
public partial class BrushComponent : BmSDK.Engine.PrimitiveComponent, BmSDK.IGameObject
{
    ...
    public unsafe ref BmSDK.Engine.KMeshProps.FKAggregateGeom BrushAggGeom
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.KMeshProps.FKAggregateGeom>(Ptr + 548);

    /// <summary>
    /// StructProperty: CachedPhysBrushData
    /// </summary>
    public unsafe ref BmSDK.Engine.BrushComponent.FKCachedConvexData CachedPhysBrushData
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.BrushComponent.FKCachedConvexData>(Ptr + 656);
