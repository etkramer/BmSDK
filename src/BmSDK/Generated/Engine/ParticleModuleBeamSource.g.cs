...
public partial class ParticleModuleBeamSource : BmSDK.Engine.ParticleModuleBeamBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleBeamSource.
    /// </summary>
    public static ParticleModuleBeamSource DefaultObject => (ParticleModuleBeamSource)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe ref BmSDK.DistributionVector.FRawDistributionVector Source
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.DistributionVector.FRawDistributionVector>(Ptr + 72);

    /// <summary>
    /// StructProperty: SourceTangent
    /// </summary>
    public unsafe ref BmSDK.DistributionVector.FRawDistributionVector SourceTangent
