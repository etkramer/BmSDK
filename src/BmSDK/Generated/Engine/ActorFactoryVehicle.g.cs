...
public partial class ActorFactoryVehicle : BmSDK.Engine.ActorFactory, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ActorFactoryVehicle.
    /// </summary>
    public static ActorFactoryVehicle DefaultObject => (ActorFactoryVehicle)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ActorFactoryVehicle>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ActorFactoryVehicle>, new()
