...
public partial class InterpTrackSkelControlScale : BmSDK.Engine.InterpTrackFloatBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpTrackSkelControlScale.
    /// </summary>
    public static InterpTrackSkelControlScale DefaultObject => (InterpTrackSkelControlScale)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpTrackSkelControlScale>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpTrackSkelControlScale>, new()
