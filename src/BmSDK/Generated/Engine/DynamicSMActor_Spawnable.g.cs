...
public partial class DynamicSMActor_Spawnable : BmSDK.Engine.DynamicSMActor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.DynamicSMActor_Spawnable", false);
    ...
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<DynamicSMActor_Spawnable>, new()
