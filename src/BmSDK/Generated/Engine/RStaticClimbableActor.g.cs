...
public partial class RStaticClimbableActor : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.RStaticClimbableActor", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RStaticClimbableActor() { }

    /// <summary>
    /// Constructs a new RStaticClimbableActor
    /// </summary>
    public RStaticClimbableActor(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RStaticClimbableActor Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RStaticClimbableActor(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RStaticClimbableActor>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RStaticClimbableActor>, new()
    ...
    public partial record struct FRailingBlockerPair
    {
        ...
        /// <summary>
        /// ArrayProperty: OtherActors
        /// </summary>
        public unsafe BmSDK.TArray<BmSDK.Engine.RStaticClimbableActor> OtherActors
        {
    ...
    /// <summary>
    /// BoolProperty: bDontBlockShimmyEdges
    /// </summary>
    public unsafe bool bDontBlockShimmyEdges
    {
    ...
    /// <summary>
    /// BoolProperty: bNoRailingTops
    /// </summary>
    public unsafe bool bNoRailingTops
    {
    ...
    /// <summary>
    /// BoolProperty: bCanBeRailingBlocker
    /// </summary>
    public unsafe bool bCanBeRailingBlocker
    {
    ...
    /// <summary>
    /// ArrayProperty: RailingBlockers
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.Engine.RStaticClimbableActor.FRailingBlockerPair> RailingBlockers
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.RStaticClimbableActor.FRailingBlockerPair>>(Ptr + 672); }
