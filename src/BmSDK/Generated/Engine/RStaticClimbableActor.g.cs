...
/// <summary>
/// ABSTRACT Class: RStaticClimbableActor<br/>
/// (size = 688)
/// (flags = 144703635)
/// </summary>
public partial class RStaticClimbableActor : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RStaticClimbableActor.
    /// </summary>
    public static RStaticClimbableActor DefaultObject => (RStaticClimbableActor)StaticClass().DefaultObject;
