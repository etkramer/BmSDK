...
public partial class ParticleModuleLocationWorldOffset_Seeded : BmSDK.Engine.ParticleModuleLocationWorldOffset, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleLocationWorldOffset_Seeded.
    /// </summary>
    public static ParticleModuleLocationWorldOffset_Seeded DefaultObject => (ParticleModuleLocationWorldOffset_Seeded)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleLocationWorldOffset_Seeded>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleLocationWorldOffset_Seeded>, new()
    ...
    public unsafe ref BmSDK.Engine.ParticleModule.FParticleRandomSeedInfo RandomSeedInfo
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.ParticleModule.FParticleRandomSeedInfo>(Ptr + 168);
}
