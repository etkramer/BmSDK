...
public partial class RockSceneCaptureCubeMapComponent : BmSDK.Engine.SceneCaptureCubeMapComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RockSceneCaptureCubeMapComponent.
    /// </summary>
    public static RockSceneCaptureCubeMapComponent DefaultObject => (RockSceneCaptureCubeMapComponent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RockSceneCaptureCubeMapComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RockSceneCaptureCubeMapComponent>, new()
