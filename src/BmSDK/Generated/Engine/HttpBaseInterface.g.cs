...
public partial class HttpBaseInterface : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Constructs a new HttpBaseInterface
    /// </summary>
    public HttpBaseInterface(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, HttpBaseInterface Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
