...
public partial class NxRadialForceField : BmSDK.Engine.NxForceField, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as NxRadialForceField.
    /// </summary>
    public static NxRadialForceField DefaultObject => (NxRadialForceField)StaticClass().DefaultObject;
    ...
    /// </summary>
    public NxRadialForceField(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
