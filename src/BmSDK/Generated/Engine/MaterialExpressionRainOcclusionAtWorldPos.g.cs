...
public partial class MaterialExpressionRainOcclusionAtWorldPos : BmSDK.Engine.MaterialExpression, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionRainOcclusionAtWorldPos.
    /// </summary>
    public static MaterialExpressionRainOcclusionAtWorldPos DefaultObject => (MaterialExpressionRainOcclusionAtWorldPos)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionRainOcclusionAtWorldPos>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionRainOcclusionAtWorldPos>, new()
