...
public partial class InterpTrackInstVisibility : BmSDK.Engine.InterpTrackInst, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpTrackInstVisibility.
    /// </summary>
    public static InterpTrackInstVisibility DefaultObject => (InterpTrackInstVisibility)StaticClass().DefaultObject;
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.InterpTrackVisibility.EVisibilityTrackAction>(Ptr + 84); }
