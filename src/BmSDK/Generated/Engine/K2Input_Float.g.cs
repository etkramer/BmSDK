...
public partial class K2Input_Float : BmSDK.Engine.K2Input, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as K2Input_Float.
    /// </summary>
    public static K2Input_Float DefaultObject => (K2Input_Float)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<K2Input_Float>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<K2Input_Float>, new()
