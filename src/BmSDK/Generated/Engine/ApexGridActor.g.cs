...
public partial class ApexGridActor : BmSDK.Engine.ApexFieldSamplerActor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public ApexGridActor(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, ApexGridActor Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
