...
public partial class MaterialExpressionBlurTextureSampleParameter : BmSDK.Engine.MaterialExpressionBlurTextureSample, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionBlurTextureSampleParameter.
    /// </summary>
    public static MaterialExpressionBlurTextureSampleParameter DefaultObject => (MaterialExpressionBlurTextureSampleParameter)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionBlurTextureSampleParameter>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionBlurTextureSampleParameter>, new()
    ...
    public unsafe ref BmSDK.GameObject.FGuid ExpressionGUID
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FGuid>(Ptr + 304);
}
