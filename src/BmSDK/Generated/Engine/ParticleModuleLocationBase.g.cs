...
/// <summary>
/// Class: ParticleModuleLocationBase<br/>
/// (flags = 0)
/// </summary>
public partial class ParticleModuleLocationBase : BmSDK.Engine.ParticleModule, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Constructs a new ParticleModuleLocationBase
    /// </summary>
    public ParticleModuleLocationBase(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, ParticleModuleLocationBase Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
