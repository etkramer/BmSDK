...
public partial class LandscapeProxy : BmSDK.Engine.Info, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as LandscapeProxy.
    /// </summary>
    public static LandscapeProxy DefaultObject => (LandscapeProxy)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.Engine.EngineTypes.FLightmassPrimitiveSettings LightmassSettings
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.EngineTypes.FLightmassPrimitiveSettings>(Ptr + 904);
