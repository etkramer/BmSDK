...
public partial class DistributionFloatParticleParameter : BmSDK.Engine.DistributionFloatParameterBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as DistributionFloatParticleParameter.
    /// </summary>
    public static DistributionFloatParticleParameter DefaultObject => (DistributionFloatParticleParameter)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<DistributionFloatParticleParameter>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<DistributionFloatParticleParameter>, new()
