...
public partial class AkFactName : BmSDK.Engine.AkPredicate, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkFactName.
    /// </summary>
    public static AkFactName DefaultObject => (AkFactName)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkFactName>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkFactName>, new()
