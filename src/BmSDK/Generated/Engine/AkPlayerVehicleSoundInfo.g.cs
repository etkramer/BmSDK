...
public partial class AkPlayerVehicleSoundInfo : BmSDK.Engine.AkVehicleSoundInfo, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkPlayerVehicleSoundInfo.
    /// </summary>
    public static AkPlayerVehicleSoundInfo DefaultObject => (AkPlayerVehicleSoundInfo)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkPlayerVehicleSoundInfo>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkPlayerVehicleSoundInfo>, new()
