...
public partial class DecalActorBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as DecalActorBase.
    /// </summary>
    public static DecalActorBase DefaultObject => (DecalActorBase)StaticClass().DefaultObject;
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.DecalComponent>(Ptr + 676); }
