...
public partial class ActorFactoryApexJet : BmSDK.Engine.ActorFactory, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ActorFactoryApexJet.
    /// </summary>
    public static ActorFactoryApexJet DefaultObject => (ActorFactoryApexJet)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ActorFactoryApexJet>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ActorFactoryApexJet>, new()
