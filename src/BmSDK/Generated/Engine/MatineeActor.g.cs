...
public partial class MatineeActor : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public InlineArray<BmSDK.FName> AIGroupNames => new(10, Ptr + 444, 8);
    ...
    /// </summary>
    public InlineArray<BmSDK.Engine.Pawn> AIGroupPawns => new(10, Ptr + 524, 4);
    ...
    /// </summary>
    public InlineArray<int> AIGroupInitStage => new(10, Ptr + 564, 4);
