...
public partial class AkAudioActionSwitch : BmSDK.Engine.AkAudioAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkAudioActionSwitch.
    /// </summary>
    public static AkAudioActionSwitch DefaultObject => (AkAudioActionSwitch)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkAudioActionSwitch>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkAudioActionSwitch>, new()
