...
public partial class RockReflectionVolume : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RockReflectionVolume.
    /// </summary>
    public static RockReflectionVolume DefaultObject => (RockReflectionVolume)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe ref BmSDK.Engine.RockReflectionVolume.FFReflectionBoxInfo ReflectionBoxInfo
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.RockReflectionVolume.FFReflectionBoxInfo>(Ptr + 672);
