...
public partial class AutoNavMeshPathObstacleUnregister : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AutoNavMeshPathObstacleUnregister.
    /// </summary>
    public static AutoNavMeshPathObstacleUnregister DefaultObject => (AutoNavMeshPathObstacleUnregister)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AutoNavMeshPathObstacleUnregister>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AutoNavMeshPathObstacleUnregister>, new()
