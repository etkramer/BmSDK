...
public partial class SeqAct_ActorFactoryEx : BmSDK.Engine.SeqAct_ActorFactory, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqAct_ActorFactoryEx.
    /// </summary>
    public static SeqAct_ActorFactoryEx DefaultObject => (SeqAct_ActorFactoryEx)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqAct_ActorFactoryEx>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqAct_ActorFactoryEx>, new()
