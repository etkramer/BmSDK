...
public partial class MaterialExpressionLensFlareSourceDistance : BmSDK.Engine.MaterialExpression, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionLensFlareSourceDistance.
    /// </summary>
    public static MaterialExpressionLensFlareSourceDistance DefaultObject => (MaterialExpressionLensFlareSourceDistance)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionLensFlareSourceDistance>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionLensFlareSourceDistance>, new()
