...
/// <summary>
/// ABSTRACT Class: ParticleModule<br/>
/// (size = 56)
/// (flags = 134221971)
/// </summary>
public partial class ParticleModule : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModule>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModule>, new()
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<byte>(Ptr + 48); }
