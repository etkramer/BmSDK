...
public partial class InterpGroup : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpGroup.
    /// </summary>
    public static InterpGroup DefaultObject => (InterpGroup)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.GameObject.FColor GroupColor
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FColor>(Ptr + 116);
