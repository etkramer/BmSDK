...
public partial class DistributionFloatUniformCurve : BmSDK.DistributionFloat, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as DistributionFloatUniformCurve.
    /// </summary>
    public static DistributionFloatUniformCurve DefaultObject => (DistributionFloatUniformCurve)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.GameObject.FInterpCurveVector2D ConstantCurve
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FInterpCurveVector2D>(Ptr + 112);
}
