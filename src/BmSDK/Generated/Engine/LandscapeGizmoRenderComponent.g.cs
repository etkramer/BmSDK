...
public partial class LandscapeGizmoRenderComponent : BmSDK.Engine.PrimitiveComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as LandscapeGizmoRenderComponent.
    /// </summary>
    public static LandscapeGizmoRenderComponent DefaultObject => (LandscapeGizmoRenderComponent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<LandscapeGizmoRenderComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<LandscapeGizmoRenderComponent>, new()
