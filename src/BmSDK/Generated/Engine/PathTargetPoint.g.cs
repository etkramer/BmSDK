...
public partial class PathTargetPoint : BmSDK.Engine.Keypoint, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as PathTargetPoint.
    /// </summary>
    public static PathTargetPoint DefaultObject => (PathTargetPoint)StaticClass().DefaultObject;
    ...
    /// </summary>
    public PathTargetPoint(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
