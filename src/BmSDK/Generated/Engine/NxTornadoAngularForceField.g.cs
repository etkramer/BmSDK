...
public partial class NxTornadoAngularForceField : BmSDK.Engine.NxForceField, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.NxTornadoAngularForceField", false);
    ...
    /// <summary>
    /// Gets the class default object as NxTornadoAngularForceField.
    /// </summary>
    public static NxTornadoAngularForceField DefaultObject => (NxTornadoAngularForceField)StaticClass().DefaultObject;
    ...
    /// </summary>
    protected NxTornadoAngularForceField(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<NxTornadoAngularForceField>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<NxTornadoAngularForceField>, new()
