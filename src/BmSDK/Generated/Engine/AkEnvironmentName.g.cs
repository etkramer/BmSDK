...
public partial class AkEnvironmentName : BmSDK.Engine.AkAsset, BmSDK.IGameObject
{
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkEnvironmentName>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkEnvironmentName>, new()
    ...
    /// Enum: EAuxEffectType
    /// </summary>
    public enum EAuxEffectType : byte
    {
