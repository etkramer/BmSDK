...
public partial class ParticleModuleFieldSamplerDynamicGrid : BmSDK.Engine.ParticleModuleFieldSamplerBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleFieldSamplerDynamicGrid.
    /// </summary>
    public static ParticleModuleFieldSamplerDynamicGrid DefaultObject => (ParticleModuleFieldSamplerDynamicGrid)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleFieldSamplerDynamicGrid>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleFieldSamplerDynamicGrid>, new()
