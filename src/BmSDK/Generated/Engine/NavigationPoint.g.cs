...
public partial class NavigationPoint : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// Function: Accept
    /// </summary>
    public unsafe virtual bool Accept(BmSDK.Engine.Actor Incoming, BmSDK.Engine.Actor Source)
    {
    ...
    public unsafe ref BmSDK.Engine.NavigationPoint.FNavigationOctreeObject NavOctreeObject
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.NavigationPoint.FNavigationOctreeObject>(Ptr + 672);
    ...
    public unsafe ref BmSDK.GameObject.FCylinder MaxPathSize
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FCylinder>(Ptr + 912);

    /// <summary>
    /// StructProperty: NavGuid
    /// </summary>
    public unsafe ref BmSDK.GameObject.FGuid NavGuid
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FGuid>(Ptr + 920);
