...
public partial class InterpTrackInstFaceFXRegister : BmSDK.Engine.InterpTrackInst, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpTrackInstFaceFXRegister.
    /// </summary>
    public static InterpTrackInstFaceFXRegister DefaultObject => (InterpTrackInstFaceFXRegister)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpTrackInstFaceFXRegister>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpTrackInstFaceFXRegister>, new()
