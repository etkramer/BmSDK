...
public partial class MaterialExpressionTextureSampleParameter2D : BmSDK.Engine.MaterialExpressionTextureSampleParameter, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionTextureSampleParameter2D.
    /// </summary>
    public static MaterialExpressionTextureSampleParameter2D DefaultObject => (MaterialExpressionTextureSampleParameter2D)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionTextureSampleParameter2D>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionTextureSampleParameter2D>, new()
