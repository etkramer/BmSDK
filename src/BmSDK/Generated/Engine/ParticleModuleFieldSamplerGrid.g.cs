...
public partial class ParticleModuleFieldSamplerGrid : BmSDK.Engine.ParticleModuleFieldSamplerBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleFieldSamplerGrid.
    /// </summary>
    public static ParticleModuleFieldSamplerGrid DefaultObject => (ParticleModuleFieldSamplerGrid)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleFieldSamplerGrid>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleFieldSamplerGrid>, new()
