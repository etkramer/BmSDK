...
public partial class OnlineCustomContentRequestHydra : BmSDK.Engine.OnlineCustomContentRequest, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as OnlineCustomContentRequestHydra.
    /// </summary>
    public static OnlineCustomContentRequestHydra DefaultObject => (OnlineCustomContentRequestHydra)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<OnlineCustomContentRequestHydra>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<OnlineCustomContentRequestHydra>, new()
