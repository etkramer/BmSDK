...
public partial class MaterialExpressionVectorParameter : BmSDK.Engine.MaterialExpressionParameter, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionVectorParameter.
    /// </summary>
    public static MaterialExpressionVectorParameter DefaultObject => (MaterialExpressionVectorParameter)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionVectorParameter>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionVectorParameter>, new()
    ...
    public unsafe ref BmSDK.GameObject.FLinearColor DefaultValue
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FLinearColor>(Ptr + 204);
}
