...
public partial class Trigger_LOS : BmSDK.Engine.Trigger, BmSDK.IGameObject
{
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "Engine.Trigger_LOS.OnToggle", true);
    ...
    public unsafe void TickLOS()
    {
        ...
        byte* paramsPtr = stackalloc byte[86];
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.PlayerController>>(Ptr + 688); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 688); }
    }

    /// <summary>
    /// BoolProperty: bDrawDebugForTesting
    /// </summary>
    public unsafe bool bDrawDebugForTesting
    {
    ...
    /// <summary>
    /// BoolProperty: bResetLOSListOnToggle
    /// </summary>
    public unsafe bool bResetLOSListOnToggle
    {
