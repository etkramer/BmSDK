...
public partial class MaterialExpressionMeshSubUV : BmSDK.Engine.MaterialExpressionTextureSample, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionMeshSubUV.
    /// </summary>
    public static MaterialExpressionMeshSubUV DefaultObject => (MaterialExpressionMeshSubUV)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionMeshSubUV>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionMeshSubUV>, new()
