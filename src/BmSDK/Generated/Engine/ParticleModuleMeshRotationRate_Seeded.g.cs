...
public partial class ParticleModuleMeshRotationRate_Seeded : BmSDK.Engine.ParticleModuleMeshRotationRate, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleMeshRotationRate_Seeded.
    /// </summary>
    public static ParticleModuleMeshRotationRate_Seeded DefaultObject => (ParticleModuleMeshRotationRate_Seeded)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleMeshRotationRate_Seeded>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleMeshRotationRate_Seeded>, new()
    ...
    public unsafe ref BmSDK.Engine.ParticleModule.FParticleRandomSeedInfo RandomSeedInfo
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.ParticleModule.FParticleRandomSeedInfo>(Ptr + 160);
}
