...
public partial class AkActionGlobal_Fact : BmSDK.Engine.AkActionGlobal, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkActionGlobal_Fact.
    /// </summary>
    public static AkActionGlobal_Fact DefaultObject => (AkActionGlobal_Fact)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkActionGlobal_Fact>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkActionGlobal_Fact>, new()
