...
public partial class InterpGroupInstCamera : BmSDK.Engine.InterpGroupInst, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpGroupInstCamera.
    /// </summary>
    public static InterpGroupInstCamera DefaultObject => (InterpGroupInstCamera)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpGroupInstCamera>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpGroupInstCamera>, new()
