...
public partial class SeqAct_HeadTrackingControl : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqAct_HeadTrackingControl.
    /// </summary>
    public static SeqAct_HeadTrackingControl DefaultObject => (SeqAct_HeadTrackingControl)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqAct_HeadTrackingControl>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqAct_HeadTrackingControl>, new()
