...
public partial class NxForceFieldTornadoComponent : BmSDK.Engine.NxForceFieldComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as NxForceFieldTornadoComponent.
    /// </summary>
    public static NxForceFieldTornadoComponent DefaultObject => (NxForceFieldTornadoComponent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<NxForceFieldTornadoComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<NxForceFieldTornadoComponent>, new()
