...
public partial class SeqVar_Int : BmSDK.Engine.SequenceVariable, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqVar_Int.
    /// </summary>
    public static SeqVar_Int DefaultObject => (SeqVar_Int)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqVar_Int>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqVar_Int>, new()
