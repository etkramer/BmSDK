...
public partial class InterpTrackInstEvent : BmSDK.Engine.InterpTrackInst, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpTrackInstEvent.
    /// </summary>
    public static InterpTrackInstEvent DefaultObject => (InterpTrackInstEvent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpTrackInstEvent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpTrackInstEvent>, new()
