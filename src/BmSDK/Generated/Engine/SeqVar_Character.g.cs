...
public partial class SeqVar_Character : BmSDK.Engine.SeqVar_Object, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqVar_Character.
    /// </summary>
    public static SeqVar_Character DefaultObject => (SeqVar_Character)StaticClass().DefaultObject;
    ...
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqVar_Character>, new()
