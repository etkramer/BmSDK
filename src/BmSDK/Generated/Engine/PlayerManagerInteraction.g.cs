...
public partial class PlayerManagerInteraction : BmSDK.Engine.Interaction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as PlayerManagerInteraction.
    /// </summary>
    public static PlayerManagerInteraction DefaultObject => (PlayerManagerInteraction)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<PlayerManagerInteraction>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<PlayerManagerInteraction>, new()
