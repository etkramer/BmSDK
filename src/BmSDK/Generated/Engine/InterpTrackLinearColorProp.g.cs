...
public partial class InterpTrackLinearColorProp : BmSDK.Engine.InterpTrackLinearColorBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpTrackLinearColorProp.
    /// </summary>
    public static InterpTrackLinearColorProp DefaultObject => (InterpTrackLinearColorProp)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpTrackLinearColorProp>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpTrackLinearColorProp>, new()
