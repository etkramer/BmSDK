...
public partial class SeqAct_ModifyHealth : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqAct_ModifyHealth>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqAct_ModifyHealth>, new()
    ...
    /// <summary>
    /// BoolProperty: bUseDamageLocation
    /// </summary>
    public unsafe bool bUseDamageLocation
    {
    ...
    /// <summary>
    /// ObjectProperty: DamageLocation
    /// </summary>
    public unsafe BmSDK.Engine.Actor DamageLocation
    {
