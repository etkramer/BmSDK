...
public partial class ActorFactoryAI : BmSDK.Engine.ActorFactory, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ActorFactoryAI.
    /// </summary>
    public static ActorFactoryAI DefaultObject => (ActorFactoryAI)StaticClass().DefaultObject;
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Class>>(Ptr + 180); }
