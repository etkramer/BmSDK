...
public partial class ParticleModuleRotation_Seeded : BmSDK.Engine.ParticleModuleRotation, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleRotation_Seeded.
    /// </summary>
    public static ParticleModuleRotation_Seeded DefaultObject => (ParticleModuleRotation_Seeded)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleRotation_Seeded>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleRotation_Seeded>, new()
