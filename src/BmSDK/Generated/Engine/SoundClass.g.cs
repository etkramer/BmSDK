...
public partial class SoundClass : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.SoundClass", false);
    ...
    /// <summary>
    /// Gets the class default object as SoundClass.
    /// </summary>
    public static SoundClass DefaultObject => (SoundClass)StaticClass().DefaultObject;

    internal SoundClass() { }

    /// <summary>
    /// Constructs a new SoundClass
    /// </summary>
    public SoundClass(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, SoundClass Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected SoundClass(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SoundClass>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SoundClass>, new()
    ...
    public unsafe ref BmSDK.Engine.SoundClass.FSoundClassProperties Properties
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.SoundClass.FSoundClassProperties>(Ptr + 84);

    /// <summary>
    /// ArrayProperty: ChildClassNames
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.FName> ChildClassNames
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TMap<object, object> /* TODO */>(Ptr + 140); }
    ...
    public partial record struct FSoundClassProperties
    {
        ...
        /// <summary>
        /// FloatProperty: VoiceCenterChannelVolume
        /// </summary>
        public unsafe float VoiceCenterChannelVolume
        {
        ...
        /// <summary>
        /// FloatProperty: RadioFilterVolume
        /// </summary>
        public unsafe float RadioFilterVolume
        {
        ...
        /// <summary>
        /// FloatProperty: RadioFilterVolumeThreshold
        /// </summary>
        public unsafe float RadioFilterVolumeThreshold
        {
        ...
        /// <summary>
        /// BoolProperty: bApplyEffects
        /// </summary>
        public unsafe bool bApplyEffects
        {
        ...
        /// <summary>
        /// BoolProperty: bApplyAmbientVolumes
        /// </summary>
        public unsafe bool bApplyAmbientVolumes
        {
