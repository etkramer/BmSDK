...
public partial class ParticleModuleVelocity_Seeded : BmSDK.Engine.ParticleModuleVelocity, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleVelocity_Seeded.
    /// </summary>
    public static ParticleModuleVelocity_Seeded DefaultObject => (ParticleModuleVelocity_Seeded)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.Engine.ParticleModule.FParticleRandomSeedInfo RandomSeedInfo
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.ParticleModule.FParticleRandomSeedInfo>(Ptr + 116);
}
