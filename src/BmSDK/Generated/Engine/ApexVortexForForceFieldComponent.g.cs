...
public partial class ApexVortexForForceFieldComponent : BmSDK.Engine.ApexVortexComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ApexVortexForForceFieldComponent.
    /// </summary>
    public static ApexVortexForForceFieldComponent DefaultObject => (ApexVortexForForceFieldComponent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ApexVortexForForceFieldComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ApexVortexForForceFieldComponent>, new()
