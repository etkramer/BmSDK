...
public partial class InterpTrackInstColorScale : BmSDK.Engine.InterpTrackInst, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpTrackInstColorScale.
    /// </summary>
    public static InterpTrackInstColorScale DefaultObject => (InterpTrackInstColorScale)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpTrackInstColorScale>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpTrackInstColorScale>, new()
