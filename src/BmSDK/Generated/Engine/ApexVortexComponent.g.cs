...
/// <summary>
/// Class: ApexVortexComponent<br/>
/// (size = 632)
/// (flags = 0)
/// </summary>
public partial class ApexVortexComponent : BmSDK.Engine.ApexFieldSamplerComponent, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.ApexVortexComponent", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal ApexVortexComponent() { }

    /// <summary>
    /// Constructs a new ApexVortexComponent
    /// </summary>
    public ApexVortexComponent(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, ApexVortexComponent Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected ApexVortexComponent(nint ptr) : base(ptr) { }
