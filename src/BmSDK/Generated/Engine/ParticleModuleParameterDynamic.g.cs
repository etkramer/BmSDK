...
public partial class ParticleModuleParameterDynamic : BmSDK.Engine.ParticleModuleParameterBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleParameterDynamic.
    /// </summary>
    public static ParticleModuleParameterDynamic DefaultObject => (ParticleModuleParameterDynamic)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleParameterDynamic>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleParameterDynamic>, new()
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.ParticleModuleParameterDynamic.FEmitterDynamicParameter>>(Ptr + 56); }
