...
public partial class InterpTrackInstColorProp : BmSDK.Engine.InterpTrackInstProperty, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpTrackInstColorProp.
    /// </summary>
    public static InterpTrackInstColorProp DefaultObject => (InterpTrackInstColorProp)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.GameObject.FColor ResetColor
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FColor>(Ptr + 108);
}
