...
public partial class AkActionGlobal_CombatMusicControl : BmSDK.Engine.AkActionGlobal_MusicControl, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkActionGlobal_CombatMusicControl.
    /// </summary>
    public static AkActionGlobal_CombatMusicControl DefaultObject => (AkActionGlobal_CombatMusicControl)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkActionGlobal_CombatMusicControl>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkActionGlobal_CombatMusicControl>, new()
