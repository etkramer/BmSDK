...
public partial class SeqAct_CastToInt : BmSDK.Engine.SeqAct_SetSequenceVariable, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqAct_CastToInt.
    /// </summary>
    public static SeqAct_CastToInt DefaultObject => (SeqAct_CastToInt)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqAct_CastToInt>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqAct_CastToInt>, new()
