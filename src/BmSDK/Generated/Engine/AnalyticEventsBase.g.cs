...
public partial class AnalyticEventsBase : BmSDK.Engine.PlatformInterfaceBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AnalyticEventsBase.
    /// </summary>
    public static AnalyticEventsBase DefaultObject => (AnalyticEventsBase)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AnalyticEventsBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AnalyticEventsBase>, new()
