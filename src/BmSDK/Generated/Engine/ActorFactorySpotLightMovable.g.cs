...
public partial class ActorFactorySpotLightMovable : BmSDK.Engine.ActorFactorySpotLight, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ActorFactorySpotLightMovable.
    /// </summary>
    public static ActorFactorySpotLightMovable DefaultObject => (ActorFactorySpotLightMovable)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ActorFactorySpotLightMovable>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ActorFactorySpotLightMovable>, new()
