...
public partial class SVehicleSimCar : BmSDK.Engine.SVehicleSimBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SVehicleSimCar.
    /// </summary>
    public static SVehicleSimCar DefaultObject => (SVehicleSimCar)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SVehicleSimCar>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SVehicleSimCar>, new()
    ...
    /// </summary>
    public unsafe ref BmSDK.GameObject.FInterpCurveFloat MaxSteerAngleCurve
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FInterpCurveFloat>(Ptr + 200);
