...
public partial class ParticleModuleLocationWorldOffset : BmSDK.Engine.ParticleModuleLocation, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleLocationWorldOffset.
    /// </summary>
    public static ParticleModuleLocationWorldOffset DefaultObject => (ParticleModuleLocationWorldOffset)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleLocationWorldOffset>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleLocationWorldOffset>, new()
