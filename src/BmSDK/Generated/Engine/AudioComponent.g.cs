...
public partial class AudioComponent : BmSDK.Engine.ActorComponent, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe virtual bool IsFadingOut()
    {
    ...
    /// Function: IsFadingIn
    /// </summary>
    public unsafe virtual bool IsFadingIn()
    {
    ...
    public unsafe ref BmSDK.GameObject.FMultiMap_Mirror SoundNodeResetWaveMap
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FMultiMap_Mirror>(Ptr + 276);
