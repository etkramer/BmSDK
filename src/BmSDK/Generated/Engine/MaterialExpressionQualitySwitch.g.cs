...
public partial class MaterialExpressionQualitySwitch : BmSDK.Engine.MaterialExpression, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionQualitySwitch.
    /// </summary>
    public static MaterialExpressionQualitySwitch DefaultObject => (MaterialExpressionQualitySwitch)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionQualitySwitch>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionQualitySwitch>, new()
    ...
    /// StructProperty: High
    /// </summary>
    public unsafe ref BmSDK.Engine.MaterialExpression.FExpressionInput High
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.MaterialExpression.FExpressionInput>(Ptr + 172);

    /// <summary>
    /// StructProperty: Low
    /// </summary>
    public unsafe ref BmSDK.Engine.MaterialExpression.FExpressionInput Low
