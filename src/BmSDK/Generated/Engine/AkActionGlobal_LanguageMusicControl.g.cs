...
public partial class AkActionGlobal_LanguageMusicControl : BmSDK.Engine.AkActionGlobal_GenericMusicControl, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkActionGlobal_LanguageMusicControl.
    /// </summary>
    public static AkActionGlobal_LanguageMusicControl DefaultObject => (AkActionGlobal_LanguageMusicControl)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkActionGlobal_LanguageMusicControl>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkActionGlobal_LanguageMusicControl>, new()
