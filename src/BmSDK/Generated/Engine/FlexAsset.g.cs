...
public partial class FlexAsset : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as FlexAsset.
    /// </summary>
    public static FlexAsset DefaultObject => (FlexAsset)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<FlexAsset>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<FlexAsset>, new()
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 RigidCenter
    ...
    /// Enum: EFlexAssetType
    /// </summary>
    public enum EFlexAssetType : byte
    {
        FLEX_Cloth = 0,
        FLEX_Solid = 1,
        FLEX_MAX = 2,
