...
public partial class SkeletalMeshCinematicActor : BmSDK.Engine.SkeletalMeshActor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SkeletalMeshCinematicActor.
    /// </summary>
    public static SkeletalMeshCinematicActor DefaultObject => (SkeletalMeshCinematicActor)StaticClass().DefaultObject;
    ...
    /// </summary>
    public SkeletalMeshCinematicActor(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
