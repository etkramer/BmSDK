...
public partial class KismetBookMark : BmSDK.Engine.BookMark2D, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as KismetBookMark.
    /// </summary>
    public static KismetBookMark DefaultObject => (KismetBookMark)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<KismetBookMark>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<KismetBookMark>, new()
