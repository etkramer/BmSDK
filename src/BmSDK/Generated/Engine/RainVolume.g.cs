...
public partial class RainVolume : BmSDK.Engine.RHeightMapCaptureVolume, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RainVolume.
    /// </summary>
    public static RainVolume DefaultObject => (RainVolume)StaticClass().DefaultObject;
