...
public partial class SeqVar_Float : BmSDK.Engine.SequenceVariable, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqVar_Float.
    /// </summary>
    public static SeqVar_Float DefaultObject => (SeqVar_Float)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqVar_Float>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqVar_Float>, new()
