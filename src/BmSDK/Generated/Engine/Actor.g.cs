...
public partial class Actor : BmSDK.StateObject, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe bool GetAudioThoughts(out BmSDK.TArray<BmSDK.Engine.Actor.FThought> ThoughtList, out System.Numerics.Vector3 ThoughtLocation, BmSDK.Engine.AkComponent akComp)
    {
    ...
    /// </summary>
    public unsafe void OnAudioDebugRender(BmSDK.Engine.AkComponent akComp, bool DebugCulled)
    {
    ...
    /// </summary>
    public unsafe void OnAudioTick(BmSDK.Engine.AkComponent akComp, float TimeDelta)
    {
    ...
    /// </summary>
    public unsafe void SetStickyAudioParameterEx(BmSDK.Engine.AkParameterName ParamName, float ParamValue, float NewReleaseValue, float NewReleaseTime, float NewSustainTime, float NewAttackTime, bool AllowPause)
    {
    ...
    /// </summary>
    public unsafe void SetStickyAudioParameter(BmSDK.Engine.AkParameterName ParamName, float ParamValue)
    {
    ...
    /// </summary>
    public unsafe void StopLoopingEvent(out BmSDK.Engine.AkWwise.FAkSoundLoop SoundLoop, bool QuickStop = default)
    {
    ...
    /// </summary>
    public unsafe bool StartLoopingEvent(out BmSDK.Engine.AkWwise.FAkSoundLoop SoundLoop, System.IntPtr SoundCallbackDelegate = default, int SoundCallbackFlags = default)
    {
    ...
    /// </summary>
    public unsafe BmSDK.Engine.AkComponent AttachNewAkComponent()
    {
    ...
    /// </summary>
    public unsafe void GetAllAkComponents(out BmSDK.TArray<BmSDK.Engine.AkComponent> akComps)
    {
    ...
    /// Function: HurtRadius
    /// </summary>
    public unsafe bool HurtRadius(float BaseDamage, float DamageRadius, BmSDK.Class DamageType, float Momentum, System.Numerics.Vector3 HurtOrigin, BmSDK.Engine.Actor IgnoredActor = default, BmSDK.Engine.Controller InstigatedByController = default, bool bDoFullDamage = default)
    {
    ...
    /// </summary>
    public unsafe BmSDK.FName GetInitialState()
    {
    ...
    /// Function: SetTimer
    /// </summary>
    public unsafe void SetTimer(float InRate, bool inbLoop = default, BmSDK.FName inTimerFunc = default, BmSDK.GameObject inObj = default)
    {
    ...
    /// Function: Trace
    /// </summary>
    public unsafe BmSDK.Engine.Actor Trace(out System.Numerics.Vector3 HitLocation, out System.Numerics.Vector3 HitNormal, System.Numerics.Vector3 TraceEnd, System.Numerics.Vector3 TraceStart, bool bTraceActors, System.Numerics.Vector3 Extent, out BmSDK.Engine.Actor.FTraceHitInfo HitInfo, int ExtraTraceFlags)
    {
    ...
    /// </summary>
    public unsafe void PhysicsVolumeChange(BmSDK.Engine.PhysicsVolume NewVolume)
    {
    ...
    /// </summary>
    public unsafe bool SetLocationForTest(System.Numerics.Vector3 NewLocation, bool bNoCheck)
    {
    ...
    /// Function: FinishAnim
    /// </summary>
    public unsafe void FinishAnim(BmSDK.Engine.AnimNodeSequence SeqNode)
    {
