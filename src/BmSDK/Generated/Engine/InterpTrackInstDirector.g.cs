...
public partial class InterpTrackInstDirector : BmSDK.Engine.InterpTrackInst, BmSDK.IGameObject
{
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpTrackInstDirector>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpTrackInstDirector>, new()
    ...
    /// </summary>
    public unsafe ref BmSDK.Engine.EngineBaseTypes.FRenderingPerformanceOverrides OldRenderingOverrides
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.EngineBaseTypes.FRenderingPerformanceOverrides>(Ptr + 92);
}
