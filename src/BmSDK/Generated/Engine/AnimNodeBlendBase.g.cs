...
public partial class AnimNodeBlendBase : BmSDK.Engine.AnimNode, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AnimNodeBlendBase.
    /// </summary>
    public static AnimNodeBlendBase DefaultObject => (AnimNodeBlendBase)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AnimNodeBlendBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AnimNodeBlendBase>, new()
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.AnimNodeBlendBase.FAnimBlendChild>>(Ptr + 208); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.GameObject.AlphaBlendType>(Ptr + 224); }
