...
public partial class ParticleModuleStoreSpawnTime : BmSDK.Engine.ParticleModuleStoreSpawnTimeBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleStoreSpawnTime.
    /// </summary>
    public static ParticleModuleStoreSpawnTime DefaultObject => (ParticleModuleStoreSpawnTime)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleStoreSpawnTime>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleStoreSpawnTime>, new()
