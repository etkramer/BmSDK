...
public partial class SpotLightToggleable : BmSDK.Engine.SpotLight, BmSDK.IGameObject
{
    ...
    /// </summary>
    public SpotLightToggleable(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, SpotLightToggleable Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
    ...
    /// </summary>
    public unsafe virtual void ApplyCheckpointRecord(out BmSDK.Engine.SpotLightToggleable.FCheckpointRecord Record)
    {
    ...
    /// </summary>
    public unsafe virtual void CreateCheckpointRecord(out BmSDK.Engine.SpotLightToggleable.FCheckpointRecord Record)
    {
