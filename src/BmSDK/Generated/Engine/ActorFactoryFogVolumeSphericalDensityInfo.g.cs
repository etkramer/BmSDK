...
public partial class ActorFactoryFogVolumeSphericalDensityInfo : BmSDK.Engine.ActorFactoryFogVolumeConstantDensityInfo, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ActorFactoryFogVolumeSphericalDensityInfo.
    /// </summary>
    public static ActorFactoryFogVolumeSphericalDensityInfo DefaultObject => (ActorFactoryFogVolumeSphericalDensityInfo)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ActorFactoryFogVolumeSphericalDensityInfo>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ActorFactoryFogVolumeSphericalDensityInfo>, new()
