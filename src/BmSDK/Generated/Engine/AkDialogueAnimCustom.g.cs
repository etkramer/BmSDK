...
public partial class AkDialogueAnimCustom : BmSDK.Engine.AkHash, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkDialogueAnimCustom.
    /// </summary>
    public static AkDialogueAnimCustom DefaultObject => (AkDialogueAnimCustom)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkDialogueAnimCustom>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkDialogueAnimCustom>, new()
