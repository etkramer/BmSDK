...
public partial class MaterialExpressionStaticBoolParameter : BmSDK.Engine.MaterialExpressionParameter, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionStaticBoolParameter.
    /// </summary>
    public static MaterialExpressionStaticBoolParameter DefaultObject => (MaterialExpressionStaticBoolParameter)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionStaticBoolParameter>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionStaticBoolParameter>, new()
