...
public partial class TerrainLayerSetup : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.TerrainLayerSetup", false);
    ...
    /// <summary>
    /// Constructs a new TerrainLayerSetup
    /// </summary>
    public TerrainLayerSetup(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, TerrainLayerSetup Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<TerrainLayerSetup>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<TerrainLayerSetup>, new()
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.TerrainLayerSetup.FTerrainFilteredMaterial>>(Ptr + 44); }
    ...
    {
        /// <summary>
        /// BoolProperty: UseNoise
        /// </summary>
        public unsafe bool UseNoise
        {
        ...
        /// <summary>
        /// FloatProperty: NoisePercent
        /// </summary>
        public unsafe float NoisePercent
        {
        ...
        /// </summary>
        public unsafe BmSDK.Engine.TerrainMaterial Material
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.TerrainMaterial>(Ptr + 80); }; }
