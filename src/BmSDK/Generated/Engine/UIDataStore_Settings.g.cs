...
/// <summary>
/// ABSTRACT Class: UIDataStore_Settings<br/>
/// (size = 108)
/// (flags = 134217883)
/// </summary>
public partial class UIDataStore_Settings : BmSDK.Engine.UIDataStore, BmSDK.IGameObject
{
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<UIDataStore_Settings>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<UIDataStore_Settings>, new()
