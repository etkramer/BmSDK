...
public partial class SeqCond_CompareObject : BmSDK.Engine.SequenceCondition, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqCond_CompareObject.
    /// </summary>
    public static SeqCond_CompareObject DefaultObject => (SeqCond_CompareObject)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqCond_CompareObject>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqCond_CompareObject>, new()
