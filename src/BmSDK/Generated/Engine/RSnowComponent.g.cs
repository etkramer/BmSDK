...
public partial class RSnowComponent : BmSDK.Engine.PrimitiveComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSnowComponent.
    /// </summary>
    public static RSnowComponent DefaultObject => (RSnowComponent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSnowComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSnowComponent>, new()
    ...
    /// </summary>
    public unsafe ref BmSDK.Engine.RSnowComponent.FRockSnowSettings SnowSettings
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.RSnowComponent.FRockSnowSettings>(Ptr + 556);

    /// <summary>
    /// StructProperty: VolumeSettings
    /// </summary>
    public unsafe ref BmSDK.Engine.RSnowComponent.FRockSnowVolumeSettings VolumeSettings
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.RSnowComponent.FRockSnowVolumeSettings>(Ptr + 600);
}
