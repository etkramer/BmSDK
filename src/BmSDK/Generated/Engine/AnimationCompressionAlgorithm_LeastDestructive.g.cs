...
public partial class AnimationCompressionAlgorithm_LeastDestructive : BmSDK.Engine.AnimationCompressionAlgorithm, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AnimationCompressionAlgorithm_LeastDestructive.
    /// </summary>
    public static AnimationCompressionAlgorithm_LeastDestructive DefaultObject => (AnimationCompressionAlgorithm_LeastDestructive)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AnimationCompressionAlgorithm_LeastDestructive>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AnimationCompressionAlgorithm_LeastDestructive>, new()
