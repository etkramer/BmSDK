...
public partial class HttpResponseInterface : BmSDK.Engine.HttpBaseInterface, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as HttpResponseInterface.
    /// </summary>
    public static HttpResponseInterface DefaultObject => (HttpResponseInterface)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<HttpResponseInterface>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<HttpResponseInterface>, new()
