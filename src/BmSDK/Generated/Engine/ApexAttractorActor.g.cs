...
public partial class ApexAttractorActor : BmSDK.Engine.ApexFieldSamplerActor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public ApexAttractorActor(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, ApexAttractorActor Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
