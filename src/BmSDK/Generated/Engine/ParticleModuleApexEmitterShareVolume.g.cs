...
public partial class ParticleModuleApexEmitterShareVolume : BmSDK.Engine.ParticleModuleApexEmitterBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleApexEmitterShareVolume.
    /// </summary>
    public static ParticleModuleApexEmitterShareVolume DefaultObject => (ParticleModuleApexEmitterShareVolume)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleApexEmitterShareVolume>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleApexEmitterShareVolume>, new()
