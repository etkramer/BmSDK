...
public partial class RActorFactoryStaticMeshDecorated : BmSDK.Engine.ActorFactoryStaticMesh, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RActorFactoryStaticMeshDecorated.
    /// </summary>
    public static RActorFactoryStaticMeshDecorated DefaultObject => (RActorFactoryStaticMeshDecorated)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RActorFactoryStaticMeshDecorated>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RActorFactoryStaticMeshDecorated>, new()
