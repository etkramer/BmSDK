...
public partial class AICommandNodeRoot : BmSDK.Engine.AICommandNodeBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AICommandNodeRoot.
    /// </summary>
    public static AICommandNodeRoot DefaultObject => (AICommandNodeRoot)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AICommandNodeRoot>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AICommandNodeRoot>, new()
