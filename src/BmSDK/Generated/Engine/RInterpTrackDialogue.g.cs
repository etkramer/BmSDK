...
public partial class RInterpTrackDialogue : BmSDK.Engine.InterpTrackVectorBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RInterpTrackDialogue.
    /// </summary>
    public static RInterpTrackDialogue DefaultObject => (RInterpTrackDialogue)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RInterpTrackDialogue>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RInterpTrackDialogue>, new()
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.RInterpTrackDialogue.FDialogueTrackKey>>(Ptr + 304); }
    ...
    /// </summary>
    public unsafe ref BmSDK.Engine.AkDialogue.FAkSpeechOptions SpeechOptions
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.AkDialogue.FAkSpeechOptions>(Ptr + 324);
    ...
    public partial record struct FDialogueTrackKey
    {
        ...
        /// ObjectProperty: Line
        /// </summary>
        public unsafe BmSDK.Engine.AkDialogueLineSingle Line
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.AkDialogueLineSingle>(Ptr + 4); }; }
