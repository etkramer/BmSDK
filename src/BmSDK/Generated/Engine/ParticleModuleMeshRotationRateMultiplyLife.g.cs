...
public partial class ParticleModuleMeshRotationRateMultiplyLife : BmSDK.Engine.ParticleModuleRotationRateBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleMeshRotationRateMultiplyLife.
    /// </summary>
    public static ParticleModuleMeshRotationRateMultiplyLife DefaultObject => (ParticleModuleMeshRotationRateMultiplyLife)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleMeshRotationRateMultiplyLife>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleMeshRotationRateMultiplyLife>, new()
