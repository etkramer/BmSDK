...
public partial class ROceanHeightBlockingVolume : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe BmSDK.Engine.ROceanHeightBlockingVolume.FFOceanBlockInfo OceanBlockInfo
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.ROceanHeightBlockingVolume.FFOceanBlockInfo>(Ptr + 672); }
