...
public partial class RockDecal : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RockDecal(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RockDecal Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
