...
public partial class ActorFactoryApexVortex : BmSDK.Engine.ActorFactory, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ActorFactoryApexVortex.
    /// </summary>
    public static ActorFactoryApexVortex DefaultObject => (ActorFactoryApexVortex)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ActorFactoryApexVortex>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ActorFactoryApexVortex>, new()
