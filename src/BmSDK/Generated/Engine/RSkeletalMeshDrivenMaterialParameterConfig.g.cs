...
/// <summary>
/// Class: RSkeletalMeshDrivenMaterialParameterConfig<br/>
/// (size = 116)
/// (flags = 134217874)
/// </summary>
public partial class RSkeletalMeshDrivenMaterialParameterConfig : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.RSkeletalMeshDrivenMaterialParameterConfig", false);
    ...
    /// <summary>
    /// Constructs a new RSkeletalMeshDrivenMaterialParameterConfig
    /// </summary>
    public RSkeletalMeshDrivenMaterialParameterConfig(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSkeletalMeshDrivenMaterialParameterConfig Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RSkeletalMeshDrivenMaterialParameterConfig(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSkeletalMeshDrivenMaterialParameterConfig>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSkeletalMeshDrivenMaterialParameterConfig>, new()
    ...
    public partial record struct FBoneRotationConfig
    {
        /// <summary>
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.GameObject.ESimpleAxis>(Ptr + 16); }; }
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.RSkeletalMeshDrivenMaterialParameterConfig.ESkeletalMeshDrivenMaterialRotationSpace>(Ptr + 17); }; }
    ...
    /// <summary>
    /// Enum: ESkeletalMeshDrivenMaterialRotationSpace
    /// </summary>
    public enum ESkeletalMeshDrivenMaterialRotationSpace : byte
    {
        SMDMRS_RelativeToReferencePose = 0,
        SMDMRS_RelativeToParentBone = 1,
        SMDMRS_MAX = 2,
    }
    ...
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.Engine.RSkeletalMeshDrivenMaterialParameterConfig.FBoneDistanceConfig> BoneDistances
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.RSkeletalMeshDrivenMaterialParameterConfig.FBoneDistanceConfig>>(Ptr + 84); }
    ...
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.Engine.RSkeletalMeshDrivenMaterialParameterConfig.FBoneRotationConfig> BoneRotations
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.RSkeletalMeshDrivenMaterialParameterConfig.FBoneRotationConfig>>(Ptr + 100); }
    ...
    public partial record struct FBoneDistanceConfig
    {
        /// <summary>
        /// NameProperty: ScalarParameterName
        /// </summary>
        ...
        /// <summary>
        /// NameProperty: Bone1Name
        /// </summary>
        public unsafe BmSDK.FName Bone1Name
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.FName>(Ptr + 8); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 8); }; }
        }
        ...
        /// <summary>
        /// NameProperty: Bone2Name
        /// </summary>
        public unsafe BmSDK.FName Bone2Name
        {
