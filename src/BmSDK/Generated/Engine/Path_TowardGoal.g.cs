...
public partial class Path_TowardGoal : BmSDK.Engine.PathConstraint, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as Path_TowardGoal.
    /// </summary>
    public static Path_TowardGoal DefaultObject => (Path_TowardGoal)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<Path_TowardGoal>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<Path_TowardGoal>, new()
