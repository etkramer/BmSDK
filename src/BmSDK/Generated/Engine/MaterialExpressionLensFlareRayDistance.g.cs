...
public partial class MaterialExpressionLensFlareRayDistance : BmSDK.Engine.MaterialExpression, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MaterialExpressionLensFlareRayDistance.
    /// </summary>
    public static MaterialExpressionLensFlareRayDistance DefaultObject => (MaterialExpressionLensFlareRayDistance)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionLensFlareRayDistance>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MaterialExpressionLensFlareRayDistance>, new()
