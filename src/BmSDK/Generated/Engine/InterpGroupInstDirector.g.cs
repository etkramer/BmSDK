...
public partial class InterpGroupInstDirector : BmSDK.Engine.InterpGroupInst, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpGroupInstDirector.
    /// </summary>
    public static InterpGroupInstDirector DefaultObject => (InterpGroupInstDirector)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpGroupInstDirector>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpGroupInstDirector>, new()
