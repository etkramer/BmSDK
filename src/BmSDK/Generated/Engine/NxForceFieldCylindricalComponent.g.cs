...
public partial class NxForceFieldCylindricalComponent : BmSDK.Engine.NxForceFieldComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as NxForceFieldCylindricalComponent.
    /// </summary>
    public static NxForceFieldCylindricalComponent DefaultObject => (NxForceFieldCylindricalComponent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<NxForceFieldCylindricalComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<NxForceFieldCylindricalComponent>, new()
