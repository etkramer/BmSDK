...
public partial class PortalVolume : BmSDK.Engine.Volume, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as PortalVolume.
    /// </summary>
    public static PortalVolume DefaultObject => (PortalVolume)StaticClass().DefaultObject;
    ...
    /// </summary>
    public PortalVolume(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
