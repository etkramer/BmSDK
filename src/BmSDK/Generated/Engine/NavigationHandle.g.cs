...
public partial class NavigationHandle : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe virtual void DrawBreadCrumbs(bool bPersistent = default)
    {
    ...
    /// </summary>
    public unsafe virtual void CopyMovePointsFromPathCache(System.Numerics.Vector3 FinalDest, out BmSDK.TArray<System.Numerics.Vector3> out_MovePoints)
    {
    ...
    /// </summary>
    public unsafe virtual int GetPathCacheLength()
    {
    ...
    /// </summary>
    public unsafe virtual bool CheckAnchorPylonIntegerity()
    {
    ...
    /// </summary>
    public unsafe virtual bool DoesPylonAHaveAPathToPylonB(BmSDK.Engine.Pylon A, BmSDK.Engine.Pylon B)
    {
    ...
    /// </summary>
    public unsafe virtual BmSDK.Engine.Pylon BuildFromPylonAToPylonB(BmSDK.Engine.Pylon A, BmSDK.Engine.Pylon B)
    {
    ...
    /// </summary>
    public unsafe virtual void CopyPathStoreToPathCache(out BmSDK.Engine.NavigationHandle.FPathStore InStore)
    {
    ...
    public unsafe ref BmSDK.Engine.NavigationHandle.FPathStore PathCache
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.NavigationHandle.FPathStore>(Ptr + 140);

    /// <summary>
    /// StructProperty: StoredPathCache
    /// </summary>
    public unsafe ref BmSDK.Engine.NavigationHandle.FPathStore StoredPathCache
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.NavigationHandle.FPathStore>(Ptr + 156);
    ...
    public unsafe ref BmSDK.Engine.Actor.FBasedPosition FinalDestination
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.Actor.FBasedPosition>(Ptr + 196);
    ...
    public unsafe ref BmSDK.Engine.NavigationHandle.FNavMeshPathParams CachedPathParams
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.NavigationHandle.FNavMeshPathParams>(Ptr + 256);
    ...
    /// </summary>
    public InlineArray<System.Numerics.Vector3> Breadcrumbs => new(10, Ptr + 316, 12, this);
