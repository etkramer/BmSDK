...
public partial class RParticleSystemEconomicalReplay : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RParticleSystemEconomicalReplay.
    /// </summary>
    public static RParticleSystemEconomicalReplay DefaultObject => (RParticleSystemEconomicalReplay)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RParticleSystemEconomicalReplay>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RParticleSystemEconomicalReplay>, new()
