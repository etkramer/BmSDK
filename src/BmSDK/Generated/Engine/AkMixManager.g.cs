...
/// <summary>
/// ABSTRACT Class: AkMixManager<br/>
/// (size = 84)
/// (flags = 134217875)
/// </summary>
public partial class AkMixManager : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkMixManager.
    /// </summary>
    public static AkMixManager DefaultObject => (AkMixManager)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkMixManager>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkMixManager>, new()
