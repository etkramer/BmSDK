...
public partial class AkActionGlobal_PredatorMusicControl : BmSDK.Engine.AkActionGlobal_MusicControl, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkActionGlobal_PredatorMusicControl.
    /// </summary>
    public static AkActionGlobal_PredatorMusicControl DefaultObject => (AkActionGlobal_PredatorMusicControl)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkActionGlobal_PredatorMusicControl>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkActionGlobal_PredatorMusicControl>, new()
