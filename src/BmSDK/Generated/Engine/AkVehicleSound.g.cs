...
public partial class AkVehicleSound : BmSDK.Engine.ActorComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkVehicleSound.
    /// </summary>
    public static AkVehicleSound DefaultObject => (AkVehicleSound)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkVehicleSound>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkVehicleSound>, new()
