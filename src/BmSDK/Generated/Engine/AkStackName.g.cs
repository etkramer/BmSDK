...
public partial class AkStackName : BmSDK.Engine.AkHash, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkStackName.
    /// </summary>
    public static AkStackName DefaultObject => (AkStackName)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkStackName>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkStackName>, new()
