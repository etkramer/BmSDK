...
public partial class AkActionTargeted : BmSDK.Engine.AkAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkActionTargeted.
    /// </summary>
    public static AkActionTargeted DefaultObject => (AkActionTargeted)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkActionTargeted>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkActionTargeted>, new()
