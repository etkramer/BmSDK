...
public partial class K2Input_Int : BmSDK.Engine.K2Input, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as K2Input_Int.
    /// </summary>
    public static K2Input_Int DefaultObject => (K2Input_Int)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<K2Input_Int>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<K2Input_Int>, new()
