...
public partial class SoundMode : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.SoundMode", false);
    ...
    /// <summary>
    /// Constructs a new SoundMode
    /// </summary>
    public SoundMode(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, SoundMode Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected SoundMode(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SoundMode>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SoundMode>, new()
    ...
    public unsafe ref BmSDK.Engine.SoundMode.FAudioEQEffect EQSettings
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.SoundMode.FAudioEQEffect>(Ptr + 88);
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.SoundMode.FSoundClassAdjuster>>(Ptr + 124); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 124); }
    }

    /// <summary>
    /// FloatProperty: InitialDelay
    /// </summary>
    ...
    public partial record struct FSoundClassAdjuster
    {
        ...
        /// <summary>
        /// NameProperty: SoundClass
        /// </summary>
        public unsafe BmSDK.FName SoundClass
        {
        ...
        /// <summary>
        /// FloatProperty: VolumeAdjuster
        /// </summary>
        public unsafe float VolumeAdjuster
        {
        ...
        /// <summary>
        /// FloatProperty: PitchAdjuster
        /// </summary>
        public unsafe float PitchAdjuster
        {
        ...
        /// <summary>
        /// FloatProperty: VoiceCenterChannelVolumeAdjuster
        /// </summary>
        public unsafe float VoiceCenterChannelVolumeAdjuster
        {
    ...
    public partial record struct FAudioEQEffect
    {
        ...
        /// <summary>
        /// FloatProperty: HFFrequency
        /// </summary>
        public unsafe float HFFrequency
        {
        ...
        /// <summary>
        /// FloatProperty: HFGain
        /// </summary>
        public unsafe float HFGain
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<float>(Ptr + 12); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 12); }; }
        }
        ...
        /// <summary>
        /// FloatProperty: MFCutoffFrequency
        /// </summary>
        public unsafe float MFCutoffFrequency
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<float>(Ptr + 16); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 16); }; }
        }
        ...
        /// <summary>
        /// FloatProperty: MFBandwidth
        /// </summary>
        public unsafe float MFBandwidth
        {
        ...
        /// <summary>
        /// FloatProperty: MFGain
        /// </summary>
        public unsafe float MFGain
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<float>(Ptr + 24); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 24); }; }
        }
        ...
        /// <summary>
        /// FloatProperty: LFFrequency
        /// </summary>
        public unsafe float LFFrequency
        {
        ...
        /// <summary>
        /// FloatProperty: LFGain
        /// </summary>
        public unsafe float LFGain
        {
