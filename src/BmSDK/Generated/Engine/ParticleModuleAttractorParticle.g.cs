...
public partial class ParticleModuleAttractorParticle : BmSDK.Engine.ParticleModuleAttractorBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleAttractorParticle.
    /// </summary>
    public static ParticleModuleAttractorParticle DefaultObject => (ParticleModuleAttractorParticle)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.DistributionFloat.FRawDistributionFloat Strength
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.DistributionFloat.FRawDistributionFloat>(Ptr + 144);
