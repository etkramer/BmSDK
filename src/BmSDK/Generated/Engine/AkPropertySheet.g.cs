...
/// <summary>
/// Class: AkPropertySheet<br/>
/// (size = 108)
/// (flags = 134217874)
/// </summary>
public partial class AkPropertySheet : BmSDK.Engine.ActorComponent, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "Engine.AkPropertySheet", false);
    ...
    /// <summary>
    /// Constructs a new AkPropertySheet
    /// </summary>
    public AkPropertySheet(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, AkPropertySheet Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected AkPropertySheet(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkPropertySheet>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkPropertySheet>, new()
    ...
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.Engine.AkAudioAction> Actions
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.AkAudioAction>>(Ptr + 76); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 76); }
    }

    /// <summary>
    /// BoolProperty: AutoActivation
    /// </summary>
    public unsafe bool AutoActivation
    {
    ...
    /// <summary>
    /// BoolProperty: Suspended
    /// </summary>
    public unsafe bool Suspended
    {
    ...
    /// <summary>
    /// ObjectProperty: ActionStackName
    /// </summary>
    public unsafe BmSDK.Engine.AkStackName ActionStackName
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.AkStackName>(Ptr + 92); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 92); }
    }

    /// <summary>
    /// IntProperty: ActionStackPriority
    /// </summary>
    public unsafe int ActionStackPriority
    {
    ...
    /// <summary>
    /// FloatProperty: CurrentActivationValue
    /// </summary>
    public unsafe float CurrentActivationValue
    {
