...
public partial class ParticleModuleLocationEmitterDirect : BmSDK.Engine.ParticleModuleLocationBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleLocationEmitterDirect.
    /// </summary>
    public static ParticleModuleLocationEmitterDirect DefaultObject => (ParticleModuleLocationEmitterDirect)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleLocationEmitterDirect>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleLocationEmitterDirect>, new()
