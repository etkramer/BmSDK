...
public partial class ParticleModuleFieldSamplerHeatSource : BmSDK.Engine.ParticleModuleFieldSamplerBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ParticleModuleFieldSamplerHeatSource.
    /// </summary>
    public static ParticleModuleFieldSamplerHeatSource DefaultObject => (ParticleModuleFieldSamplerHeatSource)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ParticleModuleFieldSamplerHeatSource>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ParticleModuleFieldSamplerHeatSource>, new()
