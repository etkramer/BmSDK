...
public partial class AkSDEntityPawnsEnemyFiring : BmSDK.AkAudio.AkSDEntityPawnsEnemy, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityPawnsEnemyFiring.
    /// </summary>
    public static AkSDEntityPawnsEnemyFiring DefaultObject => (AkSDEntityPawnsEnemyFiring)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPawnsEnemyFiring>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPawnsEnemyFiring>, new()
