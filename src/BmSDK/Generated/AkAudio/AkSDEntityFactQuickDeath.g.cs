...
public partial class AkSDEntityFactQuickDeath : BmSDK.AkAudio.AkSDEntityFact, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityFactQuickDeath.
    /// </summary>
    public static AkSDEntityFactQuickDeath DefaultObject => (AkSDEntityFactQuickDeath)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityFactQuickDeath>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityFactQuickDeath>, new()
