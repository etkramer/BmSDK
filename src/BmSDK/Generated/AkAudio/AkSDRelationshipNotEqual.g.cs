...
public partial class AkSDRelationshipNotEqual : BmSDK.AkAudio.AkSDRelationship, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDRelationshipNotEqual.
    /// </summary>
    public static AkSDRelationshipNotEqual DefaultObject => (AkSDRelationshipNotEqual)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDRelationshipNotEqual>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDRelationshipNotEqual>, new()
