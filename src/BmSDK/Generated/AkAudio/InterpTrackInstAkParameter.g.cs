...
/// <summary>
/// Class: InterpTrackInstAkParameter<br/>
/// (size = 0)
/// (flags = 0)
/// </summary>
public partial class InterpTrackInstAkParameter : BmSDK.Engine.InterpTrackInst, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "AkAudio.InterpTrackInstAkParameter", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal InterpTrackInstAkParameter() { }

    /// <summary>
    /// Constructs a new InterpTrackInstAkParameter
    /// </summary>
    public InterpTrackInstAkParameter(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, InterpTrackInstAkParameter Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected InterpTrackInstAkParameter(nint ptr) : base(ptr) { }
