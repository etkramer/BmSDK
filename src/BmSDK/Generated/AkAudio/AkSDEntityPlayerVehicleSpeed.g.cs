...
public partial class AkSDEntityPlayerVehicleSpeed : BmSDK.AkAudio.AkSDEntityPlayerBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityPlayerVehicleSpeed.
    /// </summary>
    public static AkSDEntityPlayerVehicleSpeed DefaultObject => (AkSDEntityPlayerVehicleSpeed)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPlayerVehicleSpeed>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPlayerVehicleSpeed>, new()
