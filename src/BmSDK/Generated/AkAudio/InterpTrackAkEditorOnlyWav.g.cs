...
public partial class InterpTrackAkEditorOnlyWav : BmSDK.Engine.InterpTrack, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as InterpTrackAkEditorOnlyWav.
    /// </summary>
    public static InterpTrackAkEditorOnlyWav DefaultObject => (InterpTrackAkEditorOnlyWav)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<InterpTrackAkEditorOnlyWav>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<InterpTrackAkEditorOnlyWav>, new()
