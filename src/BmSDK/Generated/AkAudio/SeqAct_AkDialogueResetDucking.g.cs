...
public partial class SeqAct_AkDialogueResetDucking : BmSDK.AkAudio.SeqAct_AkBaseSimple, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqAct_AkDialogueResetDucking.
    /// </summary>
    public static SeqAct_AkDialogueResetDucking DefaultObject => (SeqAct_AkDialogueResetDucking)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqAct_AkDialogueResetDucking>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqAct_AkDialogueResetDucking>, new()
