...
public partial class AkSDEntityPlayerDetectiveMode : BmSDK.AkAudio.AkSDEntityPlayerBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityPlayerDetectiveMode.
    /// </summary>
    public static AkSDEntityPlayerDetectiveMode DefaultObject => (AkSDEntityPlayerDetectiveMode)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPlayerDetectiveMode>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPlayerDetectiveMode>, new()
