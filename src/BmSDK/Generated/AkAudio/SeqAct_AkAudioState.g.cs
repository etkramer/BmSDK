...
/// (flags = 134226066)
/// </summary>
public partial class SeqAct_AkAudioState : BmSDK.AkAudio.SeqAct_AkBaseSimple, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqAct_AkAudioState.
    /// </summary>
    public static SeqAct_AkAudioState DefaultObject => (SeqAct_AkAudioState)StaticClass().DefaultObject;
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.AkStateName>(Ptr + 352); }
