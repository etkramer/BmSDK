...
public partial class AkSDEntityTimeDilation : BmSDK.AkAudio.AkSDEntityValue, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityTimeDilation.
    /// </summary>
    public static AkSDEntityTimeDilation DefaultObject => (AkSDEntityTimeDilation)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityTimeDilation>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityTimeDilation>, new()
