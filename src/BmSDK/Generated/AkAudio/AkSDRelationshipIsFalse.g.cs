...
public partial class AkSDRelationshipIsFalse : BmSDK.AkAudio.AkSDRelationship, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDRelationshipIsFalse.
    /// </summary>
    public static AkSDRelationshipIsFalse DefaultObject => (AkSDRelationshipIsFalse)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDRelationshipIsFalse>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDRelationshipIsFalse>, new()
