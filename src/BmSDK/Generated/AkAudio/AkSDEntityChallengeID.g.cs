...
public partial class AkSDEntityChallengeID : BmSDK.AkAudio.AkSDEntitySymbol, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityChallengeID.
    /// </summary>
    public static AkSDEntityChallengeID DefaultObject => (AkSDEntityChallengeID)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityChallengeID>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityChallengeID>, new()
