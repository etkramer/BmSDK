...
public partial class AkSDEntitySideStory : BmSDK.AkAudio.AkSDEntitySymbol, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntitySideStory.
    /// </summary>
    public static AkSDEntitySideStory DefaultObject => (AkSDEntitySideStory)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntitySideStory>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntitySideStory>, new()
