...
public partial class AkSDEntityAggLocation : BmSDK.AkAudio.AkSDEntitySymbol, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityAggLocation.
    /// </summary>
    public static AkSDEntityAggLocation DefaultObject => (AkSDEntityAggLocation)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityAggLocation>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityAggLocation>, new()
