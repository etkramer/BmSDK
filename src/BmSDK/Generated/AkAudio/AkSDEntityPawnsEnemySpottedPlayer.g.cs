...
public partial class AkSDEntityPawnsEnemySpottedPlayer : BmSDK.AkAudio.AkSDEntityPawnsEnemy, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityPawnsEnemySpottedPlayer.
    /// </summary>
    public static AkSDEntityPawnsEnemySpottedPlayer DefaultObject => (AkSDEntityPawnsEnemySpottedPlayer)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPawnsEnemySpottedPlayer>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPawnsEnemySpottedPlayer>, new()
