...
/// <summary>
/// Class: SeqAct_AkAnimOnlyDialogue<br/>
/// (flags = 0)
/// </summary>
public partial class SeqAct_AkAnimOnlyDialogue : BmSDK.AkAudio.SeqAct_AkBaseSimple, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "AkAudio.SeqAct_AkAnimOnlyDialogue", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal SeqAct_AkAnimOnlyDialogue() { }

    /// <summary>
    /// Constructs a new SeqAct_AkAnimOnlyDialogue
    /// </summary>
    public SeqAct_AkAnimOnlyDialogue(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, SeqAct_AkAnimOnlyDialogue Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected SeqAct_AkAnimOnlyDialogue(nint ptr) : base(ptr) { }
