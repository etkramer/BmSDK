...
public partial class SeqAct_AkDialogueStopSpeech : BmSDK.AkAudio.SeqAct_AkBaseSimple, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqAct_AkDialogueStopSpeech.
    /// </summary>
    public static SeqAct_AkDialogueStopSpeech DefaultObject => (SeqAct_AkDialogueStopSpeech)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqAct_AkDialogueStopSpeech>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqAct_AkDialogueStopSpeech>, new()
