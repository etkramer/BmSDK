...
public partial class AkAudioVolume : BmSDK.Engine.Volume, BmSDK.IGameObject
{
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "AkAudio.AkAudioVolume.HandleUnlink", true);
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "AkAudio.AkAudioVolume.HandleLink", true);
        byte* paramsPtr = stackalloc byte[12];
        BmSDK.Framework.MarshalUtil.ToUnmanaged(Target, paramsPtr + 0);
        var oldFlags = funcManaged.FunctionFlags;
        var oldNative = funcManaged.iNative;
    ...
    /// </summary>
    public unsafe virtual void RefreshTouching()
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "AkAudio.AkAudioVolume.RefreshTouching", true);
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "AkAudio.AkAudioVolume.UnlinkToActor", true);
        byte* paramsPtr = stackalloc byte[12];
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "AkAudio.AkAudioVolume.LinkToActor", true);
        byte* paramsPtr = stackalloc byte[12];
        BmSDK.Framework.MarshalUtil.ToUnmanaged(LinkTarget, paramsPtr + 0);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return BmSDK.Framework.MarshalUtil.ToManaged<bool>(paramsPtr + 8);
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "AkAudio.AkAudioVolume.OverrideDefaultAkAudibleSetup", true);
    ...
    public partial record struct FOverlappingVolumeInfo
    {
        /// <summary>
        /// ObjectProperty: OverlappingVolume
        /// </summary>
        public unsafe BmSDK.AkAudio.AkAudioVolume OverlappingVolume
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.AkAudio.AkAudioVolume>(Ptr + 0); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 0); }; }
        }

        /// <summary>
        /// ByteProperty: OverlapX
        /// </summary>
        public unsafe BmSDK.AkAudio.AkAudioVolume.OverlapSetting OverlapX
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.AkAudio.AkAudioVolume.OverlapSetting>(Ptr + 8); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 8); }; }
        }

        /// <summary>
        /// ByteProperty: OverlapY
        /// </summary>
        public unsafe BmSDK.AkAudio.AkAudioVolume.OverlapSetting OverlapY
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.AkAudio.AkAudioVolume.OverlapSetting>(Ptr + 9); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 9); }; }
        }

        /// <summary>
        /// ByteProperty: OverlapZ
        /// </summary>
        public unsafe BmSDK.AkAudio.AkAudioVolume.OverlapSetting OverlapZ
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.AkAudio.AkAudioVolume.OverlapSetting>(Ptr + 10); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 10); }; }
        }

        /// <summary>
        /// StructProperty: OverlapBox
        /// </summary>
        public unsafe BmSDK.GameObject.FBox OverlapBox
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.GameObject.FBox>(Ptr + 12); }; }
    ...
    public partial record struct FSwitchModifierPair
    {
        /// <summary>
        /// ObjectProperty: TouchInSwitch
        /// </summary>
        public unsafe BmSDK.Engine.AkSwitchName TouchInSwitch
        {
        ...
        /// <summary>
        /// ObjectProperty: TouchOutSwitch
        /// </summary>
        public unsafe BmSDK.Engine.AkSwitchName TouchOutSwitch
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.AkSwitchName>(Ptr + 8); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 8); }; }
        }
    }
    ...
    /// </summary>
    [StructLayout(LayoutKind.Explicit, Size = 16)]
    public partial record struct FParameterModifierPair
    {
        /// <summary>
        ...
        /// <summary>
        /// FloatProperty: TouchInValue
        /// </summary>
        public unsafe float TouchInValue
        {
        ...
        /// <summary>
        /// FloatProperty: TouchOutValue
        /// </summary>
        public unsafe float TouchOutValue
        {
    ...
    public partial record struct FTouchingActorInfo
    {
        ...
        /// <summary>
        /// BoolProperty: bTouchingFlag
        /// </summary>
        public unsafe bool bTouchingFlag
        {
