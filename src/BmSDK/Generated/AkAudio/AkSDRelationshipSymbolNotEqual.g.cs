...
public partial class AkSDRelationshipSymbolNotEqual : BmSDK.AkAudio.AkSDRelationship, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDRelationshipSymbolNotEqual.
    /// </summary>
    public static AkSDRelationshipSymbolNotEqual DefaultObject => (AkSDRelationshipSymbolNotEqual)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDRelationshipSymbolNotEqual>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDRelationshipSymbolNotEqual>, new()
