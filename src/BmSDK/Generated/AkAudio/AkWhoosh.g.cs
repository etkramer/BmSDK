...
public partial class AkWhoosh : BmSDK.Engine.AkActor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "AkAudio.AkWhoosh", false);
    ...
    /// <summary>
    /// Constructs a new AkWhoosh
    /// </summary>
    public AkWhoosh(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, AkWhoosh Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected AkWhoosh(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkWhoosh>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkWhoosh>, new()
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.AkAudio.AkWhoosh.FWhooshBy>>(Ptr + 668); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 668); }
    }

    /// <summary>
    /// ObjectProperty: AnchorPoint
    /// </summary>
    public unsafe BmSDK.AkAudio.AkWhooshAnchor AnchorPoint
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.AkAudio.AkWhooshAnchor>(Ptr + 684); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.SpriteComponent>(Ptr + 692); }
    ...
    public partial record struct FWhooshBy
    {
        ...
        /// <summary>
        /// BoolProperty: IsGliding
        /// </summary>
        public unsafe bool IsGliding
        {
        ...
        /// <summary>
        /// FloatProperty: VelocityOfTarget
        /// </summary>
        public unsafe float VelocityOfTarget
        {
        ...
        /// <summary>
        /// FloatProperty: DistanceToTrigger
        /// </summary>
        public unsafe float DistanceToTrigger
        {
        ...
        /// <summary>
        /// ObjectProperty: EventToPlayOnExit
        /// </summary>
        public unsafe BmSDK.Engine.AkEvent EventToPlayOnExit
        {
