...
public partial class AkSDEntityMusicCombatRandom : BmSDK.AkAudio.AkSDEntityValue, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityMusicCombatRandom.
    /// </summary>
    public static AkSDEntityMusicCombatRandom DefaultObject => (AkSDEntityMusicCombatRandom)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityMusicCombatRandom>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityMusicCombatRandom>, new()
