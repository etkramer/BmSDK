...
public partial class AkSDEntityPawnsEnemy : BmSDK.AkAudio.AkSDEntityPawns, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityPawnsEnemy.
    /// </summary>
    public static AkSDEntityPawnsEnemy DefaultObject => (AkSDEntityPawnsEnemy)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPawnsEnemy>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPawnsEnemy>, new()
