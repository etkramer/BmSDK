...
public partial class SeqAct_AkDialogueSurveillance : BmSDK.AkAudio.SeqAct_AkBaseSimple, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as SeqAct_AkDialogueSurveillance.
    /// </summary>
    public static SeqAct_AkDialogueSurveillance DefaultObject => (SeqAct_AkDialogueSurveillance)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<SeqAct_AkDialogueSurveillance>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<SeqAct_AkDialogueSurveillance>, new()
