...
public partial class AkSDEntityPlayersAverageHealth : BmSDK.AkAudio.AkSDEntityPlayerBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityPlayersAverageHealth.
    /// </summary>
    public static AkSDEntityPlayersAverageHealth DefaultObject => (AkSDEntityPlayersAverageHealth)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPlayersAverageHealth>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityPlayersAverageHealth>, new()
