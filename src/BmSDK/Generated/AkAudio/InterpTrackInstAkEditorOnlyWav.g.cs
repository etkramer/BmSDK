...
public partial class InterpTrackInstAkEditorOnlyWav : BmSDK.Engine.InterpTrackInst, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "AkAudio.InterpTrackInstAkEditorOnlyWav", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal InterpTrackInstAkEditorOnlyWav() { }

    /// <summary>
    /// Constructs a new InterpTrackInstAkEditorOnlyWav
    /// </summary>
    public InterpTrackInstAkEditorOnlyWav(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, InterpTrackInstAkEditorOnlyWav Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected InterpTrackInstAkEditorOnlyWav(nint ptr) : base(ptr) { }
    ...
    {
        /// <summary>
        /// IntProperty: PlayingID
        /// </summary>
        public unsafe int PlayingID
        {
        ...
        /// <summary>
        /// IntProperty: BitsPerSample
        /// </summary>
        public unsafe int BitsPerSample
        {
