...
public partial class AkSDEntityFactOverworld : BmSDK.AkAudio.AkSDEntityFact, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityFactOverworld.
    /// </summary>
    public static AkSDEntityFactOverworld DefaultObject => (AkSDEntityFactOverworld)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityFactOverworld>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityFactOverworld>, new()
