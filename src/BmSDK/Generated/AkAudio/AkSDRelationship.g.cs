...
public partial class AkSDRelationship : BmSDK.AkAudio.AkSDNode, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDRelationship.
    /// </summary>
    public static AkSDRelationship DefaultObject => (AkSDRelationship)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDRelationship>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDRelationship>, new()
