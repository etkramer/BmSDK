...
public partial class AkSDNode : BmSDK.Engine.AkHash, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "AkAudio.AkSDNode", false);
    ...
    /// <summary>
    /// Gets the class default object as AkSDNode.
    /// </summary>
    public static AkSDNode DefaultObject => (AkSDNode)StaticClass().DefaultObject;
    ...
    /// </summary>
    protected AkSDNode(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDNode>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDNode>, new()
