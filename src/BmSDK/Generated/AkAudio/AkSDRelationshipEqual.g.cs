...
public partial class AkSDRelationshipEqual : BmSDK.AkAudio.AkSDRelationship, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDRelationshipEqual.
    /// </summary>
    public static AkSDRelationshipEqual DefaultObject => (AkSDRelationshipEqual)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDRelationshipEqual>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDRelationshipEqual>, new()
