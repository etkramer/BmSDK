...
public partial class AkSDEntityFactPlayerInCombat : BmSDK.AkAudio.AkSDEntityFact, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityFactPlayerInCombat.
    /// </summary>
    public static AkSDEntityFactPlayerInCombat DefaultObject => (AkSDEntityFactPlayerInCombat)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityFactPlayerInCombat>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityFactPlayerInCombat>, new()
