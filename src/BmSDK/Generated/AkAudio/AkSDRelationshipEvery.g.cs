...
public partial class AkSDRelationshipEvery : BmSDK.AkAudio.AkSDRelationship, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDRelationshipEvery.
    /// </summary>
    public static AkSDRelationshipEvery DefaultObject => (AkSDRelationshipEvery)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDRelationshipEvery>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDRelationshipEvery>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "AkAudio.AkSDRelationshipEvery.Evaluate", true);
