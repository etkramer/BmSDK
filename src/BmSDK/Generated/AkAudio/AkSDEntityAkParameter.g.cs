...
public partial class AkSDEntityAkParameter : BmSDK.AkAudio.AkSDEntityValue, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityAkParameter.
    /// </summary>
    public static AkSDEntityAkParameter DefaultObject => (AkSDEntityAkParameter)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityAkParameter>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityAkParameter>, new()
