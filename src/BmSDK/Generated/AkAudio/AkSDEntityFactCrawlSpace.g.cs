...
public partial class AkSDEntityFactCrawlSpace : BmSDK.AkAudio.AkSDEntityFact, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as AkSDEntityFactCrawlSpace.
    /// </summary>
    public static AkSDEntityFactCrawlSpace DefaultObject => (AkSDEntityFactCrawlSpace)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<AkSDEntityFactCrawlSpace>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<AkSDEntityFactCrawlSpace>, new()
