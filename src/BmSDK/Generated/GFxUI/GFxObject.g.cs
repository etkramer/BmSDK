...
public partial class GFxObject : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    public partial record struct FASColorTransform
    {
        ...
        /// </summary>
        public unsafe ref BmSDK.GameObject.FLinearColor Multiply
        {
            get { fixed (void* thisPtr = &this) { return ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FLinearColor>((IntPtr)thisPtr + 0); } }
        }

        /// <summary>
        /// StructProperty: Add
        /// </summary>
        public unsafe ref BmSDK.GameObject.FLinearColor Add
        {
            get { fixed (void* thisPtr = &this) { return ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FLinearColor>((IntPtr)thisPtr + 16); } }
        }
    }
