...
public partial class RFadeManager : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    public unsafe virtual void SetIndependentFadeType(BmSDK.FName Identifier, bool FadeIn, float FadeT, float DelayBeforeStartFade = default)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(FadeIn, paramsPtr + 8);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(FadeT, paramsPtr + 12);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(DelayBeforeStartFade, paramsPtr + 16);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    public partial record struct FIndependentFadeState
    {
        /// <summary>
    ...
    /// <summary>
    /// StructProperty: MainFade
    /// </summary>
    public unsafe ref BmSDK.BmGame.RFadeManager.FMainFadeState MainFade
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RFadeManager.FMainFadeState>(Ptr + 668);

    /// <summary>
    /// ArrayProperty: IndependentFades
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.BmGame.RFadeManager.FIndependentFadeState> IndependentFades
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.BmGame.RFadeManager.FIndependentFadeState>>(Ptr + 688); }
    ...
    /// <summary>
    /// FloatProperty: MainFadePercLast
    /// </summary>
    public unsafe float MainFadePercLast
    {
    ...
    public partial record struct FMainFadeState
    {
        ...
        /// <summary>
        /// BoolProperty: FadeStartedByBatmobileInWater
        /// </summary>
        public unsafe bool FadeStartedByBatmobileInWater
        {
        ...
        /// <summary>
        /// BoolProperty: ControlledByInstantFade
        /// </summary>
        public unsafe bool ControlledByInstantFade
        {
