...
public partial class RSeqEvent_TakedownFront : BmSDK.BmGame.RSeqEvent_TakedownBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_TakedownFront.
    /// </summary>
    public static RSeqEvent_TakedownFront DefaultObject => (RSeqEvent_TakedownFront)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_TakedownFront>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_TakedownFront>, new()
