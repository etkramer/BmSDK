...
public partial class RSeqAct_CinematicMode : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    public unsafe virtual void ApplyHudRestrictions(bool do_apply)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(do_apply, paramsPtr + 0);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    /// <summary>
    /// Enum: CinematicHudType
    /// </summary>
    public enum CinematicHudType : byte
    {
        CHT_OFF = 0,
        CHT_EntireHud = 1,
        CHT_OnlyButtonPrompts = 2,
        CHT_OnlyNewObjectiveText = 3,
        CHT_OnlyTargets = 4,
        CHT_MAX = 5,
    }
