...
public partial class RBMAIAction_ClimbToGarg : BmSDK.BmGame.RBMAIAction, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBMAIAction_ClimbToGarg(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMAIAction_ClimbToGarg Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
    ...
    /// </summary>
    public unsafe void PlayClimbAnim()
    {
    ...
    /// </summary>
    public unsafe void SetClimbAnimTransitionName()
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId GrappleAnimID
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId ClimbOnAnimID
    {
