...
public partial class RActorFactoryStaticMeshDamageable : BmSDK.Engine.ActorFactoryStaticMesh, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RActorFactoryStaticMeshDamageable.
    /// </summary>
    public static RActorFactoryStaticMeshDamageable DefaultObject => (RActorFactoryStaticMeshDamageable)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RActorFactoryStaticMeshDamageable>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RActorFactoryStaticMeshDamageable>, new()
