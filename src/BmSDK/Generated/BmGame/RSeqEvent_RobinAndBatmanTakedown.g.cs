...
public partial class RSeqEvent_RobinAndBatmanTakedown : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_RobinAndBatmanTakedown.
    /// </summary>
    public static RSeqEvent_RobinAndBatmanTakedown DefaultObject => (RSeqEvent_RobinAndBatmanTakedown)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_RobinAndBatmanTakedown>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_RobinAndBatmanTakedown>, new()
