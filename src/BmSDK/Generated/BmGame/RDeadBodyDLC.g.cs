...
public partial class RDeadBodyDLC : BmSDK.BmGame.RDeadBody, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDeadBodyDLC.
    /// </summary>
    public static RDeadBodyDLC DefaultObject => (RDeadBodyDLC)StaticClass().DefaultObject;
