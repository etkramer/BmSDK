...
public partial class RInterpTrackInstVehicleTurretYaw : BmSDK.Engine.InterpTrackInst, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RInterpTrackInstVehicleTurretYaw.
    /// </summary>
    public static RInterpTrackInstVehicleTurretYaw DefaultObject => (RInterpTrackInstVehicleTurretYaw)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RInterpTrackInstVehicleTurretYaw>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RInterpTrackInstVehicleTurretYaw>, new()
