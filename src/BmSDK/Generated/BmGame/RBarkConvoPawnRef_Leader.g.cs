...
public partial class RBarkConvoPawnRef_Leader : BmSDK.BmGame.RBarkConvoPawnRef, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBarkConvoPawnRef_Leader.
    /// </summary>
    public static RBarkConvoPawnRef_Leader DefaultObject => (RBarkConvoPawnRef_Leader)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBarkConvoPawnRef_Leader>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBarkConvoPawnRef_Leader>, new()
