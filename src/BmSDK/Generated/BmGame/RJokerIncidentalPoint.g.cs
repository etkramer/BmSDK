...
public partial class RJokerIncidentalPoint : BmSDK.BmGame.RDummyTarget, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RJokerIncidentalPoint", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RJokerIncidentalPoint() { }

    /// <summary>
    /// Constructs a new RJokerIncidentalPoint
    /// </summary>
    public RJokerIncidentalPoint(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RJokerIncidentalPoint Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RJokerIncidentalPoint(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RJokerIncidentalPoint>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RJokerIncidentalPoint>, new()
    ...
    {
        /// <summary>
        /// ByteProperty: CombatQuality
        /// </summary>
        public unsafe BmSDK.BmGame.RPawnJokerHallucination.CombatQualityType CombatQuality
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPawnJokerHallucination.CombatQualityType>(Ptr + 0); }; }
    ...
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.BmGame.RJokerIncidentalPoint.FReactionAnimations> Overlays
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.BmGame.RJokerIncidentalPoint.FReactionAnimations>>(Ptr + 704); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 704); }
    }

    /// <summary>
    /// BoolProperty: bStillActive
    /// </summary>
    public unsafe bool bStillActive
    {
