...
public partial class RPlaceableCombatDroppedWeapon : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RPlaceableCombatDroppedWeapon(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RPlaceableCombatDroppedWeapon Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
