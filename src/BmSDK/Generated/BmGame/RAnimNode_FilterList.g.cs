...
public partial class RAnimNode_FilterList : BmSDK.Engine.AnimNodeBlendBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAnimNode_FilterList.
    /// </summary>
    public static RAnimNode_FilterList DefaultObject => (RAnimNode_FilterList)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAnimNode_FilterList>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAnimNode_FilterList>, new()
