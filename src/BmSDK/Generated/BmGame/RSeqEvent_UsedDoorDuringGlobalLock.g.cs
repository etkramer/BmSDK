...
public partial class RSeqEvent_UsedDoorDuringGlobalLock : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_UsedDoorDuringGlobalLock.
    /// </summary>
    public static RSeqEvent_UsedDoorDuringGlobalLock DefaultObject => (RSeqEvent_UsedDoorDuringGlobalLock)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_UsedDoorDuringGlobalLock>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_UsedDoorDuringGlobalLock>, new()
