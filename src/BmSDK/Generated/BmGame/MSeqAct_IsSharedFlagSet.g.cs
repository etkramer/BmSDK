...
public partial class MSeqAct_IsSharedFlagSet : BmSDK.Engine.SequenceCondition, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MSeqAct_IsSharedFlagSet.
    /// </summary>
    public static MSeqAct_IsSharedFlagSet DefaultObject => (MSeqAct_IsSharedFlagSet)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MSeqAct_IsSharedFlagSet>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MSeqAct_IsSharedFlagSet>, new()
