...
public partial class RSeqEvent_FailsafeBatmanSeen : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_FailsafeBatmanSeen.
    /// </summary>
    public static RSeqEvent_FailsafeBatmanSeen DefaultObject => (RSeqEvent_FailsafeBatmanSeen)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_FailsafeBatmanSeen>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_FailsafeBatmanSeen>, new()
