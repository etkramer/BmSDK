...
public partial class RCombatMove_2DVillainBlock : BmSDK.BmGame.RCombatMove_BatmanAttack, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RCombatMove_2DVillainBlock(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_2DVillainBlock Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT Villain2D
    {
    ...
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.TArray<BmSDK.TArray<BmSDK.Engine.Actor.Timers>>> BlockAnims
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.TArray<BmSDK.TArray<BmSDK.Engine.Actor.Timers>>>>(Ptr + 868); }
