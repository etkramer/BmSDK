...
public partial class RDmgType_ChainTakedown : BmSDK.BmGame.RDmgType_Takedown, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_ChainTakedown.
    /// </summary>
    public static RDmgType_ChainTakedown DefaultObject => (RDmgType_ChainTakedown)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_ChainTakedown>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_ChainTakedown>, new()
