...
public partial class RBarkCharacterDefInstance : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBarkCharacterDefInstance.
    /// </summary>
    public static RBarkCharacterDefInstance DefaultObject => (RBarkCharacterDefInstance)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBarkCharacterDefInstance>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBarkCharacterDefInstance>, new()
