...
public partial class RSeqAct_PauseRestartRandomPopulation : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_PauseRestartRandomPopulation.
    /// </summary>
    public static RSeqAct_PauseRestartRandomPopulation DefaultObject => (RSeqAct_PauseRestartRandomPopulation)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_PauseRestartRandomPopulation>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_PauseRestartRandomPopulation>, new()
