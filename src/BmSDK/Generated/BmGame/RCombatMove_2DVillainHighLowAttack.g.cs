...
public partial class RCombatMove_2DVillainHighLowAttack : BmSDK.BmGame.RCombatMove_VillainAttack, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_2DVillainHighLowAttack.
    /// </summary>
    public static RCombatMove_2DVillainHighLowAttack DefaultObject => (RCombatMove_2DVillainHighLowAttack)StaticClass().DefaultObject;
    ...
    public unsafe virtual void StartCanCounter(BmSDK.FName NewCounterBone)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(NewCounterBone, paramsPtr + 0);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    public unsafe virtual void PlayAttackAnim(BmSDK.FName AnimName, bool bQueue, bool bPlayOnTarget)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(bPlayOnTarget, paramsPtr + 12);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RCombatMove_2DVillainHighLowAttack.CanBeUsed", true);
    ...
    public partial record struct FMoveSequence
    {
        /// <summary>
        /// ArrayProperty: VillainSuccess
        /// </summary>
        public unsafe BmSDK.TArray<BmSDK.FName> VillainSuccess
        {
        ...
        /// <summary>
        /// ArrayProperty: PlayerSuccess
        /// </summary>
        public unsafe BmSDK.TArray<BmSDK.FName> PlayerSuccess
        {
        ...
        /// <summary>
        /// ArrayProperty: AttackBone
        /// </summary>
        public unsafe BmSDK.TArray<BmSDK.BmGame.RGameInfo.BoneNameList> AttackBone
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.BmGame.RGameInfo.BoneNameList>>(Ptr + 32); }; }
    ...
    /// StructProperty: Move
    /// </summary>
    public unsafe ref BmSDK.BmGame.RCombatMove_2DVillainHighLowAttack.FMoveSequence Move
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RCombatMove_2DVillainHighLowAttack.FMoveSequence>(Ptr + 836);
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId AttackAnimID
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId>(Ptr + 896);

    /// <summary>
    /// StructProperty: QueuedAnimID
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId QueuedAnimID
