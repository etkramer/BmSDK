...
public partial class RBMAIAction_RiotRunBase : BmSDK.BmGame.RBMAIAction_BaseMove, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMAIAction_RiotRunBase.
    /// </summary>
    public static RBMAIAction_RiotRunBase DefaultObject => (RBMAIAction_RiotRunBase)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 SavedCornerPosition
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 1072);

    /// <summary>
    /// StructProperty: SavedCornerRotation
    /// </summary>
    public unsafe ref BmSDK.Rotator SavedCornerRotation
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 1084);
    ...
    /// </summary>
    public unsafe ref BmSDK.Rotator EntranceRot
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 1332);

    /// <summary>
    /// StructProperty: MoveDirectWhileWaitingPoint
    /// </summary>
    public unsafe ref System.Numerics.Vector3 MoveDirectWhileWaitingPoint
