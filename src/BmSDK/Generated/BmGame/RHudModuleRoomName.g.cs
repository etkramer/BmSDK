...
public partial class RHudModuleRoomName : BmSDK.BmGame.RHudModule, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RHudModuleRoomName.
    /// </summary>
    public static RHudModuleRoomName DefaultObject => (RHudModuleRoomName)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RHudModuleRoomName>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RHudModuleRoomName>, new()
