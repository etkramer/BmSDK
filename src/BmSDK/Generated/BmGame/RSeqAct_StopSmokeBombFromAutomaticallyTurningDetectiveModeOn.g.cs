...
public partial class RSeqAct_StopSmokeBombFromAutomaticallyTurningDetectiveModeOn : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_StopSmokeBombFromAutomaticallyTurningDetectiveModeOn.
    /// </summary>
    public static RSeqAct_StopSmokeBombFromAutomaticallyTurningDetectiveModeOn DefaultObject => (RSeqAct_StopSmokeBombFromAutomaticallyTurningDetectiveModeOn)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_StopSmokeBombFromAutomaticallyTurningDetectiveModeOn>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_StopSmokeBombFromAutomaticallyTurningDetectiveModeOn>, new()
