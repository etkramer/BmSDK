...
public partial class RTrailProximityNode : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RTrailProximityNode.
    /// </summary>
    public static RTrailProximityNode DefaultObject => (RTrailProximityNode)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RTrailProximityNode(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
