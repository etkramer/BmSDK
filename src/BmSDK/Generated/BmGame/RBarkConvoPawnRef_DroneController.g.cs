...
public partial class RBarkConvoPawnRef_DroneController : BmSDK.BmGame.RBarkConvoPawnRef, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBarkConvoPawnRef_DroneController.
    /// </summary>
    public static RBarkConvoPawnRef_DroneController DefaultObject => (RBarkConvoPawnRef_DroneController)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBarkConvoPawnRef_DroneController>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBarkConvoPawnRef_DroneController>, new()
