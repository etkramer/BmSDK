...
public partial class RVehicleBehaviour_PursuitCop : BmSDK.BmGame.RVehicleBehaviour_FollowVehicle, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RVehicleBehaviour_PursuitCop", false);
    ...
    /// <summary>
    /// Gets the class default object as RVehicleBehaviour_PursuitCop.
    /// </summary>
    public static RVehicleBehaviour_PursuitCop DefaultObject => (RVehicleBehaviour_PursuitCop)StaticClass().DefaultObject;

    internal RVehicleBehaviour_PursuitCop() { }

    /// <summary>
    /// Constructs a new RVehicleBehaviour_PursuitCop
    /// </summary>
    public RVehicleBehaviour_PursuitCop(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RVehicleBehaviour_PursuitCop Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RVehicleBehaviour_PursuitCop(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_PursuitCop>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_PursuitCop>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RVehicleBehaviour_PursuitCop.GetObjClassVersion", true);
        byte* paramsPtr = stackalloc byte[4];
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RVehicleBatmobileBase>(Ptr + 696); }
    ...
    /// <summary>
    /// BoolProperty: FollowVehicleEngagedByBatman
    /// </summary>
    public unsafe bool FollowVehicleEngagedByBatman
    {
    ...
    /// <summary>
    /// BoolProperty: ExplodeWithOccupants
    /// </summary>
    public unsafe bool ExplodeWithOccupants
    {
    ...
    /// <summary>
    /// FloatProperty: BackoffPlayerRange
    /// </summary>
    public unsafe float BackoffPlayerRange
    {
    ...
    /// <summary>
    /// FloatProperty: BackoffFollowOffsetBase
    /// </summary>
    public unsafe float BackoffFollowOffsetBase
    {
    ...
    /// <summary>
    /// FloatProperty: BackoffFollowOffsetExtra
    /// </summary>
    public unsafe float BackoffFollowOffsetExtra
    {
