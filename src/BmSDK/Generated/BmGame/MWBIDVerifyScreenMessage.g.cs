...
public partial class MWBIDVerifyScreenMessage : BmSDK.BmGame.MWBIDDataMessage, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MWBIDVerifyScreenMessage.
    /// </summary>
    public static MWBIDVerifyScreenMessage DefaultObject => (MWBIDVerifyScreenMessage)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MWBIDVerifyScreenMessage>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MWBIDVerifyScreenMessage>, new()
    ...
    /// </summary>
    public enum ButtonGroup_Verify : byte
    {
        BGV_ResendEmail = 0,
        BGV_ChangeWBID = 1,
        BGV_OK = 2,
