...
/// <summary>
/// ABSTRACT Class: RSeqAct_JokerRooftopControllerBase<br/>
/// (size = 648)
/// (flags = 134226067)
/// </summary>
public partial class RSeqAct_JokerRooftopControllerBase : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_JokerRooftopControllerBase.
    /// </summary>
    public static RSeqAct_JokerRooftopControllerBase DefaultObject => (RSeqAct_JokerRooftopControllerBase)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_JokerRooftopControllerBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_JokerRooftopControllerBase>, new()
