...
public partial class RBMAIAction_GrabHostage : BmSDK.BmGame.RBMAIAction, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBMAIAction_GrabHostage(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
    ...
    /// Function: PlayGrab
    /// </summary>
    public unsafe virtual void PlayGrab(System.Numerics.Vector3 GrabLoc, BmSDK.BmGame.RPawnFriendly TargetHostage)
    {
    ...
    /// </summary>
    public unsafe virtual BmSDK.FName GetGrabAnimNameNoTurn()
    {
    ...
    /// </summary>
    public unsafe virtual BmSDK.FName GetGrabAnimNameNormal()
    {
    ...
    /// </summary>
    public unsafe virtual void FireGrabbedEvents()
    {
    ...
    /// Function: SetHostage
    /// </summary>
    public unsafe virtual void SetHostage(BmSDK.BmGame.RPawnFriendly NewHostage, int NewGrabIndex)
    {
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId GrabAnimID
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId>(Ptr + 580);

    /// <summary>
    /// StructProperty: TurnRefPoint
    /// </summary>
    public unsafe ref System.Numerics.Vector3 TurnRefPoint
