...
public partial class RSeqAct_GenerateConversationCueFile : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_GenerateConversationCueFile.
    /// </summary>
    public static RSeqAct_GenerateConversationCueFile DefaultObject => (RSeqAct_GenerateConversationCueFile)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_GenerateConversationCueFile>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_GenerateConversationCueFile>, new()
