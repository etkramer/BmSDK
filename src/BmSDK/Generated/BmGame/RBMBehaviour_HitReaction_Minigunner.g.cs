...
public partial class RBMBehaviour_HitReaction_Minigunner : BmSDK.BmGame.RBMBehaviour_HitReaction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_HitReaction_Minigunner.
    /// </summary>
    public static RBMBehaviour_HitReaction_Minigunner DefaultObject => (RBMBehaviour_HitReaction_Minigunner)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_HitReaction_Minigunner>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_HitReaction_Minigunner>, new()
