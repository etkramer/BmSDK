...
public partial class RDestructibleProp_SignPost : BmSDK.BmGame.RDestructibleProp, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RDestructibleProp_SignPost(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RDestructibleProp_SignPost Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
