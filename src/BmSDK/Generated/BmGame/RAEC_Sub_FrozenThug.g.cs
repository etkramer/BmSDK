...
/// (flags = 8388626)
/// </summary>
public partial class RAEC_Sub_FrozenThug : BmSDK.BmGame.RAlertEventCoordinatorBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAEC_Sub_FrozenThug.
    /// </summary>
    public static RAEC_Sub_FrozenThug DefaultObject => (RAEC_Sub_FrozenThug)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RAEC_Sub_FrozenThug(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
    ...
    /// <summary>
    /// ObjectProperty: FrozenCon
    /// </summary>
    public unsafe BmSDK.BmGame.RBMAIController FrozenCon
    {
    ...
    /// <summary>
    /// BoolProperty: bAttackOnExit
    /// </summary>
    public unsafe bool bAttackOnExit
    {
    ...
    /// <summary>
    /// BoolProperty: bWatchBatarangOnExit
    /// </summary>
    public unsafe bool bWatchBatarangOnExit
    {
