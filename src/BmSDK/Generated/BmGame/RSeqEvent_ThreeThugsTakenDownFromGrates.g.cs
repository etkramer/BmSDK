...
public partial class RSeqEvent_ThreeThugsTakenDownFromGrates : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_ThreeThugsTakenDownFromGrates.
    /// </summary>
    public static RSeqEvent_ThreeThugsTakenDownFromGrates DefaultObject => (RSeqEvent_ThreeThugsTakenDownFromGrates)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThreeThugsTakenDownFromGrates>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThreeThugsTakenDownFromGrates>, new()
