...
public partial class RAnimNotify_CanCorrectAfterHere : BmSDK.Engine.AnimNotify, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAnimNotify_CanCorrectAfterHere.
    /// </summary>
    public static RAnimNotify_CanCorrectAfterHere DefaultObject => (RAnimNotify_CanCorrectAfterHere)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_CanCorrectAfterHere>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_CanCorrectAfterHere>, new()
