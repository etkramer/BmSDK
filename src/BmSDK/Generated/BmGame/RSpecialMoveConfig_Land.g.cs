...
public partial class RSpecialMoveConfig_Land : BmSDK.BmGame.RSpecialMoveConfig_PoseTransition, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_Land.
    /// </summary>
    public static RSpecialMoveConfig_Land DefaultObject => (RSpecialMoveConfig_Land)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct ScreenShake
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct>(Ptr + 332);
