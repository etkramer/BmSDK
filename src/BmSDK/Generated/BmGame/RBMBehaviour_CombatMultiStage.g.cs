...
public partial class RBMBehaviour_CombatMultiStage : BmSDK.BmGame.RBMBehaviour_CombatAI, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_CombatMultiStage.
    /// </summary>
    public static RBMBehaviour_CombatMultiStage DefaultObject => (RBMBehaviour_CombatMultiStage)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_CombatMultiStage>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_CombatMultiStage>, new()
    ...
    /// </summary>
    public unsafe virtual void ChangeThugState(bool bPlayOutAnim = default, bool bPlayInAnim = default)
    {
    ...
    /// </summary>
    public unsafe virtual BmSDK.FName GetMultiTauntMoveStance()
    {
    ...
    /// </summary>
    public unsafe virtual void OnStartQueuedAnim(BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId Id, float TimeLeftOver)
    {
