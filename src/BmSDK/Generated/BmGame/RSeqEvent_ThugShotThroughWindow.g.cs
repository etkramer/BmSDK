...
public partial class RSeqEvent_ThugShotThroughWindow : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_ThugShotThroughWindow.
    /// </summary>
    public static RSeqEvent_ThugShotThroughWindow DefaultObject => (RSeqEvent_ThugShotThroughWindow)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThugShotThroughWindow>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThugShotThroughWindow>, new()
