...
public partial class RAnimNotify_CounterHit : BmSDK.Engine.AnimNotify, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAnimNotify_CounterHit.
    /// </summary>
    public static RAnimNotify_CounterHit DefaultObject => (RAnimNotify_CounterHit)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.BmGame.RPawnPlayerCombat.FCounterInfo CounterInfo
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RPawnPlayerCombat.FCounterInfo>(Ptr + 44);
}
