...
/// <summary>
/// Class: RWalkerProjectile<br/>
/// (size = 976)
/// (flags = 10485778)
/// </summary>
public partial class RWalkerProjectile : BmSDK.BmGame.RBasicProjectile, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RWalkerProjectile", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RWalkerProjectile() { }

    /// <summary>
    /// Constructs a new RWalkerProjectile
    /// </summary>
    public RWalkerProjectile(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RWalkerProjectile Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RWalkerProjectile(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RWalkerProjectile>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RWalkerProjectile>, new()
    ...
    /// <summary>
    /// FloatProperty: DistTravelled
    /// </summary>
    public unsafe float DistTravelled
    {
    ...
    /// <summary>
    /// FloatProperty: InitialVelZ
    /// </summary>
    public unsafe float InitialVelZ
    {
    ...
    /// <summary>
    /// BoolProperty: TrackGround
    /// </summary>
    public unsafe bool TrackGround
    {
