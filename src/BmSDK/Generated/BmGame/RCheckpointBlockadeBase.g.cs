...
public partial class RCheckpointBlockadeBase : BmSDK.Engine.RStaticClimbableActor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCheckpointBlockadeBase.
    /// </summary>
    public static RCheckpointBlockadeBase DefaultObject => (RCheckpointBlockadeBase)StaticClass().DefaultObject;
    ...
    public unsafe virtual void TriggerSound(BmSDK.Engine.AkEvent UpDownEvent)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(UpDownEvent, paramsPtr + 0);
        var oldFlags = funcManaged.FunctionFlags;
        var oldNative = funcManaged.iNative;
        funcManaged.FunctionFlags &= ~BmSDK.Function.EFunctionFlags.FUNC_Native;
        funcManaged.FunctionFlags |= BmSDK.Function.EFunctionFlags.FUNC_Defined;
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Pylon.FEdgeReference>>(Ptr + 704); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Pylon.FObstaclePolyPylonPair>>(Ptr + 720); }
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 NavMeshCutOffset
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 748);

    /// <summary>
    /// ComponentProperty: LosBlocker
    /// </summary>
    public unsafe BmSDK.Engine.RAggGeomCollisionComponent LosBlocker
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.RAggGeomCollisionComponent>(Ptr + 760); }
    ...
    /// </summary>
    public unsafe BmSDK.Engine.AkEvent UpEvent
    {
    ...
    /// </summary>
    public unsafe BmSDK.Engine.AkEvent DownEvent
    {
