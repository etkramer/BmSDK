...
public partial class RVehicleGuardPoint : BmSDK.BmGame.RDummyTarget, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.TArray<BmSDK.TArray<BmSDK.Engine.Actor.Timers>>> ValidEnemyArchetypes
    {
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT ReservedVeh
    {
