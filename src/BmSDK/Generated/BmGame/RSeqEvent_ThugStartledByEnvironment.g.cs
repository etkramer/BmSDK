...
public partial class RSeqEvent_ThugStartledByEnvironment : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_ThugStartledByEnvironment.
    /// </summary>
    public static RSeqEvent_ThugStartledByEnvironment DefaultObject => (RSeqEvent_ThugStartledByEnvironment)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThugStartledByEnvironment>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThugStartledByEnvironment>, new()
