...
public partial class RAnimNotify_IK : BmSDK.Engine.AnimNotify, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Constructs a new RAnimNotify_IK
    /// </summary>
    public RAnimNotify_IK(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RAnimNotify_IK Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
