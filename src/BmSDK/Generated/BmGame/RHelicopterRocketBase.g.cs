...
/// <summary>
/// ABSTRACT Class: RHelicopterRocketBase<br/>
/// (size = 768)
/// (flags = 144703635)
/// </summary>
public partial class RHelicopterRocketBase : BmSDK.Engine.DynamicSMActor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RHelicopterRocketBase.
    /// </summary>
    public static RHelicopterRocketBase DefaultObject => (RHelicopterRocketBase)StaticClass().DefaultObject;
