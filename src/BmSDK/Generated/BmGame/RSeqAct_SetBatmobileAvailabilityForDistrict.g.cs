...
public partial class RSeqAct_SetBatmobileAvailabilityForDistrict : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SetBatmobileAvailabilityForDistrict.
    /// </summary>
    public static RSeqAct_SetBatmobileAvailabilityForDistrict DefaultObject => (RSeqAct_SetBatmobileAvailabilityForDistrict)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetBatmobileAvailabilityForDistrict>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetBatmobileAvailabilityForDistrict>, new()
