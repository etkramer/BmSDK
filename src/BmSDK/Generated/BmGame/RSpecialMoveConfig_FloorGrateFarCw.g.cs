...
public partial class RSpecialMoveConfig_FloorGrateFarCw : BmSDK.BmGame.RSpecialMoveConfig_FloorGrateFar, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_FloorGrateFarCw.
    /// </summary>
    public static RSpecialMoveConfig_FloorGrateFarCw DefaultObject => (RSpecialMoveConfig_FloorGrateFarCw)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_FloorGrateFarCw>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_FloorGrateFarCw>, new()
