...
public partial class RVehicleExclusionVolume : BmSDK.Engine.Volume, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RVehicleExclusionVolume.
    /// </summary>
    public static RVehicleExclusionVolume DefaultObject => (RVehicleExclusionVolume)StaticClass().DefaultObject;
    ...
    /// </summary>
    public enum VehicleExclusionTypes : byte
    {
        VExT_Vehicles = 0,
        VExT_Rioters = 1,
