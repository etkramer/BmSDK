...
public partial class RDmgType_CombatEnvTakedown : BmSDK.BmGame.RDamageType, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_CombatEnvTakedown.
    /// </summary>
    public static RDmgType_CombatEnvTakedown DefaultObject => (RDmgType_CombatEnvTakedown)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_CombatEnvTakedown>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_CombatEnvTakedown>, new()
