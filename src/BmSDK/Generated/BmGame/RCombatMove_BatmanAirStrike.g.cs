...
public partial class RCombatMove_BatmanAirStrike : BmSDK.BmGame.RCombatMove_BatmanStrike, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_BatmanAirStrike.
    /// </summary>
    public static RCombatMove_BatmanAirStrike DefaultObject => (RCombatMove_BatmanAirStrike)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe virtual bool IsWallInTargetDirection()
    {
    ...
    /// Function: IsSliding
    /// </summary>
    public unsafe override bool IsSliding()
    {
    ...
    /// </summary>
    public unsafe virtual void StopSliding()
    {
    ...
    /// Function: FullSpeed
    /// </summary>
    public unsafe virtual void FullSpeed()
    {
