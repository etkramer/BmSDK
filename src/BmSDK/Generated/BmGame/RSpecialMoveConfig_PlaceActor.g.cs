...
public partial class RSpecialMoveConfig_PlaceActor : BmSDK.BmGame.RSpecialMoveConfig_RelativeAnimWithAlignment, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_PlaceActor.
    /// </summary>
    public static RSpecialMoveConfig_PlaceActor DefaultObject => (RSpecialMoveConfig_PlaceActor)StaticClass().DefaultObject;
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Class>(Ptr + 468); }
    ...
    /// </summary>
    public unsafe BmSDK.Engine.Actor ArchetypeToCreate
    {
