...
public partial class RDisruptableItem : BmSDK.BmGame.RDisruptableObjectBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RDisruptableItem(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RDisruptableItem Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
