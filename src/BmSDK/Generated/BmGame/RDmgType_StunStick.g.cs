...
public partial class RDmgType_StunStick : BmSDK.BmGame.RDmgType_Electricity, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_StunStick.
    /// </summary>
    public static RDmgType_StunStick DefaultObject => (RDmgType_StunStick)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_StunStick>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_StunStick>, new()
