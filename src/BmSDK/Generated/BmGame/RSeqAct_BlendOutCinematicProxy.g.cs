...
public partial class RSeqAct_BlendOutCinematicProxy : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_BlendOutCinematicProxy.
    /// </summary>
    public static RSeqAct_BlendOutCinematicProxy DefaultObject => (RSeqAct_BlendOutCinematicProxy)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_BlendOutCinematicProxy>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_BlendOutCinematicProxy>, new()
