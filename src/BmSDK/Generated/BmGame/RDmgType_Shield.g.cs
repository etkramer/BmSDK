...
/// (flags = 18)
/// </summary>
public partial class RDmgType_Shield : BmSDK.BmGame.RDamageType, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_Shield.
    /// </summary>
    public static RDmgType_Shield DefaultObject => (RDmgType_Shield)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_Shield>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_Shield>, new()
