...
public partial class RGrenadeGrateAssignmentPicker : BmSDK.BmGame.RGroupAssignmentPicker, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RGrenadeGrateAssignmentPicker.
    /// </summary>
    public static RGrenadeGrateAssignmentPicker DefaultObject => (RGrenadeGrateAssignmentPicker)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RGrenadeGrateAssignmentPicker>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RGrenadeGrateAssignmentPicker>, new()
