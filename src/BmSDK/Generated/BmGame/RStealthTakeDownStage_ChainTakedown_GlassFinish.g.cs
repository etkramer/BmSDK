...
/// <summary>
/// Class: RStealthTakeDownStage_ChainTakedown_GlassFinish<br/>
/// (size = 1844)
/// (flags = 10485778)
/// </summary>
public partial class RStealthTakeDownStage_ChainTakedown_GlassFinish : BmSDK.BmGame.RStealthTakedownStage_ChainTakedown_Base, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RStealthTakeDownStage_ChainTakedown_GlassFinish", false);
    ...
    /// <summary>
    /// Gets the class default object as RStealthTakeDownStage_ChainTakedown_GlassFinish.
    /// </summary>
    public static RStealthTakeDownStage_ChainTakedown_GlassFinish DefaultObject => (RStealthTakeDownStage_ChainTakedown_GlassFinish)StaticClass().DefaultObject;

    internal RStealthTakeDownStage_ChainTakedown_GlassFinish() { }

    /// <summary>
    /// Constructs a new RStealthTakeDownStage_ChainTakedown_GlassFinish
    /// </summary>
    public RStealthTakeDownStage_ChainTakedown_GlassFinish(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null, BmSDK.Engine.Level Level = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), default, Location, Rotation, Template, Owner, Instigator, Level)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RStealthTakeDownStage_ChainTakedown_GlassFinish(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RStealthTakeDownStage_ChainTakedown_GlassFinish>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RStealthTakeDownStage_ChainTakedown_GlassFinish>, new()
