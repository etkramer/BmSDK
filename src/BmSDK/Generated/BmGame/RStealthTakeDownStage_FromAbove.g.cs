...
public partial class RStealthTakeDownStage_FromAbove : BmSDK.BmGame.RStealthTakeDownStage, BmSDK.IGameObject
{
    ...
    public unsafe ref BmSDK.BmGame.REnvironmentCheckTicker.FEnvironmentSpecialMoveLocator StartLoc
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.REnvironmentCheckTicker.FEnvironmentSpecialMoveLocator>(Ptr + 1680);

    /// <summary>
    /// StructProperty: GrappleLocation
    /// </summary>
    public unsafe ref System.Numerics.Vector3 GrappleLocation
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 1812);
}
