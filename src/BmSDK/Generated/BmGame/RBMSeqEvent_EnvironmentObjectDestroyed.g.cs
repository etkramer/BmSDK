...
public partial class RBMSeqEvent_EnvironmentObjectDestroyed : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMSeqEvent_EnvironmentObjectDestroyed.
    /// </summary>
    public static RBMSeqEvent_EnvironmentObjectDestroyed DefaultObject => (RBMSeqEvent_EnvironmentObjectDestroyed)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMSeqEvent_EnvironmentObjectDestroyed>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMSeqEvent_EnvironmentObjectDestroyed>, new()
