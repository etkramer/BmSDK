...
/// <summary>
/// Class: RCombatMove_GadgetRicochetSticks<br/>
/// (size = 0)
/// (flags = 0)
/// </summary>
public partial class RCombatMove_GadgetRicochetSticks : BmSDK.BmGame.RCombatMove_BatmanAttack, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Constructs a new RCombatMove_GadgetRicochetSticks
    /// </summary>
    public RCombatMove_GadgetRicochetSticks(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_GadgetRicochetSticks Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
