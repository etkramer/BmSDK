...
public partial class RNavMeshObstacle_Queue : BmSDK.Engine.NavMeshObstacle, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RNavMeshObstacle_Queue.
    /// </summary>
    public static RNavMeshObstacle_Queue DefaultObject => (RNavMeshObstacle_Queue)StaticClass().DefaultObject;
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Pylon.FEdgeReference>>(Ptr + 708); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Pylon.FObstaclePolyPylonPair>>(Ptr + 724); }
