...
/// (flags = 8388626)
/// </summary>
public partial class RAEC_Casualty_Sub_FindCas : BmSDK.BmGame.RAlertEventCoordinatorBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAEC_Casualty_Sub_FindCas.
    /// </summary>
    public static RAEC_Casualty_Sub_FindCas DefaultObject => (RAEC_Casualty_Sub_FindCas)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RAEC_Casualty_Sub_FindCas(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RAEC_Casualty_Sub_FindCas.StartChild", true);
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RAEC_Casualty_Sub_FindCas.Tick", true);
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RAEC_Casualty_Sub_FindCas.VillainStolen", true);
        byte* paramsPtr = stackalloc byte[4];
    ...
    /// <summary>
    /// ObjectProperty: FindCasCon
    /// </summary>
    public unsafe BmSDK.BmGame.RBMAIController FindCasCon
    {
