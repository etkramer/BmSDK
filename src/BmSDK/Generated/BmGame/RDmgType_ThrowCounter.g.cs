...
public partial class RDmgType_ThrowCounter : BmSDK.BmGame.RDmgType_Counter, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_ThrowCounter.
    /// </summary>
    public static RDmgType_ThrowCounter DefaultObject => (RDmgType_ThrowCounter)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_ThrowCounter>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_ThrowCounter>, new()
