...
public partial class RVehicleScenario : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RVehicleScenario.
    /// </summary>
    public static RVehicleScenario DefaultObject => (RVehicleScenario)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RVehicleScenario>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RVehicleScenario>, new()
    ...
    /// </summary>
    public enum VehicleScenarioPlaceholderType : byte
    {
