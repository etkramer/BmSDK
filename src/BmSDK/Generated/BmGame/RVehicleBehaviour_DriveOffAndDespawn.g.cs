...
public partial class RVehicleBehaviour_DriveOffAndDespawn : BmSDK.BmGame.RVehicleBehaviour_RunAway, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RVehicleBehaviour_DriveOffAndDespawn.
    /// </summary>
    public static RVehicleBehaviour_DriveOffAndDespawn DefaultObject => (RVehicleBehaviour_DriveOffAndDespawn)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_DriveOffAndDespawn>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_DriveOffAndDespawn>, new()
