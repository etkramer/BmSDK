...
public partial class RParticleModuleWaitForDeath : BmSDK.BmGame.RParticleModuleOnDeathBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RParticleModuleWaitForDeath.
    /// </summary>
    public static RParticleModuleWaitForDeath DefaultObject => (RParticleModuleWaitForDeath)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RParticleModuleWaitForDeath>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RParticleModuleWaitForDeath>, new()
