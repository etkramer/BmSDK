...
public partial class RTimeTrialWaypointBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RTimeTrialWaypointBase.
    /// </summary>
    public static RTimeTrialWaypointBase DefaultObject => (RTimeTrialWaypointBase)StaticClass().DefaultObject;
    ...
    public unsafe virtual BmSDK.Engine.REmitter EnableEmitter(BmSDK.Engine.REmitter E, BmSDK.Engine.ParticleSystem Template, BmSDK.Rotator RotationOffset)
    {
        ...
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.REmitter>(paramsPtr + 28);
    }
    ...
    /// </summary>
    public unsafe ref BmSDK.Rotator PrimaryEmitterRotation
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 764);

    /// <summary>
    /// StructProperty: SecondaryEmitterRotation
    /// </summary>
    public unsafe ref BmSDK.Rotator SecondaryEmitterRotation
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 776);
