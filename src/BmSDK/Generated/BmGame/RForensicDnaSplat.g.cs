...
public partial class RForensicDnaSplat : BmSDK.Engine.DecalActor, BmSDK.BmGame.REvidenceInterface, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RForensicDnaSplat(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RForensicDnaSplat Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
