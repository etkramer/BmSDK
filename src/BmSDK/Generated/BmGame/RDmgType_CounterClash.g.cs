...
public partial class RDmgType_CounterClash : BmSDK.BmGame.RDmgType_Counter, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_CounterClash.
    /// </summary>
    public static RDmgType_CounterClash DefaultObject => (RDmgType_CounterClash)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_CounterClash>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_CounterClash>, new()
