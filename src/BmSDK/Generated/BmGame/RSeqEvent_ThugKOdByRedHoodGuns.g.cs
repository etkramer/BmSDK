...
public partial class RSeqEvent_ThugKOdByRedHoodGuns : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_ThugKOdByRedHoodGuns.
    /// </summary>
    public static RSeqEvent_ThugKOdByRedHoodGuns DefaultObject => (RSeqEvent_ThugKOdByRedHoodGuns)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThugKOdByRedHoodGuns>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThugKOdByRedHoodGuns>, new()
