...
public partial class RDmgType_RiddlerLaser : BmSDK.BmGame.RDmgType_NoXP, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_RiddlerLaser.
    /// </summary>
    public static RDmgType_RiddlerLaser DefaultObject => (RDmgType_RiddlerLaser)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_RiddlerLaser>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_RiddlerLaser>, new()
