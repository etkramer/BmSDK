...
/// (flags = 8388626)
/// </summary>
public partial class RAEC_Casualty_Sub_Rail : BmSDK.BmGame.RAlertEventCoordinatorBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RAEC_Casualty_Sub_Rail(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
    ...
    /// <summary>
    /// ObjectProperty: RailCon
    /// </summary>
    public unsafe BmSDK.BmGame.RBMAIController RailCon
    {
