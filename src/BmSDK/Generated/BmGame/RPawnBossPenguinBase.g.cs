...
public partial class RPawnBossPenguinBase : BmSDK.BmGame.RPawnVillain, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe bool FindMovementDestination()
    {
    ...
    /// </summary>
    public unsafe bool ShouldIMove()
    {
    ...
    /// </summary>
    public unsafe void NavMeshRepath()
    {
    ...
    /// </summary>
    public unsafe BmSDK.FName GetHitReactAnimName(bool bLeft)
    {
    ...
    /// </summary>
    public unsafe void PlayMeleeCamera()
    {
    ...
    /// Function: MagBlast
    /// </summary>
    public unsafe void MagBlast(float Str)
    {
    ...
    public partial record struct FRocketParameters
    {
        ...
        /// </summary>
        public unsafe float MinTimeBetweenAttacks
        {
