...
public partial class RSeqAct_MultipleMobileObjectives : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_MultipleMobileObjectives.
    /// </summary>
    public static RSeqAct_MultipleMobileObjectives DefaultObject => (RSeqAct_MultipleMobileObjectives)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_MultipleMobileObjectives>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_MultipleMobileObjectives>, new()
