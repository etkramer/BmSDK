...
public partial class RBatmobileBooster : BmSDK.BmGame.RVehicleWeapon, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBatmobileBooster(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBatmobileBooster Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
