...
public partial class RPoseConfig : BmSDK.BmGame.RConfig, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe virtual void AddPoseRelaxed(BmSDK.FName MovementStance, BmSDK.FName IdleFullBodyAnim, BmSDK.Engine.RAimingConfig AimingConfig = default)
    {
    ...
    /// Function: AddPose
    /// </summary>
    public unsafe virtual void AddPose(BmSDK.FName MovementStance, BmSDK.FName WeaponStance, BmSDK.FName IdleFullBodyAnim, BmSDK.Engine.RAimingConfig AimingConfig = default, bool AllowTurningToAim = default)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(AllowTurningToAim, paramsPtr + 32);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    public partial record struct FTransition
    {
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimConfig.FAnimConfig>(Ptr + 100); }; }
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPoseConfig.ETransitionMagicGadgetBlend>(Ptr + 144); }; }
        ...
        /// <summary>
        /// BoolProperty: bRenderFlipped
        /// </summary>
        public unsafe bool bRenderFlipped
        {
    ...
    /// <summary>
    /// Enum: ETransitionMagicGadgetBlend
    /// </summary>
    public enum ETransitionMagicGadgetBlend : byte
    {
        TMGB_Nope = 0,
        TMGB_Additive = 1,
        TMGB_ModelspaceUpperAdditiveLower = 2,
        TMGB_MAX = 3,
    }
    ...
    /// </summary>
    public enum EPoseAllowMirroring : byte
    {
