...
public partial class RPredBombablePlantBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RPredBombablePlantBase.
    /// </summary>
    public static RPredBombablePlantBase DefaultObject => (RPredBombablePlantBase)StaticClass().DefaultObject;
