...
public partial class RDmgType_Excavator : BmSDK.BmGame.RDmgType_Barge, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_Excavator.
    /// </summary>
    public static RDmgType_Excavator DefaultObject => (RDmgType_Excavator)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_Excavator>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_Excavator>, new()
