...
public partial class RSpecialMoveConfig_ChuteToCrawlSpace : BmSDK.BmGame.RSpecialMoveConfig_RelativeAnimMove, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_ChuteToCrawlSpace.
    /// </summary>
    public static RSpecialMoveConfig_ChuteToCrawlSpace DefaultObject => (RSpecialMoveConfig_ChuteToCrawlSpace)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_ChuteToCrawlSpace>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_ChuteToCrawlSpace>, new()
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RPhysUtil.FCapeStateChangeData ChuteLoopCape
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RPhysUtil.FCapeStateChangeData>(Ptr + 596);
}
