...
public partial class RBreakableProp : BmSDK.BmGame.RBreakablePropStatic, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBreakableProp(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBreakableProp Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
