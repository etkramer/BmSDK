...
public partial class RSeqAct_AddOrRemovePersistentHudTarget : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_AddOrRemovePersistentHudTarget.
    /// </summary>
    public static RSeqAct_AddOrRemovePersistentHudTarget DefaultObject => (RSeqAct_AddOrRemovePersistentHudTarget)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_AddOrRemovePersistentHudTarget>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_AddOrRemovePersistentHudTarget>, new()
