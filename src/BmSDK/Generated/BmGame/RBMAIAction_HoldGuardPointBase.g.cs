...
/// <summary>
/// ABSTRACT Class: RBMAIAction_HoldGuardPointBase<br/>
/// (size = 908)
/// (flags = 10485779)
/// </summary>
public partial class RBMAIAction_HoldGuardPointBase : BmSDK.BmGame.RBMAIAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMAIAction_HoldGuardPointBase.
    /// </summary>
    public static RBMAIAction_HoldGuardPointBase DefaultObject => (RBMAIAction_HoldGuardPointBase)StaticClass().DefaultObject;
