...
public partial class RVehicleSimCarNPC : BmSDK.BmGame.RVehicleSimNPC, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RVehicleSimCarNPC.
    /// </summary>
    public static RVehicleSimCarNPC DefaultObject => (RVehicleSimCarNPC)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RVehicleSimCarNPC>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RVehicleSimCarNPC>, new()
