...
public partial class RCharacter_JokerThug1Base : BmSDK.BmGame.RCharacter_JokerThug, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_JokerThug1Base.
    /// </summary>
    public static RCharacter_JokerThug1Base DefaultObject => (RCharacter_JokerThug1Base)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug1Base>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_JokerThug1Base>, new()
