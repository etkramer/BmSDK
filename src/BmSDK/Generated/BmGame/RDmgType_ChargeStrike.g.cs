...
public partial class RDmgType_ChargeStrike : BmSDK.BmGame.RDmgType_Strike, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_ChargeStrike.
    /// </summary>
    public static RDmgType_ChargeStrike DefaultObject => (RDmgType_ChargeStrike)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_ChargeStrike>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_ChargeStrike>, new()
