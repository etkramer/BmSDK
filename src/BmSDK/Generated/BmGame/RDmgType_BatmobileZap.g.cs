...
public partial class RDmgType_BatmobileZap : BmSDK.BmGame.RDmgType_Electricity, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_BatmobileZap.
    /// </summary>
    public static RDmgType_BatmobileZap DefaultObject => (RDmgType_BatmobileZap)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_BatmobileZap>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_BatmobileZap>, new()
