...
public partial class RAEC_JammedGun : BmSDK.BmGame.RAlertEventCoordinatorBase, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RAEC_JammedGun", false);
    ...
    /// <summary>
    /// Gets the class default object as RAEC_JammedGun.
    /// </summary>
    public static RAEC_JammedGun DefaultObject => (RAEC_JammedGun)StaticClass().DefaultObject;

    internal RAEC_JammedGun() { }

    /// <summary>
    /// Constructs a new RAEC_JammedGun
    /// </summary>
    public RAEC_JammedGun(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RAEC_JammedGun(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAEC_JammedGun>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAEC_JammedGun>, new()
    ...
    /// <summary>
    /// ObjectProperty: JammedCon
    /// </summary>
    public unsafe BmSDK.BmGame.RBMAIController JammedCon
    {
