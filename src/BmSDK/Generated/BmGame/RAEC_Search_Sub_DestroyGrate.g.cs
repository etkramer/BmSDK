...
public partial class RAEC_Search_Sub_DestroyGrate : BmSDK.BmGame.RAlertEventCoordinatorSolo, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAEC_Search_Sub_DestroyGrate.
    /// </summary>
    public static RAEC_Search_Sub_DestroyGrate DefaultObject => (RAEC_Search_Sub_DestroyGrate)StaticClass().DefaultObject;
    ...
    /// </summary>
    public enum GrateGrenadeAnimDir : byte
    {
        eGGAD_Back = 0,
        eGGAD_Right = 1,
        eGGAD_Left = 2,
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 GrateLookRefPoint
    ...
    public unsafe ref BmSDK.Rotator animRefRot
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 728);
