...
public partial class RDmgType_WhipMiss : BmSDK.BmGame.RDamageType, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_WhipMiss.
    /// </summary>
    public static RDmgType_WhipMiss DefaultObject => (RDmgType_WhipMiss)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_WhipMiss>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_WhipMiss>, new()
