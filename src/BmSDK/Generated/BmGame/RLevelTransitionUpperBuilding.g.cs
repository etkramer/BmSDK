...
public partial class RLevelTransitionUpperBuilding : BmSDK.BmGame.RLevelTransition, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RLevelTransitionUpperBuilding(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RLevelTransitionUpperBuilding Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
