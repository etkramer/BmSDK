...
public partial class RLootDestinationBase : BmSDK.Engine.SkeletalMeshActor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RLootDestinationBase.
    /// </summary>
    public static RLootDestinationBase DefaultObject => (RLootDestinationBase)StaticClass().DefaultObject;
