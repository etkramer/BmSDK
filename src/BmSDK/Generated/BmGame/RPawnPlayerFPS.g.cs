...
public partial class RPawnPlayerFPS : BmSDK.BmGame.RPawnPlayerAnim, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RPawnPlayerFPS.
    /// </summary>
    public static RPawnPlayerFPS DefaultObject => (RPawnPlayerFPS)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 CopOffsetVal
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 3112);

    /// <summary>
    /// StructProperty: CopTranslationTarget
    /// </summary>
    public unsafe ref System.Numerics.Vector3 CopTranslationTarget
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 3124);

    /// <summary>
    /// StructProperty: CopRotationTarget
    /// </summary>
    public unsafe ref BmSDK.Rotator CopRotationTarget
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 3136);
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId FiringAnim
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId>(Ptr + 3176);

    /// <summary>
    /// StructProperty: ReloadAnim
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId ReloadAnim
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId>(Ptr + 3180);
