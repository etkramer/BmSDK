...
/// <summary>
/// Class: RSpecialMoveInstance_DropToLedgeHang<br/>
/// (flags = 0)
/// </summary>
public partial class RSpecialMoveInstance_DropToLedgeHang : BmSDK.BmGame.RSpecialMoveInstance_RelativeAnimWithTravelAnim, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RSpecialMoveInstance_DropToLedgeHang", false);
    ...
    /// <summary>
    /// Constructs a new RSpecialMoveInstance_DropToLedgeHang
    /// </summary>
    public RSpecialMoveInstance_DropToLedgeHang(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSpecialMoveInstance_DropToLedgeHang Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RSpecialMoveInstance_DropToLedgeHang(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveInstance_DropToLedgeHang>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveInstance_DropToLedgeHang>, new()
