...
public partial class RSeqAct_DeadThugOnscreenCounter : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_DeadThugOnscreenCounter.
    /// </summary>
    public static RSeqAct_DeadThugOnscreenCounter DefaultObject => (RSeqAct_DeadThugOnscreenCounter)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_DeadThugOnscreenCounter>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_DeadThugOnscreenCounter>, new()
