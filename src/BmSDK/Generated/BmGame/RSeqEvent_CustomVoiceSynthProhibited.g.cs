...
public partial class RSeqEvent_CustomVoiceSynthProhibited : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_CustomVoiceSynthProhibited.
    /// </summary>
    public static RSeqEvent_CustomVoiceSynthProhibited DefaultObject => (RSeqEvent_CustomVoiceSynthProhibited)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_CustomVoiceSynthProhibited>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_CustomVoiceSynthProhibited>, new()
