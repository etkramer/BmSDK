...
public partial class RSpecialMoveConfig_HarpoonThug : BmSDK.BmGame.RSpecialMoveConfig, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_HarpoonThug.
    /// </summary>
    public static RSpecialMoveConfig_HarpoonThug DefaultObject => (RSpecialMoveConfig_HarpoonThug)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.BmGame.RSpecialMoveConfig_HarpoonThug.FBatclawBatmanAnimConfig CornerAnims
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RSpecialMoveConfig_HarpoonThug.FBatclawBatmanAnimConfig>(Ptr + 416);

    /// <summary>
    /// StructProperty: FireScreenShake
    /// </summary>
    public unsafe ref BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct FireScreenShake
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct>(Ptr + 452);
