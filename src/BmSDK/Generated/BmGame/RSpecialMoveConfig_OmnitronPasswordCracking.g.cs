...
public partial class RSpecialMoveConfig_OmnitronPasswordCracking : BmSDK.BmGame.RSpecialMoveConfig, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_OmnitronPasswordCracking.
    /// </summary>
    public static RSpecialMoveConfig_OmnitronPasswordCracking DefaultObject => (RSpecialMoveConfig_OmnitronPasswordCracking)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_OmnitronPasswordCracking>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_OmnitronPasswordCracking>, new()
