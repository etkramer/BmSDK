...
public partial class RSeqAct_ToggleRobinLieutenantAssist : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_ToggleRobinLieutenantAssist.
    /// </summary>
    public static RSeqAct_ToggleRobinLieutenantAssist DefaultObject => (RSeqAct_ToggleRobinLieutenantAssist)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ToggleRobinLieutenantAssist>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ToggleRobinLieutenantAssist>, new()
