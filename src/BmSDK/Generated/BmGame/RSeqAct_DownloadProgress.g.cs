...
public partial class RSeqAct_DownloadProgress : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_DownloadProgress.
    /// </summary>
    public static RSeqAct_DownloadProgress DefaultObject => (RSeqAct_DownloadProgress)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_DownloadProgress>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_DownloadProgress>, new()
    ...
    /// </summary>
    public unsafe virtual void OutroComplete()
    {
