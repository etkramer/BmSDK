...
public partial class RVehicleMine : BmSDK.BmGame.RProjectile, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RVehicleMine(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RVehicleMine Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
