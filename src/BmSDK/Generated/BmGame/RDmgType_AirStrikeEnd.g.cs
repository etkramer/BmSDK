...
public partial class RDmgType_AirStrikeEnd : BmSDK.BmGame.RDmgType_AirStrike, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_AirStrikeEnd.
    /// </summary>
    public static RDmgType_AirStrikeEnd DefaultObject => (RDmgType_AirStrikeEnd)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_AirStrikeEnd>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_AirStrikeEnd>, new()
