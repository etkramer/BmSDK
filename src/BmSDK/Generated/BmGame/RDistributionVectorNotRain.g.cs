...
public partial class RDistributionVectorNotRain : BmSDK.BmGame.RDistributionVectorRain, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDistributionVectorNotRain.
    /// </summary>
    public static RDistributionVectorNotRain DefaultObject => (RDistributionVectorNotRain)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDistributionVectorNotRain>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDistributionVectorNotRain>, new()
