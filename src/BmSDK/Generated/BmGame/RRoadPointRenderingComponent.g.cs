...
public partial class RRoadPointRenderingComponent : BmSDK.Engine.PrimitiveComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RRoadPointRenderingComponent.
    /// </summary>
    public static RRoadPointRenderingComponent DefaultObject => (RRoadPointRenderingComponent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RRoadPointRenderingComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RRoadPointRenderingComponent>, new()
