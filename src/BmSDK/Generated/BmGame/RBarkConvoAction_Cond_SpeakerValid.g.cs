...
public partial class RBarkConvoAction_Cond_SpeakerValid : BmSDK.BmGame.RBarkConvoActionCond, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBarkConvoAction_Cond_SpeakerValid.
    /// </summary>
    public static RBarkConvoAction_Cond_SpeakerValid DefaultObject => (RBarkConvoAction_Cond_SpeakerValid)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBarkConvoAction_Cond_SpeakerValid>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBarkConvoAction_Cond_SpeakerValid>, new()
