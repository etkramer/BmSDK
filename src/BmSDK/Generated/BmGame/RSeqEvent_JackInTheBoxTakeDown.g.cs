...
public partial class RSeqEvent_JackInTheBoxTakeDown : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_JackInTheBoxTakeDown.
    /// </summary>
    public static RSeqEvent_JackInTheBoxTakeDown DefaultObject => (RSeqEvent_JackInTheBoxTakeDown)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_JackInTheBoxTakeDown>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_JackInTheBoxTakeDown>, new()
