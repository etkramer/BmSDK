...
public partial class RDmgType_JokerBoxerCloseAttackStrike : BmSDK.BmGame.RDmgType_Strike, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_JokerBoxerCloseAttackStrike.
    /// </summary>
    public static RDmgType_JokerBoxerCloseAttackStrike DefaultObject => (RDmgType_JokerBoxerCloseAttackStrike)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_JokerBoxerCloseAttackStrike>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_JokerBoxerCloseAttackStrike>, new()
