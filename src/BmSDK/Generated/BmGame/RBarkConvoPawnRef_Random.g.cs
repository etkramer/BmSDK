...
public partial class RBarkConvoPawnRef_Random : BmSDK.BmGame.RBarkConvoPawnRef, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBarkConvoPawnRef_Random.
    /// </summary>
    public static RBarkConvoPawnRef_Random DefaultObject => (RBarkConvoPawnRef_Random)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBarkConvoPawnRef_Random>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBarkConvoPawnRef_Random>, new()
