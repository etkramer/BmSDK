...
public partial class RSpecialMoveConfig_RelativeAnimWithAlignment : BmSDK.BmGame.RSpecialMoveConfig_RelativeAnimMove, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_RelativeAnimWithAlignment.
    /// </summary>
    public static RSpecialMoveConfig_RelativeAnimWithAlignment DefaultObject => (RSpecialMoveConfig_RelativeAnimWithAlignment)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_RelativeAnimWithAlignment>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_RelativeAnimWithAlignment>, new()
