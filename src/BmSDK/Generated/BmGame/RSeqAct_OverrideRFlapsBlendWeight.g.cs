...
public partial class RSeqAct_OverrideRFlapsBlendWeight : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_OverrideRFlapsBlendWeight.
    /// </summary>
    public static RSeqAct_OverrideRFlapsBlendWeight DefaultObject => (RSeqAct_OverrideRFlapsBlendWeight)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_OverrideRFlapsBlendWeight>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_OverrideRFlapsBlendWeight>, new()
