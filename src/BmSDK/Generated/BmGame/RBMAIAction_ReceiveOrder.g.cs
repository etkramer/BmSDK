...
/// <summary>
/// Class: RBMAIAction_ReceiveOrder<br/>
/// (flags = 0)
/// </summary>
public partial class RBMAIAction_ReceiveOrder : BmSDK.BmGame.RBMAIAction, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RBMAIAction_ReceiveOrder", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RBMAIAction_ReceiveOrder() { }

    /// <summary>
    /// Constructs a new RBMAIAction_ReceiveOrder
    /// </summary>
    public RBMAIAction_ReceiveOrder(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMAIAction_ReceiveOrder Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RBMAIAction_ReceiveOrder(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMAIAction_ReceiveOrder>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMAIAction_ReceiveOrder>, new()
    ...
    /// <summary>
    /// BoolProperty: bNervous
    /// </summary>
    public unsafe bool bNervous
    {
    ...
    /// <summary>
    /// BoolProperty: bStartedAnim
    /// </summary>
    public unsafe bool bStartedAnim
    {
    ...
    /// <summary>
    /// StructProperty: ReceiveAnimID
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId ReceiveAnimID
    {
