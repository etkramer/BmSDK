...
public partial class RSeqEvent_StartBangOnDoor_Normal : BmSDK.BmGame.RSeqEvent_StartBangOnDoor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_StartBangOnDoor_Normal.
    /// </summary>
    public static RSeqEvent_StartBangOnDoor_Normal DefaultObject => (RSeqEvent_StartBangOnDoor_Normal)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_StartBangOnDoor_Normal>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_StartBangOnDoor_Normal>, new()
