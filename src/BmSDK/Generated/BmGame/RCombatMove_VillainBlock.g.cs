...
public partial class RCombatMove_VillainBlock : BmSDK.BmGame.RCombatMove, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_VillainBlock.
    /// </summary>
    public static RCombatMove_VillainBlock DefaultObject => (RCombatMove_VillainBlock)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RCombatMove_VillainBlock(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId BlockID
