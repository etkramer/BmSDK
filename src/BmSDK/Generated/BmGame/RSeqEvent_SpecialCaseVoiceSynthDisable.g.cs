...
public partial class RSeqEvent_SpecialCaseVoiceSynthDisable : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_SpecialCaseVoiceSynthDisable.
    /// </summary>
    public static RSeqEvent_SpecialCaseVoiceSynthDisable DefaultObject => (RSeqEvent_SpecialCaseVoiceSynthDisable)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_SpecialCaseVoiceSynthDisable>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_SpecialCaseVoiceSynthDisable>, new()
