...
public partial class RTunnelMeshBase : BmSDK.Engine.StaticMeshActor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RTunnelMeshBase.
    /// </summary>
    public static RTunnelMeshBase DefaultObject => (RTunnelMeshBase)StaticClass().DefaultObject;
    ...
    /// </summary>
    public enum ETunnelMeshType : byte
    {
        TMT_FloorVent = 0,
        TMT_CeilingVent = 1,
        MAX_TMT = 2,
