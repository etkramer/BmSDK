...
public partial class RSeqEvent_KOWithMayhemModeStatus : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_KOWithMayhemModeStatus.
    /// </summary>
    public static RSeqEvent_KOWithMayhemModeStatus DefaultObject => (RSeqEvent_KOWithMayhemModeStatus)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_KOWithMayhemModeStatus>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_KOWithMayhemModeStatus>, new()
