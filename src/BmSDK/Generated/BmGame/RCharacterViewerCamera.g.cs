...
/// <summary>
/// Class: RCharacterViewerCamera<br/>
/// (size = 968)
/// (flags = 144704146)
/// </summary>
public partial class RCharacterViewerCamera : BmSDK.BmGame.RCameraActor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RCharacterViewerCamera", false);
    ...
    /// <summary>
    /// Constructs a new RCharacterViewerCamera
    /// </summary>
    public RCharacterViewerCamera(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCharacterViewerCamera(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacterViewerCamera>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacterViewerCamera>, new()
    ...
    public unsafe virtual void UpdateInput(float DeltaSeconds, BmSDK.BmGame.RPlayerInput PlayerInput)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(PlayerInput, paramsPtr + 4);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    public unsafe virtual void InitControls(float InAutoRotateIdleTimeRemaining)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(InAutoRotateIdleTimeRemaining, paramsPtr + 0);
    ...
    /// <summary>
    /// Struct: FCapturedActorState
    /// </summary>
    [StructLayout(LayoutKind.Explicit, Size = 12)]
    public partial record struct FCapturedActorState
    {
        /// <summary>
        ...
        /// <summary>
        /// FloatProperty: DistanceXY
        /// </summary>
        public unsafe float DistanceXY
        {
    ...
    /// <summary>
    /// ObjectProperty: AutomaticallyUseConfig
    /// </summary>
    public unsafe BmSDK.BmGame.RCharacterViewerConfig AutomaticallyUseConfig
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RCharacterViewerConfig>(Ptr + 864); }
    ...
    /// <summary>
    /// FloatProperty: HeightSpeed
    /// </summary>
    public unsafe float HeightSpeed
    {
    ...
    /// <summary>
    /// FloatProperty: AutoRotateBlendOutDuration
    /// </summary>
    public unsafe float AutoRotateBlendOutDuration
    {
    ...
    /// <summary>
    /// FloatProperty: AutoRotateBlendInDuration
    /// </summary>
    public unsafe float AutoRotateBlendInDuration
    {
    ...
    /// <summary>
    /// FloatProperty: AutoRotateIdleDuration
    /// </summary>
    public unsafe float AutoRotateIdleDuration
    {
    ...
    /// <summary>
    /// ObjectProperty: LiveConfig
    /// </summary>
    public unsafe BmSDK.BmGame.RCharacterViewerConfig LiveConfig
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RCharacterViewerConfig>(Ptr + 896); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 896); }
    }

    /// <summary>
    /// FloatProperty: AutoRotateIdleTimeRemaining
    /// </summary>
    public unsafe float AutoRotateIdleTimeRemaining
    {
    ...
    /// <summary>
    /// FloatProperty: AutoRotateWeight
    /// </summary>
    public unsafe float AutoRotateWeight
    {
    ...
    /// <summary>
    /// BoolProperty: AutoSwitchPlayerToMe
    /// </summary>
    public unsafe bool AutoSwitchPlayerToMe
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Actor>>(Ptr + 912); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 912); }
    }

    /// <summary>
    /// ArrayProperty: CapturedActors
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.BmGame.RCharacterViewerCamera.FCapturedActorState> CapturedActors
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.BmGame.RCharacterViewerCamera.FCapturedActorState>>(Ptr + 924); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 924); }
    }

    /// <summary>
    /// IntProperty: InitialYaw
    /// </summary>
    public unsafe int InitialYaw
    {
    ...
    /// <summary>
    /// FloatProperty: CurrentHeightControl
    /// </summary>
    public unsafe float CurrentHeightControl
    {
    ...
    /// <summary>
    /// FloatProperty: CurrentFOVControl
    /// </summary>
    public unsafe float CurrentFOVControl
    {
    ...
    /// </summary>
    public unsafe float ZoomedInHeightSpeedScale
    {
    ...
    /// <summary>
    /// FloatProperty: ZoomedOutHeightSpeedScale
    /// </summary>
    public unsafe float ZoomedOutHeightSpeedScale
    {
