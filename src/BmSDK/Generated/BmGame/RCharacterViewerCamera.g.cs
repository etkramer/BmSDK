...
public partial class RCharacterViewerCamera : BmSDK.BmGame.RCameraActor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RCharacterViewerCamera(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCharacterViewerCamera Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
