...
public partial class RHotWireBoxBase : BmSDK.BmGame.RInteractableItem, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RHotWireBoxBase(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RHotWireBoxBase Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
