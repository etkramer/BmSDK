...
public partial class RDmgType_RiddlerMineExplosion_Player : BmSDK.BmGame.RDmgType_ThugMineExplosion_Player, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_RiddlerMineExplosion_Player.
    /// </summary>
    public static RDmgType_RiddlerMineExplosion_Player DefaultObject => (RDmgType_RiddlerMineExplosion_Player)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_RiddlerMineExplosion_Player>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_RiddlerMineExplosion_Player>, new()
