...
public partial class RSnapToPositionActor : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RSnapToPositionActor(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSnapToPositionActor Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
