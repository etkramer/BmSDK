...
public partial class RSeqAct_RemoveRHDFromInventory : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_RemoveRHDFromInventory.
    /// </summary>
    public static RSeqAct_RemoveRHDFromInventory DefaultObject => (RSeqAct_RemoveRHDFromInventory)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_RemoveRHDFromInventory>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_RemoveRHDFromInventory>, new()
