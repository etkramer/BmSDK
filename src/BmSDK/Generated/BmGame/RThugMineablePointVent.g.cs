...
public partial class RThugMineablePointVent : BmSDK.BmGame.RThugMineablePointBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RThugMineablePointVent(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RThugMineablePointVent Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
