...
/// <summary>
/// Class: RWeakIceBase<br/>
/// (size = 472)
/// (flags = 142606482)
/// </summary>
public partial class RWeakIceBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RWeakIceBase", false);
    ...
    /// <summary>
    /// Gets the class default object as RWeakIceBase.
    /// </summary>
    public static RWeakIceBase DefaultObject => (RWeakIceBase)StaticClass().DefaultObject;

    internal RWeakIceBase() { }

    /// <summary>
    /// Constructs a new RWeakIceBase
    /// </summary>
    public RWeakIceBase(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RWeakIceBase(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RWeakIceBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RWeakIceBase>, new()
    ...
    /// </summary>
    public unsafe virtual void BreakFromDive()
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RWeakIceBase.BreakFromDive", true);
    ...
    public partial record struct FFloorData
    {
        /// <summary>
        /// ObjectProperty: FloorBreakFX
        /// </summary>
        public unsafe BmSDK.Engine.ParticleSystem FloorBreakFX
        {
        ...
        /// <summary>
        /// ObjectProperty: FloorCrackFX
        /// </summary>
        public unsafe BmSDK.Engine.ParticleSystem FloorCrackFX
        {
        ...
        /// <summary>
        /// FloatProperty: CrackTime
        /// </summary>
        public unsafe float CrackTime
        {
        ...
        /// <summary>
        /// FloatProperty: BreakTimeStart
        /// </summary>
        public unsafe float BreakTimeStart
        {
        ...
        /// <summary>
        /// FloatProperty: BreakTimeEnd
        /// </summary>
        public unsafe float BreakTimeEnd
        {
        ...
        /// <summary>
        /// BoolProperty: bCracking
        /// </summary>
        public unsafe bool bCracking
        {
        ...
        /// <summary>
        /// BoolProperty: bCracked
        /// </summary>
        public unsafe bool bCracked
        {
        ...
        /// <summary>
        /// BoolProperty: bBreaking
        /// </summary>
        public unsafe bool bBreaking
        {
    ...
    /// </summary>
    public unsafe BmSDK.Engine.MaterialInstanceConstant CrackMat
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.MaterialInstanceConstant>(Ptr + 464); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 464); }
    }

    /// <summary>
    /// FloatProperty: Cracks
    /// </summary>
    public unsafe float Cracks
    {
