...
public partial class RBMCutscene_MultiBatClawCam : BmSDK.BmGame.RBMCutscene_BatClawCam, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMCutscene_MultiBatClawCam.
    /// </summary>
    public static RBMCutscene_MultiBatClawCam DefaultObject => (RBMCutscene_MultiBatClawCam)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMCutscene_MultiBatClawCam>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMCutscene_MultiBatClawCam>, new()
