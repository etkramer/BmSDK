...
/// <summary>
/// ABSTRACT Class: RGangInteractPointBase<br/>
/// (size = 1304)
/// (flags = 144703635)
/// </summary>
public partial class RGangInteractPointBase : BmSDK.Engine.RGangInteractPointEngineBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RGangInteractPointBase.
    /// </summary>
    public static RGangInteractPointBase DefaultObject => (RGangInteractPointBase)StaticClass().DefaultObject;
    ...
    public unsafe virtual void AttachToCar(int Seat)
    {
        ...
        byte* paramsPtr = stackalloc byte[4];
        BmSDK.Framework.MarshalUtil.ToUnmanaged(Seat, paramsPtr + 0);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    public partial record struct FWeaponAnimsets
    {
        /// <summary>
    ...
    public unsafe ref BmSDK.GameObject.FGuid Gid
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.GameObject.FGuid>(Ptr + 1288);
    ...
    /// </summary>
    public enum ObjectPickupTypes : byte
    {
        OPT_None = 0,
        OPT_News1 = 1,
        OPT_News2 = 2,
