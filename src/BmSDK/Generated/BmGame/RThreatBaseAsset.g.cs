...
public partial class RThreatBaseAsset : BmSDK.BmGame.RConfig, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RThreatBaseAsset", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RThreatBaseAsset() { }

    /// <summary>
    /// Constructs a new RThreatBaseAsset
    /// </summary>
    public RThreatBaseAsset(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RThreatBaseAsset Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RThreatBaseAsset(nint ptr) : base(ptr) { }
