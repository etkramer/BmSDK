...
public partial class RSeqEvent_CrimeSceneCompleted : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_CrimeSceneCompleted.
    /// </summary>
    public static RSeqEvent_CrimeSceneCompleted DefaultObject => (RSeqEvent_CrimeSceneCompleted)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_CrimeSceneCompleted>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_CrimeSceneCompleted>, new()
    ...
    /// </summary>
    public enum CrimeSceneCompletionLevel : byte
    {
