...
public partial class MSnareTrap : BmSDK.BmGame.RProjectileGadgetBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MSnareTrap.
    /// </summary>
    public static MSnareTrap DefaultObject => (MSnareTrap)StaticClass().DefaultObject;
    ...
    public unsafe ref System.Numerics.Vector3 AimLocation
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 2648);
