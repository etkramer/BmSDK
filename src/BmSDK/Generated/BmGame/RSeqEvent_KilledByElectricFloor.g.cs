...
public partial class RSeqEvent_KilledByElectricFloor : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_KilledByElectricFloor.
    /// </summary>
    public static RSeqEvent_KilledByElectricFloor DefaultObject => (RSeqEvent_KilledByElectricFloor)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_KilledByElectricFloor>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_KilledByElectricFloor>, new()
