...
public partial class RSpecialMoveInstance_MagnetiseObject : BmSDK.BmGame.RSpecialMoveInstance, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RSpecialMoveInstance_MagnetiseObject", false);
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveInstance_MagnetiseObject.
    /// </summary>
    public static RSpecialMoveInstance_MagnetiseObject DefaultObject => (RSpecialMoveInstance_MagnetiseObject)StaticClass().DefaultObject;

    internal RSpecialMoveInstance_MagnetiseObject() { }

    /// <summary>
    /// Constructs a new RSpecialMoveInstance_MagnetiseObject
    /// </summary>
    public RSpecialMoveInstance_MagnetiseObject(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSpecialMoveInstance_MagnetiseObject Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RSpecialMoveInstance_MagnetiseObject(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveInstance_MagnetiseObject>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveInstance_MagnetiseObject>, new()
