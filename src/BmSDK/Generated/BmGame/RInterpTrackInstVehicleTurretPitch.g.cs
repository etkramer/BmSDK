...
public partial class RInterpTrackInstVehicleTurretPitch : BmSDK.Engine.InterpTrackInst, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RInterpTrackInstVehicleTurretPitch.
    /// </summary>
    public static RInterpTrackInstVehicleTurretPitch DefaultObject => (RInterpTrackInstVehicleTurretPitch)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RInterpTrackInstVehicleTurretPitch>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RInterpTrackInstVehicleTurretPitch>, new()
