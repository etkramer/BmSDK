...
public partial class RDmgType_BaseballBat : BmSDK.BmGame.RDmgType_HeavyStrike, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_BaseballBat.
    /// </summary>
    public static RDmgType_BaseballBat DefaultObject => (RDmgType_BaseballBat)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_BaseballBat>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_BaseballBat>, new()
