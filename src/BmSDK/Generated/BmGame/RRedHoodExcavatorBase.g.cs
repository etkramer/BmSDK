...
public partial class RRedHoodExcavatorBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RRedHoodExcavatorBase.
    /// </summary>
    public static RRedHoodExcavatorBase DefaultObject => (RRedHoodExcavatorBase)StaticClass().DefaultObject;
    ...
    /// </summary>
    public enum ExcavatorLightTypes : byte
    {
        ELT_FrontLight = 0,
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 pathStart
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 860);

    /// <summary>
    /// StructProperty: PathGoal
    /// </summary>
    public unsafe ref System.Numerics.Vector3 PathGoal
