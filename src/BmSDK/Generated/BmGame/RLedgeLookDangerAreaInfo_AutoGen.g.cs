...
public partial class RLedgeLookDangerAreaInfo_AutoGen : BmSDK.BmGame.RLedgeLookDangerAreaInfo, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RLedgeLookDangerAreaInfo_AutoGen", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RLedgeLookDangerAreaInfo_AutoGen() { }

    /// <summary>
    /// Constructs a new RLedgeLookDangerAreaInfo_AutoGen
    /// </summary>
    public RLedgeLookDangerAreaInfo_AutoGen(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RLedgeLookDangerAreaInfo_AutoGen Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RLedgeLookDangerAreaInfo_AutoGen(nint ptr) : base(ptr) { }
    ...
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RLedgeLookDangerAreaInfo_AutoGen>, new()
    ...
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.TArray<BmSDK.TArray<BmSDK.Engine.Actor.Timers>>> FencePointList
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<NEED_UPDATE_ARRAYPROPERTY_LAYOUT>(Ptr + 696); }
