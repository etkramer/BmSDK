...
public partial class RBMBehaviour_DiveAwayFromCar : BmSDK.BmGame.RBMBehaviour, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_DiveAwayFromCar.
    /// </summary>
    public static RBMBehaviour_DiveAwayFromCar DefaultObject => (RBMBehaviour_DiveAwayFromCar)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_DiveAwayFromCar>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_DiveAwayFromCar>, new()
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 ForceDiveDirection
