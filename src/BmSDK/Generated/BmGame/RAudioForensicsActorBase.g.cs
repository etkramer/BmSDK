...
public partial class RAudioForensicsActorBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RAudioForensicsActorBase(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RAudioForensicsActorBase Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
