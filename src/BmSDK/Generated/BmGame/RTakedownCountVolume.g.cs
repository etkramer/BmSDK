...
public partial class RTakedownCountVolume : BmSDK.Engine.Volume, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RTakedownCountVolume", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RTakedownCountVolume() { }

    /// <summary>
    /// Constructs a new RTakedownCountVolume
    /// </summary>
    public RTakedownCountVolume(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RTakedownCountVolume Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RTakedownCountVolume(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RTakedownCountVolume>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RTakedownCountVolume>, new()
    ...
    /// <summary>
    /// IntProperty: takedownThreshold
    /// </summary>
    public unsafe int takedownThreshold
    {
    ...
    /// <summary>
    /// IntProperty: numManDownsToTriggerResponseEvent
    /// </summary>
    public unsafe int numManDownsToTriggerResponseEvent
    {
    ...
    /// <summary>
    /// IntProperty: numTakedowns
    /// </summary>
    public unsafe int numTakedowns
    {
