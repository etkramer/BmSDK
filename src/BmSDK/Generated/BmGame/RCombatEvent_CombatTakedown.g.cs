...
public partial class RCombatEvent_CombatTakedown : BmSDK.BmGame.RCombatEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCombatEvent_CombatTakedown.
    /// </summary>
    public static RCombatEvent_CombatTakedown DefaultObject => (RCombatEvent_CombatTakedown)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatEvent_CombatTakedown>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatEvent_CombatTakedown>, new()
