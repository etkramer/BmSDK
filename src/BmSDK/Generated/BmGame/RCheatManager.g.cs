...
public partial class RCheatManager : BmSDK.Engine.CheatManager, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe void TestStatsRevenge(int Batman, int Catwoman, int Robin, int Nightwing)
    {
    ...
    /// </summary>
    public unsafe void TestStatsUpgrades(int Batman, int Catwoman)
    {
    ...
    /// </summary>
    public unsafe void TestStatsRiddlerGrid100()
    {
    ...
    /// </summary>
    public unsafe void TestStatsRiddlerGrid(int Batman, int Catwoman)
    {
    ...
    /// </summary>
    public unsafe void TestStatsClearRiddlerGrid()
    {
    ...
    /// </summary>
    public unsafe void TestStatsCWLoot(int Quantity)
    {
    ...
    /// </summary>
    public unsafe void TestStatsSide100()
    {
    ...
    /// </summary>
    public unsafe void TestStatsSide(int Azrael, int Bane, int Deadshot, int Hush, int Hatter, int Nora, int Riddler, int Zsasz, int ARTrain, int Iceberg, int Freeze, int Bullies)
    {
    ...
    /// </summary>
    public unsafe void TurnOffSickness()
    {
    ...
    /// </summary>
    public unsafe void SetSideStoryDebug_Zsasz(int Value)
    {
    ...
    /// </summary>
    public unsafe void SetSideStoryDebug_Riddler(int Value)
    {
    ...
    /// </summary>
    public unsafe void SetSideStoryDebug_Nora(int Value)
    {
    ...
    /// </summary>
    public unsafe void SetSideStoryDebug_MadHatter(int Value)
    {
    ...
    /// </summary>
    public unsafe void SetSideStoryDebug_Hush(int Value)
    {
    ...
    /// </summary>
    public unsafe void SetSideStoryDebug_Deadshot(int Value)
    {
    ...
    /// </summary>
    public unsafe void SetSideStoryDebug_Bane(int Value)
    {
    ...
    /// </summary>
    public unsafe void SetSideStoryDebug_Azrael(int Value)
    {
    ...
    /// Function: SS_Unlock
    /// </summary>
    public unsafe void SS_Unlock(bool bLock = default)
    {
    ...
    /// </summary>
    public unsafe void UnlockRiddler()
    {
    ...
    /// </summary>
    public unsafe void UnlockTapes()
    {
    ...
    /// </summary>
    public unsafe void UnlockGallery()
    {
    ...
    /// Function: UnlockTape
    /// </summary>
    public unsafe void UnlockTape(int Id)
    {
    ...
    /// Function: UnlockBio
    /// </summary>
    public unsafe void UnlockBio(int Id)
    {
    ...
    /// </summary>
    public unsafe void UnlockChallengeMode()
    {
    ...
    /// </summary>
    public unsafe void UnlockCharacter(BmSDK.FString CharName)
    {
    ...
    /// </summary>
    public unsafe void DumpDialogueCoord()
    {
    ...
    /// </summary>
    public unsafe void DebugTomMiller()
    {
    ...
    /// </summary>
    public unsafe void TriggerRandomOverlay()
    {
