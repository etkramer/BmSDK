...
public partial class RRadioNWViewPostProcess : BmSDK.BmGame.RViewPostProcess, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RRadioNWViewPostProcess.
    /// </summary>
    public static RRadioNWViewPostProcess DefaultObject => (RRadioNWViewPostProcess)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RRadioNWViewPostProcess>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RRadioNWViewPostProcess>, new()
