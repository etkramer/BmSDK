...
public partial class RSpecialMoveInstance_DriveCar : BmSDK.BmGame.RSpecialMoveInstance_RunningRelativeAnimMove, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveInstance_DriveCar.
    /// </summary>
    public static RSpecialMoveInstance_DriveCar DefaultObject => (RSpecialMoveInstance_DriveCar)StaticClass().DefaultObject;
