...
/// <summary>
/// Class: RFlockComponent<br/>
/// (size = 140)
/// (flags = 134217874)
/// </summary>
public partial class RFlockComponent : BmSDK.Engine.ActorComponent, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RFlockComponent", false);
    ...
    /// <summary>
    /// Constructs a new RFlockComponent
    /// </summary>
    public RFlockComponent(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RFlockComponent Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RFlockComponent(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RFlockComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RFlockComponent>, new()
    ...
    /// <summary>
    /// IntProperty: NumberOfBirds
    /// </summary>
    public unsafe int NumberOfBirds
    {
    ...
    /// <summary>
    /// FloatProperty: DirectionVariance
    /// </summary>
    public unsafe float DirectionVariance
    {
    ...
    /// <summary>
    /// FloatProperty: SpeedVariance
    /// </summary>
    public unsafe float SpeedVariance
    {
    ...
    /// <summary>
    /// FloatProperty: RandomisationTimeMax
    /// </summary>
    public unsafe float RandomisationTimeMax
    {
    ...
    /// <summary>
    /// StructProperty: PreviousTargetPosition
    /// </summary>
    public unsafe ref System.Numerics.Vector3 PreviousTargetPosition
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 116);

    /// <summary>
    /// ArrayProperty: Birds
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.BmGame.RFlockComponent.FBird> Birds
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.BmGame.RFlockComponent.FBird>>(Ptr + 128); }
    ...
    public partial record struct FBird
    {
        /// <summary>
        ...
        /// <summary>
        /// FloatProperty: TimeTillNextRandomisation
        /// </summary>
        public unsafe float TimeTillNextRandomisation
        {
