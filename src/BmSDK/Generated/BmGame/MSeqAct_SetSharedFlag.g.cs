...
public partial class MSeqAct_SetSharedFlag : BmSDK.Engine.SeqAct_SetSequenceVariable, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MSeqAct_SetSharedFlag.
    /// </summary>
    public static MSeqAct_SetSharedFlag DefaultObject => (MSeqAct_SetSharedFlag)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MSeqAct_SetSharedFlag>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MSeqAct_SetSharedFlag>, new()
