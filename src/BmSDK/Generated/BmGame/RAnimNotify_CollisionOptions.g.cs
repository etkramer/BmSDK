...
public partial class RAnimNotify_CollisionOptions : BmSDK.Engine.AnimNotify, BmSDK.IGameObject
{
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_CollisionOptions>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_CollisionOptions>, new()
    ...
    /// </summary>
    public unsafe ref BmSDK.Engine.AnimSequence.FAnimCollisionOptions CollisionOptions
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.AnimSequence.FAnimCollisionOptions>(Ptr + 84);
}
