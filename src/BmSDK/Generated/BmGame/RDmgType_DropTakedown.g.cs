...
public partial class RDmgType_DropTakedown : BmSDK.BmGame.RDmgType_Takedown, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_DropTakedown.
    /// </summary>
    public static RDmgType_DropTakedown DefaultObject => (RDmgType_DropTakedown)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_DropTakedown>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_DropTakedown>, new()
