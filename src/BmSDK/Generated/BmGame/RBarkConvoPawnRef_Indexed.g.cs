...
public partial class RBarkConvoPawnRef_Indexed : BmSDK.BmGame.RBarkConvoPawnRef, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBarkConvoPawnRef_Indexed.
    /// </summary>
    public static RBarkConvoPawnRef_Indexed DefaultObject => (RBarkConvoPawnRef_Indexed)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBarkConvoPawnRef_Indexed>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBarkConvoPawnRef_Indexed>, new()
