...
public partial class RBMSeqEvent_StartleKnockedThugOut : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMSeqEvent_StartleKnockedThugOut.
    /// </summary>
    public static RBMSeqEvent_StartleKnockedThugOut DefaultObject => (RBMSeqEvent_StartleKnockedThugOut)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMSeqEvent_StartleKnockedThugOut>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMSeqEvent_StartleKnockedThugOut>, new()
