...
public partial class RAEC_Casualty_Sub_MedicBusyQuickDismiss : BmSDK.BmGame.RAEC_Casualty_Sub_Solo, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RAEC_Casualty_Sub_MedicBusyQuickDismiss(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RAEC_Casualty_Sub_MedicBusyQuickDismiss Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
