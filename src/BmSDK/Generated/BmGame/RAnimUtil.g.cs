...
public partial class RAnimUtil : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Constructs a new RAnimUtil
    /// </summary>
    public RAnimUtil(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RAnimUtil Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
    ...
    public unsafe static BmSDK.BmGame.RAnimUtil.FMeetingPoints GetMeetingPoints(float Begin, float End)
    {
        ...
        return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil.FMeetingPoints>(paramsPtr + 8);
    }
    ...
    {
        /// <summary>
        /// StructProperty: BeginRotation
        /// </summary>
        public unsafe System.Numerics.Vector3 BeginRotation
        {
        ...
        /// </summary>
        public unsafe System.Numerics.Vector3 EndRotation
        {
        ...
        /// <summary>
        /// StructProperty: BeginTranslation
        /// </summary>
        public unsafe System.Numerics.Vector3 BeginTranslation
        {
        ...
        /// <summary>
        /// StructProperty: EndTranslation
        /// </summary>
        public unsafe System.Numerics.Vector3 EndTranslation
        {
    ...
    public partial record struct FRelativeTarget
    {
        ...
        /// <summary>
        /// ByteProperty: AnimSource
        /// </summary>
        public unsafe BmSDK.BmGame.RAnimUtil.ERelativeTargetAnimSource AnimSource
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil.ERelativeTargetAnimSource>(Ptr + 40); }; }
    ...
    public enum ERelativeTargetAnimSource
    {
        ...
        RTAS_AnimOrigin = 1,
        RTAS_AnimBegin_SkelComponent = 2,
        RTAS_AnimEnd_SkelComponent = 3,
        RTAS_AnimBegin_Actor = 4,
        RTAS_AnimEnd_Actor = 5,
        RTAS_MAX = 6,
    }
    ...
    public partial record struct FCyclePhase
    {
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.RAutomaticTransitions.EFootSyncPoint>(Ptr + 0); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 0); }; }
        }
    ...
    public partial record struct FAnimTarget
    {
        ...
        /// <summary>
        /// BoolProperty: EnableActor
        /// </summary>
        public unsafe bool EnableActor
        {
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil.EAbsoluteOrRelative>(Ptr + 32); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 32); }; }
        }
    ...
    public enum ERootBoneSubtractionMode
    {
        ...
        RBSM_ZeroAllFramesLerp = 3,
        RBSM_ZeroAllFramesLerpRotation = 4,
        RBSM_Linear = 5,
        RBSM_MAX = 6,
    }
    ...
    public partial record struct FProportionalMotion
    {
        ...
        /// <summary>
        /// StructProperty: TranslationProportion
        /// </summary>
        public unsafe System.Numerics.Vector3 TranslationProportion
        {
        ...
        /// <summary>
        /// StructProperty: RotationProportion
        /// </summary>
        public unsafe System.Numerics.Vector3 RotationProportion
        {
        ...
        /// <summary>
        /// ObjectProperty: DrivingActor
        /// </summary>
        public unsafe BmSDK.Engine.Actor DrivingActor
        {
        ...
        /// <summary>
        /// ComponentProperty: DrivingComponent
        /// </summary>
        public unsafe BmSDK.Engine.PrimitiveComponent DrivingComponent
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.PrimitiveComponent>(Ptr + 60); }; }
    ...
    public partial record struct FResolvedAnimConfig
    {
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.RAimingConfig>(Ptr + 16); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 16); }; }
        }
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RResolvedDirectionalAnimConfig>(Ptr + 24); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 24); }; }
        }
        ...
        /// <summary>
        /// BoolProperty: ModelspaceUpperBody
        /// </summary>
        public unsafe bool ModelspaceUpperBody
        {
    ...
    public partial record struct FRagdollIndices
    {
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<int>>(Ptr + 64); }; }
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<int>>(Ptr + 112); }; }
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<int>>(Ptr + 128); }; }
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<int>>(Ptr + 144); }; }
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<int>>(Ptr + 160); }; }
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<int>>(Ptr + 176); }; }
