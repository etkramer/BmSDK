...
public partial class RNavMeshGoal_WithinVolume : BmSDK.Engine.NavMeshPathGoalEvaluator, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RNavMeshGoal_WithinVolume.
    /// </summary>
    public static RNavMeshGoal_WithinVolume DefaultObject => (RNavMeshGoal_WithinVolume)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RNavMeshGoal_WithinVolume>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RNavMeshGoal_WithinVolume>, new()
