...
public partial class RBatSignalBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RBatSignalBase", false);
    ...
    /// <summary>
    /// Gets the class default object as RBatSignalBase.
    /// </summary>
    public static RBatSignalBase DefaultObject => (RBatSignalBase)StaticClass().DefaultObject;

    internal RBatSignalBase() { }

    /// <summary>
    /// Constructs a new RBatSignalBase
    /// </summary>
    public RBatSignalBase(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RBatSignalBase(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBatSignalBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBatSignalBase>, new()
    ...
    /// <summary>
    /// BoolProperty: WantFadeIn
    /// </summary>
    public unsafe bool WantFadeIn
    {
    ...
    /// <summary>
    /// BoolProperty: WasTooCloseToRotate
    /// </summary>
    public unsafe bool WasTooCloseToRotate
    {
    ...
    /// <summary>
    /// FloatProperty: FadeInDelay
    /// </summary>
    public unsafe float FadeInDelay
    {
    ...
    /// <summary>
    /// FloatProperty: ConeZScale
    /// </summary>
    public unsafe float ConeZScale
    {
    ...
    /// <summary>
    /// ArrayProperty: MaterialInstances
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.Engine.MaterialInstanceConstant> MaterialInstances
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.MaterialInstanceConstant>>(Ptr + 448); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 448); }
    }

    /// <summary>
    /// ArrayProperty: StaticMeshes
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.Engine.StaticMeshComponent> StaticMeshes
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.StaticMeshComponent>>(Ptr + 460); }
    ...
    /// <summary>
    /// FloatProperty: DistForMinScale
    /// </summary>
    public unsafe float DistForMinScale
    {
    ...
    /// <summary>
    /// FloatProperty: DistForMaxScale
    /// </summary>
    public unsafe float DistForMaxScale
    {
