...
public partial class RSpecialMoveConfig_PullDriverFromCar : BmSDK.BmGame.RSpecialMoveConfig_RelativeAnimMove, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_PullDriverFromCar.
    /// </summary>
    public static RSpecialMoveConfig_PullDriverFromCar DefaultObject => (RSpecialMoveConfig_PullDriverFromCar)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_PullDriverFromCar>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_PullDriverFromCar>, new()
    ...
    /// </summary>
    public unsafe ref BmSDK.Rotator FlipRotationOffet
