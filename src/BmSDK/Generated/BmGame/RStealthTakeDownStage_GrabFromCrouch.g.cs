...
public partial class RStealthTakeDownStage_GrabFromCrouch : BmSDK.BmGame.RStealthTakeDownStage, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RStealthTakeDownStage_GrabFromCrouch(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RStealthTakeDownStage_GrabFromCrouch Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
