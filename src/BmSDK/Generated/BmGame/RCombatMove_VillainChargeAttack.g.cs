...
public partial class RCombatMove_VillainChargeAttack : BmSDK.BmGame.RCombatMove_VillainAttack, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_VillainChargeAttack.
    /// </summary>
    public static RCombatMove_VillainChargeAttack DefaultObject => (RCombatMove_VillainChargeAttack)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe virtual void PlayChargeBark()
    {
    ...
    /// </summary>
    public unsafe virtual bool CanTargetBeGrabbed()
    {
    ...
    /// </summary>
    public unsafe virtual bool IsInGrabRange(float TestRange, System.Numerics.Vector3 TestLoc)
    {
    ...
    /// </summary>
    public unsafe virtual bool TryPlayWallSmash(System.Numerics.Vector3 WallLoc, System.Numerics.Vector3 WallNormal)
    {
    ...
    /// </summary>
    public unsafe virtual void PlayStopAnim()
    {
    ...
    /// </summary>
    public unsafe virtual void TargettedByProjectile()
    {
    ...
    /// </summary>
    public unsafe virtual void ChargeContact()
    {
    ...
    /// Function: ImpactWall
    /// </summary>
    public unsafe virtual void ImpactWall()
    {
    ...
    /// </summary>
    public unsafe virtual void ChargeStart()
    {
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId VillainInAnimId
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId>(Ptr + 808);

    /// <summary>
    /// StructProperty: TargetAnimID
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId TargetAnimID
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId>(Ptr + 812);
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 GrabStartLoc
    ...
    public unsafe ref BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct ImpactScreenShake
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct>(Ptr + 900);
}
