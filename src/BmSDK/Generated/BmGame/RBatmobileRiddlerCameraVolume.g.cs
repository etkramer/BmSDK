...
public partial class RBatmobileRiddlerCameraVolume : BmSDK.Engine.Volume, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBatmobileRiddlerCameraVolume.
    /// </summary>
    public static RBatmobileRiddlerCameraVolume DefaultObject => (RBatmobileRiddlerCameraVolume)StaticClass().DefaultObject;
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RBatmobileRiddlerCameraVolume.UnTouch", true);
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RBatmobileRiddlerCameraVolume.Touch", true);
