...
public partial class RSeqEvent_BatmobileFailedToRoute : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_BatmobileFailedToRoute.
    /// </summary>
    public static RSeqEvent_BatmobileFailedToRoute DefaultObject => (RSeqEvent_BatmobileFailedToRoute)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_BatmobileFailedToRoute>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_BatmobileFailedToRoute>, new()
