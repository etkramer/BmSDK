...
/// <summary>
/// Class: RAEC_MissingHostage<br/>
/// (size = 468)
/// (flags = 8388626)
/// </summary>
public partial class RAEC_MissingHostage : BmSDK.BmGame.RAlertEventCoordinatorBase, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RAEC_MissingHostage", false);
    ...
    /// <summary>
    /// Constructs a new RAEC_MissingHostage
    /// </summary>
    public RAEC_MissingHostage(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RAEC_MissingHostage(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAEC_MissingHostage>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAEC_MissingHostage>, new()
    ...
    public unsafe virtual void PlayMissingHostageBark(int NumMissing)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(NumMissing, paramsPtr + 0);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    /// <summary>
    /// ObjectProperty: LookCon
    /// </summary>
    public unsafe BmSDK.BmGame.RBMAIController LookCon
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RMissingHostageAIMarker MissingPoint
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RMissingHostageAIMarker>(Ptr + 456); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 456); }
    }

    /// <summary>
    /// FloatProperty: LookTimer
    /// </summary>
    public unsafe float LookTimer
    {
