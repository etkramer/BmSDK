...
public partial class RDmgType_DualTakedown : BmSDK.BmGame.RDmgType_CombatTakedown, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_DualTakedown.
    /// </summary>
    public static RDmgType_DualTakedown DefaultObject => (RDmgType_DualTakedown)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_DualTakedown>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_DualTakedown>, new()
