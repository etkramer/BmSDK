...
public partial class RSeqAct_IsDefaultPlayerSkin : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_IsDefaultPlayerSkin.
    /// </summary>
    public static RSeqAct_IsDefaultPlayerSkin DefaultObject => (RSeqAct_IsDefaultPlayerSkin)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_IsDefaultPlayerSkin>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_IsDefaultPlayerSkin>, new()
