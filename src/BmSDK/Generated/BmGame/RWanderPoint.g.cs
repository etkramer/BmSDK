...
public partial class RWanderPoint : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RWanderPoint(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RWanderPoint Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
