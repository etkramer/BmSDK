...
public partial class RSeqAct_FireFPSGunDuringMatinee : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_FireFPSGunDuringMatinee.
    /// </summary>
    public static RSeqAct_FireFPSGunDuringMatinee DefaultObject => (RSeqAct_FireFPSGunDuringMatinee)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_FireFPSGunDuringMatinee>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_FireFPSGunDuringMatinee>, new()
