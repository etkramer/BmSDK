...
public partial class RBMScout : BmSDK.Engine.Scout, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBMScout(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMScout Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
