...
public partial class RBreakableDemonSealBase : BmSDK.BmGame.RHarpoonTriggerBase, BmSDK.BmGame.RSecretInterface, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBreakableDemonSealBase(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBreakableDemonSealBase Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
