...
public partial class RSeqAct_SetRandomPopulationBase : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SetRandomPopulationBase.
    /// </summary>
    public static RSeqAct_SetRandomPopulationBase DefaultObject => (RSeqAct_SetRandomPopulationBase)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetRandomPopulationBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetRandomPopulationBase>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RSeqAct_SetRandomPopulationBase.GetObjClassVersion", true);
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RSeqAct_SetRandomPopulationBase.FWanderingData WandererData
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RSeqAct_SetRandomPopulationBase.FWanderingData>(Ptr + 384);

    /// <summary>
    /// StructProperty: RiotWeaponData
    /// </summary>
    public unsafe ref BmSDK.BmGame.RSeqAct_SetRandomPopulationBase.FRiotWeapons RiotWeaponData
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RSeqAct_SetRandomPopulationBase.FRiotWeapons>(Ptr + 392);
