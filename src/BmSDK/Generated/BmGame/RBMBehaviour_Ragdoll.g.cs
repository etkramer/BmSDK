...
public partial class RBMBehaviour_Ragdoll : BmSDK.BmGame.RBMBehaviour, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe virtual float GetGetupTimerStartTime()
    {
    ...
    /// </summary>
    public unsafe virtual void EmergencyDampRagdoll()
    {
    ...
    /// </summary>
    public unsafe virtual bool IsUnderBatmobile()
    {
    ...
    /// </summary>
    public unsafe override float GetEstimatedDoingSomethingDangerousTime()
    {
    ...
    public unsafe ref BmSDK.BmGame.RPawnCombat.FDamageInfo WritheDmgInfo
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RPawnCombat.FDamageInfo>(Ptr + 620);
