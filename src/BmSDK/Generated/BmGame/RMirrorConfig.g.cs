...
public partial class RMirrorConfig : BmSDK.BmGame.RConfig, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RMirrorConfig", false);
    ...
    /// <summary>
    /// Constructs a new RMirrorConfig
    /// </summary>
    public RMirrorConfig(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RMirrorConfig Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RMirrorConfig(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RMirrorConfig>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RMirrorConfig>, new()
    ...
    /// ArrayProperty: Bones
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.BmGame.RMirrorConfig.FNamedMirror> Bones
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.BmGame.RMirrorConfig.FNamedMirror>>(Ptr + 44); }
    ...
    {
        /// <summary>
        /// NameProperty: DestBone
        /// </summary>
        public unsafe BmSDK.FName DestBone
        {
        ...
        /// <summary>
        /// NameProperty: SourceBone
        /// </summary>
        public unsafe BmSDK.FName SourceBone
        {
    ...
    {
        /// <summary>
        /// BoolProperty: FlipRotationX
        /// </summary>
        public unsafe bool FlipRotationX
        {
        ...
        /// <summary>
        /// BoolProperty: FlipRotationY
        /// </summary>
        public unsafe bool FlipRotationY
        {
        ...
        /// <summary>
        /// BoolProperty: FlipRotationZ
        /// </summary>
        public unsafe bool FlipRotationZ
        {
        ...
        /// <summary>
        /// BoolProperty: FlipTranslationX
        /// </summary>
        public unsafe bool FlipTranslationX
        {
        ...
        /// <summary>
        /// BoolProperty: FlipTranslationZ
        /// </summary>
        public unsafe bool FlipTranslationZ
        {
        ...
        /// <summary>
        /// BoolProperty: Rotate180X
        /// </summary>
        public unsafe bool Rotate180X
        {
