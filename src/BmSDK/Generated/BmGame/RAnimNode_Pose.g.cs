...
public partial class RAnimNode_Pose : BmSDK.Engine.AnimNode, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe void DisableGlobalAdditiveAnim()
    {
    ...
    /// </summary>
    public unsafe void SetGlobalAdditiveAnim(BmSDK.Engine.AnimSequence AddAnim, BmSDK.Engine.AnimSequence SubtractAnim, float Time, float Weight)
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimConfig.FCustomAdditiveAnimConfig GetAdditiveAnim(BmSDK.FName AnimName, BmSDK.FName BaseAnimName, BmSDK.Engine.AnimSet Set, BmSDK.TArray<BmSDK.Engine.AnimSet> ExtraSets, float Weight, float HideWeight)
    {
    ...
    /// </summary>
    public unsafe bool IsValidAnim(BmSDK.FName AnimName, BmSDK.Engine.AnimSet Set, BmSDK.TArray<BmSDK.Engine.AnimSet> ExtraSets = default)
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimConfig.FCustomAnimConfig GetFullBodyAnim(BmSDK.FName AnimName, BmSDK.Engine.AnimSet Set, BmSDK.TArray<BmSDK.Engine.AnimSet> ExtraSets, BmSDK.BmGame.RAimingConfig AimingConfig, BmSDK.BmGame.RPresetAimingConfigs.EPresetAimingConfig PresetAimingConfig = default)
    {
    ...
    /// </summary>
    public unsafe void PushRagdollOn(BmSDK.FName Description, float MotorWeight, float BlendInDuration, float BlendOutDuration, BmSDK.TArray<BmSDK.FName> FixedBodies)
    {
    ...
    /// </summary>
    public unsafe void GetThoughts(BmSDK.BmGame.RPersistentDebugData.FPerCharacterTypeAnimDebug Options, out BmSDK.TArray<BmSDK.Engine.Actor.FThought> OutThoughts)
    {
    ...
    /// </summary>
    public unsafe void SetAdditiveAnimStateOnAll(int Index, float Time, float Weight)
    {
    ...
    /// </summary>
    public unsafe void SetAdditiveAnimState(int Index, float Time, float Weight)
    {
    ...
    /// </summary>
    public unsafe bool GetTransitionActorPosition(BmSDK.BmGame.RAnimConfig.FCustomAnimConfig Anim, float Time, System.Numerics.Vector3 WorldReferencePosition, int WorldReferenceYaw, bool Mirrored, out System.Numerics.Vector3 Out_Position, out BmSDK.Rotator out_Rotation)
    {
    ...
    /// </summary>
    public unsafe float GetMeetingPointTranslationXPercent(BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId Id)
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_OverlayPlayer.FOverlayId PlayAdditiveOverlay(BmSDK.BmGame.RAnimConfig.FCustomAdditiveAnimConfig Anim, float StartTime = default)
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_OverlayPlayer.FOverlayId PlayIdleOverlay(BmSDK.FName OverlayName, BmSDK.BmGame.RAnimConfig.FCustomAnimConfig OverrideAnim = default, float StartTime = default)
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_OverlayPlayer.FOverlayId PlayWeaponOverlay(BmSDK.FName OverlayName, BmSDK.BmGame.RAnimConfig.FCustomAnimConfig OverrideAnim = default, float StartTime = default)
    {
    ...
    /// Function: AimAtActor
    /// </summary>
    public unsafe void AimAtActor(BmSDK.Engine.Actor Actor, BmSDK.FName Description, BmSDK.FName ActorBoneName = default, BmSDK.BmGame.RAnimConfig.EYesNoDefault AllowTurningToAim = default, float LimitScale = default)
    {
    ...
    /// Function: AimAt
    /// </summary>
    public unsafe void AimAt(System.Numerics.Vector3 Position, BmSDK.FName Description, BmSDK.BmGame.RAnimUtil.EAbsoluteOrRelative Space, BmSDK.BmGame.RAnimConfig.EYesNoDefault AllowTurningToAim = default, float LimitScale = default)
    {
    ...
    /// </summary>
    public unsafe void PlayOneShotMovementCycle(BmSDK.BmGame.RAnimConfig.FCustomAnimConfig AnimConfig)
    {
    ...
    /// </summary>
    public unsafe float GetAnimMovementSpeed(BmSDK.Engine.AnimSequence Sequence)
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RPoseConfig.EMovementSpeed GetMovementSpeed()
    {
    ...
    /// </summary>
    public unsafe void SetMovementSpeed(BmSDK.BmGame.RPoseConfig.EMovementSpeed NewSpeed, float NewSpeedScale)
    {
    ...
    /// </summary>
    public unsafe BmSDK.Rotator GetTransitionTargetRotation()
    {
    ...
    /// </summary>
    public unsafe int GetTransitionTargetYaw()
    {
    ...
    /// </summary>
    public unsafe System.Numerics.Vector3 GetTransitionTargetPosition()
    {
    ...
    /// </summary>
    public unsafe void SetIdleTargetRotation(BmSDK.Rotator NewRotation)
    {
    ...
    /// </summary>
    public unsafe void SetIdleTargetYaw(int NewYaw)
    {
    ...
    /// </summary>
    public unsafe void SetIdleTargetPosition(System.Numerics.Vector3 NewPosition)
    {
    ...
    /// </summary>
    public unsafe void SetTransitionTargetRotation(BmSDK.Rotator NewRotation)
    {
    ...
    /// </summary>
    public unsafe void SetTransitionTargetYaw(int NewYaw)
    {
    ...
    /// </summary>
    public unsafe void SetTransitionTargetPosition(System.Numerics.Vector3 NewPosition)
    {
    ...
    /// </summary>
    public unsafe void OverrideTransitionTime(float NormalizedTime, int DisableTimeAdvanceForNumFrames = default)
    {
    ...
    /// </summary>
    public unsafe void UpdateMatineeMovementTarget(System.Numerics.Vector3 TargetLocation, BmSDK.Rotator TargetRotation)
    {
    ...
    /// </summary>
    public unsafe void UpdateMatineeAnim(BmSDK.FName AnimName, float Time, bool FireNotifies, bool Looping)
    {
    ...
    /// </summary>
    public unsafe void DummyOnPlayedQueuedTransition(BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId Id)
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimNode_Pose.FEditorNonsense>(Ptr + 216); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimNode_Pose.FEditorNonsense>(Ptr + 324); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimNode_Pose.FCurveFloatState>(Ptr + 440); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPoseConfig.FMoveToConfig>(Ptr + 452); }
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil.FAnimSequenceFinder Finder
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil.FAnimSequenceFinder>(Ptr + 456); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_PosePlayer.FPosePlayer>(Ptr + 560); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_MovementPlayer.FMovementPlayer>(Ptr + 1492); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_MovementOutput.FMovementOutput>(Ptr + 1588); }
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_Layers.FFallLandLayer FallLandLayer
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_Layers.FFallLandLayer>(Ptr + 1684); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_OverlayPlayer.FOverlayPlayer>(Ptr + 1696); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_OverlayPlayer.FOverlayPlayer>(Ptr + 2028); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_OverlayPlayer.FAdditiveOverlayPlayer>(Ptr + 2360); }
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_OverlayPlayer.FRandomOverlayPlayer RandomIdleOverlays
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_OverlayPlayer.FRandomOverlayPlayer>(Ptr + 2780); }
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil.FAnimConstants AnimConstants
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil.FAnimConstants>(Ptr + 2820); }
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_AnimOutput.FAnimOutput AnimOutput
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_AnimOutput.FAnimOutput>(Ptr + 3312); }
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_AdditiveAnimOutput.FAdditiveAnimOutput AdditiveAnimOutput
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_AdditiveAnimOutput.FAdditiveAnimOutput>(Ptr + 6288); }
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_AimingOutput.FAimingOutputInput AimingOutputInput
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_AimingOutput.FAimingOutputInput>(Ptr + 9392); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 9392); }
    }

    /// <summary>
    /// StructProperty: AimingOutput
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil_AimingOutput.FAimingOutput AimingOutput
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil_AimingOutput.FAimingOutput>(Ptr + 9404); }
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil.FPersistentThoughts NotifyThoughts
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil.FPersistentThoughts>(Ptr + 9476); }
    ...
    /// </summary>
    public unsafe BmSDK.Rotator PreviousRotation
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Rotator>(Ptr + 9512); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 9512); }
    }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimNode_Pose.FBreathingState>(Ptr + 9532); }
    ...
    /// </summary>
    public unsafe BmSDK.GameObject.FMatrix HeadMatrix
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.GameObject.FMatrix>(Ptr + 9552); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 9552); }
    }
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimUtil.FPersistentThoughts PoseLog
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil.FPersistentThoughts>(Ptr + 9620); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 9620); }
    }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimUtil.FNotifyAnim>(Ptr + 9680); }
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAnimNode_Pose.FGlobalAdditiveAnimState GlobalAdditiveAnim
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimNode_Pose.FGlobalAdditiveAnimState>(Ptr + 9700); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 9700); }
    }
