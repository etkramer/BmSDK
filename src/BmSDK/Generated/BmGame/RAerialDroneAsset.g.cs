...
public partial class RAerialDroneAsset : BmSDK.BmGame.RThreatBaseAsset, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAerialDroneAsset.
    /// </summary>
    public static RAerialDroneAsset DefaultObject => (RAerialDroneAsset)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAerialDroneAsset>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAerialDroneAsset>, new()
