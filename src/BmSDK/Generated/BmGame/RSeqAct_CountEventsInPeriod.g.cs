...
public partial class RSeqAct_CountEventsInPeriod : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_CountEventsInPeriod.
    /// </summary>
    public static RSeqAct_CountEventsInPeriod DefaultObject => (RSeqAct_CountEventsInPeriod)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_CountEventsInPeriod>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_CountEventsInPeriod>, new()
