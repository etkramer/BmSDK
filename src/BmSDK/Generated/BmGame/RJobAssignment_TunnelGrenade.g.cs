...
public partial class RJobAssignment_TunnelGrenade : BmSDK.BmGame.RJobAssignment, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RJobAssignment_TunnelGrenade.
    /// </summary>
    public static RJobAssignment_TunnelGrenade DefaultObject => (RJobAssignment_TunnelGrenade)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RJobAssignment_TunnelGrenade>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RJobAssignment_TunnelGrenade>, new()
