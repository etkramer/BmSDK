...
public partial class RBMBehaviour_ControlledByVehicle : BmSDK.BmGame.RBMBehaviour_Controlled, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_ControlledByVehicle.
    /// </summary>
    public static RBMBehaviour_ControlledByVehicle DefaultObject => (RBMBehaviour_ControlledByVehicle)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_ControlledByVehicle>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_ControlledByVehicle>, new()
