...
public partial class RSeqAct_SetVehicleNPCWeaponScripted : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SetVehicleNPCWeaponScripted.
    /// </summary>
    public static RSeqAct_SetVehicleNPCWeaponScripted DefaultObject => (RSeqAct_SetVehicleNPCWeaponScripted)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetVehicleNPCWeaponScripted>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetVehicleNPCWeaponScripted>, new()
