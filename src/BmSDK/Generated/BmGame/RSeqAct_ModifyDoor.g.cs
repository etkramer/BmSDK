...
public partial class RSeqAct_ModifyDoor : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_ModifyDoor.
    /// </summary>
    public static RSeqAct_ModifyDoor DefaultObject => (RSeqAct_ModifyDoor)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ModifyDoor>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ModifyDoor>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RSeqAct_ModifyDoor.GetObjClassVersion", true);
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RGameRI.FDebugSaveDescription SaveGameDescription
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RGameRI.FDebugSaveDescription>(Ptr + 352);
