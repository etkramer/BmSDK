...
/// <summary>
/// Class: RBMAIAction_PostGrenadeTunnelLook<br/>
/// (flags = 0)
/// </summary>
public partial class RBMAIAction_PostGrenadeTunnelLook : BmSDK.BmGame.RBMAIAction, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RBMAIAction_PostGrenadeTunnelLook", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RBMAIAction_PostGrenadeTunnelLook() { }

    /// <summary>
    /// Constructs a new RBMAIAction_PostGrenadeTunnelLook
    /// </summary>
    public RBMAIAction_PostGrenadeTunnelLook(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMAIAction_PostGrenadeTunnelLook Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RBMAIAction_PostGrenadeTunnelLook(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMAIAction_PostGrenadeTunnelLook>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMAIAction_PostGrenadeTunnelLook>, new()
    ...
    /// </summary>
    public unsafe System.Numerics.Vector3 grateLoc
    {
