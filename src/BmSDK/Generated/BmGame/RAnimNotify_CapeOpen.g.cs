...
public partial class RAnimNotify_CapeOpen : BmSDK.Engine.AnimNotify, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAnimNotify_CapeOpen.
    /// </summary>
    public static RAnimNotify_CapeOpen DefaultObject => (RAnimNotify_CapeOpen)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_CapeOpen>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_CapeOpen>, new()
