...
public partial class RBatmobileEMPMissile : BmSDK.BmGame.RPursuitModeMissileLauncher, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBatmobileEMPMissile.
    /// </summary>
    public static RBatmobileEMPMissile DefaultObject => (RBatmobileEMPMissile)StaticClass().DefaultObject;
    ...
    public unsafe virtual void SwitchLockOnTarget(System.Numerics.Vector3 WorldDirection)
    {
        ...
        byte* paramsPtr = stackalloc byte[12];
        BmSDK.Framework.MarshalUtil.ToUnmanaged(WorldDirection, paramsPtr + 0);
        var oldFlags = funcManaged.FunctionFlags;
        var oldNative = funcManaged.iNative;
        funcManaged.FunctionFlags &= ~BmSDK.Function.EFunctionFlags.FUNC_Native;
        funcManaged.FunctionFlags |= BmSDK.Function.EFunctionFlags.FUNC_Defined;
    ...
    public unsafe virtual void SetLockOnTarget(BmSDK.BmGame.RVehicleNPC VehTarget)
    {
        ...
        byte* paramsPtr = stackalloc byte[16];
        BmSDK.Framework.MarshalUtil.ToUnmanaged(VehTarget, paramsPtr + 0);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    public unsafe virtual bool FireMissile(System.Numerics.Vector3 FireDir)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(FireDir, paramsPtr + 0);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
    ...
    /// <summary>
    /// Enum: EMissileAnimState
    /// </summary>
    public enum EMissileAnimState : byte
    {
        EMAS_Down = 0,
        EMAS_GoingUp = 1,
        EMAS_Up = 2,
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 TargetScreenLoc
