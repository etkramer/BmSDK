...
public partial class RDmgType_RagdollNoStars : BmSDK.BmGame.RDmgType_Ragdoll, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_RagdollNoStars.
    /// </summary>
    public static RDmgType_RagdollNoStars DefaultObject => (RDmgType_RagdollNoStars)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_RagdollNoStars>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_RagdollNoStars>, new()
