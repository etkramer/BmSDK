...
public partial class RDmgType_BeatDownCriticalEnd : BmSDK.BmGame.RDmgType_BeatDownEnd, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_BeatDownCriticalEnd.
    /// </summary>
    public static RDmgType_BeatDownCriticalEnd DefaultObject => (RDmgType_BeatDownCriticalEnd)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_BeatDownCriticalEnd>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_BeatDownCriticalEnd>, new()
