...
/// <summary>
/// Class: RAEC_Search_CornerGroup<br/>
/// (size = 456)
/// (flags = 8388626)
/// </summary>
public partial class RAEC_Search_CornerGroup : BmSDK.BmGame.RAEC_SubGroup, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RAEC_Search_CornerGroup", false);
    ...
    /// <summary>
    /// Constructs a new RAEC_Search_CornerGroup
    /// </summary>
    public RAEC_Search_CornerGroup(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RAEC_Search_CornerGroup(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAEC_Search_CornerGroup>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAEC_Search_CornerGroup>, new()
    ...
    public unsafe virtual void SetLeaderFromSearch(BmSDK.BmGame.RBMAIController NewLeader, BmSDK.BmGame.RAEC_Search_Sub.FRestoreSearchState OldState, BmSDK.BmGame.RCornerWallMarker StartCorner, BmSDK.BmGame.RCornerWallMarker EndCorner)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(StartCorner, paramsPtr + 32);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(EndCorner, paramsPtr + 36);
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RAEC_Search_Sub_CornerLead LeaderSubAEC
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAEC_Search_Sub_CornerLead>(Ptr + 452); }
