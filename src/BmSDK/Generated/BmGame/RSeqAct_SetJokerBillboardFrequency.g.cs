...
public partial class RSeqAct_SetJokerBillboardFrequency : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SetJokerBillboardFrequency.
    /// </summary>
    public static RSeqAct_SetJokerBillboardFrequency DefaultObject => (RSeqAct_SetJokerBillboardFrequency)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetJokerBillboardFrequency>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetJokerBillboardFrequency>, new()
