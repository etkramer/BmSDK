...
public partial class RCharacter_PDLC_HarleyThugBase : BmSDK.BmGame.RCharacter, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCharacter_PDLC_HarleyThugBase.
    /// </summary>
    public static RCharacter_PDLC_HarleyThugBase DefaultObject => (RCharacter_PDLC_HarleyThugBase)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCharacter_PDLC_HarleyThugBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCharacter_PDLC_HarleyThugBase>, new()
