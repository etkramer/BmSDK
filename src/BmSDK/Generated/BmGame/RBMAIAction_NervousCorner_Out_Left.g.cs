...
public partial class RBMAIAction_NervousCorner_Out_Left : BmSDK.BmGame.RBMAIAction_NervousCorner_Out, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMAIAction_NervousCorner_Out_Left.
    /// </summary>
    public static RBMAIAction_NervousCorner_Out_Left DefaultObject => (RBMAIAction_NervousCorner_Out_Left)StaticClass().DefaultObject;
