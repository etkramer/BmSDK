...
public partial class RBMAIAction_RestoreMines : BmSDK.BmGame.RBMAIAction_RestoreSpecial, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBMAIAction_RestoreMines(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMAIAction_RestoreMines Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
