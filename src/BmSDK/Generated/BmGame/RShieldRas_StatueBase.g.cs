...
public partial class RShieldRas_StatueBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RShieldRas_StatueBase.
    /// </summary>
    public static RShieldRas_StatueBase DefaultObject => (RShieldRas_StatueBase)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RShieldRas_StatueBase(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
