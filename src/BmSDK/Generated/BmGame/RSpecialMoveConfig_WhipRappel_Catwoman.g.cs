...
public partial class RSpecialMoveConfig_WhipRappel_Catwoman : BmSDK.BmGame.RSpecialMoveConfig, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_WhipRappel_Catwoman.
    /// </summary>
    public static RSpecialMoveConfig_WhipRappel_Catwoman DefaultObject => (RSpecialMoveConfig_WhipRappel_Catwoman)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_WhipRappel_Catwoman>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_WhipRappel_Catwoman>, new()
