...
public partial class MAEC_Sub_AttractEnemiesToLocation : BmSDK.BmGame.RAlertEventCoordinatorSolo, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MAEC_Sub_AttractEnemiesToLocation.
    /// </summary>
    public static MAEC_Sub_AttractEnemiesToLocation DefaultObject => (MAEC_Sub_AttractEnemiesToLocation)StaticClass().DefaultObject;
