...
public partial class RSeqAct_AudioCombatNotify : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_AudioCombatNotify.
    /// </summary>
    public static RSeqAct_AudioCombatNotify DefaultObject => (RSeqAct_AudioCombatNotify)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_AudioCombatNotify>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_AudioCombatNotify>, new()
    ...
    /// </summary>
    public enum R_ShowInEditor_AudioCombNotify : byte
    {
