...
public partial class RVehicleBehaviour_FlyingGuard : BmSDK.BmGame.RVehicleBehaviour, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RVehicleBehaviour_FlyingGuard.
    /// </summary>
    public static RVehicleBehaviour_FlyingGuard DefaultObject => (RVehicleBehaviour_FlyingGuard)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_FlyingGuard>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_FlyingGuard>, new()
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 FlyerOriginalTargetPoint
