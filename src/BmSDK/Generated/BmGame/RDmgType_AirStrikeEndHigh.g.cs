...
public partial class RDmgType_AirStrikeEndHigh : BmSDK.BmGame.RDmgType_AirStrikeEnd, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_AirStrikeEndHigh.
    /// </summary>
    public static RDmgType_AirStrikeEndHigh DefaultObject => (RDmgType_AirStrikeEndHigh)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_AirStrikeEndHigh>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_AirStrikeEndHigh>, new()
