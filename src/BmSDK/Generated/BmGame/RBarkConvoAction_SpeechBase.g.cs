...
public partial class RBarkConvoAction_SpeechBase : BmSDK.BmGame.RBarkConvoAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBarkConvoAction_SpeechBase.
    /// </summary>
    public static RBarkConvoAction_SpeechBase DefaultObject => (RBarkConvoAction_SpeechBase)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBarkConvoAction_SpeechBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBarkConvoAction_SpeechBase>, new()
