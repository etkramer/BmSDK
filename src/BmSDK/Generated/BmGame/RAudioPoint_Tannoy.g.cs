...
public partial class RAudioPoint_Tannoy : BmSDK.BmGame.RAudioPointController, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RAudioPoint_Tannoy(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RAudioPoint_Tannoy Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
