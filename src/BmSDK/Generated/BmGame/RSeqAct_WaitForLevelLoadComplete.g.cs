...
public partial class RSeqAct_WaitForLevelLoadComplete : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_WaitForLevelLoadComplete.
    /// </summary>
    public static RSeqAct_WaitForLevelLoadComplete DefaultObject => (RSeqAct_WaitForLevelLoadComplete)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_WaitForLevelLoadComplete>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_WaitForLevelLoadComplete>, new()
