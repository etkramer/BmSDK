...
public partial class RCombatMove_BatmanGrabThrownObject : BmSDK.BmGame.RCombatMove_BatmanWeaponAttack, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_BatmanGrabThrownObject.
    /// </summary>
    public static RCombatMove_BatmanGrabThrownObject DefaultObject => (RCombatMove_BatmanGrabThrownObject)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe virtual void AllowWeaponSwitch()
    {
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId IntoGrabAnimID
