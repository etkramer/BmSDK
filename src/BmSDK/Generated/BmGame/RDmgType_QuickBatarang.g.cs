...
public partial class RDmgType_QuickBatarang : BmSDK.BmGame.RDmgType_Batarang, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_QuickBatarang.
    /// </summary>
    public static RDmgType_QuickBatarang DefaultObject => (RDmgType_QuickBatarang)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_QuickBatarang>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_QuickBatarang>, new()
