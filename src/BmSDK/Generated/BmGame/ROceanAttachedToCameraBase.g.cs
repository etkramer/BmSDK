...
/// <summary>
/// Class: ROceanAttachedToCameraBase<br/>
/// (size = 436)
/// (flags = 142606482)
/// </summary>
public partial class ROceanAttachedToCameraBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.ROceanAttachedToCameraBase", false);
    ...
    /// <summary>
    /// Gets the class default object as ROceanAttachedToCameraBase.
    /// </summary>
    public static ROceanAttachedToCameraBase DefaultObject => (ROceanAttachedToCameraBase)StaticClass().DefaultObject;

    internal ROceanAttachedToCameraBase() { }

    /// <summary>
    /// Constructs a new ROceanAttachedToCameraBase
    /// </summary>
    public ROceanAttachedToCameraBase(BmSDK.FName Name = default, System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null, BmSDK.Engine.Level Level = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Name, Location, Rotation, Template, Owner, Instigator, Level)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected ROceanAttachedToCameraBase(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ROceanAttachedToCameraBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ROceanAttachedToCameraBase>, new()
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.ROceanComponent>(Ptr + 432); }
