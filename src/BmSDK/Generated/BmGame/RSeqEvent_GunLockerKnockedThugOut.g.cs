...
public partial class RSeqEvent_GunLockerKnockedThugOut : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_GunLockerKnockedThugOut.
    /// </summary>
    public static RSeqEvent_GunLockerKnockedThugOut DefaultObject => (RSeqEvent_GunLockerKnockedThugOut)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_GunLockerKnockedThugOut>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_GunLockerKnockedThugOut>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RSeqEvent_GunLockerKnockedThugOut.GetObjClassVersion", true);
