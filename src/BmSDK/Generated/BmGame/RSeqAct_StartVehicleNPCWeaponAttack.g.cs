...
public partial class RSeqAct_StartVehicleNPCWeaponAttack : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_StartVehicleNPCWeaponAttack.
    /// </summary>
    public static RSeqAct_StartVehicleNPCWeaponAttack DefaultObject => (RSeqAct_StartVehicleNPCWeaponAttack)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_StartVehicleNPCWeaponAttack>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_StartVehicleNPCWeaponAttack>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RSeqAct_StartVehicleNPCWeaponAttack.GetObjClassVersion", true);
        byte* paramsPtr = stackalloc byte[4];
