...
public partial class RDmgType_ComboBatarang : BmSDK.BmGame.RDmgType_Batarang, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_ComboBatarang.
    /// </summary>
    public static RDmgType_ComboBatarang DefaultObject => (RDmgType_ComboBatarang)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_ComboBatarang>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_ComboBatarang>, new()
