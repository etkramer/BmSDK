...
public partial class RSeqAct_CompletedBatcaveWithBeatdowns : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_CompletedBatcaveWithBeatdowns.
    /// </summary>
    public static RSeqAct_CompletedBatcaveWithBeatdowns DefaultObject => (RSeqAct_CompletedBatcaveWithBeatdowns)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_CompletedBatcaveWithBeatdowns>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_CompletedBatcaveWithBeatdowns>, new()
