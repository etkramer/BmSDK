...
public partial class RSeqAct_SetCombatParams : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SetCombatParams.
    /// </summary>
    public static RSeqAct_SetCombatParams DefaultObject => (RSeqAct_SetCombatParams)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetCombatParams>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetCombatParams>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RSeqAct_SetCombatParams.GetObjClassVersion", true);
    ...
    /// </summary>
    public enum MaxSimultaneousCounterSize : byte
    {
        MSCS_Default = 0,
        MSCS_2Thugs = 1,
        MSCS_3Thugs = 2,
