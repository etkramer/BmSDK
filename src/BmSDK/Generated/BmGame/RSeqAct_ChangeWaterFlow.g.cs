...
public partial class RSeqAct_ChangeWaterFlow : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RSeqAct_ChangeWaterFlow.GetObjClassVersion", true);
