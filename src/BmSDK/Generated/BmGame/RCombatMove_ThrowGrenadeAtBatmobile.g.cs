...
public partial class RCombatMove_ThrowGrenadeAtBatmobile : BmSDK.BmGame.RCombatMove_VillainThrowBrick, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_ThrowGrenadeAtBatmobile.
    /// </summary>
    public static RCombatMove_ThrowGrenadeAtBatmobile DefaultObject => (RCombatMove_ThrowGrenadeAtBatmobile)StaticClass().DefaultObject;
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RCombatMove_ThrowGrenadeAtBatmobile.ExitMove", true);
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RCombatMove_ThrowGrenadeAtBatmobile.Initialise", true);
        byte* paramsPtr = stackalloc byte[0];
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
