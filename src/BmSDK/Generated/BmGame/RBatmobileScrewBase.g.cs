...
public partial class RBatmobileScrewBase : BmSDK.Engine.InterpActor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBatmobileScrewBase.
    /// </summary>
    public static RBatmobileScrewBase DefaultObject => (RBatmobileScrewBase)StaticClass().DefaultObject;
