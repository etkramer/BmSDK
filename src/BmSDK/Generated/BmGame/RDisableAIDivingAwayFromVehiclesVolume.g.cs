...
public partial class RDisableAIDivingAwayFromVehiclesVolume : BmSDK.Engine.Volume, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RDisableAIDivingAwayFromVehiclesVolume", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RDisableAIDivingAwayFromVehiclesVolume() { }

    /// <summary>
    /// Constructs a new RDisableAIDivingAwayFromVehiclesVolume
    /// </summary>
    public RDisableAIDivingAwayFromVehiclesVolume(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RDisableAIDivingAwayFromVehiclesVolume Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RDisableAIDivingAwayFromVehiclesVolume(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDisableAIDivingAwayFromVehiclesVolume>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDisableAIDivingAwayFromVehiclesVolume>, new()
    ...
    /// <summary>
    /// BoolProperty: bInactiveIfBatmobileIsInside
    /// </summary>
    public unsafe bool bInactiveIfBatmobileIsInside
    {
    ...
    /// <summary>
    /// BoolProperty: bActiveBatmobile
    /// </summary>
    public unsafe bool bActiveBatmobile
    {
    ...
    /// <summary>
    /// BoolProperty: bReallyActive
    /// </summary>
    public unsafe bool bReallyActive
    {
