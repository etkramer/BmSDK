...
public partial class RBMAIAction_RunTo : BmSDK.BmGame.RBMAIAction_BaseMove, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMAIAction_RunTo.
    /// </summary>
    public static RBMAIAction_RunTo DefaultObject => (RBMAIAction_RunTo)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RBMAIAction_RunTo(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
