...
public partial class RChaseLocationSearch : BmSDK.BmGame.RSearchTreeFinder, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe void StartSearch(System.Numerics.Vector3 ChaseCenter, float ChaseDist, BmSDK.Engine.Actor AvoidActor = default)
    {
    ...
    /// </summary>
    public unsafe void GetInternalPolys(out BmSDK.TArray<int> OutPolyList)
    {
