...
/// <summary>
/// Class: RCombatMove_RasAttack<br/>
/// (size = 513)
/// (flags = 8388626)
/// </summary>
public partial class RCombatMove_RasAttack : BmSDK.BmGame.RCombatMove_VillainAttack, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RCombatMove_RasAttack", false);
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_RasAttack.
    /// </summary>
    public static RCombatMove_RasAttack DefaultObject => (RCombatMove_RasAttack)StaticClass().DefaultObject;

    internal RCombatMove_RasAttack() { }

    /// <summary>
    /// Constructs a new RCombatMove_RasAttack
    /// </summary>
    public RCombatMove_RasAttack(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCombatMove_RasAttack(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCombatMove_RasAttack>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCombatMove_RasAttack>, new()
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPawnBossRasBase>(Ptr + 484); }
    ...
    /// <summary>
    /// FloatProperty: EnergyRadius
    /// </summary>
    public unsafe float EnergyRadius
    {
    ...
    /// <summary>
    /// BoolProperty: bClearRealRasOnExit
    /// </summary>
    public unsafe bool bClearRealRasOnExit
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RCombatMove_RasAttack.RasAttackType AttackType
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RCombatMove_RasAttack.RasAttackType>(Ptr + 512); }
