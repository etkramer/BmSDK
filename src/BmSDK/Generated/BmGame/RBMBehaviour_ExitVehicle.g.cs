...
public partial class RBMBehaviour_ExitVehicle : BmSDK.BmGame.RBMBehaviour, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_ExitVehicle.
    /// </summary>
    public static RBMBehaviour_ExitVehicle DefaultObject => (RBMBehaviour_ExitVehicle)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_ExitVehicle>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_ExitVehicle>, new()
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RGameInfo.FExitVehicleAnimationInfo ExitAnimInfo
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RGameInfo.FExitVehicleAnimationInfo>(Ptr + 640);
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId ExitAnimID
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 LastSafeNavMeshLocation
