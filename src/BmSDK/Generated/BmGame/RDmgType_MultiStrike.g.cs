...
public partial class RDmgType_MultiStrike : BmSDK.BmGame.RDmgType_Strike, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_MultiStrike.
    /// </summary>
    public static RDmgType_MultiStrike DefaultObject => (RDmgType_MultiStrike)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_MultiStrike>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_MultiStrike>, new()
