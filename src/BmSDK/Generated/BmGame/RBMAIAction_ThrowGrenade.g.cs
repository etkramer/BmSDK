...
/// <summary>
/// Class: RBMAIAction_ThrowGrenade<br/>
/// (size = 600)
/// (flags = 8388626)
/// </summary>
public partial class RBMAIAction_ThrowGrenade : BmSDK.BmGame.RBMAIAction, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RBMAIAction_ThrowGrenade", false);
    ...
    /// <summary>
    /// Gets the class default object as RBMAIAction_ThrowGrenade.
    /// </summary>
    public static RBMAIAction_ThrowGrenade DefaultObject => (RBMAIAction_ThrowGrenade)StaticClass().DefaultObject;

    internal RBMAIAction_ThrowGrenade() { }

    /// <summary>
    /// Constructs a new RBMAIAction_ThrowGrenade
    /// </summary>
    public RBMAIAction_ThrowGrenade(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RBMAIAction_ThrowGrenade(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMAIAction_ThrowGrenade>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMAIAction_ThrowGrenade>, new()
    ...
    public unsafe virtual void StartThrowAnim(System.Numerics.Vector3 ThrowStandPoint, BmSDK.Rotator ThrowRotation)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(ThrowStandPoint, paramsPtr + 0);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(ThrowRotation, paramsPtr + 12);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    /// <summary>
    /// StructProperty: ThrowTarget
    /// </summary>
    public unsafe ref System.Numerics.Vector3 ThrowTarget
