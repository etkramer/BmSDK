...
public partial class RSeqEvent_ThugKOdBySomethingOtherThanRedHoodGuns : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_ThugKOdBySomethingOtherThanRedHoodGuns.
    /// </summary>
    public static RSeqEvent_ThugKOdBySomethingOtherThanRedHoodGuns DefaultObject => (RSeqEvent_ThugKOdBySomethingOtherThanRedHoodGuns)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThugKOdBySomethingOtherThanRedHoodGuns>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThugKOdBySomethingOtherThanRedHoodGuns>, new()
