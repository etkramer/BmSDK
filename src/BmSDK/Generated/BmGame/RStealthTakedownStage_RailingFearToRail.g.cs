...
public partial class RStealthTakedownStage_RailingFearToRail : BmSDK.BmGame.RStealthTakeDownStage, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RStealthTakedownStage_RailingFearToRail(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RStealthTakedownStage_RailingFearToRail Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
