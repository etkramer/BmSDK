...
public partial class RSeqAct_IsFirecrewDialogueAllowed : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_IsFirecrewDialogueAllowed.
    /// </summary>
    public static RSeqAct_IsFirecrewDialogueAllowed DefaultObject => (RSeqAct_IsFirecrewDialogueAllowed)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_IsFirecrewDialogueAllowed>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_IsFirecrewDialogueAllowed>, new()
