...
public partial class RBatmobileWinchProjectile : BmSDK.BmGame.RProjectileWithRope, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBatmobileWinchProjectile.
    /// </summary>
    public static RBatmobileWinchProjectile DefaultObject => (RBatmobileWinchProjectile)StaticClass().DefaultObject;
