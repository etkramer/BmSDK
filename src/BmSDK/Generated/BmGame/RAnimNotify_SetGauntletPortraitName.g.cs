...
public partial class RAnimNotify_SetGauntletPortraitName : BmSDK.Engine.AnimNotify, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAnimNotify_SetGauntletPortraitName.
    /// </summary>
    public static RAnimNotify_SetGauntletPortraitName DefaultObject => (RAnimNotify_SetGauntletPortraitName)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_SetGauntletPortraitName>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_SetGauntletPortraitName>, new()
