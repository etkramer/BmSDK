...
public partial class RInterpTrackInstVehicleWheelspin : BmSDK.Engine.InterpTrackInst, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RInterpTrackInstVehicleWheelspin.
    /// </summary>
    public static RInterpTrackInstVehicleWheelspin DefaultObject => (RInterpTrackInstVehicleWheelspin)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RInterpTrackInstVehicleWheelspin>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RInterpTrackInstVehicleWheelspin>, new()
