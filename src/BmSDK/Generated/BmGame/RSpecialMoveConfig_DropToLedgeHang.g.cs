...
/// (flags = 4114)
/// </summary>
public partial class RSpecialMoveConfig_DropToLedgeHang : BmSDK.BmGame.RSpecialMoveConfig_RelativeAnimMove, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveConfig_DropToLedgeHang.
    /// </summary>
    public static RSpecialMoveConfig_DropToLedgeHang DefaultObject => (RSpecialMoveConfig_DropToLedgeHang)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_DropToLedgeHang>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveConfig_DropToLedgeHang>, new()
