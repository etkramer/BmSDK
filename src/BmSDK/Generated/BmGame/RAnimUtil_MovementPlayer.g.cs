...
public partial class RAnimUtil_MovementPlayer : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Constructs a new RAnimUtil_MovementPlayer
    /// </summary>
    public RAnimUtil_MovementPlayer(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RAnimUtil_MovementPlayer Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
