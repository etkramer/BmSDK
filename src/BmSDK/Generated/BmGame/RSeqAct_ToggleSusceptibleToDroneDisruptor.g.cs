...
public partial class RSeqAct_ToggleSusceptibleToDroneDisruptor : BmSDK.Engine.SeqAct_Toggle, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_ToggleSusceptibleToDroneDisruptor.
    /// </summary>
    public static RSeqAct_ToggleSusceptibleToDroneDisruptor DefaultObject => (RSeqAct_ToggleSusceptibleToDroneDisruptor)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ToggleSusceptibleToDroneDisruptor>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ToggleSusceptibleToDroneDisruptor>, new()
