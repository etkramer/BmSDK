...
public partial class RVehicleFlying : BmSDK.BmGame.RVehicleNPC, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RVehicleFlying.
    /// </summary>
    public static RVehicleFlying DefaultObject => (RVehicleFlying)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe override void ProjectileInFlight()
    {
    ...
    /// </summary>
    public unsafe virtual void ProjectileExplodedCallback()
    {
    ...
    /// </summary>
    public unsafe virtual void FireProjectile()
    {
    ...
    /// </summary>
    public unsafe virtual void DrawWarningHUD()
    {
    ...
    /// </summary>
    public unsafe override BmSDK.BmGame.RRoadNetwork GetRoadNetwork()
    {
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 ShootFromPoint
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 7684);

    /// <summary>
    /// StructProperty: ShootTargetPoint
    /// </summary>
    public unsafe ref System.Numerics.Vector3 ShootTargetPoint
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 7696);
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 BumpRepelDir
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 7724);
    ...
    /// </summary>
    public unsafe ref BmSDK.Engine.AkWwise.FAkSoundHandle ShootSoundHandle
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.AkWwise.FAkSoundHandle>(Ptr + 7740);
}
