...
public partial class RGFxMovieVideoOverlay : BmSDK.BmGame.RGFxMovie, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RGFxMovieVideoOverlay.
    /// </summary>
    public static RGFxMovieVideoOverlay DefaultObject => (RGFxMovieVideoOverlay)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RGFxMovieVideoOverlay>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RGFxMovieVideoOverlay>, new()
