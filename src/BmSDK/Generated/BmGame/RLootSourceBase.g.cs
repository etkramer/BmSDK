...
/// <summary>
/// ABSTRACT Class: RLootSourceBase<br/>
/// (size = 1036)
/// (flags = 10485779)
/// </summary>
public partial class RLootSourceBase : BmSDK.BmGame.RLootPointBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RLootSourceBase.
    /// </summary>
    public static RLootSourceBase DefaultObject => (RLootSourceBase)StaticClass().DefaultObject;
