...
public partial class RNavMeshPath_WithinVolume : BmSDK.Engine.NavMeshPathConstraint, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RNavMeshPath_WithinVolume.
    /// </summary>
    public static RNavMeshPath_WithinVolume DefaultObject => (RNavMeshPath_WithinVolume)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RNavMeshPath_WithinVolume>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RNavMeshPath_WithinVolume>, new()
