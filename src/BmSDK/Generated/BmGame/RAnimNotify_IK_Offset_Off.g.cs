...
public partial class RAnimNotify_IK_Offset_Off : BmSDK.BmGame.RAnimNotify_IK, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAnimNotify_IK_Offset_Off.
    /// </summary>
    public static RAnimNotify_IK_Offset_Off DefaultObject => (RAnimNotify_IK_Offset_Off)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_IK_Offset_Off>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_IK_Offset_Off>, new()
