...
public partial class ROceanSMActor : BmSDK.Engine.DynamicSMActor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ROceanSMActor.
    /// </summary>
    public static ROceanSMActor DefaultObject => (ROceanSMActor)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 bouyancyPos1
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 bouyancyPos2
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 BasePos
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 812);

    /// <summary>
    /// StructProperty: baseRot
    /// </summary>
    public unsafe ref BmSDK.Rotator baseRot
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 824);
