...
public partial class RForensicsDeviceAsyncTicker : BmSDK.Engine.ActorComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RForensicsDeviceAsyncTicker.
    /// </summary>
    public static RForensicsDeviceAsyncTicker DefaultObject => (RForensicsDeviceAsyncTicker)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RForensicsDeviceAsyncTicker>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RForensicsDeviceAsyncTicker>, new()
