...
public partial class RHudModuleBoss : BmSDK.BmGame.RHudModule, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RHudModuleBoss.
    /// </summary>
    public static RHudModuleBoss DefaultObject => (RHudModuleBoss)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RHudModuleBoss>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RHudModuleBoss>, new()
