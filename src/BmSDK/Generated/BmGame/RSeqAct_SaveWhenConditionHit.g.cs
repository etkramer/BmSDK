...
public partial class RSeqAct_SaveWhenConditionHit : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SaveWhenConditionHit.
    /// </summary>
    public static RSeqAct_SaveWhenConditionHit DefaultObject => (RSeqAct_SaveWhenConditionHit)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SaveWhenConditionHit>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SaveWhenConditionHit>, new()
