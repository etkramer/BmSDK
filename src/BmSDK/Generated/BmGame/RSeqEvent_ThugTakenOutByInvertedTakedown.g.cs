...
public partial class RSeqEvent_ThugTakenOutByInvertedTakedown : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_ThugTakenOutByInvertedTakedown.
    /// </summary>
    public static RSeqEvent_ThugTakenOutByInvertedTakedown DefaultObject => (RSeqEvent_ThugTakenOutByInvertedTakedown)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThugTakenOutByInvertedTakedown>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_ThugTakenOutByInvertedTakedown>, new()
