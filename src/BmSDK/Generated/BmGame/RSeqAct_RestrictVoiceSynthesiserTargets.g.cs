...
public partial class RSeqAct_RestrictVoiceSynthesiserTargets : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_RestrictVoiceSynthesiserTargets.
    /// </summary>
    public static RSeqAct_RestrictVoiceSynthesiserTargets DefaultObject => (RSeqAct_RestrictVoiceSynthesiserTargets)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_RestrictVoiceSynthesiserTargets>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_RestrictVoiceSynthesiserTargets>, new()
