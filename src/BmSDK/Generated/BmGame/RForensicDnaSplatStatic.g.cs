...
/// <summary>
/// Class: RForensicDnaSplatStatic<br/>
/// (size = 516)
/// (flags = 142606994)
/// </summary>
public partial class RForensicDnaSplatStatic : BmSDK.Engine.Actor, BmSDK.BmGame.REvidenceInterface, BmSDK.BmGame.RXrayInterface, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RForensicDnaSplatStatic", false);
    ...
    /// <summary>
    /// Gets the class default object as RForensicDnaSplatStatic.
    /// </summary>
    public static RForensicDnaSplatStatic DefaultObject => (RForensicDnaSplatStatic)StaticClass().DefaultObject;

    internal RForensicDnaSplatStatic() { }

    /// <summary>
    /// Constructs a new RForensicDnaSplatStatic
    /// </summary>
    public RForensicDnaSplatStatic(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RForensicDnaSplatStatic(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RForensicDnaSplatStatic>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RForensicDnaSplatStatic>, new()
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.REvidence>(Ptr + 456); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPlayerController>(Ptr + 468); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.ParticleSystemComponent>(Ptr + 472); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.StaticMeshComponent>(Ptr + 492); }
