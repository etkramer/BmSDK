...
public partial class MBMBehaviour_BulletHitReaction : BmSDK.BmGame.RBMBehaviour_HitReaction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MBMBehaviour_BulletHitReaction.
    /// </summary>
    public static MBMBehaviour_BulletHitReaction DefaultObject => (MBMBehaviour_BulletHitReaction)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MBMBehaviour_BulletHitReaction>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MBMBehaviour_BulletHitReaction>, new()
