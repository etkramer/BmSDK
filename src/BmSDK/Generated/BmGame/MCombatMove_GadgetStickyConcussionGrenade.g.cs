...
/// <summary>
/// ABSTRACT Class: MCombatMove_GadgetStickyConcussionGrenade<br/>
/// (size = 836)
/// (flags = 10485779)
/// </summary>
public partial class MCombatMove_GadgetStickyConcussionGrenade : BmSDK.BmGame.RCombatMove_BatmanAttack, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MCombatMove_GadgetStickyConcussionGrenade.
    /// </summary>
    public static MCombatMove_GadgetStickyConcussionGrenade DefaultObject => (MCombatMove_GadgetStickyConcussionGrenade)StaticClass().DefaultObject;
