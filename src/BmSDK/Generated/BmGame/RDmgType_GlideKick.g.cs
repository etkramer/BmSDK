...
/// <summary>
/// Class: RDmgType_GlideKick<br/>
/// (size = 0)
/// (flags = 0)
/// </summary>
public partial class RDmgType_GlideKick : BmSDK.BmGame.RDmgType_HeavyStrike, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RDmgType_GlideKick", false);
    ...
    /// <summary>
    /// Constructs a new RDmgType_GlideKick
    /// </summary>
    public RDmgType_GlideKick(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RDmgType_GlideKick Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
