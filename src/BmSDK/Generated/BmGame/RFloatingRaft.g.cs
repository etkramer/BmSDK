...
public partial class RFloatingRaft : BmSDK.BmGame.RFloatingProp, BmSDK.IGameObject
{
    ...
    /// </summary>
    public InlineArray<System.Numerics.Vector3> WakeOffsets => new(4, Ptr + 1096, 12);
    ...
    /// </summary>
    public InlineArray<float> WakeScales => new(4, Ptr + 1144, 4);
    ...
    /// </summary>
    public InlineArray<int> WakeEmitterTypes => new(4, Ptr + 1160, 4);
    ...
    /// </summary>
    public InlineArray<BmSDK.Engine.Emitter> WakeEmitters => new(4, Ptr + 1176, 4);
