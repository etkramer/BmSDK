...
public partial class RCapeOnlyBlockingVolume : BmSDK.Engine.BlockingVolume, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCapeOnlyBlockingVolume.
    /// </summary>
    public static RCapeOnlyBlockingVolume DefaultObject => (RCapeOnlyBlockingVolume)StaticClass().DefaultObject;
