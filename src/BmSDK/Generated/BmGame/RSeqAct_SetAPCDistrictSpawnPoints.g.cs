...
public partial class RSeqAct_SetAPCDistrictSpawnPoints : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SetAPCDistrictSpawnPoints.
    /// </summary>
    public static RSeqAct_SetAPCDistrictSpawnPoints DefaultObject => (RSeqAct_SetAPCDistrictSpawnPoints)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetAPCDistrictSpawnPoints>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetAPCDistrictSpawnPoints>, new()
