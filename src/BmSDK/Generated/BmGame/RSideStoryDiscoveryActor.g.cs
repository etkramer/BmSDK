...
public partial class RSideStoryDiscoveryActor : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSideStoryDiscoveryActor.
    /// </summary>
    public static RSideStoryDiscoveryActor DefaultObject => (RSideStoryDiscoveryActor)StaticClass().DefaultObject;
