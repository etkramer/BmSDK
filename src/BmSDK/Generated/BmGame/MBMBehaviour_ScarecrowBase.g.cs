...
public partial class MBMBehaviour_ScarecrowBase : BmSDK.BmGame.RBMBehaviour, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MBMBehaviour_ScarecrowBase.
    /// </summary>
    public static MBMBehaviour_ScarecrowBase DefaultObject => (MBMBehaviour_ScarecrowBase)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MBMBehaviour_ScarecrowBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MBMBehaviour_ScarecrowBase>, new()
