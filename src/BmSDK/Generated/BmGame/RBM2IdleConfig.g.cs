...
public partial class RBM2IdleConfig : BmSDK.BmGame.RConfig, BmSDK.IGameObject
{
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBM2IdleConfig>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBM2IdleConfig>, new()
    ...
    /// </summary>
    public enum EMovementStances : byte
    {
        EMS_Normal = 0,
        EMS_Aiming = 1,
        EMS_Combat = 2,
    ...
    public unsafe ref BmSDK.BmGame.RBM2IdleConfig.FAnimationSets Anims
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RBM2IdleConfig.FAnimationSets>(Ptr + 100);

    /// <summary>
    /// StructProperty: BMDialogueAnims
    /// </summary>
    public unsafe ref BmSDK.BmGame.RBM2IdleConfig.FBM2IdleSet BMDialogueAnims
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RBM2IdleConfig.FBM2IdleSet>(Ptr + 196);

    /// <summary>
    /// StructProperty: ConversationAnims
    /// </summary>
    public unsafe ref BmSDK.BmGame.RBM2IdleConfig.FDialogueAnimationSets ConversationAnims
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RBM2IdleConfig.FDialogueAnimationSets>(Ptr + 220);
    ...
    public unsafe ref BmSDK.BmGame.RBM2IdleConfig.FInterrogationAnimations InterrogationOverride
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RBM2IdleConfig.FInterrogationAnimations>(Ptr + 332);
    ...
    /// </summary>
    public unsafe ref System.Numerics.Vector3 ThumbnailMeshOffset
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 420);

    /// <summary>
    /// StructProperty: ThumbnailMeshRotation
    /// </summary>
    public unsafe ref BmSDK.Rotator ThumbnailMeshRotation
