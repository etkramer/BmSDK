...
public partial class RSeqAct_SetGrateAllowTakedownOnly : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SetGrateAllowTakedownOnly.
    /// </summary>
    public static RSeqAct_SetGrateAllowTakedownOnly DefaultObject => (RSeqAct_SetGrateAllowTakedownOnly)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetGrateAllowTakedownOnly>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetGrateAllowTakedownOnly>, new()
