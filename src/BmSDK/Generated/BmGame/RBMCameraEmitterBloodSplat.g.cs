...
public partial class RBMCameraEmitterBloodSplat : BmSDK.BmGame.RBMCameraEmitter, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMCameraEmitterBloodSplat.
    /// </summary>
    public static RBMCameraEmitterBloodSplat DefaultObject => (RBMCameraEmitterBloodSplat)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RBMCameraEmitterBloodSplat(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
