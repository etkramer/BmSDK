...
public partial class RJokerBillboard : BmSDK.BmGame.RJokerSwappableBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RJokerBillboard.
    /// </summary>
    public static RJokerBillboard DefaultObject => (RJokerBillboard)StaticClass().DefaultObject;
