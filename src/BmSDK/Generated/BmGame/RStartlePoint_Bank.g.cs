...
public partial class RStartlePoint_Bank : BmSDK.BmGame.RStartlePoint, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RStartlePoint_Bank.
    /// </summary>
    public static RStartlePoint_Bank DefaultObject => (RStartlePoint_Bank)StaticClass().DefaultObject;
