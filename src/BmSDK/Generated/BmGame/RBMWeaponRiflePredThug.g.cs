...
public partial class RBMWeaponRiflePredThug : BmSDK.BmGame.RBMWeaponRiflePredBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBMWeaponRiflePredThug(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMWeaponRiflePredThug Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
