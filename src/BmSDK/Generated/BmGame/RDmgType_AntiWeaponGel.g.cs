...
public partial class RDmgType_AntiWeaponGel : BmSDK.BmGame.RDmgType_Strike, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_AntiWeaponGel.
    /// </summary>
    public static RDmgType_AntiWeaponGel DefaultObject => (RDmgType_AntiWeaponGel)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_AntiWeaponGel>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_AntiWeaponGel>, new()
