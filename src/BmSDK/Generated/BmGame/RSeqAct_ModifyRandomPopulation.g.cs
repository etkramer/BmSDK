...
public partial class RSeqAct_ModifyRandomPopulation : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_ModifyRandomPopulation.
    /// </summary>
    public static RSeqAct_ModifyRandomPopulation DefaultObject => (RSeqAct_ModifyRandomPopulation)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ModifyRandomPopulation>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ModifyRandomPopulation>, new()
