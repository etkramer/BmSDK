...
public partial class RStealthTakeDownStage_ChainTakedown_DropThroughCeilingGrateFinish : BmSDK.BmGame.RStealthTakeDownStage_ChainTakedown_GlassFinish, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RStealthTakeDownStage_ChainTakedown_DropThroughCeilingGrateFinish(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RStealthTakeDownStage_ChainTakedown_DropThroughCeilingGrateFinish Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
