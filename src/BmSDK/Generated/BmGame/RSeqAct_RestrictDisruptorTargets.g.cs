...
public partial class RSeqAct_RestrictDisruptorTargets : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_RestrictDisruptorTargets.
    /// </summary>
    public static RSeqAct_RestrictDisruptorTargets DefaultObject => (RSeqAct_RestrictDisruptorTargets)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_RestrictDisruptorTargets>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_RestrictDisruptorTargets>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RSeqAct_RestrictDisruptorTargets.GetObjClassVersion", true);
