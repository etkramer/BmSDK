...
public partial class RBMBehaviour_Controlled : BmSDK.BmGame.RBMBehaviour, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_Controlled.
    /// </summary>
    public static RBMBehaviour_Controlled DefaultObject => (RBMBehaviour_Controlled)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_Controlled>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_Controlled>, new()
    ...
    /// </summary>
    public unsafe virtual bool ShouldStopDialogue()
    {
