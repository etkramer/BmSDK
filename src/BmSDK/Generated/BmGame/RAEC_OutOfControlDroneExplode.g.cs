...
public partial class RAEC_OutOfControlDroneExplode : BmSDK.BmGame.RAlertEventCoordinatorBase, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RAEC_OutOfControlDroneExplode", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RAEC_OutOfControlDroneExplode() { }

    /// <summary>
    /// Constructs a new RAEC_OutOfControlDroneExplode
    /// </summary>
    public RAEC_OutOfControlDroneExplode(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RAEC_OutOfControlDroneExplode Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RAEC_OutOfControlDroneExplode(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAEC_OutOfControlDroneExplode>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAEC_OutOfControlDroneExplode>, new()
    ...
    public unsafe virtual void StartExplodeReaction(BmSDK.BmGame.RPawnVillain NewDroneConPawn, System.Numerics.Vector3 ExplodeLocation)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(NewDroneConPawn, paramsPtr + 0);
    ...
    public partial record struct FConDist
    {
        /// <summary>
        /// ObjectProperty: C
        /// </summary>
        public unsafe BmSDK.BmGame.RBMAIController C
        {
    ...
    /// <summary>
    /// ObjectProperty: DroneConPawn
    /// </summary>
    public unsafe BmSDK.BmGame.RPawnVillain DroneConPawn
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPawnVillain>(Ptr + 728); }
