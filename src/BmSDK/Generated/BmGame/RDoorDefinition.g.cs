...
public partial class RDoorDefinition : BmSDK.BmGame.RConfig, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDoorDefinition.
    /// </summary>
    public static RDoorDefinition DefaultObject => (RDoorDefinition)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDoorDefinition>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDoorDefinition>, new()
