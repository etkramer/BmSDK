...
/// <summary>
/// Class: RRasSwordAttackBladeBase<br/>
/// (size = 496)
/// (flags = 8388626)
/// </summary>
public partial class RRasSwordAttackBladeBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RRasSwordAttackBladeBase", false);
    ...
    /// <summary>
    /// Gets the class default object as RRasSwordAttackBladeBase.
    /// </summary>
    public static RRasSwordAttackBladeBase DefaultObject => (RRasSwordAttackBladeBase)StaticClass().DefaultObject;

    internal RRasSwordAttackBladeBase() { }

    /// <summary>
    /// Constructs a new RRasSwordAttackBladeBase
    /// </summary>
    public RRasSwordAttackBladeBase(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RRasSwordAttackBladeBase(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RRasSwordAttackBladeBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RRasSwordAttackBladeBase>, new()
    ...
    public unsafe virtual void Initialise(BmSDK.BmGame.RPawnBossRasBase RasPawn, float Delay, System.Numerics.Vector3 Dir, float GoDelay, bool bMain)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(GoDelay, paramsPtr + 20);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(bMain, paramsPtr + 24);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPawnBossRasBase>(Ptr + 428); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 428); }
    }

    /// <summary>
    /// ComponentProperty: SwordFxComponent
    /// </summary>
    public unsafe BmSDK.Engine.ParticleSystemComponent SwordFxComponent
    {
    ...
    /// <summary>
    /// FloatProperty: WaitingTime
    /// </summary>
    public unsafe float WaitingTime
    {
    ...
    /// </summary>
    public unsafe float BladeSpeed
    {
    ...
    /// <summary>
    /// BoolProperty: bIsMain
    /// </summary>
    public unsafe bool bIsMain
    {
    ...
    /// <summary>
    /// FloatProperty: CutDelay
    /// </summary>
    public unsafe float CutDelay
    {
    ...
    /// <summary>
    /// ComponentProperty: BladeMeshComp
    /// </summary>
    public unsafe BmSDK.Engine.StaticMeshComponent BladeMeshComp
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.StaticMeshComponent>(Ptr + 484); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.DynamicLightEnvironmentComponent>(Ptr + 488); }
    ...
    /// </summary>
    public unsafe BmSDK.Engine.NxForceFieldTornadoComponent ForceField
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.NxForceFieldTornadoComponent>(Ptr + 492); }
