...
public partial class RPawnJokerHallucination : BmSDK.BmGame.RPawnFriendly, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RPawnJokerHallucination.
    /// </summary>
    public static RPawnJokerHallucination DefaultObject => (RPawnJokerHallucination)StaticClass().DefaultObject;
    ...
    /// </summary>
    public enum CombatQualityType : byte
    {
        CQT_Lame = 0,
        CQT_Excellent = 1,
        CQT_Neutral = 2,
    ...
    /// </summary>
    public enum TypesOfHallucination : byte
    {
