...
public partial class RDmgType_FloorPickup : BmSDK.BmGame.RDmgType_Strike, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_FloorPickup.
    /// </summary>
    public static RDmgType_FloorPickup DefaultObject => (RDmgType_FloorPickup)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_FloorPickup>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_FloorPickup>, new()
