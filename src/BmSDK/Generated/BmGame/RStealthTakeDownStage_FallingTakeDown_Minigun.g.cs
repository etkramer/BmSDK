...
public partial class RStealthTakeDownStage_FallingTakeDown_Minigun : BmSDK.BmGame.RStealthTakeDownStage_FallingTakeDown, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RStealthTakeDownStage_FallingTakeDown_Minigun(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RStealthTakeDownStage_FallingTakeDown_Minigun Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
