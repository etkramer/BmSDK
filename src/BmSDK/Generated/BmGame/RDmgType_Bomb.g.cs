...
/// (flags = 18)
/// </summary>
public partial class RDmgType_Bomb : BmSDK.BmGame.RDmgType_Venom, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_Bomb.
    /// </summary>
    public static RDmgType_Bomb DefaultObject => (RDmgType_Bomb)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_Bomb>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_Bomb>, new()
