...
public partial class MBMAIAction_MayhemStartle : BmSDK.BmGame.RBMAIAction_BatShockStartle, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.MBMAIAction_MayhemStartle", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal MBMAIAction_MayhemStartle() { }

    /// <summary>
    /// Constructs a new MBMAIAction_MayhemStartle
    /// </summary>
    public MBMAIAction_MayhemStartle(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, MBMAIAction_MayhemStartle Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected MBMAIAction_MayhemStartle(nint ptr) : base(ptr) { }
    ...
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MBMAIAction_MayhemStartle>, new()
    ...
    /// </summary>
    public unsafe NEED_UPDATE_OBJECTPROPERTY_LAYOUT StartleTarget
    {
