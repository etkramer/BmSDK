...
public partial class RSeqAct_SetCombatParamsForPawns : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SetCombatParamsForPawns.
    /// </summary>
    public static RSeqAct_SetCombatParamsForPawns DefaultObject => (RSeqAct_SetCombatParamsForPawns)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetCombatParamsForPawns>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SetCombatParamsForPawns>, new()
