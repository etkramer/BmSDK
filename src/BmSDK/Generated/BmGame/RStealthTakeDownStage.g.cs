...
public partial class RStealthTakeDownStage : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe void FindVictimFreeRagdollZone(out System.Numerics.Vector3 ReferencePosition, BmSDK.Rotator ReferenceRotation, float maxOffset = default)
    {
    ...
    /// </summary>
    public unsafe void GotoStageEx(BmSDK.BmGame.RPawnPlayer.EStealthTakeDownStages NextStageClass, bool bClientRequest = default)
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RPawnPlayer.EStealthTakeDownStages GetNextStage()
    {
    ...
    /// </summary>
    public unsafe void PlayVictimAnim(float OverrideStartTime = default)
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct>(Ptr + 480); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RDOFManager.FDofStruct>(Ptr + 624); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RStealthTakeDownStage.FTakeDownStageAnimSet>(Ptr + 688); }
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RPawnPlayer.FEnvironmentSpecialMoveLocator CustomLocator
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPawnPlayer.FEnvironmentSpecialMoveLocator>(Ptr + 836); }
