...
public partial class RRiotBrain : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RRiotBrain.
    /// </summary>
    public static RRiotBrain DefaultObject => (RRiotBrain)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RRiotBrain>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RRiotBrain>, new()
    ...
    /// Enum: RiotFailReason
    /// </summary>
    public enum RiotFailReason : byte
    {
        RFR_NoPath = 0,
