...
/// <summary>
/// Class: MAEC_MayhemMode_Sub<br/>
/// (size = 704)
/// (flags = 10485778)
/// </summary>
public partial class MAEC_MayhemMode_Sub : BmSDK.BmGame.RAlertEventCoordinatorSolo, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.MAEC_MayhemMode_Sub", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal MAEC_MayhemMode_Sub() { }

    /// <summary>
    /// Constructs a new MAEC_MayhemMode_Sub
    /// </summary>
    public MAEC_MayhemMode_Sub(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, MAEC_MayhemMode_Sub Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected MAEC_MayhemMode_Sub(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MAEC_MayhemMode_Sub>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MAEC_MayhemMode_Sub>, new()
