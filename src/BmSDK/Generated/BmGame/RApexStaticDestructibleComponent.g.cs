...
public partial class RApexStaticDestructibleComponent : BmSDK.Engine.ApexStaticDestructibleComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RApexStaticDestructibleComponent.
    /// </summary>
    public static RApexStaticDestructibleComponent DefaultObject => (RApexStaticDestructibleComponent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RApexStaticDestructibleComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RApexStaticDestructibleComponent>, new()
    ...
    /// </summary>
    public unsafe ref BmSDK.Engine.KMeshProps.FKAggregateGeom PlayerNavigationGeometry
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.KMeshProps.FKAggregateGeom>(Ptr + 728);
