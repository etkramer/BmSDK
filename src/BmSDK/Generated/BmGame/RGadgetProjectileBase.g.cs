...
public partial class RGadgetProjectileBase : BmSDK.Engine.Projectile, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RGadgetProjectileBase.
    /// </summary>
    public static RGadgetProjectileBase DefaultObject => (RGadgetProjectileBase)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RGadgetProjectileBase(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
