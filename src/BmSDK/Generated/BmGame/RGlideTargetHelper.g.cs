...
/// <summary>
/// Class: RGlideTargetHelper<br/>
/// (size = 0)
/// (flags = 0)
/// </summary>
public partial class RGlideTargetHelper : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RGlideTargetHelper", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RGlideTargetHelper() { }

    /// <summary>
    /// Constructs a new RGlideTargetHelper
    /// </summary>
    public RGlideTargetHelper(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RGlideTargetHelper Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RGlideTargetHelper(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RGlideTargetHelper>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RGlideTargetHelper>, new()
