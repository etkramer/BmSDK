...
/// (flags = 18)
/// </summary>
public partial class RDmgType_Pipe : BmSDK.BmGame.RDmgType_HeavyStrike, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_Pipe.
    /// </summary>
    public static RDmgType_Pipe DefaultObject => (RDmgType_Pipe)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_Pipe>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_Pipe>, new()
