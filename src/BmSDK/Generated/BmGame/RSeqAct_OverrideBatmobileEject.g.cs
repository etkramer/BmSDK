...
public partial class RSeqAct_OverrideBatmobileEject : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_OverrideBatmobileEject.
    /// </summary>
    public static RSeqAct_OverrideBatmobileEject DefaultObject => (RSeqAct_OverrideBatmobileEject)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_OverrideBatmobileEject>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_OverrideBatmobileEject>, new()
