...
public partial class RGargoyleBombBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RGargoyleBombBase.
    /// </summary>
    public static RGargoyleBombBase DefaultObject => (RGargoyleBombBase)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RGargoyleBombBase(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
