...
public partial class RDmgType_RECRagdoll : BmSDK.BmGame.RDmgType_Ragdoll, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_RECRagdoll.
    /// </summary>
    public static RDmgType_RECRagdoll DefaultObject => (RDmgType_RECRagdoll)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_RECRagdoll>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_RECRagdoll>, new()
