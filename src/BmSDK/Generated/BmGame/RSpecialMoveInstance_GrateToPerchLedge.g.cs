...
public partial class RSpecialMoveInstance_GrateToPerchLedge : BmSDK.BmGame.RSpecialMoveInstance_RelativeAnimMove, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveInstance_GrateToPerchLedge.
    /// </summary>
    public static RSpecialMoveInstance_GrateToPerchLedge DefaultObject => (RSpecialMoveInstance_GrateToPerchLedge)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RSpecialMoveInstance_GrateToPerchLedge(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null, BmSDK.Engine.Level Level = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), default, Location, Rotation, Template, Owner, Instigator, Level)) { }
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RSpecialMoveInstance_GrateToPerchLedge.CancelSpecialMove", true);
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RSpecialMoveInstance_GrateToPerchLedge.TriggerSpecialMove", true);
