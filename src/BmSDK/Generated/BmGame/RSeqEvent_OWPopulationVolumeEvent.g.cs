...
public partial class RSeqEvent_OWPopulationVolumeEvent : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_OWPopulationVolumeEvent.
    /// </summary>
    public static RSeqEvent_OWPopulationVolumeEvent DefaultObject => (RSeqEvent_OWPopulationVolumeEvent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_OWPopulationVolumeEvent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_OWPopulationVolumeEvent>, new()
