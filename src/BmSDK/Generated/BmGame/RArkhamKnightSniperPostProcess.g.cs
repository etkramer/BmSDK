...
public partial class RArkhamKnightSniperPostProcess : BmSDK.BmGame.RViewPostProcess, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RArkhamKnightSniperPostProcess.
    /// </summary>
    public static RArkhamKnightSniperPostProcess DefaultObject => (RArkhamKnightSniperPostProcess)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RArkhamKnightSniperPostProcess>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RArkhamKnightSniperPostProcess>, new()
