...
public partial class RDmgType_Dive : BmSDK.BmGame.RDamageType, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_Dive.
    /// </summary>
    public static RDmgType_Dive DefaultObject => (RDmgType_Dive)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_Dive>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_Dive>, new()
