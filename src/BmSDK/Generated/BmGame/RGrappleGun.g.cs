...
public partial class RGrappleGun : BmSDK.BmGame.RInventoryGadget, BmSDK.IGameObject
{
    ...
    /// </summary>
    public InlineArray<BmSDK.GameObject.FColor> DebugDrawColor => new(13, Ptr + 1380, 4);
    ...
    /// </summary>
    public InlineArray<System.Numerics.Vector3> GrappleWayPoints => new(8, Ptr + 1508, 12);
    ...
    /// </summary>
    public InlineArray<float> GrappleWayPointDistances => new(8, Ptr + 1604, 4);
