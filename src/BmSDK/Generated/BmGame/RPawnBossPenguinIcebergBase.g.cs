...
public partial class RPawnBossPenguinIcebergBase : BmSDK.BmGame.RPawnFriendly, BmSDK.BmGame.RBatarangableInterface, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe void HelpPlayerSelectFreezeJammer()
    {
    ...
    /// </summary>
    public unsafe void DodgeBatarang()
    {
    ...
    /// </summary>
    public unsafe void BatmanWithinRange()
    {
    ...
    /// </summary>
    public unsafe void PenguinHitByGadget()
    {
    ...
    /// </summary>
    public unsafe void ResetGunXray()
    {
    ...
    /// </summary>
    public unsafe bool BatmanTooClose()
    {
    ...
    /// </summary>
    public unsafe void StartNextState()
    {
    ...
    /// </summary>
    public unsafe void StopFiringIce()
    {
    ...
    /// </summary>
    public unsafe System.Numerics.Vector3 GetAimPoint()
    {
    ...
    /// </summary>
    public unsafe void CheckBatarang()
    {
