...
public partial class RDeathCamera : BmSDK.BmGame.RCameraActor, BmSDK.IGameObject
{
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RDeathCamera.GetLookAtLocation", true);
    ...
    /// </summary>
    public unsafe virtual void SetUpCamera(System.Numerics.Vector3 Loc, BmSDK.Engine.Pawn targetAct)
    {
    ...
    /// </summary>
    public unsafe BmSDK.Engine.Pawn TargetHead
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.Pawn>(Ptr + 1260); }
    ...
    public unsafe ref BmSDK.Rotator InitialRot
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 1284);

    /// <summary>
    /// StructProperty: LerpLookTarget
    /// </summary>
    public unsafe ref System.Numerics.Vector3 LerpLookTarget
