...
public partial class RStealthTakedownStage_ChainTakedown_LedgeHangNoRailingStart : BmSDK.BmGame.RStealthTakeDownStage_ChainTakedown_LedgeHangRailingStart, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RStealthTakedownStage_ChainTakedown_LedgeHangNoRailingStart(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RStealthTakedownStage_ChainTakedown_LedgeHangNoRailingStart Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
