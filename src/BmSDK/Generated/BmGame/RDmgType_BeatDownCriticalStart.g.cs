...
public partial class RDmgType_BeatDownCriticalStart : BmSDK.BmGame.RDmgType_BeatDownStart, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_BeatDownCriticalStart.
    /// </summary>
    public static RDmgType_BeatDownCriticalStart DefaultObject => (RDmgType_BeatDownCriticalStart)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_BeatDownCriticalStart>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_BeatDownCriticalStart>, new()
