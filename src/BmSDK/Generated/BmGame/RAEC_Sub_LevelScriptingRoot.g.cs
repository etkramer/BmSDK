...
public partial class RAEC_Sub_LevelScriptingRoot : BmSDK.BmGame.RAlertEventCoordinatorSolo, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAEC_Sub_LevelScriptingRoot.
    /// </summary>
    public static RAEC_Sub_LevelScriptingRoot DefaultObject => (RAEC_Sub_LevelScriptingRoot)StaticClass().DefaultObject;
