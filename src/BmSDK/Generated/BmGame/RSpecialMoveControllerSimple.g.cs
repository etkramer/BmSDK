...
public partial class RSpecialMoveControllerSimple : BmSDK.BmGame.RSpecialMoveController, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveControllerSimple.
    /// </summary>
    public static RSpecialMoveControllerSimple DefaultObject => (RSpecialMoveControllerSimple)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveControllerSimple>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveControllerSimple>, new()
