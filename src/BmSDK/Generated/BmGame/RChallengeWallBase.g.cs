...
public partial class RChallengeWallBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RChallengeWallBase(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RChallengeWallBase Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
    ...
    /// </summary>
    public unsafe void HitByRagdoll(BmSDK.BmGame.RPawn HitPawn, System.Numerics.Vector3 HitLocation, System.Numerics.Vector3 HitNormal, float Speed)
    {
    ...
    /// </summary>
    public unsafe System.Numerics.Vector3 BaseNavMeshLocation
    {
