...
public partial class RAEC_ConvergeMine : BmSDK.BmGame.RAlertEventCoordinatorBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAEC_ConvergeMine.
    /// </summary>
    public static RAEC_ConvergeMine DefaultObject => (RAEC_ConvergeMine)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe virtual BmSDK.FName GetBarkEventValue()
    {
    ...
    /// </summary>
    public unsafe virtual BmSDK.BmGame.RPawnVillain GetBestSpeakerFromConvergeList()
    {
    ...
    /// </summary>
    public enum ConvergeTargetType : byte
    {
        CTT_Mine = 0,
        CTT_ExplosiveGel = 1,
        CTT_ExplosivePile = 2,
