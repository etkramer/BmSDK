...
public partial class RBMBehaviour_MoveToMultiplePoints : BmSDK.BmGame.RBMBehaviour_MoveToBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_MoveToMultiplePoints.
    /// </summary>
    public static RBMBehaviour_MoveToMultiplePoints DefaultObject => (RBMBehaviour_MoveToMultiplePoints)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_MoveToMultiplePoints>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_MoveToMultiplePoints>, new()
