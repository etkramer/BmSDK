...
/// <summary>
/// Class: RWaterFlowTarget<br/>
/// (flags = 0)
/// </summary>
public partial class RWaterFlowTarget : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RWaterFlowTarget", false);
    ...
    /// <summary>
    /// Constructs a new RWaterFlowTarget
    /// </summary>
    public RWaterFlowTarget(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RWaterFlowTarget Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RWaterFlowTarget(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RWaterFlowTarget>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RWaterFlowTarget>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RWaterFlowTarget.OnToggle", true);
    ...
    /// <summary>
    /// FloatProperty: FlowDropOff
    /// </summary>
    public unsafe float FlowDropOff
    {
    ...
    /// <summary>
    /// FloatProperty: SwirlDropOff
    /// </summary>
    public unsafe float SwirlDropOff
    {
    ...
    /// <summary>
    /// FloatProperty: RadialDropoff
    /// </summary>
    public unsafe float RadialDropoff
    {
    ...
    /// <summary>
    /// BoolProperty: bIgnoreHeightForTargetDistanceCalculation
    /// </summary>
    public unsafe bool bIgnoreHeightForTargetDistanceCalculation
    {
