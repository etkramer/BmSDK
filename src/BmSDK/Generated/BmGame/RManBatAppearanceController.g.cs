...
public partial class RManBatAppearanceController : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RManBatAppearanceController.
    /// </summary>
    public static RManBatAppearanceController DefaultObject => (RManBatAppearanceController)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RManBatAppearanceController>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RManBatAppearanceController>, new()
    ...
    /// </summary>
    public enum TypesOfAppearance : byte
    {
        Manbat_Ledge = 0,
