...
public partial class RAnimNode_Bat : BmSDK.Engine.AnimNode, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAnimNode_Bat.
    /// </summary>
    public static RAnimNode_Bat DefaultObject => (RAnimNode_Bat)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAnimNode_Bat>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAnimNode_Bat>, new()
