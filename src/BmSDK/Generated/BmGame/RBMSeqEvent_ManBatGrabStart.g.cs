...
public partial class RBMSeqEvent_ManBatGrabStart : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMSeqEvent_ManBatGrabStart.
    /// </summary>
    public static RBMSeqEvent_ManBatGrabStart DefaultObject => (RBMSeqEvent_ManBatGrabStart)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMSeqEvent_ManBatGrabStart>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMSeqEvent_ManBatGrabStart>, new()
