...
/// <summary>
/// ABSTRACT Class: RAnimUtil_MovementOutput<br/>
/// (size = 84)
/// (flags = 134217875)
/// </summary>
public partial class RAnimUtil_MovementOutput : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RAnimUtil_MovementOutput", false);
    ...
    /// <summary>
    /// Gets the class default object as RAnimUtil_MovementOutput.
    /// </summary>
    public static RAnimUtil_MovementOutput DefaultObject => (RAnimUtil_MovementOutput)StaticClass().DefaultObject;

    internal RAnimUtil_MovementOutput() { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RAnimUtil_MovementOutput(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAnimUtil_MovementOutput>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAnimUtil_MovementOutput>, new()
    ...
    {
        /// <summary>
        /// FloatProperty: RagdollFacing
        /// </summary>
        public unsafe float RagdollFacing
        {
        ...
        /// <summary>
        /// BoolProperty: CheatsEnabled
        /// </summary>
        public unsafe bool CheatsEnabled
        {
        ...
        /// <summary>
        /// BoolProperty: PreAnimUpdateHandledFalling
        /// </summary>
        public unsafe bool PreAnimUpdateHandledFalling
        {
        ...
        /// <summary>
        /// BoolProperty: bUpdatedRagdollLastFrame
        /// </summary>
        public unsafe bool bUpdatedRagdollLastFrame
        {
        ...
        /// <summary>
        /// StructProperty: DesiredLocation
        /// </summary>
        public unsafe System.Numerics.Vector3 DesiredLocation
        {
        ...
        /// </summary>
        public unsafe BmSDK.GameObject.FQuat DesiredRotation
        {
        ...
        /// <summary>
        /// ByteProperty: DesiredPhysics
        /// </summary>
        public unsafe BmSDK.Engine.Actor.EPhysics DesiredPhysics
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.Actor.EPhysics>(Ptr + 112); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 112); }; }
        }

        /// <summary>
        /// IntProperty: StuckCounter
        /// </summary>
        public unsafe int StuckCounter
        {
    ...
    public partial record struct FProceduralMovement
    {
        ...
        /// <summary>
        /// FloatProperty: AddYawVelocity
        /// </summary>
        public unsafe float AddYawVelocity
        {
        ...
        /// <summary>
        /// BoolProperty: OverrideTranslationVelocityEnabled
        /// </summary>
        public unsafe bool OverrideTranslationVelocityEnabled
        {
        ...
        /// <summary>
        /// BoolProperty: OverrideYawVelocityEnabled
        /// </summary>
        public unsafe bool OverrideYawVelocityEnabled
        {
        ...
        /// <summary>
        /// FloatProperty: OverrideYawVelocity
        /// </summary>
        public unsafe float OverrideYawVelocity
        {
