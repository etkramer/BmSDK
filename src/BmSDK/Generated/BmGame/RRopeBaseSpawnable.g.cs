...
public partial class RRopeBaseSpawnable : BmSDK.BmGame.RRopeBase, BmSDK.IGameObject
{
    ...
    public partial record struct FHangingFearRopeSetupParams
    {
        ...
        {
            get { fixed (void* thisPtr = &this) { return ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RRopeComponent.FRopeExtraAttachConnection>((IntPtr)thisPtr + 24); } }
        }
        /// <summary>
        /// StructProperty: RopeExtraAttachConnections
        /// </summary>
        ...
        {
            get { fixed (void* thisPtr = &this) { return ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RRopeComponent.FRopeExtraAttachConnection>((IntPtr)thisPtr + 76); } }
        }
