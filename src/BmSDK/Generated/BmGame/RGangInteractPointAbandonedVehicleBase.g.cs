...
public partial class RGangInteractPointAbandonedVehicleBase : BmSDK.BmGame.RGangInteractPointBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RGangInteractPointAbandonedVehicleBase.
    /// </summary>
    public static RGangInteractPointAbandonedVehicleBase DefaultObject => (RGangInteractPointAbandonedVehicleBase)StaticClass().DefaultObject;
    ...
    /// </summary>
    public enum GangPointCarState : byte
    {
        GPCS_Wheels = 0,
        GPCS_Top = 1,
        GPCS_Side = 2,
