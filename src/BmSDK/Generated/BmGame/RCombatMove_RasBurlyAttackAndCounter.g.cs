...
public partial class RCombatMove_RasBurlyAttackAndCounter : BmSDK.BmGame.RCombatMove, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RCombatMove_RasBurlyAttackAndCounter(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCombatMove_RasBurlyAttackAndCounter Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
