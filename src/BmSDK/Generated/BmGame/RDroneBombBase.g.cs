...
/// <summary>
/// ABSTRACT Class: RDroneBombBase<br/>
/// (size = 476)
/// (flags = 142606483)
/// </summary>
public partial class RDroneBombBase : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RDroneBombBase", false);
    ...
    /// <summary>
    /// Gets the class default object as RDroneBombBase.
    /// </summary>
    public static RDroneBombBase DefaultObject => (RDroneBombBase)StaticClass().DefaultObject;

    internal RDroneBombBase() { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RDroneBombBase(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDroneBombBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDroneBombBase>, new()
    ...
    /// <summary>
    /// ComponentProperty: LightAttachment
    /// </summary>
    public unsafe BmSDK.Engine.PointLightComponent LightAttachment
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.PointLightComponent>(Ptr + 436); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 436); }
    }

    /// <summary>
    /// FloatProperty: NextToggleTime
    /// </summary>
    public unsafe float NextToggleTime
    {
    ...
    /// <summary>
    /// FloatProperty: FlashMinDuration
    /// </summary>
    public unsafe float FlashMinDuration
    {
    ...
    /// <summary>
    /// FloatProperty: FlashMaxDuration
    /// </summary>
    public unsafe float FlashMaxDuration
    {
    ...
    /// <summary>
    /// FloatProperty: BombVelocity
    /// </summary>
    public unsafe float BombVelocity
    {
