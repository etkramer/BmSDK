...
public partial class RSentryKitAssignmentPicker : BmSDK.BmGame.RGroupAssignmentPicker, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSentryKitAssignmentPicker.
    /// </summary>
    public static RSentryKitAssignmentPicker DefaultObject => (RSentryKitAssignmentPicker)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSentryKitAssignmentPicker>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSentryKitAssignmentPicker>, new()
