...
public partial class R3rdPersonCamera : BmSDK.Engine.Camera, BmSDK.IGameObject
{
    ...
    /// </summary>
    public InlineArray<BmSDK.BmGame.R3rdPersonCamera.FVector3WithTime> CameraSmoothingBuffer => new(10, Ptr + 12300, 16);
    ...
    /// </summary>
    public InlineArray<float> ZoomPoints => new(9, Ptr + 12528, 4);
    ...
    /// </summary>
    public InlineArray<System.Numerics.Vector3> ZoomPointDir => new(9, Ptr + 12564, 12);
    ...
    /// </summary>
    public InlineArray<System.Numerics.Vector3> TightZoomPointDir => new(9, Ptr + 12672, 12);
