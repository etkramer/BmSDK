...
public partial class RSeqAct_SuppressDetectiveModeThroughWalls : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SuppressDetectiveModeThroughWalls.
    /// </summary>
    public static RSeqAct_SuppressDetectiveModeThroughWalls DefaultObject => (RSeqAct_SuppressDetectiveModeThroughWalls)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SuppressDetectiveModeThroughWalls>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SuppressDetectiveModeThroughWalls>, new()
