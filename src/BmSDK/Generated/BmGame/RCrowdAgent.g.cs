...
/// <summary>
/// Class: RCrowdAgent<br/>
/// (size = 544)
/// (flags = 142606994)
/// </summary>
public partial class RCrowdAgent : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RCrowdAgent", false);
    ...
    /// <summary>
    /// Constructs a new RCrowdAgent
    /// </summary>
    public RCrowdAgent(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RCrowdAgent(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCrowdAgent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCrowdAgent>, new()
    ...
    public unsafe virtual void AdvanceFlockStage(int StageNum = default)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(StageNum, paramsPtr + 0);
    ...
    public unsafe virtual bool CanRespondToAttractor(BmSDK.BmGame.RCrowdAttractor Attractor)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(Attractor, paramsPtr + 0);
    ...
    /// </summary>
    public unsafe bool bRotateToTargetRot
    {
    ...
    /// <summary>
    /// FloatProperty: AttractionMulti
    /// </summary>
    public unsafe float AttractionMulti
    {
    ...
    /// <summary>
    /// FloatProperty: WaveTimeMulti
    /// </summary>
    public unsafe float WaveTimeMulti
    {
    ...
    /// <summary>
    /// FloatProperty: WaveTimer
    /// </summary>
    public unsafe float WaveTimer
    {
    ...
    /// <summary>
    /// FloatProperty: CurrScale
    /// </summary>
    public unsafe float CurrScale
    {
    ...
    /// <summary>
    /// IntProperty: AgentGroup
    /// </summary>
    public unsafe int AgentGroup
    {
    ...
    /// <summary>
    /// FloatProperty: FlockStageTimer
    /// </summary>
    public unsafe float FlockStageTimer
    {
    ...
    /// <summary>
    /// FloatProperty: FlockNextStageTime
    /// </summary>
    public unsafe float FlockNextStageTime
    {
    ...
    /// <summary>
    /// FloatProperty: DebugTimer
    /// </summary>
    public unsafe float DebugTimer
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RCrowdSequence>(Ptr + 540); }
