...
public partial class RCrowdAgent : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RCrowdAgent(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RCrowdAgent Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
    ...
    /// <summary>
    /// FloatProperty: ScaleBlend
    /// </summary>
    public unsafe float ScaleBlend
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RCrowdSequence>(Ptr + 788); }
