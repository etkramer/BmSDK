...
public partial class RSeqEvent_EvidenceTrailAdvanced : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_EvidenceTrailAdvanced.
    /// </summary>
    public static RSeqEvent_EvidenceTrailAdvanced DefaultObject => (RSeqEvent_EvidenceTrailAdvanced)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_EvidenceTrailAdvanced>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_EvidenceTrailAdvanced>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RSeqEvent_EvidenceTrailAdvanced.GetObjClassVersion", true);
