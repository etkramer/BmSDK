...
public partial class RSwingChutePointRenderingComponent : BmSDK.Engine.PrimitiveComponent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSwingChutePointRenderingComponent.
    /// </summary>
    public static RSwingChutePointRenderingComponent DefaultObject => (RSwingChutePointRenderingComponent)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSwingChutePointRenderingComponent>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSwingChutePointRenderingComponent>, new()
