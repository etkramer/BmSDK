...
public partial class RSeqEvent_3GelWallsUsedForTakedowns : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_3GelWallsUsedForTakedowns.
    /// </summary>
    public static RSeqEvent_3GelWallsUsedForTakedowns DefaultObject => (RSeqEvent_3GelWallsUsedForTakedowns)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_3GelWallsUsedForTakedowns>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_3GelWallsUsedForTakedowns>, new()
