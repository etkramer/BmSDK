...
public partial class RVehicleBehaviour_FollowVehicle : BmSDK.BmGame.RVehicleBehaviour, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RVehicleBehaviour_FollowVehicle.
    /// </summary>
    public static RVehicleBehaviour_FollowVehicle DefaultObject => (RVehicleBehaviour_FollowVehicle)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_FollowVehicle>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RVehicleBehaviour_FollowVehicle>, new()
