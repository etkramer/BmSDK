...
public partial class ROnlineStatsReadMostWanted : BmSDK.Engine.OnlineStatsRead, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as ROnlineStatsReadMostWanted.
    /// </summary>
    public static ROnlineStatsReadMostWanted DefaultObject => (ROnlineStatsReadMostWanted)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<ROnlineStatsReadMostWanted>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<ROnlineStatsReadMostWanted>, new()
    ...
    /// </summary>
    public enum EMWLeaderboardColumns : byte
    {
        EMWC_RatingScore = 0,
