...
public partial class RSeqAct_AddRemoveApexClothCollision : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_AddRemoveApexClothCollision.
    /// </summary>
    public static RSeqAct_AddRemoveApexClothCollision DefaultObject => (RSeqAct_AddRemoveApexClothCollision)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_AddRemoveApexClothCollision>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_AddRemoveApexClothCollision>, new()
