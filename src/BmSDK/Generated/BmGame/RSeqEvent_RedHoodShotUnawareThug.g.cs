...
public partial class RSeqEvent_RedHoodShotUnawareThug : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_RedHoodShotUnawareThug.
    /// </summary>
    public static RSeqEvent_RedHoodShotUnawareThug DefaultObject => (RSeqEvent_RedHoodShotUnawareThug)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_RedHoodShotUnawareThug>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_RedHoodShotUnawareThug>, new()
