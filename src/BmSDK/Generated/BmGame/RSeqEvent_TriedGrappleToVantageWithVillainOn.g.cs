...
public partial class RSeqEvent_TriedGrappleToVantageWithVillainOn : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_TriedGrappleToVantageWithVillainOn.
    /// </summary>
    public static RSeqEvent_TriedGrappleToVantageWithVillainOn DefaultObject => (RSeqEvent_TriedGrappleToVantageWithVillainOn)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_TriedGrappleToVantageWithVillainOn>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_TriedGrappleToVantageWithVillainOn>, new()
