...
public partial class RBatmobileMissileLauncher : BmSDK.BmGame.RVehicleWeapon, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBatmobileMissileLauncher.
    /// </summary>
    public static RBatmobileMissileLauncher DefaultObject => (RBatmobileMissileLauncher)StaticClass().DefaultObject;
    ...
    public unsafe ref BmSDK.Rotator LaunchRotationOffset
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 2548);
