...
public partial class RHostageGrabPoint : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RHostageGrabPoint.
    /// </summary>
    public static RHostageGrabPoint DefaultObject => (RHostageGrabPoint)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RHostageGrabPoint(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
