...
public partial class RSeqEvent_DestructiblePropDamage : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_DestructiblePropDamage.
    /// </summary>
    public static RSeqEvent_DestructiblePropDamage DefaultObject => (RSeqEvent_DestructiblePropDamage)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_DestructiblePropDamage>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_DestructiblePropDamage>, new()
