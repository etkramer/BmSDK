...
public partial class RSeqEvent_AirshipTiltVolumeHardened : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_AirshipTiltVolumeHardened.
    /// </summary>
    public static RSeqEvent_AirshipTiltVolumeHardened DefaultObject => (RSeqEvent_AirshipTiltVolumeHardened)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_AirshipTiltVolumeHardened>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_AirshipTiltVolumeHardened>, new()
