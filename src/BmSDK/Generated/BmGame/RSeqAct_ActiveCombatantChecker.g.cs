...
public partial class RSeqAct_ActiveCombatantChecker : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_ActiveCombatantChecker.
    /// </summary>
    public static RSeqAct_ActiveCombatantChecker DefaultObject => (RSeqAct_ActiveCombatantChecker)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ActiveCombatantChecker>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_ActiveCombatantChecker>, new()
