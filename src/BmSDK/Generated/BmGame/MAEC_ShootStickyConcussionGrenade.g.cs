...
public partial class MAEC_ShootStickyConcussionGrenade : BmSDK.BmGame.RAlertEventCoordinatorBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as MAEC_ShootStickyConcussionGrenade.
    /// </summary>
    public static MAEC_ShootStickyConcussionGrenade DefaultObject => (MAEC_ShootStickyConcussionGrenade)StaticClass().DefaultObject;
    ...
    public unsafe virtual void GatherPointsFromCenter(System.Numerics.Vector3 TargetLoc, BmSDK.Rotator rotator1, float Radius)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(rotator1, paramsPtr + 12);
