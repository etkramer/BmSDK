...
public partial class RBatmobileSonar : BmSDK.BmGame.RVehicleWeapon, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBatmobileSonar.
    /// </summary>
    public static RBatmobileSonar DefaultObject => (RBatmobileSonar)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe virtual void SetMeshOwner(BmSDK.Engine.Actor NewOwner, BmSDK.Engine.ActorComponent MeshComp)
    {
    ...
    /// </summary>
    public unsafe virtual void UpdateScannedMeshes(float DeltaTime)
    {
    ...
    /// </summary>
    public unsafe virtual void FireForensicPulseSideStory(BmSDK.BmGame.RPlayerController PC)
    {
    ...
    /// </summary>
    public unsafe virtual void FireForensicPulse(BmSDK.BmGame.RPlayerController PC)
    {
    ...
    /// </summary>
    public unsafe virtual void AlertNearbyVehicles(System.Numerics.Vector3 pos, float Range)
    {
    ...
    /// </summary>
    public unsafe virtual void StopBatmobileMoving()
    {
    ...
    /// </summary>
    public unsafe virtual void ScannedVehiclesOff()
    {
    ...
    /// </summary>
    public unsafe virtual void CreateScannedMesh(BmSDK.Engine.Actor Target, BmSDK.Engine.SkeletalMeshComponent MeshToHighlight, out int NumScannedVehicles, BmSDK.Engine.MaterialInterface MaterialToUse)
    {
    ...
    /// </summary>
    public unsafe virtual void PerformVehicleScan()
    {
    ...
    /// Function: FirePulse
    /// </summary>
    public unsafe virtual bool FirePulse()
    {
    ...
    /// </summary>
    public unsafe virtual void NoScannerOffSound()
    {
    ...
    /// </summary>
    public unsafe virtual void NoScannerOnSound()
    {
    ...
    /// </summary>
    public unsafe virtual void SonarReleased()
    {
    ...
    /// </summary>
    public unsafe virtual void SonarPressed()
    {
    ...
    public unsafe ref BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct ChargingScreenShake
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct>(Ptr + 2408);
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct ScanScreenShake
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct>(Ptr + 2688);

    /// <summary>
    /// StructProperty: BlastScreenShake
    /// </summary>
    public unsafe ref BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct BlastScreenShake
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RBMScreenShakeModifier.FBMScreenShakeStruct>(Ptr + 2844);
