...
public partial class RSeqCond_AreSideStoriesDisabled : BmSDK.Engine.SequenceCondition, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqCond_AreSideStoriesDisabled.
    /// </summary>
    public static RSeqCond_AreSideStoriesDisabled DefaultObject => (RSeqCond_AreSideStoriesDisabled)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqCond_AreSideStoriesDisabled>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqCond_AreSideStoriesDisabled>, new()
