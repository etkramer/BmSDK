...
/// <summary>
/// Class: RDmgType_BigHit<br/>
/// (size = 0)
/// (flags = 0)
/// </summary>
public partial class RDmgType_BigHit : BmSDK.BmGame.RDamageType, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RDmgType_BigHit", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal RDmgType_BigHit() { }

    /// <summary>
    /// Constructs a new RDmgType_BigHit
    /// </summary>
    public RDmgType_BigHit(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RDmgType_BigHit Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RDmgType_BigHit(nint ptr) : base(ptr) { }
