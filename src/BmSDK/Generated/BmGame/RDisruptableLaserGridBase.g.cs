...
public partial class RDisruptableLaserGridBase : BmSDK.BmGame.RDisruptableObjectDoor, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDisruptableLaserGridBase.
    /// </summary>
    public static RDisruptableLaserGridBase DefaultObject => (RDisruptableLaserGridBase)StaticClass().DefaultObject;
    ...
    public unsafe virtual void HitPawn(BmSDK.BmGame.RPawnCombat PawnToHit, bool bUseDamagedBy = default)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(bUseDamagedBy, paramsPtr + 8);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return;
    }
    ...
    public unsafe ref BmSDK.Engine.AkWwise.FAkSoundHandle ShockedFXSoundHandle
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Engine.AkWwise.FAkSoundHandle>(Ptr + 848);
