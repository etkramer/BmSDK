...
public partial class RAEC_Sub_MuseumBooth : BmSDK.BmGame.RAlertEventCoordinatorBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAEC_Sub_MuseumBooth.
    /// </summary>
    public static RAEC_Sub_MuseumBooth DefaultObject => (RAEC_Sub_MuseumBooth)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RAEC_Sub_MuseumBooth(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
