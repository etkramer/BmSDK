...
public partial class RSeqAct_SwitchDualPlayerCharacter : BmSDK.BmGame.RSeqAct_SpawnerBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_SwitchDualPlayerCharacter.
    /// </summary>
    public static RSeqAct_SwitchDualPlayerCharacter DefaultObject => (RSeqAct_SwitchDualPlayerCharacter)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SwitchDualPlayerCharacter>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_SwitchDualPlayerCharacter>, new()
