...
public partial class RSeqEvent_BatmobileRiddlerButton : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_BatmobileRiddlerButton.
    /// </summary>
    public static RSeqEvent_BatmobileRiddlerButton DefaultObject => (RSeqEvent_BatmobileRiddlerButton)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_BatmobileRiddlerButton>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_BatmobileRiddlerButton>, new()
