...
public partial class RDmgType_ThugMineExplosion_Player : BmSDK.BmGame.RDmgType_Explosion, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_ThugMineExplosion_Player.
    /// </summary>
    public static RDmgType_ThugMineExplosion_Player DefaultObject => (RDmgType_ThugMineExplosion_Player)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_ThugMineExplosion_Player>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_ThugMineExplosion_Player>, new()
