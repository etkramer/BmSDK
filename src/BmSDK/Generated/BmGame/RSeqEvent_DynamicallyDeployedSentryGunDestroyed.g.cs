...
public partial class RSeqEvent_DynamicallyDeployedSentryGunDestroyed : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_DynamicallyDeployedSentryGunDestroyed.
    /// </summary>
    public static RSeqEvent_DynamicallyDeployedSentryGunDestroyed DefaultObject => (RSeqEvent_DynamicallyDeployedSentryGunDestroyed)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_DynamicallyDeployedSentryGunDestroyed>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_DynamicallyDeployedSentryGunDestroyed>, new()
