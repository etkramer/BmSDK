...
public partial class RGFxMovieWorldBase : BmSDK.BmGame.RGFxMovie, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RGFxMovieWorldBase.
    /// </summary>
    public static RGFxMovieWorldBase DefaultObject => (RGFxMovieWorldBase)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RGFxMovieWorldBase>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RGFxMovieWorldBase>, new()
