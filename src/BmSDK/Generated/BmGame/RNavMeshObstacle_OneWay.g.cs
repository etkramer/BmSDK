...
public partial class RNavMeshObstacle_OneWay : BmSDK.Engine.NavMeshObstacle, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RNavMeshObstacle_OneWay(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RNavMeshObstacle_OneWay Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
