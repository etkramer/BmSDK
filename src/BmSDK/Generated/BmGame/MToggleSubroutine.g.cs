...
public partial class MToggleSubroutine : BmSDK.BmGame.MHackSubroutine, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.MToggleSubroutine", false);
            s_staticClass.AddToRoot();
        }
        return s_staticClass;
    }

    internal MToggleSubroutine() { }

    /// <summary>
    /// Constructs a new MToggleSubroutine
    /// </summary>
    public MToggleSubroutine(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, MToggleSubroutine Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected MToggleSubroutine(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<MToggleSubroutine>
        => ((Engine.Actor)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="Engine.Actor.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<MToggleSubroutine>, new()
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.MHackableInterface.FSubroutineDefinition Definition
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.MHackableInterface.FSubroutineDefinition>(Ptr + 712); }
