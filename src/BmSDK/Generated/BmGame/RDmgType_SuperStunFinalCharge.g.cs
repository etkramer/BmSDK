...
public partial class RDmgType_SuperStunFinalCharge : BmSDK.BmGame.RDmgType_SuperStunFinal, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_SuperStunFinalCharge.
    /// </summary>
    public static RDmgType_SuperStunFinalCharge DefaultObject => (RDmgType_SuperStunFinalCharge)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_SuperStunFinalCharge>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_SuperStunFinalCharge>, new()
