...
public partial class RRandomDelay : BmSDK.Engine.Actor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RRandomDelay(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RRandomDelay Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
