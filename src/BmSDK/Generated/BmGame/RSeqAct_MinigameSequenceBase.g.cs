...
/// <summary>
/// Class: RSeqAct_MinigameSequenceBase<br/>
/// (flags = 0)
/// </summary>
public partial class RSeqAct_MinigameSequenceBase : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Constructs a new RSeqAct_MinigameSequenceBase
    /// </summary>
    public RSeqAct_MinigameSequenceBase(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSeqAct_MinigameSequenceBase Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
