...
public partial class RGFxMovieModularHud_LocalRadar : BmSDK.BmGame.RGFxMovieModularHudBase, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RGFxMovieModularHud_LocalRadar.
    /// </summary>
    public static RGFxMovieModularHud_LocalRadar DefaultObject => (RGFxMovieModularHud_LocalRadar)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RGFxMovieModularHud_LocalRadar>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RGFxMovieModularHud_LocalRadar>, new()
    ...
    /// </summary>
    public unsafe override void RegisterAsManualAdvanceMovie(bool do_register)
    {
