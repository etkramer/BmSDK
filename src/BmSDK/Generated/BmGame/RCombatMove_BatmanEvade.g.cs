...
public partial class RCombatMove_BatmanEvade : BmSDK.BmGame.RCombatMove_BatmanAttack, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCombatMove_BatmanEvade.
    /// </summary>
    public static RCombatMove_BatmanEvade DefaultObject => (RCombatMove_BatmanEvade)StaticClass().DefaultObject;
    ...
    /// </summary>
    public RCombatMove_BatmanEvade(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
