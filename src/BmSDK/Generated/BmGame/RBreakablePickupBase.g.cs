...
public partial class RBreakablePickupBase : BmSDK.BmGame.RBreakableProp, BmSDK.BmGame.RSecretInterface, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RBreakablePickupBase(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBreakablePickupBase Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
