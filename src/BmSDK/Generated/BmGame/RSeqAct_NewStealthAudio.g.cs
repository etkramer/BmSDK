...
/// <summary>
/// Class: RSeqAct_NewStealthAudio<br/>
/// (size = 288)
/// (flags = 134226066)
/// </summary>
public partial class RSeqAct_NewStealthAudio : BmSDK.Engine.SeqAct_Latent, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RSeqAct_NewStealthAudio", false);
    ...
    /// <summary>
    /// Constructs a new RSeqAct_NewStealthAudio
    /// </summary>
    public RSeqAct_NewStealthAudio(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RSeqAct_NewStealthAudio Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RSeqAct_NewStealthAudio(nint ptr) : base(ptr) { }
    ...
    /// <summary>
    /// Function: UpdateStealthValue
    /// </summary>
    public unsafe void UpdateStealthValue(float DeltaTime)
    {
    ...
    /// </summary>
    public unsafe void InitializeSetting()
    {
    ...
    /// </summary>
    public unsafe void LogToScreen(BmSDK.FString String)
    {
    ...
    /// </summary>
    public unsafe void SetMusicState(BmSDK.Engine.AkStateName StateToSet)
    {
    ...
    /// <summary>
    /// Function: SetStealthParam
    /// </summary>
    public unsafe void SetStealthParam(float SetValue, float timeToInterp)
    {
    ...
    /// <summary>
    /// IntProperty: MaximumToSetParameterTo
    /// </summary>
    public unsafe int MaximumToSetParameterTo
    {
    ...
    /// <summary>
    /// IntProperty: StartingParameterValue
    /// </summary>
    public unsafe int StartingParameterValue
    {
    ...
    /// <summary>
    /// FloatProperty: TimeBeforeStartDecreasing
    /// </summary>
    public unsafe float TimeBeforeStartDecreasing
    {
    ...
    /// <summary>
    /// IntProperty: MimimumValueToFallToAfterEnemiesKilled
    /// </summary>
    public unsafe int MimimumValueToFallToAfterEnemiesKilled
    {
    ...
    /// <summary>
    /// ObjectProperty: StealthParam
    /// </summary>
    public unsafe BmSDK.Engine.AkParameterName StealthParam
    {
    ...
    /// <summary>
    /// ObjectProperty: SuccessState
    /// </summary>
    public unsafe BmSDK.Engine.AkStateName SuccessState
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.AkStateName>(Ptr + 240); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 240); }
    }

    /// <summary>
    /// ObjectProperty: FailState
    /// </summary>
    public unsafe BmSDK.Engine.AkStateName FailState
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.AkStateName>(Ptr + 244); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 244); }
    }

    /// <summary>
    /// ObjectProperty: SPDefaultState
    /// </summary>
    public unsafe BmSDK.Engine.AkStateName SPDefaultState
    {
    ...
    /// <summary>
    /// FloatProperty: TimeToInterpolateBetweenValues
    /// </summary>
    public unsafe float TimeToInterpolateBetweenValues
    {
    ...
    /// <summary>
    /// BoolProperty: DebugOutput
    /// </summary>
    public unsafe bool DebugOutput
    {
    ...
    /// <summary>
    /// BoolProperty: bSetDefault
    /// </summary>
    public unsafe bool bSetDefault
    {
    ...
    /// <summary>
    /// BoolProperty: bDropDown
    /// </summary>
    public unsafe bool bDropDown
    {
    ...
    /// <summary>
    /// BoolProperty: bNewKnockout
    /// </summary>
    public unsafe bool bNewKnockout
    {
    ...
    /// <summary>
    /// BoolProperty: bPlayerBeingShotAt
    /// </summary>
    public unsafe bool bPlayerBeingShotAt
    {
    ...
    /// <summary>
    /// BoolProperty: bOldPlayerBeingShotAt
    /// </summary>
    public unsafe bool bOldPlayerBeingShotAt
    {
    ...
    /// <summary>
    /// FloatProperty: DebugOutputUpdateTime
    /// </summary>
    public unsafe float DebugOutputUpdateTime
    {
    ...
    /// <summary>
    /// FloatProperty: DebugOutputTimer
    /// </summary>
    public unsafe float DebugOutputTimer
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPlayerController>(Ptr + 268); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 268); }
    }

    /// <summary>
    /// FloatProperty: TimeSinceLastTakeDown
    /// </summary>
    public unsafe float TimeSinceLastTakeDown
    {
    ...
    /// <summary>
    /// IntProperty: NumberOfPawnsKnockedOut
    /// </summary>
    public unsafe int NumberOfPawnsKnockedOut
    {
    ...
    /// <summary>
    /// FloatProperty: CurrentSilentPredatorValue
    /// </summary>
    public unsafe float CurrentSilentPredatorValue
    {
    ...
    /// <summary>
    /// FloatProperty: OldCurrentSilentPredatorValue
    /// </summary>
    public unsafe float OldCurrentSilentPredatorValue
    {
