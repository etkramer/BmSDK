...
public partial class RBMBehaviour_CombatCroc : BmSDK.BmGame.RBMBehaviour_CombatJokerBoxer, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_CombatCroc.
    /// </summary>
    public static RBMBehaviour_CombatCroc DefaultObject => (RBMBehaviour_CombatCroc)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_CombatCroc>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_CombatCroc>, new()
