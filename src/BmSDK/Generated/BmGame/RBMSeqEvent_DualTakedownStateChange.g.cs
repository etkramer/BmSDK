...
public partial class RBMSeqEvent_DualTakedownStateChange : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMSeqEvent_DualTakedownStateChange.
    /// </summary>
    public static RBMSeqEvent_DualTakedownStateChange DefaultObject => (RBMSeqEvent_DualTakedownStateChange)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMSeqEvent_DualTakedownStateChange>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMSeqEvent_DualTakedownStateChange>, new()
