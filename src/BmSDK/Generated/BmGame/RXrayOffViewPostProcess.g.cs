...
public partial class RXrayOffViewPostProcess : BmSDK.BmGame.RViewPostProcess, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RXrayOffViewPostProcess.
    /// </summary>
    public static RXrayOffViewPostProcess DefaultObject => (RXrayOffViewPostProcess)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RXrayOffViewPostProcess>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RXrayOffViewPostProcess>, new()
