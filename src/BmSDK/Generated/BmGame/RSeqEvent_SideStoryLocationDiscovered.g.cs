...
public partial class RSeqEvent_SideStoryLocationDiscovered : BmSDK.Engine.SequenceEvent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqEvent_SideStoryLocationDiscovered.
    /// </summary>
    public static RSeqEvent_SideStoryLocationDiscovered DefaultObject => (RSeqEvent_SideStoryLocationDiscovered)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_SideStoryLocationDiscovered>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqEvent_SideStoryLocationDiscovered>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmGame.RSeqEvent_SideStoryLocationDiscovered.GetObjClassVersion", true);
