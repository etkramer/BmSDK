...
public partial class RFreezeSprayProjectile : BmSDK.BmGame.RGadgetProjectileBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe void ProximityTriggerd(BmSDK.BmGame.RPawnVillain NearbyVillain)
    {
    ...
    /// </summary>
    public unsafe void StartFreezeBlastFailEffect(bool bUseOffset = default)
    {
    ...
    /// </summary>
    public unsafe void FreezeVictimBody(BmSDK.BmGame.RPawnVillain Victim, bool bInstant = default)
    {
