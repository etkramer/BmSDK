...
public partial class RDmgType_Takedown_LedgeHang : BmSDK.BmGame.RDmgType_Takedown_Hang, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RDmgType_Takedown_LedgeHang.
    /// </summary>
    public static RDmgType_Takedown_LedgeHang DefaultObject => (RDmgType_Takedown_LedgeHang)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RDmgType_Takedown_LedgeHang>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RDmgType_Takedown_LedgeHang>, new()
