...
public partial class RJobAssignment_GrateGrenade : BmSDK.BmGame.RJobAssignment, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RJobAssignment_GrateGrenade.
    /// </summary>
    public static RJobAssignment_GrateGrenade DefaultObject => (RJobAssignment_GrateGrenade)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RJobAssignment_GrateGrenade>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RJobAssignment_GrateGrenade>, new()
