...
public partial class RAnimNotify_ValidFrames : BmSDK.BmGame.RAnimNotify_BeginEnd, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAnimNotify_ValidFrames.
    /// </summary>
    public static RAnimNotify_ValidFrames DefaultObject => (RAnimNotify_ValidFrames)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_ValidFrames>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAnimNotify_ValidFrames>, new()
