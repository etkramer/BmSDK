...
public partial class RRadioCWViewPostProcess : BmSDK.BmGame.RViewPostProcess, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RRadioCWViewPostProcess.
    /// </summary>
    public static RRadioCWViewPostProcess DefaultObject => (RRadioCWViewPostProcess)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RRadioCWViewPostProcess>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RRadioCWViewPostProcess>, new()
