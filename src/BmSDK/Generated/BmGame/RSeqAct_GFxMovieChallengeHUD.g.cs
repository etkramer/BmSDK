...
public partial class RSeqAct_GFxMovieChallengeHUD : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_GFxMovieChallengeHUD.
    /// </summary>
    public static RSeqAct_GFxMovieChallengeHUD DefaultObject => (RSeqAct_GFxMovieChallengeHUD)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_GFxMovieChallengeHUD>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_GFxMovieChallengeHUD>, new()
