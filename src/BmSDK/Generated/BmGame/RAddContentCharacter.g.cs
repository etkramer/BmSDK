...
public partial class RAddContentCharacter : BmSDK.BmGame.RAdditionalContent, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RAddContentCharacter.
    /// </summary>
    public static RAddContentCharacter DefaultObject => (RAddContentCharacter)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RAddContentCharacter>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RAddContentCharacter>, new()
