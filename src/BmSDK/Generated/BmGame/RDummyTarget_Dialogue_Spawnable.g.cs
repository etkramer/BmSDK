...
public partial class RDummyTarget_Dialogue_Spawnable : BmSDK.BmGame.RDummyTarget_Dialogue, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RDummyTarget_Dialogue_Spawnable(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RDummyTarget_Dialogue_Spawnable Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
