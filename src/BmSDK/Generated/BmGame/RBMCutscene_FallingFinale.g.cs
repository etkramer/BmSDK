...
public partial class RBMCutscene_FallingFinale : BmSDK.BmGame.RBMCutscene_SilentPredatorFinale, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMCutscene_FallingFinale.
    /// </summary>
    public static RBMCutscene_FallingFinale DefaultObject => (RBMCutscene_FallingFinale)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMCutscene_FallingFinale>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMCutscene_FallingFinale>, new()
