...
public partial class RPawnCombat : BmSDK.BmGame.RPawnCharacter, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe bool GetKnockBackAnimInfo(BmSDK.BmGame.RPawnVillain Villain, BmSDK.BmGame.RPawnCombat.CounterLimb Limb, out BmSDK.FName KnockBackAnimName, out BmSDK.Engine.AnimSet KnockBackAnimset)
    {
    ...
    /// </summary>
    public unsafe void KnockedOutPawn(BmSDK.BmGame.RPawnCombat KOPawn)
    {
    ...
    /// </summary>
    public unsafe bool FindHighestPriorityPawnFromList(BmSDK.TArray<BmSDK.BmGame.RPawnVillain> TestPawnList, BmSDK.Class dmgType, out BmSDK.BmGame.RPawnVillain PriorityPawn, float MaxDist)
    {
    ...
    /// </summary>
    public unsafe bool FindClosestPawnFromList(BmSDK.TArray<BmSDK.BmGame.RPawnVillain> TestPawnList, out float ClosestDist, out BmSDK.BmGame.RPawnVillain ClosestPawn)
    {
    ...
    /// </summary>
    public unsafe void PlaySound_Impact(BmSDK.BmGame.RPawnCombat Villain, bool bIsStrike, bool bFinishingBlow, bool bIsHeadImpact, bool bIsPunch, bool bIsStrong, bool bIsBlocked, bool bCanEmote = default)
    {
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RPawnCombat.CounterLimb GetCounterLimb()
    {
    ...
    /// Function: PawnAngle
    /// </summary>
    public unsafe float PawnAngle(BmSDK.BmGame.RPawnCombat OtherPawn)
    {
    ...
    /// </summary>
    public unsafe void NudgeTouchedRigidBodies(System.Numerics.Vector3 footPosition, System.Numerics.Vector3 characterVelocity, float forceScale, float characterVelocityLimit, bool applyAsImpulse)
    {
    ...
    /// </summary>
    public unsafe bool IsClayfaceDrone()
    {
