...
public partial class RMissingHostageAIMarker : BmSDK.Engine.Actor, BmSDK.BmGame.RSpotableInterface, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RMissingHostageAIMarker(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RMissingHostageAIMarker Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }
