...
/// <summary>
/// Class: RSpecialMoveInstance_AnimMove<br/>
/// (size = 888)
/// (flags = 10485778)
/// </summary>
public partial class RSpecialMoveInstance_AnimMove : BmSDK.BmGame.RSpecialMoveInstance, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmGame.RSpecialMoveInstance_AnimMove", false);
    ...
    /// <summary>
    /// Gets the class default object as RSpecialMoveInstance_AnimMove.
    /// </summary>
    public static RSpecialMoveInstance_AnimMove DefaultObject => (RSpecialMoveInstance_AnimMove)StaticClass().DefaultObject;

    internal RSpecialMoveInstance_AnimMove() { }

    /// <summary>
    /// Constructs a new RSpecialMoveInstance_AnimMove
    /// </summary>
    public RSpecialMoveInstance_AnimMove(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null, BmSDK.Engine.Level Level = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), default, Location, Rotation, Template, Owner, Instigator, Level)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RSpecialMoveInstance_AnimMove(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveInstance_AnimMove>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSpecialMoveInstance_AnimMove>, new()
    ...
    /// Function: AlignRoot
    /// </summary>
    public unsafe virtual void AlignRoot(float CollisionHeight, BmSDK.BmGame.REnvironmentCheckTicker.FEnvironmentSpecialMoveLocator Loc)
    {
    ...
    /// <summary>
    /// StructProperty: Overlay
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_OverlayPlayer.FOverlayId Overlay
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RAnimUtil_OverlayPlayer.FOverlayId>(Ptr + 876);

    /// <summary>
    /// BoolProperty: bStage2
    /// </summary>
    public unsafe bool bStage2
    {
