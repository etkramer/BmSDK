...
/// (flags = 8388626)
/// </summary>
public partial class RAEC_Sub_Disarmed : BmSDK.BmGame.RAlertEventCoordinatorBase, BmSDK.IGameObject
{
    ...
    /// </summary>
    public RAEC_Sub_Disarmed(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), Location, Rotation, Template, Owner, Instigator)) { }
    ...
    /// <summary>
    /// ObjectProperty: DisarmedCon
    /// </summary>
    public unsafe BmSDK.BmGame.RBMAIController DisarmedCon
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RBMCombatThrownObject>(Ptr + 456); }
