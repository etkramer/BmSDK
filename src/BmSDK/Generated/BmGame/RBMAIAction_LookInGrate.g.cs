...
public partial class RBMAIAction_LookInGrate : BmSDK.BmGame.RBMAIAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMAIAction_LookInGrate.
    /// </summary>
    public static RBMAIAction_LookInGrate DefaultObject => (RBMAIAction_LookInGrate)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe ref BmSDK.BmGame.RBMAIAction_LookInGrate.FsCachedAnimData cachedAnimData
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RBMAIAction_LookInGrate.FsCachedAnimData>(Ptr + 992);
