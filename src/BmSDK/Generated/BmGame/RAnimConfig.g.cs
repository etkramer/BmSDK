...
public partial class RAnimConfig : BmSDK.GameObject, BmSDK.IGameObject
{
    ...
    public partial record struct FCustomAdditiveAnimConfig
    {
        ...
        public unsafe BmSDK.BmGame.RAnimConfig.EAdditiveSubtractMode SubtractMode
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAnimConfig.EAdditiveSubtractMode>(Ptr + 32); }; }
    ...
    public partial record struct FCustomAnimConfig
    {
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.RAimingConfig>(Ptr + 32); }; }
            set { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 32); }; }
        }
        ...
        {
            get { fixed (void* thisPtr = &this) { IntPtr Ptr = (IntPtr)thisPtr; return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RDirectionalAnimConfig>(Ptr + 40); }; }
