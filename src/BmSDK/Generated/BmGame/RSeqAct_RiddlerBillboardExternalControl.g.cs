...
public partial class RSeqAct_RiddlerBillboardExternalControl : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_RiddlerBillboardExternalControl.
    /// </summary>
    public static RSeqAct_RiddlerBillboardExternalControl DefaultObject => (RSeqAct_RiddlerBillboardExternalControl)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_RiddlerBillboardExternalControl>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_RiddlerBillboardExternalControl>, new()
