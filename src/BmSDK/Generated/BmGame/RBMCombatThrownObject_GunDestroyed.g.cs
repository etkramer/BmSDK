...
public partial class RBMCombatThrownObject_GunDestroyed : BmSDK.BmGame.RBMCombatThrownObject, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RBMCombatThrownObject_GunDestroyed.
    /// </summary>
    public static RBMCombatThrownObject_GunDestroyed DefaultObject => (RBMCombatThrownObject_GunDestroyed)StaticClass().DefaultObject;
    ...
    /// </summary>
    public unsafe ref BmSDK.Rotator rThugDirection
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 1184);
}
