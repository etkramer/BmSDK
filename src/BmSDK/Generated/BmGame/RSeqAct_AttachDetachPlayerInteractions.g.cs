...
public partial class RSeqAct_AttachDetachPlayerInteractions : BmSDK.Engine.SequenceAction, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RSeqAct_AttachDetachPlayerInteractions.
    /// </summary>
    public static RSeqAct_AttachDetachPlayerInteractions DefaultObject => (RSeqAct_AttachDetachPlayerInteractions)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RSeqAct_AttachDetachPlayerInteractions>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RSeqAct_AttachDetachPlayerInteractions>, new()
