...
public partial class RInteractableItem : BmSDK.Engine.StaticMeshActor, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe virtual bool CanBeMissileTargetted()
    {
    ...
    /// </summary>
    public unsafe virtual bool HasUsedEvent()
    {
    ...
    /// </summary>
    public unsafe ref BmSDK.Rotator UseAngleOffset
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 856);
