...
public partial class RVehicleSimTankNPC : BmSDK.BmGame.RVehicleSimNPC, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RVehicleSimTankNPC.
    /// </summary>
    public static RVehicleSimTankNPC DefaultObject => (RVehicleSimTankNPC)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RVehicleSimTankNPC>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RVehicleSimTankNPC>, new()
