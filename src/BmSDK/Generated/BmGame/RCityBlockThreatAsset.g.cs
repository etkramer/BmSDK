...
public partial class RCityBlockThreatAsset : BmSDK.BmGame.RConfig, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RCityBlockThreatAsset.
    /// </summary>
    public static RCityBlockThreatAsset DefaultObject => (RCityBlockThreatAsset)StaticClass().DefaultObject;
    ...
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RCityBlockThreatAsset>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RCityBlockThreatAsset>, new()
